...
#define CXWnd__GetWindowTextA_x                                    0x0         // Removed / Inlined
...
// Camera
#define EverQuest__Cameras_x                                       0x0 // EverQuest -> rdi: [rdi+rax*8+1410h]
