...
enum ALTCURRENCY
{
	...
	ALTCURRENCY_FAYCITES = 14,
	ALTCURRENCY_MCKENZIE = 18,
	ALTCURRENCY_BAYLE = 19,
	ALTCURRENCY_RECLAMATION = 20,
	ALTCURRENCY_BRELLIUM = 21,
	ALTCURRENCY_MOTES = 22,
	ALTCURRENCY_VOUCHER = 26,
	ALTCURRENCY_COMMEMORATIVE_COINS = 33,
	ALTCURRENCY_ENERGYCRYSTALS = 36,
	ALTCURRENCY_BIFURCATEDCOIN = 39,
	ALTCURRENCY_ADOPTIVE = 40,
	ALTCURRENCY_SATHIRSTRADEGEMS = 41,
	ALTCURRENCY_FETTERREDIFRITCOINS = 45,
	ALTCURRENCY_FROSTSTONEDUCAT = 48,
	ALTCURRENCY_WARLORDSSYMBOL = 49,
	ALTCURRENCY_OVERSEERTETRADRACHM = 50,
	ALTCURRENCY_RESTLESSMARK = 51,
	ALTCURRENCY_WARFORGEDEMBLEM = 52,
	ALTCURRENCY_SPIRITUALMEDALLION = 56,
};
