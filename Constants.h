...
enum ALTCURRENCY
{
	...
	ALTCURRENCY_FAYCITES = 14, // Retained for backwards compatiblity
	...
	ALTCURRENCY_MCKENZIE = 18, // Retained for backwards compatiblity
	ALTCURRENCY_BAYLEMARKS = 19, // SoD
	ALTCURRENCY_BAYLE = 19, // Retained for backwards compatiblity
	ALTCURRENCY_TOKENSOFRECLAMATION = 20, // EQ
	ALTCURRENCY_RECLAMATION = 20, // Retained for backwards compatiblity
	ALTCURRENCY_BRELLIUMTOKENS = 21, // UF
	ALTCURRENCY_BRELLIUM = 21, // Retained for backwards compatiblity
	ALTCURRENCY_DREAMMOTES = 22, // HoT
	ALTCURRENCY_MOTES = 22, // Retained for backwards compatiblity
	...
	ALTCURRENCY_VOUCHER = 26, // Retained for backwards compatiblity
	...
	ALTCURRENCY_COMMEMORATIVE_COINS = 33, // Retained for backwards compatiblity
	ALTCURRENCY_FISTSOFBAYLE = 34, // CoTF
	ALTCURRENCY_NOBLES = 35, // EQ
	ALTCURRENCY_ARXENERGYCRYSTALS = 36, // TDS
	ALTCURRENCY_ENERGYCRYSTALS = 36, // Retained for backwards compatiblity
	ALTCURRENCY_PIECESOFEIGHT = 37, // TDS
	ALTCURRENCY_REMNANTSOFTRANQUILITY = 38, // TBM
	ALTCURRENCY_BIFURCATEDCOINS = 39, // TBM
	ALTCURRENCY_BIFURCATEDCOIN = 39, // Retained for backwards compatiblity
	ALTCURRENCY_ADOPTIONCOINS = 40, // EQ
	ALTCURRENCY_ADOPTIVE = 40, // Retained for backwards compatiblity
	ALTCURRENCY_SATHIRTRADEGEMS = 41, // EoK
	ALTCURRENCY_SATHIRSTRADEGEMS = 41, // Retained for backwards compatiblity
	...
	ALTCURRENCY_FETTERREDIFRITCOINS = 45, // Retained for backwards compatiblity
	ALTCURRENCY_ENTWINEDDJINNCOINS = 46, // TBL
	ALTCURRENCY_CRYSTALLIZEDLUCK = 47, // TBL
	ALTCURRENCY_FROSTSTONEDUCATS = 48, // ToV Group
	ALTCURRENCY_FROSTSTONEDUCAT = 48, // Retained for backwards compatiblity
	ALTCURRENCY_WARLORDSSYMBOLS = 49, // ToV Raid
	ALTCURRENCY_WARLORDSSYMBOL = 49, // Retained for backwards compatibility
	ALTCURRENCY_OVERSEERTETRADRACHMS = 50, // Overseer
	ALTCURRENCY_OVERSEERTETRADRACHM = 50, // Retained for backwards compatiblity
	ALTCURRENCY_RESTLESSMARKS = 51, // CoV
	ALTCURRENCY_RESTLESSMARK = 51, // Retained for backwards compatibility
	ALTCURRENCY_WARFORGEDEMBLEMS = 52, // CoV
	ALTCURRENCY_WARFORGEDEMBLEM = 52, // Retained for backwards compatibility
	...
	ALTCURRENCY_SPIRITUALMEDALLION = 56, // Retained for backwards compatibility
