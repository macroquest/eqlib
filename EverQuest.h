...
/*0x040*/ uint32_t          Command;
/*0x044*/ uint8_t           SoloMode;
...
/*0x060*/ uint8_t           Runmode;
/*0x063*/ uint8_t           MouseCntrl;
/*0x064*/ uint8_t           MouseActive;
/*0x065*/ uint8_t           ForceCrouch;
/*0x068*/ UINT              ForceCrouchTimer;
/*0x06c*/ float             friction;
/*0x070*/ float             afriction;
/*0x074*/ int               MouseX;
/*0x078*/ int               MouseY;
/*0x07c*/ int               MouseZ;
/*0x080*/ int               Lastmx;
...
/*0x09c*/ uint8_t           CurrentChan;
/*0x0a0*/ int               CurrentLang;
/*0x0a4*/ char              TellTarget[64];
/*0x0e4*/ uint32_t          LastMinute;
/*0x0f0*/ uint8_t           MInverse;
/*0x0f2*/ uint8_t           MouseLook;
/*0x0f3*/ bool              bDefaultMouseLook;
/*0x0f4*/ uint8_t           Strafe;
/*0x0f5*/ bool              bNetstat;
/*0x0f6*/ uint8_t           ModInventory;
/*0x0f8*/ uint32_t          LastHitter;
/*0x0fc*/ uint8_t           Harmless;
/*0x0fd*/ uint8_t           Silenced;
/*0x104*/ uint32_t          EventJump;
/*0x108*/ uint32_t          LastJump;
/*0x10c*/ uint32_t          FrameTime;
/*0x110*/ int               AutoRun;
/*0x114*/ uint32_t          PoisonTimer;
/*0x118*/ ItemGlobalIndex   PoisonGI;
/*0x12c*/ uint8_t           OldMouseButtons[8];
/*0x134*/ uint8_t           MouseButtons[8];
/*0x13c*/ bool              bIsMouseRightHanded;
/*0x140*/ int8_t            EncumberStatus;
/*0x148*/ char              PendingCharacterName[64];
/*0x188*/ int               TutorialMode;
/*0x194*/ uint32_t          RMouseDown;
/*0x198*/ uint32_t          LMouseDown;
/*0x19c*/ char              Snooper[64];
/*0x1dc*/ uint32_t          DuelTarget;
/*0x1e0*/ uint32_t          DuelMe;
/*0x1e4*/ uint8_t           DuelOn;
/*0x1e8*/ uint32_t          AutoHelp;
/*0x1f0*/ uint32_t          LastLocalUpdate;
/*0x1fc*/ int               SavedPC;
/*0x200*/ int               InfraRed;
...
/*0x214*/ int               UltraBlue;
/*0x218*/ int               globalOffset;
/*0x298*/ uint32_t          ExitCounter;
/*0x29c*/ uint32_t          ExitStart;
/*0x2a0*/ uint32_t          ForcedExitCounter;
/*0x2a4*/ uint32_t          OfflineModeRequestTime;
/*0x2b4*/ float             CampY;
/*0x2b8*/ float             CampX;
/*0x2bc*/ float             CampZ;
/*0x2d0*/ long              MyY;
...
/*0x71c*/ int               Rateleft;
/*0x720*/ int               Rateright;
/*0x724*/ int               RaceWar; // FIXME: Continue adjusting from here
/*0x728*/ int               Ruleset;
