...
/*0x200*/ int                BarIndex;
/*0x204*/ int                ButtonIndex;
/*0x208*/ uint32_t           Timer;
/*0x20c*/ CTextureAnimation* DecalIcon;
/*0x210*/ int                LastButtonType;
/*0x214*/ int                LastButtonSlot;
/*0x218*/ char               LastButtonPage;
/*0x219*/ EqItemGuid         LastItemGuid;
/*0x22c*/ int                LastItemId;
/*0x230*/ int                LastIconType;
/*0x234*/ int                LastIconSlot;
/*0x238*/ CXStr              LastLabel;
/*0x23c*/ CXStr              DefaultLabel;
/*0x240*/ bool               bForceUpdate;
/*0x244*/ CTextObjectInterface* pKeyMapText;
/*0x248*/ int                Unknown0x228;
/*0x24c*/ CButtonWnd*        pButtonWnd;
/*0x250*/ CInvSlotWnd*       pInvSlotWnd;
/*0x254*/ CSpellGemWnd*      pSpellGemWnd;
/*0x258*/ CXSize             BaseSize;
/*0x260*/ int                ButtonPercentSize;
/*0x264*/ CXSize             BaseButtonSize;
/*0x26c*/ CXSize             BaseDecalSize;
/*0x274*/ CXSize             BaseInvButtonSize;
/*0x27c*/ CXSize             BaseSpellButtonSize;
...
/*0x20c*/ int          Unknown0x1ec;
/*0x210*/ CXStr        Text;
/*0x214*/ int          Unknown0x1f4;
/*0x218*/ bool         Unknown0x1f8;
/*0x21c*/ int          Unknown0x1fc;
/*0x220*/
};
...
/*0x268*/ int64_t            LastFlashTime;
/*0x270*/ COLORREF           CRHighlightFlashColor;
/*0x274*/ bool               bHighlightOnNewMessages;
/*0x275*/ bool               bFlashing;
/*0x278*/
};
...
/*0x248*/ uint32_t             spacing;
/*0x24c*/ bool                 expandLast;
/*0x250*/ int                  paddingLeft;
/*0x254*/ int                  paddingRight;
/*0x258*/ int                  paddingTop;
/*0x25c*/ int                  paddingBottom;
/*0x260*/ };
...
{
public:
/*0x260*/ ArrayClass<CXWnd*>         visibleChildren;
/*0x270*/ ArrayClass<CXRect>         dividerRects;
/*0x280*/ int                        activeDivider;
/*0x284*/ bool                       dividerHover;
/*0x285*/ bool                       dividerMoving;
/*0x288*/ int                        oldPosCoord;              // X for horizontal, Y for vertical
/*0x28c*/ bool                       bStyle_Dividers;          // the Style_Dividers property from XML
/*0x290*/
};
...
{
public:
/*0x260*/ bool                       horizontalFirst;
/*0x261*/ bool                       anchorToTop;
/*0x262*/ bool                       anchorToLeft;
/*0x264*/ int                        secondarySpacing;
/*0x268*/ bool                       firstPieceTemplate;
/*0x269*/ bool                       snapToChildren;
/*0x26c*/ CXWnd*                     autoStretchWindow;
/*0x270*/ };
...
/*0x248*/ CStmlWnd*                    pstmlStatus;
/*0x24c*/ CListWnd*                    plistItems;
/*0x250*/ CListWnd*                    plistInventory;
/*0x254*/ CListWnd*                    plistCompensation;
/*0x258*/ CListWnd*                    plistBuyLines;
/*0x25c*/ CEditWnd*                    peditSearch;
/*0x260*/ CButtonWnd*                  pbtnSearch;
/*0x264*/ CButtonWnd*                  pbtnAddItem;
/*0x268*/ CButtonWnd*                  pbtnRemoveItem;
/*0x26c*/ CButtonWnd*                  pbtnPlat;
/*0x270*/ CButtonWnd*                  pbtnGold;
/*0x274*/ CButtonWnd*                  pbtnSilver;
/*0x278*/ CButtonWnd*                  pbtnCopper;
/*0x27c*/ CButtonWnd*                  pbtnCreate;
/*0x280*/ CEditWnd*                    peditCount;
/*0x284*/ CButtonWnd*                  pbtnRemoveLine;
/*0x288*/ CButtonWnd*                  pbtnUpdateLine;
/*0x28c*/ CButtonWnd*                  pbtnActiveLine;
/*0x290*/ CButtonWnd*                  pbtnActivateAllLines;
/*0x294*/ CButtonWnd*                  pbtnListLines;
/*0x298*/ CButtonWnd*                  pbtnClearStatus;
/*0x29c*/ CButtonWnd*                  pbtnStartStop;
/*0x2a0*/ CButtonWnd*                  pbtnOfflineMode;
/*0x2a4*/ CEditWnd*                    peditWelcome;
/*0x2a8*/ CButtonWnd*                  pbtnUpdateWelcome;
/*0x2ac*/ CButtonWnd*                  pbtnRefreshInventory;
/*0x2b0*/ CLayoutWnd*                  pLayout;
/*0x2b4*/ CLayoutWnd*                  pStatusLayout;
/*0x2b8*/ uint32_t                     lastUpdateTime;
/*0x2bc*/ uint32_t                     lastSearchTime;
/*0x2c0*/ uint32_t                     quantityRequest;
/*0x2c4*/ ArrayClass<BarterInventoryItem> InventoryItems;
/*0x2d4*/ ArrayClass2<BarterSearchedItem> SearchedItems;
...
/*0x248*/ HashTable<BarterBuyerSearchData> Buyers;
/*0x258*/ CListWnd*                    plistInventory;
/*0x25c*/ CListWnd*                    plistBuyLines;
/*0x260*/ CListWnd*                    plistDetails;
/*0x264*/ CEditWnd*                    peditSearch;
/*0x268*/ CButtonWnd*                  pbtnRefreshInventory;
/*0x26c*/ CButtonWnd*                  pbtnSearch;
/*0x270*/ CButtonWnd*                  pbtnWelcome;
/*0x274*/ CButtonWnd*                  pbtnGreeting;
/*0x278*/ CButtonWnd*                  pbtnFind;
/*0x27c*/ CButtonWnd*                  pbtnHide;
/*0x280*/ CButtonWnd*                  pbtnBuyLineInspectItem;
/*0x284*/ CButtonWnd*                  pbtnCompensationInspectItem;
/*0x288*/ CButtonWnd*                  pbtnCompensationPreviewItem;
/*0x28c*/ CButtonWnd*                  pbtnSellButton;
/*0x290*/ CComboWnd*                   pcomboPlayersCombo;
/*0x294*/ CLayoutWnd*                  pLayout;
/*0x298*/ CLayoutWnd*                  pMatchLayout;
/*0x29c*/ bool                         NeedsUpdate;
/*0x2a0*/ ArrayClass<BarterBuyLine>    BuyLines;
/*0x2b0*/ ArrayClass2<BarterInventoryItem> InventoryItems;
/*0x2c8*/ // more members
};
...
public:
	...
	// todo: check
/*0x024c*/ uint8_t     UnknownPadding[0x34];
/*0x0280*/ BazaarSearchResults searchResults[MAX_BAZAAR_SEARCH_RESULTS];
/*0x9560*/ HashTable<BazaarTraderData> Traders;
/*0x9570*/ CListWnd*   pItemList;
/*0x9574*/ CButtonWnd* pQueryButton;
/*0x9578*/ CButtonWnd* pWelcomeButton;
/*0x957c*/ CButtonWnd* pUpdatePlayerButton;
/*0x9580*/ CButtonWnd* pRequestItemButton;
/*0x9584*/ CButtonWnd* pRequestPreviewButton;
/*0x9588*/ CButtonWnd* pFindTraderButton;
/*0x958c*/ CButtonWnd* pHideTradersButton;
/*0x9590*/ CButtonWnd* pDefaultButton;
/*0x9594*/ CButtonWnd* pBuyButton;
/*0x9598*/ CLabelWnd*  pItemNameLabel;
/*0x959c*/ CLabelWnd*  pPlayersLabel;
/*0x95a0*/ CLabelWnd*  pItemSlotLabel;
/*0x95a4*/ CLabelWnd*  pStatSlotLabel;
/*0x95a8*/ CLabelWnd*  pRaceSlotLabel;
/*0x95ac*/ CLabelWnd*  pClassSlotLabel;
/*0x95b0*/ CLabelWnd*  pItemTypeLabel;
/*0x95b4*/ CLabelWnd*  pSearchResultLabel;
/*0x95b8*/ CLabelWnd*  pMaxPriceLabel;
/*0x95bc*/ CLabelWnd*  pMinPriceLabel;
/*0x95c0*/ CLabelWnd*  pItemPrestigeLabel;
/*0x95c4*/ CLabelWnd*  pItemAugmentLabel;
/*0x95c8*/ CComboWnd*  pItemSlotCombobox;
/*0x95cc*/ CComboWnd*  pStatSlotCombobox;
/*0x95d0*/ CComboWnd*  pRaceSlotCombobox;
/*0x95d4*/ CComboWnd*  pClassSlotCombobox;
/*0x95d8*/ CComboWnd*  pItemTypeCombobox;
/*0x95dc*/ CComboWnd*  pPlayersCombobox;
/*0x95e0*/ CComboWnd*  pItemPrestigeCombobox;
/*0x95e4*/ CComboWnd*  pItemAugmentCombobox;
/*0x95e8*/ CEditWnd*   pItemNameInput;
/*0x95ec*/ CEditWnd*   pMaxPriceInput;
/*0x95f0*/ CEditWnd*   pMinPriceInput;
/*0x95f4*/ CEditWnd*   pMaxLevelInput;
/*0x95f8*/ CEditWnd*   pMinLevelInput;
/*0x95fc*/ CEditWnd*   pMaxResultsPerTraderInput;
/*0x9600*/ BYTE        Unknown0x92C8[0x8];
/*0x9608*/
};
...
/*0x24c*/ int                selectedSlot;
/*0x250*/ int                curBazaarIndex;
/*0x254*/ int                curItemPrice;
/*0x258*/ int                moneyBtnIndex;
/*0x25c*/ ItemPtr            selectedItem;
/*0x260*/ CButtonWnd*        startButton;
/*0x264*/ CButtonWnd*        endButton;
/*0x268*/ CButtonWnd*        clearButton;
/*0x26c*/ CButtonWnd*        setPriceButton;
/*0x270*/ CButtonWnd*        listButton;
/*0x274*/ uint32_t           unknown0x25c;
/*0x278*/ CButtonWnd*        addButton;
/*0x27c*/ CButtonWnd*        removeButton;
/*0x280*/ CButtonWnd*        moneyButton[4];         // NumMoneySlotTypes
/*0x290*/ CButtonWnd*        offlineModeButton;
/*0x294*/ CStmlWnd*          bazaarText;
/*0x298*/ CInvSlotWnd*       bazaarSlots[MAX_BAZAAR_ITEMS];
/*0x5b8*/ ItemContainer      bazaarItems;
/*0x5d4*/ uint32_t           myPrice[MAX_BAZAAR_ITEMS];
/*0x8f4*/ bool               bItemActive[MAX_BAZAAR_ITEMS];
/*0x9bc*/ char               iniFilename[64];
/*0x9fc*/ bool               bIsMerchant;
/*0xa00*/
};
...
/*0x254*/ int                           Unknown0x244;
/*0x258*/ int                           offset;
/*0x25c*/ int                           timestamp;
/*0x260*/ double                        speed;
/*0x268*/ int                           timer;
/*0x26c*/ CompassLineSource             lineAdventure;
/*0x29c*/ ArrayClass<CompassLineSource*> lineData;
/*0x2ac*/
};
...
/*0x24c*/ bool                Unknown0;
/*0x24d*/ bool                Unknown1;
/*0x250*/ uint32_t            Unknown2;
/*0x254*/ uint32_t            Timestamp;
/*0x258*/ uint32_t            Counter;
/*0x25c*/ HashTable<ItemGlobalIndex, int> Items;
/*0x26c*/ HashTable<SoeUtil::String, int> ItemNames;     // just a guess, likely inaccurate.
/*0x27c*/ CStaticAnimationTemplate* FIW_ClassAnim;
/*0x280*/ CSidlScreenWnd*     FIW_CharacterView;
/*0x284*/ CListWnd*           FIW_ItemList;
/*0x288*/ CButtonWnd*         FIW_QueryButton;
/*0x28c*/ CButtonWnd*         FIW_RequestItemButton;
/*0x290*/ CButtonWnd*         FIW_RequestPreviewButton;
/*0x294*/ CButtonWnd*         FIW_Default;
/*0x298*/ CButtonWnd*         FIW_GrabButton;
/*0x29c*/ CButtonWnd*         FIW_HighlightButton;
/*0x2a0*/ CButtonWnd*         FIW_DestroyItem;
/*0x2a4*/ CComboWnd*          FIW_ItemLocationCombobox;
/*0x2a8*/ CComboWnd*          FIW_ItemSlotCombobox;
/*0x2ac*/ CComboWnd*          FIW_StatSlotCombobox;
/*0x2b0*/ CComboWnd*          FIW_RaceSlotCombobox;
/*0x2b4*/ CComboWnd*          FIW_ClassSlotCombobox;
/*0x2b8*/ CComboWnd*          FIW_ItemTypeCombobox;
/*0x2bc*/ CComboWnd*          FIW_ItemPrestigeCombobox;
/*0x2c0*/ CComboWnd*          FIW_ItemAugmentCombobox;
/*0x2c4*/ CEditWnd*           FIW_ItemNameInput;
/*0x2c8*/ CEditWnd*           FIW_MaxLevelInput;
/*0x2cc*/ CEditWnd*           FIW_MinLevelInput;
/*0x2d0*/ CLabelWnd*          FIW_DragonHoardLabel;
/*0x2d4*/
};
...
/*0x2a8*/ ItemPtr            LinkedItem;              // If the slot is linked to a specific item
...
// @sizeof(CItemDisplyWnd) == 0x648 :: 2021-09-13 (live) @ 0x79FD00
constexpr size_t CItemDisplayWnd_size = 0x648;
...
/*0x24c*/ CButtonWnd*       IconButton;
/*0x250*/ CStmlWnd*         ItemLore;
/*0x254*/ CTabWnd*          ItemDescriptionTabBox;
/*0x258*/ CPageWnd*         ItemDescriptionTab;
/*0x25c*/ CPageWnd*         ItemLoreTab;
/*0x260*/ CSidlScreenWnd*   pAppearanceSocketScreen;
/*0x264*/ CButtonWnd*       pAppearanceSocketItem;
/*0x268*/ CButtonWnd*       pAppearanceSocketBuyButton;
/*0x26c*/ CStmlWnd*         pAppearanceSocketDescription;
/*0x270*/ CSidlScreenWnd*   pItemSocketScreen[6];
/*0x288*/ CButtonWnd*       pItemSocketItemButton[6];
/*0x2a0*/ CStmlWnd*         pItemSocketDescription[6];
/*0x2b8*/ CXStr             ItemInfo;                 // this item is placable in yards, guild yards blah blah , This item can be used in tradeskills
/*0x2bc*/ CXStr             Unknown0x2ac;
/*0x2c0*/ CXStr             Unknown0x2b0;
/*0x2c4*/ CXStr             WindowTitle;
/*0x2c8*/ CXStr             ItemAdvancedLoreText;
/*0x2cc*/ CXStr             ItemMadeByText;
...
/*0x2e0*/ CTextureAnimation* DragIcons;
/*0x2e4*/ bool              bTaggable;
/*0x2e5*/ bool              bFailed;
/*0x2e8*/ unsigned int      TabCount;
/*0x2ec*/ CLabel*           ModButtonLabel;
/*0x2f0*/ CLabel*           RewardButtonLabel;
/*0x2f4*/ CStmlWnd*         ConvertStml;
/*0x2f8*/ CLabel*           MadeByLabel;
/*0x2fc*/ CLabel*           CollectedLabel;
/*0x300*/ CLabel*           ScribedLabel;
/*0x304*/ int               Row;
/*0x308*/ bool              bAntiTwink;
/*0x30c*/ CButtonWnd*       ModButton;
/*0x310*/ CButtonWnd*       RewardButton;
/*0x314*/ CButtonWnd*       PrintRealEstateItems;
/*0x318*/ CButtonWnd*       ConvertButton;
/*0x31c*/ bool              bCollected;
/*0x31d*/ bool              bCollectedReceived;
/*0x320*/ int               Unknown0x0310;
/*0x324*/ int               Unknown0x0314;
/*0x328*/ bool              bScribed;
/*0x329*/ bool              bScribedReceived;
/*0x32a*/ BYTE              Unknown0x31a[0x2f2];
/*0x61c*/ DWORD             Unknown0x60c;
/*0x620*/ DWORD             Unknown0x610;
/*0x624*/ DWORD             Unknown0x614;
/*0x628*/ DWORD             Unknown0x618;
/*0x62c*/ DWORD             Unknown0x61c;
/*0x630*/ DWORD             Unknown0x620;
/*0x634*/ DWORD             Unknown0x624;
/*0x638*/ DWORD             Unknown0x628;
/*0x63c*/ DWORD             Unknown0x62c;
/*0x640*/ DWORD             Unknown0x630;
/*0x644*/ uint32_t          ItemWndIndex;
/*0x648*/
};
...
/*0x24c*/ CListWnd*     pList[eNumPages];        // KRW_Mounts_List, KRW_Illusions_List, KRW_Familiars_List, KRW_HeroForge_List
/*0x25c*/ CLabel*       pStatLabel[eNumPages];   // KRW_Mounts_StatsNameLabel, KRW_Illusions_StatNameLabel, KRW_Familiars_StatNameLabel,
/*0x26c*/ CLabel*       pCountLabel[eNumPages];  // KRW_Mounts_CountLabel, KRW_Illusions_CountLabel, KRW_Familiars_CountLabel, KRW_HeroForge_CountLabel
/*0x27c*/ CButtonWnd*   pBtnStat[eNumPages];     // KRW_Mounts_Selected, KRW_Illusions_Selected, KRW_Familiars_Selected, KRW_HeroForge_SlotButton
/*0x28c*/ CButtonWnd*   pBtnSlot[eNumPages];     // KRW_Mounts_SlotButton, KRW_Illusions_SlotButton, KRW_Familiars_SlotButton
/*0x29c*/ uint8_t       Unknown0x28c[0x18];
/*0x2b4*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x2b8*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x2bc*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x2c0*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x2c4*/ uint8_t       Unknown0x2b4[0x8];
/*0x2cc*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x2d0*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x2d4*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x2d8*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x2dc*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x2e0*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
...
/*0x250*/ bool              bServerClose;
/*0x251*/ bool              bLootingActive;
/*0x254*/ int               LootIndex[InvSlot_Max];
/*0x2e4*/ uint32_t          nNextRefreshTime;
/*0x2e8*/ bool              bInventoryWasActive;
/*0x2ec*/ ItemContainer     LootItems;
/*0x308*/ bool              bCloseOnComplete;
/*0x309*/ bool              bRightClickLoot;
/*0x30a*/ bool              bLootAllReady;
/*0x30c*/ CXWnd*            LootInvWnd;
/*0x310*/ CInvSlotWnd*      LootSlotWnd[InvSlot_Max];
/*0x3a0*/ CLabel*           CorpseNameLabel;
/*0x3a4*/ CButtonWnd*       DoneButton;
/*0x3a8*/ CButtonWnd*       BroadcastButton;
/*0x3ac*/ CButtonWnd*       LootAllButton;
/*0x3b0*/ bool              bPopupPending;
/*0x3b4*/
...
/*0x34c*/ uint8_t            Unknown0x340[0x100];
/*0x44c*/
...
/*0x2f8*/ ECombatState       CombatState;                       // right above "A_PWCSInCombat"
/*0x2fc*/ uint32_t           Unknown0x2f4;
/*0x300*/
};
...
/*0x2c8*/ PlayerClient*       ActiveMerchant;
...
/*0x250*/ CPopDialogWnd* m_currentPopup;
/*0x254*/ int            LeftPageNbr;
/*0x258*/ int            SelectedBookIndex;
/*0x25c*/ int            MemSlotIndex;
/*0x260*/ int            SpellId;
/*0x264*/ int            MemTicksLeft;
/*0x268*/ int            ScribeBookSlot;
/*0x26c*/ int            ScribeTicksLeft;
/*0x270*/
};
...
/*0x2e4*/ ItemContainer      TradeItems;
...
/*0x2e0*/ uint32_t                NextButtonRefreshTime;
...
{
public:
/*0x24c*/ EQZoneIndex             currentZone;
/*0x250*/ bool                    zonePathDirty;
/*0x254*/ CListWnd*               listZones;
/*0x258*/
};
