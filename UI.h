...
/*0x208*/ libMozilla::Window* m_mozillaWnd;
/*0x20c*/
	// more ...
};
...
/*0x2a0*/ VePointer<CONTENTS> LinkedItem;              // ItemBasePtr
...
/*0x2d0*/ VePointer<CONTENTS> pItem; // ItemBasePtr
...
/*0x248*/ BYTE              Unknown0x240[0x94];
/*0x2dc*/ DWORD             NumOfSlots;
/*0x2e0*/ BYTE              Unknown0x02e0[0x4];
/*0x2e4*/ INVENTORYARRAY*   pInventoryArray;
/*0x2e8*/ DWORD             Size;
/*0x2ec*/ DWORD             NumOfSlots3;
/*0x2f0*/ BYTE              Unknown0x2e8[0x8];
/*0x2f8*/ BYTE              Unknown0x2f0;
/*0x2f9*/ BYTE              Unknown0x2f1;
/*0x2fa*/ BYTE              Unknown0x2f2;
/*0x2fb*/ BYTE              Unknown0x2f3;
...
/*0x24c*/ bool         bInventoryWasActive;
/*0x250*/ VeArray<VePointer<MerchantPageHandler>> PageHandlers;
...
/*0x27d*/ BYTE         Unknown0x268[0x10];
/*0x290*/ char*        Labels[0xc];
/*0x2c0*/ CEditWnd*    SearchEdit;
/*0x2c4*/ CButtonWnd*  SearchButton;
/*0x2c8*/ CLabel*      MerchantNameLabel;
/*0x2cc*/ CLabel*      SelectedItemLabel;
/*0x2d0*/ CLabel*      SelectedPriceLabel;
/*0x2d4*/ CButtonWnd*  InspectButton;
/*0x2d8*/ CButtonWnd*  PreviewButton;
/*0x2dc*/ CButtonWnd*  SelectedItemButton;
/*0x2e0*/ CButtonWnd*  BuyButton;
/*0x2e4*/ CButtonWnd*  BuyMarketPlaceButton;
/*0x2e8*/ CButtonWnd*  SellButton;
/*0x2ec*/ CButtonWnd*  RecoverButton;
/*0x2f0*/ CButtonWnd*  RetrieveButton;
/*0x2f4*/ CButtonWnd*  RetrieveAllButton;
/*0x2f8*/ CButtonWnd*  SendButton;
/*0x2fc*/ CButtonWnd*  AdventureButton;
/*0x300*/ CLabel*      SendToLabel;
/*0x304*/ CEditWnd*    SendToEdit;
/*0x308*/ CLabel*      NoteLabel;
/*0x30c*/ CEditWnd*    NoteEdit;
/*0x310*/ CButtonWnd*  ClearNoteButton;
/*0x314*/ CListWnd*    ItemsList;
/*0x318*/ CListWnd*    ItemsRecoveryList;
/*0x31c*/ CListWnd*    ItemsMailList;
/*0x320*/ CButtonWnd*  DoneButton;
/*0x324*/ CPageWnd*    PurchasePage;
/*0x328*/ CPageWnd*    RecoveryPage;
/*0x32c*/ CPageWnd*    MailPage;
/*0x330*/ CTabWnd*     TabWindow;
/*0x334*/ CButtonWnd*  UsableButton;
/*0x338*/ CLabel*      CurrentCurrencyLabel;
/*0x33c*/ int          Unknown0x32c;
/*0x340*/ int          Unknown0x330;
/*0x344*/ int          Unknown0x334;
/*0x348*/ int          Unknown0x338;
/*0x34c*/ int          Unknown0x33C;
/*0x350*/ int          Guk_Currency;
/*0x354*/ uint8_t      Unknown0x340[0x108];
/*0x45c*/
#endif
