...
// @sizeof(CButtonWnd) == 0x368 :: 2022-05-24 (test) @ 0x140534d0e
...
// @sizeof(CFindItemWnd) == 0x400 :: 2022-05-24 (test) @ 0x140158877
...
// @sizeof(CFindLocationWnd) == 0x3b0 :: 2022-05-24 (test) @ 0x140159035
...
// @sizeof(CItemDisplayWnd) == 0xaa8 :: 2022-05-24 (test) @ 0x1403acff4
...
// @sizeof(CKeyRingWnd) == 0x440 :: 2022-05-24 (test) @ 0x140158327
...
// @sizeof(CLootWnd) == 0x520 :: 2022-05-24 (test) @ 0x1401585a5
...
// @sizeof(CMapViewWnd) == 0x878 :: 2022-05-24 (test) @ 0x140157d1b
...
// @sizeof(CPetInfoWnd) == 0xce8:: 2022-05-24 (test) @ 0x1401577bc
constexpr size_t CPetInfoWnd_size = 0xce8;
...
/*0x2e8*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
...
/*0x370*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x378*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS_NPC];
/*0x680*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS_NPC]; // PetBuff%d - was pWnd
/*0x988*/ int                Buff[MAX_TOTAL_BUFFS_NPC];         // Spell ID# of each buff
/*0xb10*/ HashTable<CXStr>   WhoCast;
/*0xb28*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0xb2c*/ bool               bHadPetLastTime;
/*0xb2d*/ bool               bShowOnSummon;
/*0xb30*/ uint32_t           ListContextMenuID;
/*0xb38*/ CXWnd*             pRequestingWnd;
/*0xb40*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS_NPC]; // duration until buff fades, in milliseconds
/*0xcc4*/ bool               bRemovedBuffBlockMenuItem;
/*0xcc8*/ int                PetCommandSelectContextMenu;
/*0xcd0*/ CXWnd*             LastClickedButton;
/*0xcd8*/ bool               bPetButtonsDirty;
/*0xcd9*/ bool               Sit;
/*0xcda*/ bool               Stop;
/*0xcdb*/ bool               ReGroup;
/*0xcdc*/ bool               Follow;
...
// @sizeof(CPlayerWnd) == 0x418 :: 2022-05-24 (test) @ 0x14015814f
...
// @sizeof(CTargetWnd) == 0x420 :: 2022-05-24 (test) @ 0x140157ff0
