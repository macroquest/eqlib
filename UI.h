...
// @sizeof(CButtonWnd) == 0x350 :: 2023-09-14 (live) @ 0x1405a47be
...
// @sizeof(CCursorAttachment) == 0x630 :: 2023-09-14 (live) @ 0x140185b68
...
/*0x3c4*/ int                       Type;
/*0x3c8*/ int                       Index;
/*0x3cc*/ EqItemGuid                ItemGuid;
/*0x3e0*/ int                       ItemID;
/*0x3e4*/ int                       Qty;
/*0x3e8*/ int                       IconID;
/*0x3f0*/ SoeUtil::String           AssignedName;
/*0x408*/ int                       Unknown0x264;
/*0x40c*/ char                      AssignedNameCopy[0x40];
/*0x450*/ CXStr                     ButtonText;
/*0x458*/ CStaticAnimationTemplate* pBGStaticAnim;                  // CA_Anim
/*0x460*/ CStaticAnimationTemplate* pOverlayStaticAnim;             // CA_Anim2
/*0x468*/ CSpellGemWnd*             pSpellGem;                      // CA_SpellGem
/*0x470*/ CTextObjectInterface*     pTextObjectInterface;
/*0x478*/ CTextObjectInterface*     pButtonTextObjectInterface;
/*0x480*/ int                       TextfontStyle;
/*0x484*/ int                       Unknown0x2C4;
/*0x488*/
};
...
// @sizeof(CFindItemWnd) == 0x400 :: 2023-09-14 (live) @ 0x1401871f4
...
// @sizeof(CFindLocationWnd) == 0x3a8 :: 2023-09-14 (live) @ 0x1401879b2
...
// @sizeof(CGroupWnd) == 0x708 :: 2023-09-14 (live) @ 0x1401862e7
constexpr size_t CGroupWnd_size = 0x708;
...
/*0x03d4*/ uint8_t     Unknown0x03ac[0xdbc];
/*0x1190*/ int64_t     VitalityCap;
/*0x1198*/ int         AAVitalityCap;
/*0x119c*/
};
...
/*0x350*/ GameFaceComponent  component;
...
// @sizeof(CItemDisplayWnd) == 0xab0 :: 2023-09-14 (live) @ 0x1403ff854
...
// @sizeof(CKeyRingWnd) == 0x438 :: 2023-09-14 (live) @ 0x140186c55
...
// @sizeof(CLootWnd) == 0xcc8 :: 2023-09-14 (live) @ 0x140186f22
...
// @sizeof(CMapViewWnd) == 0x868 :: 2023-09-14 (live) @ 0x140186649
...
// @sizeof(CPetInfoWnd) == 0x2940 :: 2023-09-14 (live) @ 0x14018610f
...
// @sizeof(CPlayerWnd) == 0x410 :: 2023-09-14 (live) @ 0x140186a7d
...
// @sizeof(CTargetWnd) == 0x418 :: 2023-09-14 (live) @ 0x14018691e
