...
constexpr size_t CButtonWnd_size = 0x338; // @sizeof(CButtonWnd) :: 2024-12-02 (beta) @ 0x1405BD670
...
constexpr size_t CBuffWindow_size = 0x340; // @sizeof(CBuffWindow) :: 2024-12-02 (beta) @ 0x14018DAAF
...
constexpr size_t CCursorAttachment_size = 0x618; // @sizeof(CCursorAttachment) :: 2024-12-02 (beta) @ 0x14018CE48
...
constexpr size_t CFindItemWnd_size = 0x3E8; // @sizeof(CFindItemWnd) :: 2024-12-02 (beta) @ 0x14018E4D6
...
constexpr size_t CFindLocationWnd_size = 0x798; // @sizeof(CFindLocationWnd) :: 2024-12-02 (beta) @ 0x14018EC94
...
/*0x5b0*/ UIButtonComponent       filterRaidCheckBoxComponent;
/*0x650*/ UIStmlComponent         noneLabelComponent;
/*0x6f0*/ uint32_t                lastUpdateTime;
/*0x6f4*/ uint32_t                lastFindRequestTime;
/*0x6f8*/ bool                    didFindRequest;
/*0x700*/ PlayerDataArray         unfilteredPlayerList;
/*0x718*/ PlayerDataArray         filteredGroupPlayerList;
/*0x730*/ PlayerDataArray         unfilteredRaidPlayerList;
/*0x748*/ POIDataArray            unfilteredPOIDataList;
/*0x760*/ ZoneConnectionDataArray unfilteredZoneConnectionList;
/*0x778*/ FindableReferenceList   referenceList;
/*0x790*/ uint32_t                lastId;
/*0x794*/ bool                    dataRequested;
/*0x795*/ bool                    playerListDirty;
/*0x796*/ bool                    zoneConnectionsRcvd;
/*0x798*/
};
...
constexpr size_t CGiveWnd_size = 0xB10; // @sizeof(CGiveWnd) :: 2024-12-02 (beta) @ 0x14018E746
...
constexpr size_t CGroupWnd_size = 0x6F0; // @sizeof(CGroupWnd) :: 2024-12-02 (beta) @ 0x14018D5C7
...
constexpr size_t CItemDisplayWnd_size = 0xA98; // @sizeof(CItemDisplayWnd) :: 2024-12-02 (beta) @ 0x140415024
...
constexpr size_t CKeyRingWnd_size = 0x458; // @sizeof(CKeyRingWnd) :: 2024-12-02 (beta) @ 0x14018DF35
...
/*0x420*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x428*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
...
constexpr size_t CLootWnd_size = 0xCB0; // @sizeof(CLootWnd) :: 2024-12-02 (beta) @ 0x14018E204
...
constexpr size_t CMapViewWnd_size = 0x838; // @sizeof(CMapViewWnd) :: 2024-12-02 (beta) @ 0x14018D929
...
constexpr size_t CPetInfoWnd_size = 0x3C0; // @sizeof(CPetInfoWnd) :: 2024-12-02 (beta) @ 0x14018D3EF
...
constexpr size_t CPlayerWnd_size = 0x3F8; // @sizeof(CPlayerWnd) :: 2024-12-02 (beta) @ 0x14018DD5D
...
constexpr size_t CSpellDisplayWnd_size = 0x3A8; // @sizeof(CSpellDisplayWnd) :: 2024-12-02 (beta) @ 0x1404E4E4E
...
constexpr size_t CTargetWnd_size = 0x3B8; // @sizeof(CTargetWnd) :: 2024-12-02 (beta) @ 0x14018DBFE
...
constexpr size_t CTradeWnd_size = 0x16E8; // @sizeof(CTradeWnd) :: 2024-12-02 (beta) @ 0x14018E3EC
...
constexpr size_t ZoneGuideManagerClient_size = 0xF7C8; // @sizeof(ZoneGuideManagerClient) :: 2024-12-02 (beta) @ 0x14033CB0F
