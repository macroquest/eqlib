...
/*0x368*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS];
/*0x670*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS];     // PetBuff%d - was pWnd
/*0x978*/ int                Buff[MAX_TOTAL_BUFFS];             // Spell ID# of each buff
...
/*0xb30*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS];     // duration until buff fades, in milliseconds
