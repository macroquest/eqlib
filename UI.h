...
// @sizeof(CButtonWnd) == 0x328 :: 2023-11-09 (live) @ 0x1405a52b0
...
// @sizeof(CBuffWindow) == 0x330 :: 2023-11-09 (live) @ 0x140186acf
...
// @sizeof(CCursorAttachment) == 0x608 :: 2023-11-09 (live) @ 0x140185e68
...
// @sizeof(CFindItemWnd) == 0x3d8 :: 2023-11-09 (live) @ 0x1401874f4
...
// @sizeof(CFindLocationWnd) == 0x380 :: 2023-11-09 (live) @ 0x140187cb2
...
// @sizeof(CGroupWnd) == 0x6e0 :: 2023-11-09 (live) @ 0x1401865e7
...
// @sizeof(CItemDisplayWnd) == 0xa88 :: 2023-11-09 (live) @ 0x1404000c4
...
// @sizeof(CKeyRingWnd) == 0x410 :: 2023-11-09 (live) @ 0x140186f55
...
// @sizeof(CLootWnd) == 0xca0 :: 2023-11-09 (live) @ 0x140187222
...
// @sizeof(CMapViewWnd) == 0x818 :: 2023-11-09 (live) @ 0x140186949
...
// @sizeof(CPetInfoWnd) == 0x3b0 :: 2023-11-09 (live) @ 0x14018640f
...
/*0x22b8*/ int                PetBuffTimer[MAX_TOTAL_BUFFS_NPC]; // duration until buff fades, in milliseconds
...
// @sizeof(CPlayerWnd) == 0x3e8 :: 2023-11-09 (live) @ 0x140186d7d
...
// @sizeof(CTargetWnd) == 0x3a8:: 2023-11-09 (live) @ 0x140186c1e
...
/*0x2d8*/ SoeUtil::Array<CTextureAnimation*> ptaBuffIcons;
/*0x2f0*/ SoeUtil::Array<CButtonWnd*> pTargetBuff;
/*0x308*/ SoeUtil::Array<int>       BuffSpellID;
