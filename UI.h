...
// @sizeof(CButtonWnd) == 0x360 :: 2022-09-16 (live) @ 0x14053d6ce
...
/*0x410*/ CButtonWnd*  DoneButton;
/*0x418*/ CButtonWnd*  ChangeButton;
/*0x420*/ CButtonWnd*  AutoButton;
/*0x428*/ CButtonWnd*  AltStorageButton;
/*0x430*/ CButtonWnd*  FindItemButton;
/*0x438*/ CButtonWnd*  DragonHoardButton;
/*0x440*/ int          BankSize;
/*0x444*/
...
// @sizeof(CFindItemWnd) == 0x3f8 :: 2022-09-16 (live) @ 0x140159e59
...
// @sizeof(CFindLocationWnd) == 0x3a8 :: 2022-09-16 (live) @ 0x14015a617
...
/*0x360*/ CTextureAnimation* pBackground;
/*0x368*/ ItemGlobalIndex    ItemLocation;            // WindowType = ItemLocation.Location, InvSlot = ItemLocation.GetTopSlot()
/*0x378*/ ItemPtr            LinkedItem;              // If the slot is linked to a specific item
/*0x380*/ int                ItemOffsetX;
/*0x384*/ int                ItemOffsetY;
/*0x388*/ CTextureAnimation* ptItem;
/*0x390*/ int                Quantity;
/*0x394*/ bool               bSelected;
/*0x395*/ bool               bFindSelected;
/*0x398*/ int                RecastLeft;
/*0x39c*/ bool               bHotButton;
/*0x39d*/ bool               bInventorySlotLinked;
/*0x3a0*/ CInvSlot*          pInvSlot;
/*0x3a8*/ CTextObjectInterface* pTextObject;
/*0x3b0*/ int                TextFontStyle;
/*0x3b4*/ int                Mode;
/*0x3b8*/ D3DCOLOR           BGTintRollover;
/*0x3bc*/ D3DCOLOR           BGTintNormal;
/*0x3c0*/ int                LastTime;
/*0x3c4*/ int                Unknown0x2cc;
/*0x3c8*/
...
// @sizeof(CItemDisplayWnd) == 0xaa0 :: 2022-09-16 (live) @ 0x1403b3e94
...
/*0x420*/ CLabel*           RewardButtonLabel;             // IDW_RewardButtonLabel
...
/*0x478*/ CButtonWnd*       FuseButton;                    // IDW_FuseButton
...
/*0x4b8*/ CLabel*           lblItemInfo[NumItemInfo];      // IDW_ItemInfo%d 4b0
/*0x520*/ CLabel*           lblStat[NumStatRows][NumStatCols];      // IDW_Row%dCol%dStat 518
/*0x790*/ CLabel*           lblValue[NumStatRows][NumStatCols];     // IDW_Row%dCol%dValue 788
/*0xa00*/ CLabel*           lblHeroic[NumHeroic];          // IDW_Heroic%d 9f8
/*0xa68*/ int               rightClickMenuId;
/*0xa6c*/ int               rightClickMenuSocketId;
/*0xa70*/ CComboWnd*        ItemCompareList;               // IDW_ItemCompareList
/*0xa78*/ bool              isComparing;                   // this and the next are a guess. Need to verify.
/*0xa80*/ ItemPtr           pCompareItem;
/*0xa88*/ CTAFrameDraw*     ptaPageBorderHighlight;        // FT_DefPageBorderHighlight
/*0xa90*/ CTAFrameDraw*     ptaPageBorder;                 // FT_DefPageBorder
...
// @sizeof(CKeyRingWnd) == 0x438 :: 2022-09-16 (live) @ 0x140159905
...
// @sizeof(CLootWnd) == 0x518 :: 2022-09-16 (live) @ 0x140159b87
constexpr size_t CLootWnd_size = 0x518;
...
/*0x2e8*/ int               LootIndex[InvSlot_Max];
/*0x378*/ uint32_t          nNextRefreshTime; // 370
/*0x37c*/ bool              bInventoryWasActive;
/*0x380*/ ItemContainer     LootItems;
/*0x3a8*/ bool              bCloseOnComplete;
/*0x3a9*/ bool              bRightClickLoot;
/*0x3aa*/ bool              bLootAllReady;
/*0x3b0*/ CXWnd*            LootInvWnd;                       // LootInvWnd
/*0x3b8*/ CInvSlotWnd*      LootSlotWnd[InvSlot_Max];         // LW_LootSlot%d
/*0x4d8*/ CLabel*           CorpseNameLabel;                  // LW_CorpseName
/*0x4e0*/ CButtonWnd*       DoneButton;                       // DoneButton
/*0x4e8*/ CButtonWnd*       BroadcastButton;                  // BroadcastButton
/*0x4f0*/ CButtonWnd*       LootAllButton;                    // LootAllButton
/*0x4f8*/ bool              bPopupPending;
/*0x500*/ void*             Unknown1;
/*0x508*/ void*             Unknown2;
/*0x510*/ uint32_t          Unknown3;
/*0x514*/
...
// @sizeof(CMapViewWnd) == 0x868 :: 2022-09-16 (live) @ 0x1401592f6
...
// @sizeof(CPetInfoWnd) == 0x2940 :: 2022-09-16 (live) @ 0x140158dbc
...
// @sizeof(CPlayerWnd) == 0x410 :: 2022-09-16 (live) @ 0x14015972d
...
// @sizeof(CTargetWnd) == 0x418 :: 2022-09-16 (live) @ 0x1401595cb
