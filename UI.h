...
// @sizeof(CButtonWnd) == 0x360 :: 2023-04-14 (live) @ 0x140555dce
...
/*0x308*/ CTextureAnimation*    ptaBuffIcons[MAX_BUFF_ICONS];
/*0x458*/ CButtonWnd*           pBuffButtons[MAX_BUFF_ICONS];    // was: pBuff
/*0x5a8*/ CTextObjectInterface* pTimeRemainingTexts[MAX_BUFF_ICONS];
/*0x6f8*/ CTextObjectInterface* pCounterTexts[MAX_BUFF_ICONS];
/*0x848*/ CTextObjectInterface* pLimitedUseTexts[MAX_BUFF_ICONS];
/*0x998*/ int                   spellIds[MAX_BUFF_ICONS];        // was: BuffId
/*0xa40*/ int                   buffTimers[MAX_BUFF_ICONS];      // was: BuffTimer
/*0xae8*/ HashTable<CXStr>      whoCastHash;                     // was: WhoCast
/*0xb00*/ uint32_t              nextRefreshTime;
/*0xb04*/ int                   initWindowWidth;
/*0xb08*/ int                   initWindowHeight;
/*0xb0c*/ BuffWindowType        buffWindowType;
/*0xb10*/ int                   firstEffectSlot;
/*0xb14*/ int                   lastEffectSlot;                  // was: MaxLongBuffs 0x2a (NUM_LONG_BUFFS)
/*0xb18*/ int                   maxBuffButtons;                  // was: MaxShortBuffs 0x37 (NUM_SHORT_BUFFS)
/*0xb1c*/ int                   contextMenuId;
/*0xb20*/ CXWnd*                selectedButtonWnd;               // this field doesn't alwayws appear to be initialize
/*0xb28*/ bool                  updatedMenuItems;
/*0xb2c*/ int                   lastBuffRefreshTime;
/*0xb30*/
...
/*0x2ec*/ int                       Type;
/*0x2f0*/ int                       Index;
/*0x2f4*/ EqItemGuid                ItemGuid;
/*0x308*/ int                       ItemID;
/*0x30c*/ int                       Qty;
/*0x310*/ int                       IconID;
/*0x318*/ SoeUtil::String           AssignedName;
/*0x330*/ int                       Unknown0x264;
/*0x334*/ char                      AssignedNameCopy[0x40];
/*0x378*/ CXStr                     ButtonText;
/*0x380*/ CStaticAnimationTemplate* pBGStaticAnim;                  // CA_Anim
/*0x388*/ CStaticAnimationTemplate* pOverlayStaticAnim;             // CA_Anim2
/*0x390*/ CSpellGemWnd*             pSpellGem;                      // CA_SpellGem
/*0x398*/ CTextObjectInterface*     pTextObjectInterface;
/*0x3a0*/ CTextObjectInterface*     pButtonTextObjectInterface;
/*0x3a8*/ int                       TextfontStyle;
/*0x3ac*/ int                       Unknown0x2C4;
/*0x3b0*/
};
...
// @sizeof(CFindItemWnd) == 0x410 :: 2023-04-14 (live) @ 0x14015e614
...
// @sizeof(CFindLocationWnd) == 0x3b8 :: 2023-04-14 (live) @ 0x14015edd2
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x2e8*/ CButtonWnd*        InviteButton;
/*0x2f0*/ CButtonWnd*        DisbandButton;
/*0x2f8*/ CButtonWnd*        FollowButton;
/*0x300*/ CButtonWnd*        DeclineButton;
/*0x308*/ CButtonWnd*        LFGButton;
/*0x310*/ CGaugeWnd*         HPGauge[6];
/*0x340*/ CGaugeWnd*         PetGauge[6];
/*0x370*/ CGaugeWnd*         ManaGauge[6];
/*0x3a0*/ CGaugeWnd*         EnduranceGauge[6];
/*0x3d0*/ CLabel*            HPLabel[6];
/*0x400*/ CLabel*            HPPercLabel[6];
/*0x430*/ CLabel*            ManaLabel[6];
/*0x460*/ CLabel*            ManaPercLabel[6];
/*0x490*/ CLabel*            EnduranceLabel[6];
/*0x4c0*/ CLabel*            EndurancePercLabel[6];
/*0x4f0*/ COLORREF           HPTextColor[6];
/*0x508*/ CButtonWnd*        GroupTankButton[6];
/*0x538*/ CButtonWnd*        GroupAssistButton[6];
/*0x568*/ CButtonWnd*        GroupPullerButton[6];
/*0x598*/ CButtonWnd*        GroupMarkNPCButton[6];
/*0x5c8*/ CLabel*            AggroPercLabel[6];
/*0x5f8*/ long               Timer;
/*0x600*/ CContextMenu*      GroupContextMenu;
/*0x608*/ bool               bPetbars;
/*0x609*/ bool               bManabars;
/*0x60a*/ bool               bEndurancebars;
/*0x60b*/ bool               bAggroPct;
/*0x60c*/ int                PetBarIndex;
/*0x610*/ int                ManaBarIndex;
/*0x614*/ int                EnduranceBarIndex;
/*0x618*/ int                AggroPctIndex;
/*0x61c*/ int                RoleSeparatorID;
/*0x620*/ int                RoleSelectMenu;
/*0x624*/ int                RoleSelectMenuID;
/*0x628*/ bool               bPlayerInvited;
/*0x62c*/
};
...
/*0x2dc*/ uint8_t     Unknown0x0240[0x10c];
...
// @sizeof(CItemDisplayWnd) == 0xac0 :: 2023-04-14 (live) @ 0x1403ca4a4
...
/*0x438*/ CLabel*           RewardButtonLabel;             // IDW_RewardButtonLabel
...
/*0x4d0*/ CLabel*           lblItemInfo[NumItemInfo];      // IDW_ItemInfo%d
...
// @sizeof(CKeyRingWnd) == 0x448 :: 2023-04-14 (live) @ 0x14015e075
...
// @sizeof(CLootWnd) == 0xcd8 :: 2023-04-14 (live) @ 0x14015e342
...
// @sizeof(CMapViewWnd) == 0x888 :: 2023-04-14 (live) @ 0x14015da61
...
// @sizeof(CPetInfoWnd) == 0x2950 :: 2023-04-14 (live) @ 0x14015d527
constexpr size_t CPetInfoWnd_size = 0x2950;
...
/*0x02ec*/ uint32_t           LastUpdateTime;
/*0x02f0*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
/*0x0360*/ CXWnd*             pWndBuffs;                         // BuffWindow
/*0x0368*/ CTextureAnimation* pGoodBuffBackground;               // PetBlueIconBackground
/*0x0370*/ CTextureAnimation* pBadBuffBackground;                // PetRedIconBackground
/*0x0378*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x0380*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS_NPC];
/*0x1000*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS_NPC]; // PetBuff%d - was pWnd
/*0x1c80*/ int                Buff[MAX_TOTAL_BUFFS_NPC];         // Spell ID# of each buff
/*0x22c0*/ HashTable<CXStr>   WhoCast;
/*0x22d8*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0x22dc*/ bool               bHadPetLastTime;
/*0x22dd*/ bool               bShowOnSummon;
/*0x22e0*/ uint32_t           ListContextMenuID;
/*0x22e8*/ CXWnd*             pRequestingWnd;
/*0x22f0*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS_NPC]; // duration until buff fades, in milliseconds
/*0x2930*/ bool               bRemovedBuffBlockMenuItem;
/*0x2934*/ int                PetCommandSelectContextMenu;
/*0x2938*/ CXWnd*             LastClickedButton;
/*0x2940*/ bool               bPetButtonsDirty;
/*0x2941*/ bool               Sit;
/*0x2942*/ bool               Stop;
/*0x2943*/ bool               ReGroup;
/*0x2944*/ bool               Follow;
...
// @sizeof(CPlayerWnd) == 0x420 :: 2023-04-14 (live) @ 0x14015de9d
...
/*0x2e8*/ int                WindowID;
/*0x2f0*/ CLabelWnd*         pDuration;
/*0x2f8*/ CStmlWnd*          pDescription;
/*0x300*/ CStmlWnd*          pName;
/*0x308*/ CButtonWnd*        pIcon;
/*0x310*/ SoeUtil::String    DescriptionText;
/*0x328*/ SoeUtil::String    TitleText;
/*0x340*/ bool               bActiveItem;
/*0x348*/ CTextureAnimation* ptaBuffIcons;
/*0x350*/ CTextureAnimation* ptaDragIcons;
/*0x358*/ bool               bFailed;
/*0x35c*/ ESpellDisplayType  SpellDisplayType;
/*0x360*/ int                SpellID;
/*0x364*/ int                LastUpdateTime;
/*0x368*/
};
...
// @sizeof(CTargetWnd) == 0x428 :: 2023-04-14 (live) @ 0x14015dd36
constexpr size_t CTargetWnd_size = 0x428;
...
/*0x310*/ SoeUtil::Array<CTextureAnimation*> ptaBuffIcons;      // Can go up to 400?
/*0x328*/ SoeUtil::Array<CButtonWnd*> pTargetBuff;
/*0x340*/ SoeUtil::Array<int>       BuffSpellID;                // -1 if no buff
/*0x358*/ SoeUtil::Array<int>       BuffTimer;
/*0x370*/ int                       LastBuffReceivedTime;
/*0x374*/ int                       Timer;
/*0x378*/ HashTable<CXStr>          Casters;
/*0x390*/ int                       ContextMenuID;
/*0x398*/ CXWnd*                    RequestingWnd;
/*0x3a0*/ bool                      bRemovedBuffBlockMenuItem;
/*0x3a4*/ int                       Type;                       // 1 = self, 4 = group member, 5 = PC, 7 = NPC
/*0x3a8*/ bool                      bFirstUpdate;
/*0x3b0*/ CLabelWnd*                lblAggroPctPlayer;          // Target_AggroPctPlayerLabel
/*0x3b8*/ CLabelWnd*                lblAggroPctSecondary;       // Target_AggroPctSecondaryLabel
/*0x3c0*/ CLabelWnd*                lblAggroNameSecondary;      // Target_AggroNameSecondaryLabel
/*0x3c8*/ CContextMenu*             pContextMenu;
/*0x3d0*/ int                       togglePctPlayerMenu;
/*0x3d4*/ int                       togglePctSecondaryMenu;
/*0x3d8*/ int                       toggleNameSecondaryMenu;
/*0x3dc*/ bool                      bShowPctPlayer;
/*0x3dd*/ bool                      bShowPctSecondary;
/*0x3de*/ bool                      bShowNameSecondary;
/*0x3e0*/ CLabel*                   lblHPLabel;                 // HPLabel
/*0x3e8*/ CLabel*                   lblHPPercLabel;             // HPPercLabel
/*0x3f0*/ CStaticAnimationTemplate* pTargetBoxAnimTop;          // A_TargetBoxStaticAnimTop
/*0x3f8*/ CStaticAnimationTemplate* pTargetBoxAnimBottom;       // A_TargetBoxStaticAnimBottom
/*0x400*/ CStaticAnimationTemplate* pTargetBoxAnimLeft;         // A_TargetBoxStaticAnimLeft
/*0x408*/ CStaticAnimationTemplate* pTargetBoxAnimRight;        // A_TargetBoxStaticAnimRight
/*0x410*/ CStaticAnimationTemplate* pTargetBoxAnimFill;         // A_TargetBoxStaticAnimFill
/*0x418*/ PlayerClient*             previousTarget;
/*0x420*/ uint32_t                  conColorRgba;
/*0x424*/
