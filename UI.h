...
{
public:
/*0x2c4*/ int          MoneyButtonIndex;
/*0x2c8*/ unsigned int NextRefreshTime;
/*0x2cc*/ bool         bInventoryWasActive;
/*0x2cd*/ bool         bRealEstateManagementWasActive;
/*0x2d0*/ CButtonWnd*  MoneyButtons[5];          // including shared plat
/*0x2f8*/ CLabel*      BankerNameLabel;
/*0x300*/ CInvSlotWnd* InvSlotWindows[NUM_BANK_SLOTS];
/*0x3c0*/ CLabel*      SharedBankLabel;
/*0x3c8*/ CInvSlotWnd* SharedSlotWindows[NUM_SHAREDBANK_SLOTS];
/*0x3f8*/ CButtonWnd*  DoneButton;
/*0x400*/ CButtonWnd*  ChangeButton;
/*0x408*/ CButtonWnd*  AutoButton;
/*0x410*/ CButtonWnd*  AltStorageButton;
/*0x418*/ CButtonWnd*  FindItemButton;
/*0x420*/ CButtonWnd*  DragonHoardButton;
/*0x428*/ int          BankSize;
/*0x42c*/
...
/*0x2e0*/ CTextureAnimation*    ptaBuffIcons[MAX_BUFF_ICONS];
/*0x430*/ CButtonWnd*           pBuffButtons[MAX_BUFF_ICONS];    // was: pBuff
/*0x580*/ CTextObjectInterface* pTimeRemainingTexts[MAX_BUFF_ICONS];
/*0x6d0*/ CTextObjectInterface* pCounterTexts[MAX_BUFF_ICONS];
/*0x820*/ CTextObjectInterface* pLimitedUseTexts[MAX_BUFF_ICONS];
/*0x970*/ int                   spellIds[MAX_BUFF_ICONS];        // was: BuffId
/*0xa18*/ int                   buffTimers[MAX_BUFF_ICONS];      // was: BuffTimer
/*0xac0*/ HashTable<CXStr>      whoCastHash;                     // was: WhoCast
/*0xad8*/ uint32_t              nextRefreshTime;
/*0xadc*/ int                   initWindowWidth;
/*0xae0*/ int                   initWindowHeight;
/*0xae4*/ BuffWindowType        buffWindowType;
/*0xae8*/ int                   firstEffectSlot;
/*0xaec*/ int                   lastEffectSlot;                  // was: MaxLongBuffs 0x2a (NUM_LONG_BUFFS)
/*0xaf0*/ int                   maxBuffButtons;                  // was: MaxShortBuffs 0x37 (NUM_SHORT_BUFFS)
/*0xaf4*/ int                   contextMenuId;
/*0xaf8*/ CXWnd*                selectedButtonWnd;               // this field doesn't alwayws appear to be initialize
/*0xb00*/ bool                  updatedMenuItems;
/*0xb04*/ int                   lastBuffRefreshTime;
/*0xb08*/
...
/*0x2c4*/ int                       Type;
/*0x2c8*/ int                       Index;
/*0x2cc*/ EqItemGuid                ItemGuid;
/*0x2e0*/ int                       ItemID;
/*0x2e4*/ int                       Qty;
/*0x2e8*/ int                       IconID;
/*0x2f0*/ SoeUtil::String           AssignedName;
/*0x308*/ int                       Unknown0x264;
/*0x30c*/ char                      AssignedNameCopy[0x40];
/*0x350*/ CXStr                     ButtonText;
/*0x358*/ CStaticAnimationTemplate* pBGStaticAnim;                  // CA_Anim
/*0x360*/ CStaticAnimationTemplate* pOverlayStaticAnim;             // CA_Anim2
/*0x368*/ CSpellGemWnd*             pSpellGem;                      // CA_SpellGem
/*0x370*/ CTextObjectInterface*     pTextObjectInterface;
/*0x378*/ CTextObjectInterface*     pButtonTextObjectInterface;
/*0x380*/ int                       TextfontStyle;
/*0x384*/ int                       Unknown0x2C4;
/*0x388*/
};
...
/*0x2d8*/ HashTable<ItemRecord, int> Items;
/*0x2f0*/ HashTable<SoeUtil::String, int> ItemNames;     // just a guess, likely inaccurate.
/*0x308*/ CStaticAnimationTemplate* FIW_ClassAnim;
/*0x310*/ CSidlScreenWnd*     FIW_CharacterView;
/*0x318*/ CListWnd*           FIW_ItemList;
/*0x320*/ CButtonWnd*         FIW_QueryButton;
/*0x328*/ CButtonWnd*         FIW_RequestItemButton;
/*0x330*/ CButtonWnd*         FIW_RequestPreviewButton;
/*0x338*/ CButtonWnd*         FIW_Default;
/*0x340*/ CButtonWnd*         FIW_GrabButton;
/*0x348*/ CButtonWnd*         FIW_HighlightButton;
/*0x350*/ CButtonWnd*         FIW_DestroyItem;
/*0x358*/ CComboWnd*          FIW_ItemLocationCombobox;
/*0x360*/ CComboWnd*          FIW_ItemSlotCombobox;
/*0x368*/ CComboWnd*          FIW_StatSlotCombobox;
/*0x370*/ CComboWnd*          FIW_RaceSlotCombobox;
/*0x378*/ CComboWnd*          FIW_ClassSlotCombobox;
/*0x380*/ CComboWnd*          FIW_ItemTypeCombobox;
/*0x388*/ CComboWnd*          FIW_ItemPrestigeCombobox;
/*0x390*/ CComboWnd*          FIW_ItemAugmentCombobox;
/*0x398*/ CEditWnd*           FIW_ItemNameInput;
/*0x3a0*/ CEditWnd*           FIW_MaxLevelInput;
/*0x3a8*/ CEditWnd*           FIW_MinLevelInput;
/*0x3b0*/ CLabelWnd*          FIW_DragonHoardLabel;
/*0x3b8*/
};
...
/*0x2d0*/ CButtonWnd*    pMoneyButton[4];
/*0x2f0*/ CButtonWnd*    TradeButton;
/*0x2f8*/ CButtonWnd*    CancelButton;
/*0x300*/ CLabel*        NPCNameLabel;
/*0x308*/ CInvSlotWnd*   pInvSlotWnd[MAX_GIVE_SLOTS];
/*0x328*/
};
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x2c0*/ CButtonWnd*        InviteButton;
/*0x2c8*/ CButtonWnd*        DisbandButton;
/*0x2d0*/ CButtonWnd*        FollowButton;
/*0x2d8*/ CButtonWnd*        DeclineButton;
/*0x2e0*/ CButtonWnd*        LFGButton;
/*0x2e8*/ CGaugeWnd*         HPGauge[6];
/*0x318*/ CGaugeWnd*         PetGauge[6];
/*0x348*/ CGaugeWnd*         ManaGauge[6];
/*0x378*/ CGaugeWnd*         EnduranceGauge[6];
/*0x3a8*/ CLabel*            HPLabel[6];
/*0x3d8*/ CLabel*            HPPercLabel[6];
/*0x408*/ CLabel*            ManaLabel[6];
/*0x438*/ CLabel*            ManaPercLabel[6];
/*0x468*/ CLabel*            EnduranceLabel[6];
/*0x498*/ CLabel*            EndurancePercLabel[6];
/*0x4c8*/ COLORREF           HPTextColor[6];
/*0x4e0*/ CButtonWnd*        GroupTankButton[6];
/*0x510*/ CButtonWnd*        GroupAssistButton[6];
/*0x540*/ CButtonWnd*        GroupPullerButton[6];
/*0x570*/ CButtonWnd*        GroupMarkNPCButton[6];
/*0x5a0*/ CLabel*            AggroPercLabel[6];
/*0x5d0*/ long               Timer;
/*0x5d8*/ CContextMenu*      GroupContextMenu;
/*0x5e0*/ bool               bPetbars;
/*0x5e1*/ bool               bManabars;
/*0x5e2*/ bool               bEndurancebars;
/*0x5e3*/ bool               bAggroPct;
/*0x5e4*/ int                PetBarIndex;
/*0x5e8*/ int                ManaBarIndex;
/*0x5ec*/ int                EnduranceBarIndex;
/*0x5f0*/ int                AggroPctIndex;
/*0x5f4*/ int                RoleSeparatorID;
/*0x5f8*/ int                RoleSelectMenu;
/*0x5fc*/ int                RoleSelectMenuID;
/*0x600*/ bool               bPlayerInvited;
/*0x604*/
};
...
/*0x2d4*/ uint8_t     Unknown0x0240[0xfc];
...
/*0x348*/ CTextureAnimation* pBackground;
/*0x350*/ ItemGlobalIndex    ItemLocation;            // WindowType = ItemLocation.Location, InvSlot = ItemLocation.GetTopSlot()
/*0x360*/ ItemPtr            LinkedItem;              // If the slot is linked to a specific item
...
/*0x400*/ CLabel*           ModButtonLabel;                // IDW_ModButtonLabel
/*0x408*/ CLabel*           RewardButtonLabel;             // IDW_RewardButtonLabel
...
/*0x460*/ CButtonWnd*       FuseButton;                    // IDW_FuseButton
...
/*0x4a0*/ CLabel*           lblItemInfo[NumItemInfo];      // IDW_ItemInfo%d 4b0
/*0x508*/ CLabel*           lblStat[NumStatRows][NumStatCols];      // IDW_Row%dCol%dStat 518
/*0x778*/ CLabel*           lblValue[NumStatRows][NumStatCols];     // IDW_Row%dCol%dValue 788
/*0x9e8*/ CLabel*           lblHeroic[NumHeroic];          // IDW_Heroic%d 9f8
/*0xa50*/ int               rightClickMenuId;
/*0xa54*/ int               rightClickMenuSocketId;
/*0xa58*/ CComboWnd*        ItemCompareList;               // IDW_ItemCompareList
/*0xa60*/ bool              isComparing;                   // this and the next are a guess. Need to verify.
/*0xa68*/ ItemPtr           pCompareItem;
/*0xa70*/ CTAFrameDraw*     ptaPageBorderHighlight;        // FT_DefPageBorderHighlight
/*0xa78*/ CTAFrameDraw*     ptaPageBorder;                 // FT_DefPageBorder
...
/*0x2f0*/ CLabel*       pStatLabel[eNumPages];   // KRW_Mounts_StatsNameLabel, KRW_Illusions_StatNameLabel, KRW_Familiars_StatNameLabel,
/*0x318*/ CLabel*       pCountLabel[eNumPages];  // KRW_Mounts_CountLabel, KRW_Illusions_CountLabel, KRW_Familiars_CountLabel, KRW_HeroForge_CountLabel
/*0x340*/ CButtonWnd*   pBtnStat[eNumPages];     // KRW_Mounts_Selected, KRW_Illusions_Selected, KRW_Familiars_Selected, KRW_HeroForge_SlotButton
/*0x368*/ CButtonWnd*   pBtnSlot[eNumPages];     // KRW_Mounts_SlotButton, KRW_Illusions_SlotButton, KRW_Familiars_SlotButton
/*0x390*/ uint8_t       Unknown0x28c[0x20];
/*0x3b0*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x3b8*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x3c0*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x3c8*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x3d0*/ uint8_t       Unknown0x2b4[0x8];
/*0x3d8*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x3e0*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x3e8*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x3f0*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x3f8*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x400*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
/*0x408*/ CPageWnd*     pPageTeleportation;              // KRW_TeleportationItems_Page
/*0x410*/ CTabWnd*      pTabBox;                         // KRW_Subwindows
/*0x418*/ KeyRingPages  CurrentPage;
/*0x41c*/
};
...
/*0x2d0*/ int               LootIndex[InvSlot_Max];
/*0x360*/ uint32_t          nNextRefreshTime; // 370
/*0x364*/ bool              bInventoryWasActive;
/*0x368*/ ItemContainer     LootItems;
/*0x390*/ bool              bCloseOnComplete;
/*0x391*/ bool              bRightClickLoot;
/*0x392*/ bool              bLootAllReady;
/*0x398*/ CXWnd*            LootInvWnd;                       // LootInvWnd
/*0x3a0*/ CInvSlotWnd*      LootSlotWnd[InvSlot_Max];         // LW_LootSlot%d
/*0x4c0*/ CLabel*           CorpseNameLabel;                  // LW_CorpseName
/*0x4c8*/ CButtonWnd*       DoneButton;                       // DoneButton
/*0x4d0*/ CButtonWnd*       BroadcastButton;                  // BroadcastButton
/*0x4d8*/ CButtonWnd*       LootAllButton;                    // LootAllButton
/*0x4e0*/ bool              bPopupPending;
/*0x4e8*/ void*             Unknown1;
/*0x4f0*/ void*             Unknown2;
/*0x4f8*/ uint32_t          Unknown3;
/*0x4fc*/
...
/*0x2c8*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
...
/*0x350*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x358*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS];
/*0x660*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS];     // PetBuff%d - was pWnd
/*0x968*/ int                Buff[MAX_TOTAL_BUFFS];             // Spell ID# of each buff
/*0xaf0*/ HashTable<CXStr>   WhoCast;
/*0xb08*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0xb0c*/ bool               bHadPetLastTime;
/*0xb0d*/ bool               bShowOnSummon;
/*0xb10*/ uint32_t           ListContextMenuID;
/*0xb18*/ CXWnd*             pRequestingWnd;
/*0xb20*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS];     // duration until buff fades, in milliseconds
/*0xca4*/ bool               bRemovedBuffBlockMenuItem;
/*0xca8*/ int                PetCommandSelectContextMenu;
/*0xcb0*/ CXWnd*             LastClickedButton;
/*0xcb8*/ bool               bPetButtonsDirty;
/*0xcb9*/ bool               Sit;
/*0xcba*/ bool               Stop;
/*0xcbb*/ bool               ReGroup;
/*0xcbc*/ bool               Follow;
...
/*0x2c0*/ int                WindowID;
/*0x2c8*/ CLabelWnd*         pDuration;
/*0x2d0*/ CStmlWnd*          pDescription;
/*0x2d8*/ CStmlWnd*          pName;
/*0x2e0*/ CButtonWnd*        pIcon;
/*0x2e8*/ SoeUtil::String    DescriptionText;
/*0x300*/ SoeUtil::String    TitleText;
/*0x318*/ bool               bActiveItem;
/*0x320*/ CTextureAnimation* ptaBuffIcons;
/*0x328*/ CTextureAnimation* ptaDragIcons;
/*0x330*/ bool               bFailed;
/*0x334*/ ESpellDisplayType  SpellDisplayType;
/*0x338*/ int                SpellID;
/*0x33c*/ int                LastUpdateTime;
/*0x340*/
};
...
/*0x3ac*/ int                Unknown0x02f4;
/*0x3b0*/ int                Unknown0x02f8;
/*0x3b4*/ int                SpellIconOffsetX;
/*0x3b8*/ int                SpellIconOffsetY;
/*0x3bc*/ int                spellicon;                // if this is equal to FFFFFFFF there is no spell memmed in this slot...
...
/*0x2c8*/ CXWnd*             pWndBuffs;
/*0x2d0*/ CTextureAnimation* pBuffGoodBackground;
/*0x2d8*/ CTextureAnimation* pBuffBadBackground;
/*0x2e0*/ CTextureAnimation* pBuffBypassBackground;
/*0x2e8*/ CTextureAnimation* ptaBuffIcons[MAX_TOTAL_BUFFS];
/*0x5f0*/ CButtonWnd*        pTargetBuff[MAX_TOTAL_BUFFS];
/*0x8f8*/ int                BuffSpellID[MAX_TOTAL_BUFFS]; // -1 if no buff
/*0xa7c*/ int                BuffTimer[MAX_TOTAL_BUFFS];
/*0xc00*/ int                LastBuffReceivedTime;
/*0xc04*/ int                Timer;
/*0xc08*/ HashTable<CXStr>   Casters;
/*0xc20*/ int                ContextMenuID;
/*0xc28*/ CXWnd*             RequestingWnd;
/*0xc30*/ bool               bRemovedBuffBlockMenuItem;
/*0xc34*/ int                Type;                     // 1 = self, 4 = group member, 5 = PC, 7 = NPC
/*0xc38*/ uint8_t            Unknown0x884[0x4c];
/*0xc84*/
};
...
/*0x2c8*/ bool               bInventoryWasOpen;
/*0x2d0*/ CButtonWnd*        HisMoneyButton[4];
/*0x2f0*/ CButtonWnd*        MyMoneyButton[4];
/*0x310*/ CButtonWnd*        TradeButton;
/*0x318*/ CButtonWnd*        CancelButton;
/*0x320*/ CLabel*            HisNameLabel;
/*0x328*/ CLabel*            MyNameLabel;
/*0x330*/ CInvSlotWnd*       pInvSlotWnd[MAX_TRADE_SLOTS];
/*0x3b0*/ long               HisMoney[4];
/*0x3c0*/ long               MyMoney[4];
/*0x3d0*/ ItemContainer      TradeItems;
/*0x3f8*/ bool               bHisReadyTrade;           // was HisTradeReady
/*0x3f9*/ bool               bMyReadyTrade;            // was MyTradeReady
/*0x3fa*/ bool               bIsTrading;               // was TradeWndOpen
/*0x3fc*/
