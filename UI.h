...
// @sizeof(CButtonWnd) == 0x340 :: 2023-10-12 (live) @ 0x1405A3FD0
...
// @sizeof(CCursorAttachment) == 0x620 :: 2023-10-12 (live) @ 0x140185e18
...
/*0x3b4*/ int                       Type;
/*0x3b8*/ int                       Index;
/*0x3bc*/ EqItemGuid                ItemGuid;
/*0x3d0*/ int                       ItemID;
/*0x3d4*/ int                       Qty;
/*0x3d8*/ int                       IconID;
/*0x3e0*/ SoeUtil::String           AssignedName;
/*0x3f8*/ int                       Unknown0x264;
/*0x3fc*/ char                      AssignedNameCopy[0x40];
/*0x440*/ CXStr                     ButtonText;
/*0x448*/ CStaticAnimationTemplate* pBGStaticAnim;                  // CA_Anim
/*0x450*/ CStaticAnimationTemplate* pOverlayStaticAnim;             // CA_Anim2
/*0x458*/ CSpellGemWnd*             pSpellGem;                      // CA_SpellGem
/*0x460*/ CTextObjectInterface*     pTextObjectInterface;
/*0x468*/ CTextObjectInterface*     pButtonTextObjectInterface;
/*0x470*/ int                       TextfontStyle;
/*0x474*/ int                       Unknown0x2C4;
/*0x478*/
};
...
// @sizeof(CFindItemWnd) == 0x3f0 :: 2023-10-12 (live) @ 0x1401874a4
...
// @sizeof(CFindLocationWnd) == 0x398 :: 2023-10-12 (live) @ 0x140187c62
...
// @sizeof(CGroupWnd) == 0x6f8 :: 2023-10-12 (live) @ 0x140186597
...
// @sizeof(CItemDisplayWnd) == 0xaa0 :: 2023-10-12 (live) @ 0x1403fe614
...
// @sizeof(CKeyRingWnd) == 0x428 :: 2023-10-12 (live) @ 0x140186f05
...
// @sizeof(CLootWnd) == 0xcb8 :: 2023-10-12 (live) @ 0x1401871d2
...
// @sizeof(CMapViewWnd) == 0x848 :: 2023-10-12 (live) @ 0x1401868f9
...
// @sizeof(CPlayerWnd) == 0x400 :: 2023-10-12 (live) @ 0x140186d2d
...
// @sizeof(CTargetWnd) == 0x408 :: 2023-10-12 (live) @ 0x140186bce
