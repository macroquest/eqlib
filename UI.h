...
// @sizeof(CButtonWnd) == 0x358 :: 2022-05-13 (live) @ 0x140534c1e
...
// @sizeof(CFindItemWnd) == 0x3f0 :: 2022-05-13 (live) @ 0x140158a77
...
// @sizeof(CFindLocationWnd) == 0x3a0 :: 2022-05-13 (live) @ 0x140159235
...
// @sizeof(CItemDisplayWnd) == 0xa98 :: 2022-05-13 (live) @ 0x1403ad034
...
// @sizeof(CKeyRingWnd) == 0x430 :: 2022-05-13 (live) @ 0x140158527
...
// @sizeof(CLootWnd) == 0x510 :: 2022-05-13 (live) @ 0x1401587a5
...
// @sizeof(CMapViewWnd) == 0x858 :: 2022-05-13 (live) @ 0x140157f1b
...
// @sizeof(CPetInfoWnd) == 0xcd8 :: 2022-05-13 (live) @ 0x1401579bc
constexpr size_t CPetInfoWnd_size = 0xcd8;
...
/*0x2d8*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
...
/*0x360*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x368*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS_NPC];
/*0x670*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS_NPC]; // PetBuff%d - was pWnd
/*0x978*/ int                Buff[MAX_TOTAL_BUFFS_NPC];         // Spell ID# of each buff
/*0xb00*/ HashTable<CXStr>   WhoCast;
/*0xb18*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0xb1c*/ bool               bHadPetLastTime;
/*0xb1d*/ bool               bShowOnSummon;
/*0xb20*/ uint32_t           ListContextMenuID;
/*0xb28*/ CXWnd*             pRequestingWnd;
/*0xb30*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS_NPC]; // duration until buff fades, in milliseconds
/*0xcb4*/ bool               bRemovedBuffBlockMenuItem;
/*0xcb8*/ int                PetCommandSelectContextMenu;
/*0xcc0*/ CXWnd*             LastClickedButton;
/*0xcc8*/ bool               bPetButtonsDirty;
/*0xcc9*/ bool               Sit;
/*0xcca*/ bool               Stop;
/*0xccb*/ bool               ReGroup;
/*0xccc*/ bool               Follow;
...
// @sizeof(CPlayerWnd) == 0x408 :: 2022-05-13 (live) @ 0x14015834f
...
// @sizeof(CTargetWnd) == 0x410 :: 2022-05-13 (live) @ 0x1401581f0
