...
// @sizeof(CButtonWnd) == 0x330 :: 2022-11-10 (live) @ 0x14053d31e
constexpr size_t CButtonWnd_size = 0x330;
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x250*/ int                   MouseButtonState;
/*0x254*/ bool                  bPicture;
/*0x258*/ CRadioGroup*          pGroup;
/*0x260*/ bool                  Checked;
/*0x261*/ bool                  bMouseOverLastFrame;
/*0x264*/ CXPoint               DecalOffset;
/*0x26c*/ CXSize                DecalSize;
/*0x274*/ COLORREF              DecalTint;                // Color
/*0x278*/ CXRect                TextOffsets;
/*0x288*/ int                   TextModeBits;
/*0x28c*/ COLORREF              Mouseover;
/*0x290*/ COLORREF              Pressed;
/*0x294*/ COLORREF              Disabled;
/*0x298*/ unsigned int          CoolDownBeginTime;
/*0x29c*/ unsigned int          CoolDownDuration;
/*0x2a0*/ CXStr                 Indicator;
/*0x2a8*/ unsigned int          IndicatorVal;
/*0x2b0*/ CTextObjectInterface* pIndicatorTextObject;
/*0x2b8*/ unsigned int          Unknown0x248;
/*0x2c0*/ CButtonDrawTemplate   DrawTemplate;
/*0x328*/ bool                  bAllowButtonClickThrough;
/*0x329*/ bool                  bCoolDownDoDelayedStart;
/*0x32a*/ bool                  bIsCheckbox;
/*0x32b*/ bool                  bIsDrawLasso;
/*0x32c*/ uint32_t              ButtonStyle;              // tbd
/*0x330*/
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x240*/ CListWnd*                    pListWnd;
/*0x248*/ int                          ListHeightMax;
/*0x24c*/ int                          ListHeight;
/*0x250*/ CButtonDrawTemplate          ButtonDrawTemplate;
/*0x2b8*/
};
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x240*/ eTextAlign   eAlign = eta_Left;
/*0x244*/ int          StartPos = 0;
/*0x248*/ int          EndPos = 0;
/*0x24c*/ int          MaxChars = -1;
/*0x250*/ int          MaxBytesUTF8 = -1;
/*0x258*/ CXStr        InputText;
/*0x260*/ int          TagPrintableStarts[EDITWND_MAX_TAGS];
/*0x288*/ int          TagPrintableEnds[EDITWND_MAX_TAGS];
/*0x2b0*/ int          TagOriginalStarts[EDITWND_MAX_TAGS];
/*0x2d8*/ int          TagOriginalEnds[EDITWND_MAX_TAGS];
/*0x300*/ int          TagDynamicSize[EDITWND_MAX_TAGS];
/*0x328*/ int          TagCodes[EDITWND_MAX_TAGS];
/*0x350*/ CXStr        TagStrings[EDITWND_MAX_TAGS];
/*0x3a0*/ int          TagCount;
/*0x3a4*/ uint32_t     EditStyle;
/*0x3a8*/
};
...
/*0x3a8*/ bool         bAnchorAtStart;
/*0x3a9*/ bool         bCaretAtEnd;
/*0x3aa*/ bool         bAutoVScrollCalc;
/*0x3ab*/ bool         bEditable;
/*0x3b0*/ CXStr        FilterChars;
/*0x3b8*/ int          EditMode;
/*0x3bc*/ wchar_t      PasswordChar;
/*0x3c0*/ ArrayClass2<uint32_t> LineIndices;
/*0x3e0*/
};
...
/*0x240*/ int          EQType;
/*0x244*/ D3DCOLOR     FillTint;
/*0x248*/ D3DCOLOR     LinesFillTint;
/*0x24c*/ bool         bDrawLinesFill;
/*0x250*/ int          TextOffsetX;
/*0x254*/ int          TextOffsetY;
/*0x258*/ int          GaugeOffsetX;
/*0x25c*/ int          GaugeOffsetY;
/*0x260*/ float        LastFrameVal;
/*0x268*/ CXStr        LastFrameName;
/*0x270*/ int          LastFrameTime;
/*0x274*/ int          LastFrameTarget;
/*0x278*/ CXStr        GaugeTooltip;
/*0x280*/ int          TooltipVal;
/*0x284*/ int          Unknown0x228;
/*0x288*/ CGaugeDrawTemplate DrawTemplate;
/*0x2c0*/ CTextObjectInterface* pTextObject;
/*0x2c8*/ CXStr        NextDrawStr;
/*0x2d0*/ bool         bSmooth;
/*0x2d4*/ int          TargetVal;
/*0x2d8*/ bool         bUseTargetVal;
/*0x2dc*/
};
...
/*0x27c*/ int                 CurCol;
/*0x280*/ int                 DownItem;
/*0x284*/ int                 ScrollOffsetY;
/*0x288*/ int                 HeaderHeight;
/*0x28c*/ int                 FirstVisibleLine;
/*0x290*/ int                 SortCol;
/*0x294*/ bool                bSortAsc;
/*0x295*/ bool                bFixedHeight;
/*0x296*/ bool                bOwnerDraw;
/*0x297*/ bool                bCalcHeights;
/*0x298*/ bool                bColumnSizable;
/*0x29c*/ int                 LineHeight;
/*0x2a0*/ int                 ColumnSepDragged;
/*0x2a4*/ int                 ColumnSepMouseOver;
/*0x2a8*/ COLORREF            HeaderText;
/*0x2ac*/ COLORREF            Highlight;
/*0x2b0*/ COLORREF            Selected;
/*0x2b8*/ CUITextureInfo      BGHeader;
/*0x2d8*/ COLORREF            BGHeaderTint;
/*0x2e0*/ CTextureAnimation*  pRowSep;
/*0x2e8*/ CTextureAnimation*  pColumnSep;
/*0x2f0*/ CEditBaseWnd*       pEditCell;
/*0x2f8*/ IListItemDataHandler* pItemDataHandler;
/*0x300*/ bool                bHasItemTooltips;
/*0x304*/ CXRect              PrevInsideRect;
/*0x314*/ uint32_t            ListWndStyle;
/*0x318*/ eqtime_t            LastVisibleTime;
/*0x320*/
...
/*0x2a8*/ CXStr              TabText;
/*0x2b0*/ CXStr              OrigTabText;
/*0x2b8*/ COLORREF           CRTabText;
/*0x2bc*/ COLORREF           CRTabTextActive;
/*0x2c0*/ CTextureAnimation* pTATabIcon;
/*0x2c8*/ CTextureAnimation* pTATabIconActive;
/*0x2d0*/ int                Unknown0x250;
/*0x2d4*/ int                Unknown0x254;
/*0x2d8*/ int64_t            LastFlashTime;
/*0x2e0*/ COLORREF           CRHighlightFlashColor;
/*0x2e4*/ bool               bHighlightOnNewMessages;
/*0x2e5*/ bool               bFlashing;
/*0x2e8*/
};
...
/*0x240*/ CButtonDrawTemplate      bdtThumb;
/*0x2a8*/ CTextureAnimation*       ptaBackground;
/*0x2b0*/ CTextureAnimation*       ptaEndCapLeft;
/*0x2b8*/ CTextureAnimation*       ptaEndCapRight;
/*0x2c0*/
	// more ...
};
...
public:
	...
	// todo: verify
/*0x240*/ CXStr                        STMLText;
/*0x248*/ CircularArrayClass2<STextLine> TextLines;
/*0x278*/ int32_t                      TextTotalHeight;
/*0x27c*/ int32_t                      TextTotalWidth;
/*0x280*/ int32_t                      Unknown0x224;
/*0x288*/ ArrayClass2<SLinkInfo>       Links;
/*0x2a8*/ ArrayClass<STable>           Tables;
/*0x2c0*/ bool                         bReparseNow;
/*0x2c1*/ bool                         bResized;
/*0x2c2*/ bool                         bAlignCenter;
/*0x2c4*/ int                          LineSpacingAdjust;
/*0x2c8*/ int32_t                      CapturedLinkID;
/*0x2cc*/ int32_t                      MousedOverLinkID;
/*0x2d0*/ COLORREF                     BackGroundColor;
/*0x2d4*/ COLORREF                     TextColor;
/*0x2d8*/ COLORREF                     LinkColor;
/*0x2dc*/ COLORREF                     VLinkColor;
/*0x2e0*/ COLORREF                     ALinkColor;
/*0x2e4*/ COLORREF                     MLinkColor;
/*0x2e8*/ ESTMLParseState              CurrentParseState;
/*0x2f0*/ ArrayClass2<SHistoryElement> HistoryArray;
/*0x310*/ int32_t                      HistoryIndex;
/*0x318*/ CStmlReport*                 pStmlReport;
/*0x320*/ int                          MaxLines;
/*0x324*/ int                          PlayerContextMenuIndex;
/*0x328*/ int                          Unknown0x2ac;
/*0x32c*/ int                          Unknown0x2b0;
/*0x330*/ int                          Unknown0x2b4;
/*0x334*/
};
...
/*0x240*/ CTAFrameDraw*           pTabBorder;
/*0x248*/ CTAFrameDraw*           pPageBorder;
/*0x250*/ ArrayClass<CPageWnd*>   PageArray;
/*0x268*/ int                     CurTabIndex;
/*0x26c*/ int                     TabHeight;
/*0x270*/ CXRect                  PageRect;
/*0x280*/ bool                    bShowTabs;
/*0x284*/ int                     TabStyle;
/*0x288*/ int                     TabWidth;
/*0x28c*/
};
...
/*0x2d8*/ uint32_t             spacing;
/*0x2dc*/ bool                 expandLast;
/*0x2e0*/ int                  paddingLeft;
/*0x2e4*/ int                  paddingRight;
/*0x2e8*/ int                  paddingTop;
/*0x2ec*/ int                  paddingBottom;
/*0x2f0*/ };
...
public:
/*0x2c0*/ ArrayClass<CXWnd*>         visibleChildren;
/*0x2d8*/ ArrayClass<CXRect>         dividerRects;
/*0x2f0*/ int                        activeDivider;
/*0x2f4*/ bool                       dividerHover;
/*0x2f5*/ bool                       dividerMoving;
/*0x2f8*/ int                        oldPosCoord;              // X for horizontal, Y for vertical
/*0x2fc*/ bool                       bStyle_Dividers;          // the Style_Dividers property from XML
/*0x300*/
};
...
public:
/*0x2c0*/ bool                       horizontalFirst;
/*0x2c1*/ bool                       anchorToTop;
/*0x2c2*/ bool                       anchorToLeft;
/*0x2c4*/ int                        secondarySpacing;
/*0x2c8*/ bool                       firstPieceTemplate;
/*0x2c9*/ bool                       snapToChildren;
/*0x2d0*/ CXWnd*                     autoStretchWindow;
/*0x2d8*/
};
...
/*0x2e8*/ CVerticalLayoutWnd*       pLayout;                 // ADLW_ScreenLayout
/*0x2f0*/ CListWnd*                 pPersonalLootList;       // ADLW_PLLList
/*0x2f8*/ CButtonWnd*               pPersonalSetBtn;         // ADLW_PLLSetBtn
/*0x300*/ CComboWnd*                pPersonalSetCombo;       // ADLW_PLLSetCmbo
/*0x308*/ CButtonWnd*               pLootAllBtn;             // ADLW_PLL_LootAllBtn
/*0x310*/ CButtonWnd*               pLeaveAllBtn;            // ADLW_PLL_LeaveAllBtn
/*0x318*/ CXWnd*                    pCLLWnd;                 // ADLW_CLLWnd
/*0x320*/ CListWnd*                 pConstructLootList;      // ADLW_CLLList
/*0x328*/ CButtonWnd*               pConstructSetBtn;        // ADLW_CLLSetBtn
/*0x330*/ CComboWnd*                pConstructSetCombo;      // ADLW_CLLSetCmbo
/*0x338*/ CButtonWnd*               pContructLeaveAllBtn;    // ADLW_CLL_LeaveAllBtn
/*0x340*/ CCheckBoxWnd*             pApplyFiltersChk;        // ADLW_ApplyFiltersCheck
/*0x348*/ CCheckBoxWnd*             pGroupedByNpcChk;        // ADLW_GroupedByNpcCheckbox
/*0x350*/ CButtonWnd*               pEditFiltersBtn;         // ADLW_EditFitlersBtn
/*0x358*/ CButtonWnd*               pLootSettingsBtn;        // ADLW_LootSettingsBtn
/*0x360*/ CLabelWnd*                pCalculatedMasterLooter; // ADLW_CalculatedMasterLooter
/*0x368*/ CButtonWnd*               pItemBtnTemplate;        // ADLW_ItemBtnTemplate
/*0x370*/ CButtonWnd*               pStatusTemplate;         // ADLW_StatusTemplate
/*0x378*/ CButtonWnd*               pNeverBtnTemplate;       // ADLW_NvrBtnTemplate
/*0x380*/ CButtonWnd*               pLootBtnTemplate;        // ADLW_LootBtnTemplate
/*0x388*/ CButtonWnd*               pLeaveBtnTemplate;       // ADLW_LeaveBtnTemplate
/*0x390*/ CButtonWnd*               pFreeGrabBtnTemplate;    // ADLW_FreeGrabBtnTemplate
/*0x398*/ CCheckBoxWnd*             pCheckBoxTemplate;       // ADLW_CheckBoxTemplate
/*0x3a0*/ CButtonWnd*               pTextLinkTemplate;       // ADLW_TextLinkTemplate
/*0x3a8*/ CButtonWnd*               pManageBtnTemplate;      // ADLW_ManageBtnTemplate
/*0x3b0*/ CButtonWnd*               pActionBtnTemplate;      // ADLW_ActionBtnTemplate
...
/*0x2e0*/ CButtonWnd*        pAddButton;
/*0x2e8*/ CButtonWnd*        pDeleteButton;
/*0x2f0*/ CButtonWnd*        pUseButton;
/*0x2f8*/ CButtonWnd*        pMkHotButton;
/*0x300*/ CButtonWnd*        pAutoSwapButton;
/*0x308*/ CButtonWnd*        pDisplayButtons[MAX_BANDOLIER_SLOTS];
/*0x328*/ CListWnd*          pWeaponSetList;
/*0x330*/
};
...
{
public:
/*0x2ac*/ int          MoneyButtonIndex;
/*0x2b0*/ unsigned int NextRefreshTime;
/*0x2b4*/ bool         bInventoryWasActive;
/*0x2b5*/ bool         bRealEstateManagementWasActive;
/*0x2b8*/ CButtonWnd*  MoneyButtons[5];          // including shared plat
/*0x2e0*/ CLabel*      BankerNameLabel;
/*0x2e8*/ CInvSlotWnd* InvSlotWindows[NUM_BANK_SLOTS];
/*0x3a8*/ CLabel*      SharedBankLabel;
/*0x3b0*/ CInvSlotWnd* SharedSlotWindows[NUM_SHAREDBANK_SLOTS];
/*0x3e0*/ CButtonWnd*  DoneButton;
/*0x3e8*/ CButtonWnd*  ChangeButton;
/*0x3f0*/ CButtonWnd*  AutoButton;
/*0x3f8*/ CButtonWnd*  AltStorageButton;
/*0x400*/ CButtonWnd*  FindItemButton;
/*0x408*/ CButtonWnd*  DragonHoardButton;
/*0x410*/ int          BankSize;
/*0x414*/
...
/*0x2d8*/ CStmlWnd*                    pstmlStatus;               // StatusText
/*0x2e0*/ CListWnd*                    plistItems;                // ItemSearchList
/*0x2e8*/ CListWnd*                    plistInventory;            // InventoryList
/*0x2f0*/ CListWnd*                    plistCompensation;         // CompensationList
/*0x2f8*/ CListWnd*                    plistBuyLines;             // BuyLineList
/*0x300*/ CEditWnd*                    peditSearch;               // ItemSearchEdit
/*0x308*/ CButtonWnd*                  pbtnSearch;                // ItemSearchButton
/*0x310*/ CButtonWnd*                  pbtnAddItem;               // InventoryAddButton
/*0x318*/ CButtonWnd*                  pbtnRemoveItem;            // InventoryRemoveButton
/*0x320*/ CButtonWnd*                  pbtnPlat;                  // CompensationPlat
/*0x328*/ CButtonWnd*                  pbtnGold;                  // CompensationGold
/*0x330*/ CButtonWnd*                  pbtnSilver;                // CompensationSilver
/*0x338*/ CButtonWnd*                  pbtnCopper;                // CompensationCopper
/*0x340*/ CButtonWnd*                  pbtnCreate;                // BuyLineAddButton
/*0x348*/ CEditWnd*                    peditCount;                // CountEdit
/*0x350*/ CButtonWnd*                  pbtnRemoveLine;            // BuyLineRemoveButton
/*0x358*/ CButtonWnd*                  pbtnUpdateLine;            // BuyLineModifyButton
/*0x360*/ CButtonWnd*                  pbtnActiveLine;            // BuyLineActiveButton
/*0x368*/ CButtonWnd*                  pbtnActivateAllLines;      // BuyLineActivateAllButton
/*0x370*/ CButtonWnd*                  pbtnListLines;             // ListLinesButton
/*0x378*/ CButtonWnd*                  pbtnClearStatus;           // ClearStatusButton
/*0x380*/ CButtonWnd*                  pbtnStartStop;             // StartStopButton
/*0x388*/ CButtonWnd*                  pbtnOfflineMode;           // OfflineModeButton
/*0x390*/ CEditWnd*                    peditWelcome;              // WelcomeEdit
/*0x398*/ CButtonWnd*                  pbtnUpdateWelcome;         // UpdateWelcomeButton
/*0x3a0*/ CButtonWnd*                  pbtnRefreshInventory;      // InventoryRefreshButton
/*0x3a8*/ CLayoutWnd*                  pLayout;                   // Layout
/*0x3b0*/ CLayoutWnd*                  pStatusLayout;             // StatusLayout
/*0x3b8*/ uint32_t                     lastUpdateTime;
/*0x3c0*/ eqtime_t                     lastSearchTime;
/*0x3c8*/ uint32_t                     quantityRequest;
/*0x3d0*/ ArrayClass2<BarterInventoryItem> InventoryItems;
/*0x3f0*/ ArrayClass2<BarterSearchedItem> SearchedItems;
/*0x410*/ BarterBuyLine                CurrentBuyLine;
/*0x4d8*/
};
...
/*0x2d8*/ HashTable<BarterBuyerSearchData> Buyers;
/*0x2f0*/ CListWnd*                    plistInventory;                 // InventoryList
/*0x2f8*/ CListWnd*                    plistBuyLines;                  // BuyLineList
/*0x300*/ CListWnd*                    plistDetails;                   // DetailsList
/*0x308*/ CEditWnd*                    peditSearch;                    // ItemSearchEdit
/*0x310*/ CButtonWnd*                  pbtnRefreshInventory;           // RefreshInventoryButton
/*0x318*/ CButtonWnd*                  pbtnSearch;                     // SearchButton
/*0x320*/ CButtonWnd*                  pbtnWelcome;                    // WelcomeButon
/*0x328*/ CButtonWnd*                  pbtnGreeting;                   // GreetingButton
/*0x330*/ CButtonWnd*                  pbtnFind;                       // FindButton
/*0x338*/ CButtonWnd*                  pbtnHide;                       // HideButton
/*0x340*/ CButtonWnd*                  pbtnBuyLineInspectItem;         // BuyLineInspectButton
/*0x348*/ CButtonWnd*                  pbtnCompensationInspectItem;    // CompensationInspectButton
/*0x350*/ CButtonWnd*                  pbtnCompensationPreviewItem;    // CompensationPreviewButton
/*0x358*/ CButtonWnd*                  pbtnSellButton;                 // SellButton
...
/*0x02ac*/ uint8_t                     UnknownPadding[0x34];
/*0x02e0*/ BazaarSearchResults         searchResults[MAX_BAZAAR_SEARCH_RESULTS];
/*0x95c0*/ HashTable<BazaarTraderData> Traders;
/*0x95d8*/ CListWnd*                   pItemList;                        // BZR_ItemList
/*0x95e0*/ CButtonWnd*                 pQueryButton;
/*0x95e8*/ CButtonWnd*                 pWelcomeButton;
/*0x95f0*/ CButtonWnd*                 pUpdatePlayerButton;
/*0x95f8*/ CButtonWnd*                 pRequestItemButton;
/*0x9600*/ CButtonWnd*                 pRequestPreviewButton;
/*0x9608*/ CButtonWnd*                 pFindTraderButton;
/*0x9610*/ CButtonWnd*                 pHideTradersButton;
/*0x9618*/ CButtonWnd*                 pDefaultButton;
/*0x9620*/ CButtonWnd*                 pBuyButton;
/*0x9628*/ CLabelWnd*                  pItemNameLabel;
/*0x9630*/ CLabelWnd*                  pPlayersLabel;
/*0x9638*/ CLabelWnd*                  pItemSlotLabel;
/*0x9640*/ CLabelWnd*                  pStatSlotLabel;
/*0x9648*/ CLabelWnd*                  pRaceSlotLabel;
/*0x9650*/ CLabelWnd*                  pClassSlotLabel;
/*0x9658*/ CLabelWnd*                  pItemTypeLabel;
/*0x9660*/ CLabelWnd*                  pSearchResultLabel;
/*0x9668*/ CLabelWnd*                  pMaxPriceLabel;
/*0x9670*/ CLabelWnd*                  pMinPriceLabel;
/*0x9678*/ CLabelWnd*                  pItemPrestigeLabel;
/*0x9680*/ CLabelWnd*                  pItemAugmentLabel;
/*0x9688*/ CComboWnd*                  pItemSlotCombobox;
/*0x9690*/ CComboWnd*                  pStatSlotCombobox;
/*0x9698*/ CComboWnd*                  pRaceSlotCombobox;
/*0x96a0*/ CComboWnd*                  pClassSlotCombobox;
/*0x96a8*/ CComboWnd*                  pItemTypeCombobox;
/*0x96b0*/ CComboWnd*                  pPlayersCombobox;
/*0x96b8*/ CComboWnd*                  pItemPrestigeCombobox;
/*0x96c0*/ CComboWnd*                  pItemAugmentCombobox;
/*0x96c8*/ CEditWnd*                   pItemNameInput;
/*0x96d0*/ CEditWnd*                   pMaxPriceInput;
/*0x96d8*/ CEditWnd*                   pMinPriceInput;
/*0x96e0*/ CEditWnd*                   pMaxLevelInput;
/*0x96e8*/ CEditWnd*                   pMinLevelInput;
/*0x96f0*/ CEditWnd*                   pMaxResultsPerTraderInput;
/*0x96f8*/ BYTE                        Unknown0x92C8[0x8];
/*0x9700*/
};
...
/*0x2ac*/ int                selectedSlot;
/*0x2b0*/ int                curBazaarIndex;
/*0x2b4*/ int                curItemPrice;
/*0x2b8*/ int                moneyBtnIndex;
/*0x2c0*/ ItemPtr            selectedItem;
...
/*0x2ac*/ bool                  bOldIconArrangement;
/*0x2b0*/ CTextureAnimation*    ptaBlueIconBackground;
/*0x2b8*/ CTextureAnimation*    ptaRedIconBackground;
/*0x2c0*/ CTextureAnimation*    ptaYellowIconBackground;
/*0x2c8*/ CTextureAnimation*    ptaBuffIcons[MAX_BUFF_ICONS];
/*0x418*/ CButtonWnd*           pBuffButtons[MAX_BUFF_ICONS];    // was: pBuff
/*0x568*/ CTextObjectInterface* pTimeRemainingTexts[MAX_BUFF_ICONS];
/*0x6b8*/ CTextObjectInterface* pCounterTexts[MAX_BUFF_ICONS];
/*0x808*/ CTextObjectInterface* pLimitedUseTexts[MAX_BUFF_ICONS];
/*0x958*/ int                   spellIds[MAX_BUFF_ICONS];        // was: BuffId
/*0xa00*/ int                   buffTimers[MAX_BUFF_ICONS];      // was: BuffTimer
/*0xaa8*/ HashTable<CXStr>      whoCastHash;                     // was: WhoCast
/*0xac0*/ uint32_t              nextRefreshTime;
/*0xac4*/ int                   initWindowWidth;
/*0xac8*/ int                   initWindowHeight;
/*0xacc*/ BuffWindowType        buffWindowType;
/*0xad0*/ int                   firstEffectSlot;
/*0xad4*/ int                   lastEffectSlot;                  // was: MaxLongBuffs 0x2a (NUM_LONG_BUFFS)
/*0xad8*/ int                   maxBuffButtons;                  // was: MaxShortBuffs 0x37 (NUM_SHORT_BUFFS)
/*0xadc*/ int                   contextMenuId;
/*0xae0*/ CXWnd*                selectedButtonWnd;               // this field doesn't alwayws appear to be initialize
/*0xae8*/ bool                  updatedMenuItems;
/*0xaec*/ int                   lastBuffRefreshTime;
/*0xaf0*/
...
/*0x2b8*/ CPopDialogWnd*       pCurrentPop;
/*0x2c0*/ uint32_t             lastRefresh;
/*0x2c4*/ bool                 bHorizontal;
/*0x2c8*/ CSpellGemWnd*        SpellSlots[NUM_SPELL_GEMS];     // CSPW_Spell%d
/*0x338*/ CButtonWnd*          pBtnSpellBook;                  // CSPW_SpellBook
/*0x340*/ CButtonWnd*          pBtnSpellBookH;                 // CSPW_SpellBookH
/*0x348*/ CButtonWnd*          pBtnSpellBookV;                 // CSPW_SpellBookV
/*0x350*/ CXWnd*               pHorizontalTemplate;            // CSPW_HorizontalOrientationTemplate
/*0x358*/ CXWnd*               pVerticalTemplate;              // CSPW_VerticalOrientationTemplate
/*0x360*/ CTileLayoutWnd*      pSpellGemLayout;                // CSPW_SpellGemLayout
/*0x368*/ CXWnd*               pHorizontalBook;                // CSPW_HorizontalOrientationBook
/*0x370*/ CXWnd*               pVerticalBook;                  // CSPW_VerticalOrientationBook
/*0x378*/ ArrayClass<SpellCategoryMajor*> CategorizedSpells;
/*0x390*/ int                  SpellSelectMenuID;
/*0x394*/ int                  GemMemming;
/*0x398*/ int                  LoadoutMenu;
/*0x39c*/ int                  SaveLoadoutIndex;
/*0x3a0*/ CContextMenu*        pMainMenu;
/*0x3a8*/ CContextMenu*        pLoadMenu;
/*0x3b0*/ CContextMenu*        pSaveMenu;
/*0x3b8*/ CContextMenu*        pDeleteMenu;
/*0x3c0*/
};
...
/*0x2a8*/ CChatWindowManager* ChatManager;
/*0x2b0*/ CEditWnd*    InputWnd;
/*0x2b8*/ CStmlWnd*    OutputWnd;
/*0x2c0*/ int          ChatChannel;
/*0x2c4*/ int          ChatChannelIndex;
/*0x2c8*/ char         TellTarget[0x40];
/*0x308*/ int          Language;
/*0x30c*/ bool         bIsMainChat;
/*0x30d*/ bool         bIsTellWnd;
/*0x310*/ int          TimestampFormat;
/*0x314*/ COLORREF     TimestampColor;
/*0x318*/ bool         bTimestampMatchChatColor;
/*0x320*/ CXStr        CommandHistory[0x28];
/*0x460*/ int          HistoryIndex;
/*0x464*/ int          HistoryLastShown;
/*0x468*/ int          FontSize;                 // style
/*0x46c*/ int          AlwaysChathereIndex;      // menu
/*0x470*/ int          NamesContextMenu;         // guess
/*0x474*/ int          ContextMenuID;            // also a guess
/*0x478*/ int          ContextMenuSubID[0xa];    // this is not correct but ill fix it later.
/*0x4a0*/
};
...
/*0x2ac*/ int                ContextMenuIndex;
/*0x2b0*/ int                MaxSliderValue;
/*0x2b8*/ CXWnd*             pwndCaller;
/*0x2c0*/ CButtonWnd*        ColorButton[16];
/*0x340*/ int                RedSliderValue;
/*0x348*/ CSliderWnd*        RedSlider;
/*0x350*/ CEditWnd*          RedSliderInputEdit;
/*0x358*/ int                GreenSliderValue;
/*0x360*/ CSliderWnd*        GreenSlider;
/*0x368*/ CEditWnd*          GreenSliderInputEdit;
/*0x370*/ int                BlueSliderValue;
/*0x378*/ CSliderWnd*        BlueSlider;
/*0x380*/ CEditWnd*          BlueSliderInputEdit;
/*0x388*/ CButtonWnd*        AcceptButton;
/*0x390*/
};
...
/*0x2b0*/ CStaticAnimationTemplate*     pStrip1;
/*0x2b8*/ CStaticAnimationTemplate*     pStrip2;
/*0x2c0*/ int                           Unknown0x244;
/*0x2c4*/ int                           offset;
/*0x2c8*/ int                           timestamp;
/*0x2d0*/ double                        speed;
/*0x2d8*/ int                           timer;
/*0x2dc*/ CompassLineSource             lineAdventure;
/*0x310*/ ArrayClass<CompassLineSource*> lineData;
/*0x328*/
};
...
public:
	...
	// Data members
/*0x2a8*/ CStmlWnd*    OutputText;
/*0x2b0*/ CButtonWnd*  pYesButton;
/*0x2b8*/ CButtonWnd*  pNoButton;
/*0x2c0*/ CButtonWnd*  pCancelButton;
/*0x2c8*/ CButtonWnd*  pOKButton;
/*0x2d0*/ BYTE         Unknown0x170[0x18]; // fixme x64
/*0x2e8*/
};
...
/*0x0240*/ CXWnd*             pParentMenuWnd;
/*0x0248*/ CContextMenu*      pCurrMenus[MAX_CONTEXT_MENU_DEPTH];
/*0x0288*/ int                NumVisibleMenus;
/*0x028c*/ int                CurrMenu;
/*0x0290*/ CContextMenu*      pMenus[MAX_CONTEXT_MENUS];
/*0x2290*/ int                NumMenus;
/*0x2298*/ CXWnd*             pHandlerWnd;
/*0x22a0*/ int                HandlerCmd;
/*0x22a4*/ int                DefaultMenuIndex;
/*0x22a8*/ int                DefaultHelpItem;
/*0x22ac*/ int                DefaultBGItem;
/*0x22b0*/ int                DefaultMinItem;
/*0x22b4*/ int                DefaultCloseItem;
/*0x22b8*/ int                DefaultLockItem;
/*0x22bc*/ int                DefaultEscapeItem;
/*0x22c0*/
};
...
/*0x2ac*/ int                       Type;
/*0x2b0*/ int                       Index;
/*0x2b4*/ EqItemGuid                ItemGuid;
/*0x2c8*/ int                       ItemID;
/*0x2cc*/ int                       Qty;
/*0x2d0*/ int                       IconID;
/*0x2d8*/ SoeUtil::String           AssignedName;
/*0x2f0*/ int                       Unknown0x264;
/*0x2f4*/ char                      AssignedNameCopy[0x40];
/*0x338*/ CXStr                     ButtonText;
/*0x340*/ CStaticAnimationTemplate* pBGStaticAnim;                  // CA_Anim
/*0x348*/ CStaticAnimationTemplate* pOverlayStaticAnim;             // CA_Anim2
/*0x350*/ CSpellGemWnd*             pSpellGem;                      // CA_SpellGem
/*0x358*/ CTextObjectInterface*     pTextObjectInterface;
/*0x360*/ CTextObjectInterface*     pButtonTextObjectInterface;
/*0x368*/ int                       TextfontStyle;
/*0x36c*/ int                       Unknown0x2C4;
/*0x370*/
};
...
/*0x2ac*/ bool             Unknown0x22c;
/*0x2b0*/ int              Unknown0x230;
/*0x2b4*/ int              Unknown0x234;
/*0x2b8*/ int              Unknown0x238;
/*0x2c0*/ SoeUtil::String  Unknown0x23c;
/*0x2d8*/ SoeUtil::String  Unknown0x24c;
/*0x2f0*/ CGaugeWnd*       StandingGaugeTemplate;
/*0x2f8*/ CTreeViewWnd*    Categories;
/*0x300*/ CEditWnd*        SearchNameInput;
/*0x308*/ CButtonWnd*      SearchButton;
/*0x310*/ CListWnd*        FactionList;
/*0x318*/
};
...
// @sizeof(CFindItemWnd) == 0x3c8 :: 2022-11-10 (live) @ 0x140159689
...
/*0x2ac*/ bool                Unknown0;
/*0x2ad*/ bool                Unknown1;
/*0x2b0*/ uint32_t            Unknown2;
/*0x2b4*/ uint32_t            Timestamp;
/*0x2b8*/ uint32_t            Counter;
/*0x2c0*/ ItemContainer       Container;
/*0x2e8*/ HashTable<ItemRecord, int> Items;
/*0x300*/ HashTable<SoeUtil::String, int> ItemNames;     // just a guess, likely inaccurate.
/*0x318*/ CStaticAnimationTemplate* FIW_ClassAnim;
/*0x320*/ CSidlScreenWnd*     FIW_CharacterView;
/*0x328*/ CListWnd*           FIW_ItemList;
/*0x330*/ CButtonWnd*         FIW_QueryButton;
/*0x338*/ CButtonWnd*         FIW_RequestItemButton;
/*0x340*/ CButtonWnd*         FIW_RequestPreviewButton;
/*0x348*/ CButtonWnd*         FIW_Default;
/*0x350*/ CButtonWnd*         FIW_GrabButton;
/*0x358*/ CButtonWnd*         FIW_HighlightButton;
/*0x360*/ CButtonWnd*         FIW_DestroyItem;
...
// @sizeof(CFindLocationWnd) == 0x378 :: 2022-11-10 (live) @ 0x140159e47
constexpr size_t CFindLocationWnd_size = 0x378;
...
public:
/*0x2d8*/ CListWnd*               findLocationList;        // FLW_FindLocationList
/*0x2e0*/ CCheckBoxWnd*           filterLocationsCheckBox; // FLW_FilterLocationsCheckbox
/*0x2e8*/ CCheckBoxWnd*           filterGroupCheckBox;     // FLW_FilterGroupCheckbox
/*0x2f0*/ CCheckBoxWnd*           filterRaidCheckBox;      // FLW_FilterRaidCheckbox
/*0x2f8*/ CLabelWnd*              noneLabel;               // FLW_FoundNoneLabel
/*0x300*/ uint32_t                lastUpdateTime;
/*0x304*/ uint32_t                lastFindRequestTime;
/*0x308*/ bool                    didFindRequest;
/*0x310*/ PlayerDataArray         unfilteredPlayerList;
/*0x328*/ PlayerDataArray         filteredGroupPlayerList;
/*0x340*/ PlayerDataArray         unfilteredRaidPlayerList;
/*0x358*/ POIDataArray            unfilteredPOIDataList;
/*0x370*/ ZoneConnectionDataArray unfilteredZoneConnectionList;
/*0x388*/ FindableReferenceList   referenceList;
/*0x3a0*/ uint32_t                lastId;
/*0x3a4*/ bool                    dataRequested;
/*0x3a5*/ bool                    playerListDirty;
/*0x3a6*/ bool                    zoneConnectionsRcvd;
/*0x3a8*/
};
...
/*0x2ac*/ int             Unknown0x24c;
/*0x2b0*/ CXWnd*          pWndCaller;
/*0x2b8*/ CListWnd*       pListFiles;
/*0x2c0*/ CEditWnd*       pEditEntry;
/*0x2c8*/ CComboWnd*      pComboDirHistory;
/*0x2d0*/ CButtonWnd*     pUpButton;
/*0x2d8*/ CButtonWnd*     pOKButton;
/*0x2e0*/ CButtonWnd*     pCancelButton;
/*0x2e8*/ int             Flags;
/*0x2f0*/ CXStr           SelectedFile;
/*0x2f8*/ IShellFolder*   ShellFolder;
/*0x300*/ CXStr           CurrentDir;
/*0x308*/ // more
};
...
/*0x2b8*/ CButtonWnd*    pMoneyButton[4];
/*0x2d8*/ CButtonWnd*    TradeButton;
/*0x2e0*/ CButtonWnd*    CancelButton;
/*0x2e8*/ CLabel*        NPCNameLabel;
/*0x2f0*/ CInvSlotWnd*   pInvSlotWnd[MAX_GIVE_SLOTS];
/*0x310*/
};
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x2a8*/ CButtonWnd*        InviteButton;
/*0x2b0*/ CButtonWnd*        DisbandButton;
/*0x2b8*/ CButtonWnd*        FollowButton;
/*0x2c0*/ CButtonWnd*        DeclineButton;
/*0x2c8*/ CButtonWnd*        LFGButton;
/*0x2d0*/ CGaugeWnd*         HPGauge[6];
/*0x300*/ CGaugeWnd*         PetGauge[6];
/*0x330*/ CGaugeWnd*         ManaGauge[6];
/*0x360*/ CGaugeWnd*         EnduranceGauge[6];
/*0x390*/ CLabel*            HPLabel[6];
/*0x3c0*/ CLabel*            HPPercLabel[6];
/*0x3f0*/ CLabel*            ManaLabel[6];
/*0x420*/ CLabel*            ManaPercLabel[6];
/*0x450*/ CLabel*            EnduranceLabel[6];
/*0x480*/ CLabel*            EndurancePercLabel[6];
/*0x4b0*/ COLORREF           HPTextColor[6];
/*0x4c8*/ CButtonWnd*        GroupTankButton[6];
/*0x4f8*/ CButtonWnd*        GroupAssistButton[6];
/*0x528*/ CButtonWnd*        GroupPullerButton[6];
/*0x558*/ CButtonWnd*        GroupMarkNPCButton[6];
/*0x588*/ CLabel*            AggroPercLabel[6];
/*0x5b8*/ long               Timer;
/*0x5c0*/ CContextMenu*      GroupContextMenu;
/*0x5c8*/ bool               bPetbars;
/*0x5c9*/ bool               bManabars;
/*0x5ca*/ bool               bEndurancebars;
/*0x5cb*/ bool               bAggroPct;
/*0x5cc*/ int                PetBarIndex;
/*0x5d0*/ int                ManaBarIndex;
/*0x5d4*/ int                EnduranceBarIndex;
/*0x5d8*/ int                AggroPctIndex;
/*0x5dc*/ int                RoleSeparatorID;
/*0x5e0*/ int                RoleSelectMenu;
/*0x5e4*/ int                RoleSelectMenuID;
/*0x5e8*/ bool               bPlayerInvited;
/*0x5ec*/
};
...
/*0x2c4*/ BYTE         Unknown0x148[0x3c];
/*0x300*/ BYTE         Unknown0x194;
/*0x301*/ BYTE         ShowOffline;              // 01 = show offline box is checked
/*0x302*/ BYTE         Unknown0x196[0x2];
...
/*0x308*/ GuildMember** pMember;
/*0x310*/ DWORD        TotalMemberCount;
/*0x314*/ DWORD        Unknown0x1a0;             // 150?
/*0x318*/ DWORD        Unknown0x1a4;             // 1?
/*0x31c*/ DWORD        TotalMemberCountAgain;
/*0x320*/ BYTE         Unknown0x1ac[0x1c];
/*0x33c*/ char         PersonalNotesFilePath[0x40]; // path to personal notes file
/*0x37c*/ BYTE         Unknown0x208[0x1c0];      // empty
/*0x53c*/ DWORD        Unknown0x3c8;             // 1?
/*0x540*/ DWORD        Unknown0x3cc;             // some sort of bizaare pointer...
/*0x544*/
};
...
/*0x330*/ CTextureAnimation* pBackground;
/*0x338*/ ItemGlobalIndex    ItemLocation;            // WindowType = ItemLocation.Location, InvSlot = ItemLocation.GetTopSlot()
/*0x348*/ ItemPtr            LinkedItem;              // If the slot is linked to a specific item
/*0x350*/ int                ItemOffsetX;
/*0x354*/ int                ItemOffsetY;
/*0x358*/ CTextureAnimation* ptItem;
/*0x360*/ int                Quantity;
/*0x364*/ bool               bSelected;
/*0x365*/ bool               bFindSelected;
/*0x368*/ int                RecastLeft;
/*0x36c*/ bool               bHotButton;
/*0x36d*/ bool               bInventorySlotLinked;
/*0x370*/ CInvSlot*          pInvSlot;
/*0x378*/ CTextObjectInterface* pTextObject;
/*0x380*/ int                TextFontStyle;
/*0x384*/ int                Mode;
/*0x388*/ D3DCOLOR           BGTintRollover;
/*0x38c*/ D3DCOLOR           BGTintNormal;
/*0x390*/ int                LastTime;
/*0x394*/ int                Unknown0x2cc;
/*0x398*/
...
// @sizeof(CItemDisplayWnd) == 0xa70 :: 2022-11-10 (live) @ 0x1403b3a44
constexpr size_t CItemDisplayWnd_size = 0xa70;
...
/*0x2a8*/ CStmlWnd*         Description;                   // ItemDescription
/*0x2b0*/ CButtonWnd*       IconButton;                    // IconButton
/*0x2b8*/ CStmlWnd*         ItemLore;                      // ItemLore
/*0x2c0*/ CTabWnd*          ItemDescriptionTabBox;         // ItemDescriptionTabBox
/*0x2c8*/ CPageWnd*         ItemDescriptionTab;            // ItemDescriptionTab
/*0x2d0*/ CPageWnd*         ItemLoreTab;                   // ItemLoreTab
/*0x2d8*/ CSidlScreenWnd*   pAppearanceSocketScreen;       // IDW_Appearance_Socket_Screen
/*0x2e0*/ CButtonWnd*       pAppearanceSocketItem;         // IDW_Appearance_Socket_Item
/*0x2e8*/ CButtonWnd*       pAppearanceSocketBuyButton;    // IDW_Appearance_Socket_Buy_Button
/*0x2f0*/ CStmlWnd*         pAppearanceSocketDescription;  // IDW_Appearance_Socket_Description
/*0x2f8*/ CSidlScreenWnd*   pItemSocketScreen[6];          // IDW_Socket_Slot_%d_Screen
/*0x328*/ CButtonWnd*       pItemSocketItemButton[6];      // IDW_Socket_Slot_%d_Item
/*0x358*/ CStmlWnd*         pItemSocketDescription[6];     // IDW_Socket_Slot_%d_Description
/*0x388*/ CXStr             ItemInfo;                      // "Error: Item description not set" -- "this item is placable in yards, guild yards...", "This item can be used in tradeskills", etc
/*0x390*/ CXStr             Unknown0x2ac;
/*0x398*/ CXStr             Unknown0x2b0;
/*0x3a0*/ CXStr             WindowTitle;                   // "Item Display"
/*0x3a8*/ CXStr             ItemAdvancedLoreText;          // "Error: Item lore not set"
/*0x3b0*/ CXStr             ItemMadeByText;
/*0x3b8*/ CXStr             SolventText;
/*0x3c0*/ CXStr             ItemInformationText;           // "Item Information: Placing this augment into...", "this armor can only be used in...", etc
/*0x3c8*/ ItemPtr           pItem;
...
/*0x3e8*/ CLabel*           ModButtonLabel;                // IDW_ModButtonLabel
...
/*0x448*/ CButtonWnd*       FuseButton;                    // IDW_FuseButton
...
/*0x488*/ CLabel*           lblItemInfo[NumItemInfo];      // IDW_ItemInfo%d 4b0
/*0x4f0*/ CLabel*           lblStat[NumStatRows][NumStatCols];      // IDW_Row%dCol%dStat 518
/*0x760*/ CLabel*           lblValue[NumStatRows][NumStatCols];     // IDW_Row%dCol%dValue 788
/*0x9d0*/ CLabel*           lblHeroic[NumHeroic];          // IDW_Heroic%d 9f8
/*0xa38*/ int               rightClickMenuId;
/*0xa3c*/ int               rightClickMenuSocketId;
/*0xa40*/ CComboWnd*        ItemCompareList;               // IDW_ItemCompareList
/*0xa48*/ bool              isComparing;                   // this and the next are a guess. Need to verify.
/*0xa50*/ ItemPtr           pCompareItem;
/*0xa58*/ CTAFrameDraw*     ptaPageBorderHighlight;        // FT_DefPageBorderHighlight
/*0xa60*/ CTAFrameDraw*     ptaPageBorder;                 // FT_DefPageBorder
/*0xa68*/ uint32_t          ItemWndIndex;
/*0xa6c*/
};
...
// @sizeof(CKeyRingWnd) == 0x408 :: 2022-11-10 (live) @ 0x140159135
constexpr size_t CKeyRingWnd_size = 0x408;
...
/*0x2b0*/ CListWnd*     pList[eNumPages];        // KRW_Mounts_List, KRW_Illusions_List, KRW_Familiars_List, KRW_HeroForge_List
/*0x2d8*/ CLabel*       pStatLabel[eNumPages];   // KRW_Mounts_StatsNameLabel, KRW_Illusions_StatNameLabel, KRW_Familiars_StatNameLabel,
/*0x300*/ CLabel*       pCountLabel[eNumPages];  // KRW_Mounts_CountLabel, KRW_Illusions_CountLabel, KRW_Familiars_CountLabel, KRW_HeroForge_CountLabel
/*0x328*/ CButtonWnd*   pBtnStat[eNumPages];     // KRW_Mounts_Selected, KRW_Illusions_Selected, KRW_Familiars_Selected, KRW_HeroForge_SlotButton
/*0x350*/ CButtonWnd*   pBtnSlot[eNumPages];     // KRW_Mounts_SlotButton, KRW_Illusions_SlotButton, KRW_Familiars_SlotButton
/*0x378*/ uint8_t       Unknown0x28c[0x20];
/*0x398*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x3a0*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x3a8*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x3b0*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x3b8*/ uint8_t       Unknown0x2b4[0x8];
/*0x3c0*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x3c8*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x3d0*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x3d8*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x3e0*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x3e8*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
/*0x3f0*/ CPageWnd*     pPageTeleportation;              // KRW_TeleportationItems_Page
/*0x3f8*/ CTabWnd*      pTabBox;                         // KRW_Subwindows
/*0x400*/ KeyRingPages  CurrentPage;
/*0x404*/
};
...
// @sizeof(CLootWnd) == 0x4e8 :: 2022-11-10 (live) @ 0x1401593b7
constexpr size_t CLootWnd_size = 0x4e8;
...
/*0x2b4*/ bool              bServerClose;
/*0x2b5*/ bool              bLootingActive;
/*0x2b8*/ int               LootIndex[InvSlot_Max];
/*0x348*/ uint32_t          nNextRefreshTime; // 370
/*0x34c*/ bool              bInventoryWasActive;
/*0x350*/ ItemContainer     LootItems;
/*0x378*/ bool              bCloseOnComplete;
/*0x379*/ bool              bRightClickLoot;
/*0x37a*/ bool              bLootAllReady;
/*0x380*/ CXWnd*            LootInvWnd;                       // LootInvWnd
/*0x388*/ CInvSlotWnd*      LootSlotWnd[InvSlot_Max];         // LW_LootSlot%d
/*0x4a8*/ CLabel*           CorpseNameLabel;                  // LW_CorpseName
/*0x4b0*/ CButtonWnd*       DoneButton;                       // DoneButton
/*0x4b8*/ CButtonWnd*       BroadcastButton;                  // BroadcastButton
/*0x4c0*/ CButtonWnd*       LootAllButton;                    // LootAllButton
/*0x4c8*/ bool              bPopupPending;
/*0x4d0*/ void*             Unknown1;
/*0x4d8*/ void*             Unknown2;
/*0x4e0*/ uint32_t          Unknown3;
/*0x4e4*/
...
/*0x2a8*/ float              mapViewMinX;
/*0x2ac*/ float              mapViewMinY;
/*0x2b0*/ float              mapViewMaxX;
/*0x2b4*/ float              mapViewMaxY;
/*0x2b8*/ int                panOffsetX;
/*0x2bc*/ int                panOffsetY;
/*0x2c0*/ float              lineOffsetX;
/*0x2c4*/ float              lineOffsetY;
/*0x2c8*/ float              scaleDiffX;
/*0x2cc*/ float              scaleDiffY;
/*0x2d0*/ float              mapViewScaleX;
/*0x2d4*/ float              mapViewScaleY;
/*0x2d8*/ MapViewLine*       pLines;
/*0x2e0*/ MapViewLabel*      pLabels;
/*0x2e8*/ uint32_t           nextLabelId;
/*0x2ec*/ bool               lineActive;
/*0x2f0*/ CVector3           currentPoint;
/*0x2fc*/ RGB                currentColor;
/*0x300*/ RGB                myColor;
/*0x304*/ RGB                groupColor;
/*0x308*/ RGB                findPathColor;
/*0x30c*/ bool               failedFindActive;
/*0x310*/ CVector3           failedFindPoint;
/*0x31c*/ int                failedFindType;
/*0x320*/ MapViewLine*       markedLines;
/*0x328*/ MapViewLabel*      markedLabel;
/*0x330*/ MapViewLabel*      selectedLabel;
/*0x338*/ int                layerFilter;              // bitmask of active layers
/*0x33c*/ int                activeLayer;
/*0x340*/ int                minZ;
/*0x344*/ int                maxZ;
/*0x348*/ bool               zFilterActive;
/*0x34c*/ float              zoom;
/*0x350*/ float              recalcZoom;
/*0x354*/ int                range;
/*0x358*/ bool               showGroup;
/*0x359*/ bool               showNames;
/*0x35a*/ bool               findAutoZoom;
/*0x35b*/ bool               showLabels;
/*0x35c*/ bool               recalcLabels;
/*0x35d*/ bool               canAddToMap;
/*0x360*/ EQZoneIndex        zoneId;
/*0x368*/ CXStr              customMapPath;
/*0x370*/
...
// @sizeof(CMapViewWnd) == 0x808 :: 2022-11-10 (live) @ 0x140158b26
constexpr size_t CMapViewWnd_size = 0x808;
...
/*0x2ac*/ int         ZoneId;
/*0x2b0*/ bool        bAutoMapping;
/*0x2b8*/ CButtonWnd* btnPanLeft;
/*0x2c0*/ CButtonWnd* btnPanRight;
/*0x2c8*/ CButtonWnd* btnPanUp;
/*0x2d0*/ CButtonWnd* btnPanDown;
/*0x2d8*/ CButtonWnd* btnPanReset;
/*0x2e0*/ CButtonWnd* btnZoomIn;
/*0x2e8*/ CButtonWnd* btnZoomOut;
/*0x2f0*/ CButtonWnd* btnShowGroup;
/*0x2f8*/ CButtonWnd* btnShowNames;
/*0x300*/ CButtonWnd* btnFind;
/*0x308*/ CButtonWnd* btnEndFind;
/*0x310*/ CButtonWnd* btnFindAutoZoom;
/*0x318*/ CButtonWnd* btnMapZoneGuide;
/*0x320*/ CButtonWnd* btnToolbar;
/*0x328*/ char        szZoneName[0x80];
/*0x3a8*/ CButtonWnd* btntoggleLabels;
/*0x3b0*/ CEditWnd*   editMinZ;
/*0x3b8*/ CEditWnd*   editMaxZ;
/*0x3c0*/ CButtonWnd* btnZFilter;
/*0x3c8*/ CButtonWnd* btnLayer0;
/*0x3d0*/ CButtonWnd* btnLayer1;
/*0x3d8*/ CButtonWnd* btnLayer2;
/*0x3e0*/ CButtonWnd* btnLayer3;
/*0x3e8*/ CButtonWnd* btnLayer1Active;
/*0x3f0*/ CButtonWnd* btnLayer2Active;
/*0x3f8*/ CButtonWnd* btnLayer3Active;
/*0x400*/ CButtonWnd* btnLoadCurrent;
/*0x408*/ CPageWnd*   pageAtlas;
/*0x410*/ CPageWnd*   pageMap;
/*0x418*/ CTabWnd*    tabWnd;
/*0x420*/ CXWnd*      MapRenderArea;
/*0x428*/ CComboWnd*  MapsDirSelect;
/*0x430*/ CXWnd*      AtlasRenderArea;
/*0x438*/ CAtlas*     AtlasWnd;
/*0x440*/ CComboWnd*  AtlasDirSelect;
/*0x448*/ CButtonWnd* btnAtlasZoneGuide;
/*0x450*/ CButtonWnd* btnMapIcon;
/*0x458*/ CEditWnd*   editSearchBox;
/*0x460*/ CButtonWnd* btnSearch;
/*0x468*/ CButtonWnd* btnSearchClear;
/*0x470*/ CListWnd*   listSearch;
/*0x478*/ CXWnd*      wndSearchLayout;
/*0x480*/ CButtonWnd* btnSearchHide;
/*0x488*/ CXWnd*      wndSpacer;
/*0x490*/ bool        bEditing;
/*0x498*/ MapViewMap  MapView;                            // a window component owned by CMapViewWnd
/*0x808*/
	// alias the stupid
...
/*0x2b4*/ uint32_t           NextRefreshTime;
/*0x2b8*/ bool               bInventoryWasActive;
/*0x2c0*/ PageHandlerArray   PageHandlers;
/*0x2d8*/ float              MerchantGreed;
/*0x2dc*/ ItemGlobalIndex    ItemLocation;
/*0x2e8*/ BYTE               Unknown0x254[0x8];
/*0x2f0*/ ItemPtr            pSelectedItem;
...
// @sizeof(CPetInfoWnd) == 0x2910 :: 2022-11-10 (live) @ 0x1401585ec
constexpr size_t CPetInfoWnd_size = 0x2910;
...
/*0x02ac*/ uint32_t           LastUpdateTime;
/*0x02b0*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
/*0x0320*/ CXWnd*             pWndBuffs;                         // BuffWindow
/*0x0328*/ CTextureAnimation* pGoodBuffBackground;               // PetBlueIconBackground
/*0x0330*/ CTextureAnimation* pBadBuffBackground;                // PetRedIconBackground
/*0x0338*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x0340*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS_NPC];
/*0x0fc0*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS_NPC]; // PetBuff%d - was pWnd
/*0x1c40*/ int                Buff[MAX_TOTAL_BUFFS_NPC];         // Spell ID# of each buff
/*0x2280*/ HashTable<CXStr>   WhoCast;
/*0x2298*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0x229c*/ bool               bHadPetLastTime;
/*0x229d*/ bool               bShowOnSummon;
/*0x22a0*/ uint32_t           ListContextMenuID;
/*0x22a8*/ CXWnd*             pRequestingWnd;
/*0x22b0*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS_NPC]; // duration until buff fades, in milliseconds
/*0x28f0*/ bool               bRemovedBuffBlockMenuItem;
/*0x28f4*/ int                PetCommandSelectContextMenu;
/*0x28f8*/ CXWnd*             LastClickedButton;
/*0x2900*/ bool               bPetButtonsDirty;
/*0x2901*/ bool               Sit;
/*0x2902*/ bool               Stop;
/*0x2903*/ bool               ReGroup;
/*0x2904*/ bool               Follow;
...
// @sizeof(CPlayerWnd) == 0x3e0 :: 2022-11-10 (live) @ 0x140158f5d
constexpr size_t CPlayerWnd_size = 0x3e0;
...
/*0x2cc*/ 
/*0x2b0*/ CGaugeWnd*         pPlayerHP;                         // PlayerHP
/*0x2b8*/ CGaugeWnd*         pPetHP;                            // PetHP
/*0x2c0*/ CGaugeWnd*         pPlayerMana;                       // PlayerMana
/*0x2c8*/ CGaugeWnd*         pPlayerEndurance;                  // PlayerFatigue
/*0x2d0*/ CLabel*            pPlayerHPLbl;                      // HPLabel
/*0x2d8*/ CLabel*            pPlayerManaLbl;                    // ManaLabel
/*0x2e0*/ CLabel*            pPlayerEnduranceLbl;               // FatigueLabel
/*0x2e8*/ CLabel*            pPlayerHPPercentLbl;               // HPPerLabel
/*0x2f0*/ CLabel*            pPlayerManaPercentLbl;             // ManaPercLabel
/*0x2f8*/ CLabel*            pPlayerEndurancePercentLbl;        // FatiguePercLabel
/*0x300*/ COLORREF           HPTextColor;
/*0x308*/ CButtonWnd*        pGroupRoleTankBtn;                 // GroupRoleTank
/*0x310*/ CButtonWnd*        pGroupRoleAssistBtn;               // GroupRoleAssist
/*0x318*/ CButtonWnd*        pGroupRolePullerBtn;               // GroupRolePuller
/*0x320*/ CButtonWnd*        pGroupRoleMarkNPCBtn;              // GroupRoleMarkNPC
/*0x328*/ CGaugeWnd*         pCombatTimerGauge;                 // Player_CombatTimer
/*0x330*/ CLabel*            pCombatTimerLbl;                   // Player_CombatTimerLabel
/*0x338*/ CButtonWnd*        pNewMailIconBtn;                   // PW_NewMailIcon
/*0x340*/ CButtonWnd*        pParcelsIconBtn;                   // PW_ParcelsIcon
/*0x348*/ CButtonWnd*        pParcelsOverLimitIconBtn;          // PW_ParcelsOverLimitIcon
/*0x350*/ CLabel*            pAggroPctPlayerLbl;                // PW_AggroPctPlayerLabel
/*0x358*/ CLabel*            pAggroPctSecondaryLbl;             // PW_AggroPctSecondaryLabel
/*0x360*/ CLabel*            pAggroNameSecondaryLbl;            // PW_AggroNameSecondaryLabel
/*0x368*/ bool               bDrawAutoAttackRect;
/*0x36c*/ int                LastUpdateTimer;
/*0x370*/ int                LastFrameTimer;
/*0x378*/ CStaticAnimationTemplate* pAttackIndicatorAnimTop;    // A_AttackIndicatorAnimTop
/*0x380*/ CStaticAnimationTemplate* pAttackIndicatorAnimBottom; // A_AttackIndicatorAnimBottom
/*0x388*/ CStaticAnimationTemplate* pAttackIndicatorAnimLeft;   // A_AttackIndicatorAnimLeft
/*0x390*/ CStaticAnimationTemplate* pAttackIndicatorAnimRight;  // A_AttackIndicatorAnimRight
/*0x398*/ CStaticAnimationTemplate* pAttackIndicatorAnimFill;   // A_AttackIndicatorAnimFill
/*0x3a0*/ CButtonWnd*        pCombatStateAnimButton;            // PW_CombatStateAnim
/*0x3a8*/ int                AttackIndicatorPulseValue;
/*0x3b0*/ CContextMenu*      pContextMenu;
/*0x3b8*/ uint32_t           Unknowns[9];
/*0x3dc*/ ECombatState       CombatState;                       // right above "A_PWCSInCombat"
/*0x3e0*/
};
...
public:
	...
	// todo: verify
/*0x2b4*/ int                 Unknown0x008;
/*0x2b8*/ int                 NumItems;
/*0x2bc*/ bool                HdrItemName;
/*0x2bd*/ bool                HdrTheme;
/*0x2be*/ bool                HdrPrice;
/*0x2bf*/ char                OriginalPointsLabel[0x40];
/*0x300*/ CLabel*             MerchantNameLabel;
/*0x308*/ CListWnd*           ItemList;
/*0x310*/ CListWnd*           PointList;
/*0x318*/ CButtonWnd*         EquipButton;
/*0x320*/ CButtonWnd*         PurchaseButton;
/*0x328*/ CButtonWnd*         SellButton;
/*0x330*/ CButtonWnd*         DoneButton;
/*0x338*/ CLabel*             PointsAvailableValue;
/*0x340*/ CLabel*             PointsEverEarnedLabel;
/*0x348*/ CLabel*             PointsAvailableLabel;
/*0x350*/ unsigned int        NextRefreshTime;
/*0x358*/ PlayerClient*       ActiveMerchant;
/*0x360*/ PointMerchantItem** Items;
/*0x368*/ int                 MerchantThemeId;
/*0x36c*/ int                 CurrentSelection;
/*0x370*/ int                 CurrentSort;
/*0x374*/ bool                bCurrentAscending;
/*0x378*/ ItemGlobalIndex     ItemLocation;
/*0x388*/ ItemPtr             pSelectedItem;
...
/*0x2bc*/ uint8_t            Unknown0x244[0x154];
/*0x410*/ COLORREF           ClassColors[0x10];
/*0x450*/ uint8_t            Unknown0x330[0x80];
/*0x4d0*/
};
...
/*0x2b8*/ CPopDialogWnd* m_currentPopup;
/*0x2c0*/ int            LeftPageNbr;
/*0x2c4*/ int            SelectedBookIndex;
/*0x2c8*/ int            MemSlotIndex;
/*0x2cc*/ int            SpellId;
/*0x2d0*/ int            MemTicksLeft;
/*0x2d4*/ int            ScribeBookSlot;
/*0x2d8*/ int            ScribeTicksLeft;
/*0x2dc*/
};
...
/*0x2a8*/ int                WindowID;
/*0x2b0*/ CLabelWnd*         pDuration;
/*0x2b8*/ CStmlWnd*          pDescription;
/*0x2c0*/ CStmlWnd*          pName;
/*0x2c8*/ CButtonWnd*        pIcon;
/*0x2d0*/ SoeUtil::String    DescriptionText;
/*0x2e8*/ SoeUtil::String    TitleText;
/*0x300*/ bool               bActiveItem;
/*0x308*/ CTextureAnimation* ptaBuffIcons;
/*0x310*/ CTextureAnimation* ptaDragIcons;
/*0x318*/ bool               bFailed;
/*0x31c*/ ESpellDisplayType  SpellDisplayType;
/*0x320*/ int                SpellID;
/*0x324*/ int                LastUpdateTime;
/*0x328*/
};
...
/*0x330*/ int                MouseButtonState;
/*0x334*/ bool               bChecked;
/*0x338*/ unsigned int       LastRefresh;
/*0x33c*/ D3DCOLOR           SpellGemTintArray[11];
/*0x368*/ int                SpellGemAlphaArray[11];
/*0x394*/ int                Unknown0x02f4;
/*0x398*/ int                Unknown0x02f8;
/*0x39c*/ int                SpellIconOffsetX;
/*0x3a0*/ int                SpellIconOffsetY;
/*0x3a4*/ int                spellicon;                // if this is equal to FFFFFFFF there is no spell memmed in this slot...
/*0x3a8*/ int                spellstate;               // 1 = cast in progress or refreshtime not met 2 means we ducked or aborted cast, 0 means its ok to cast, should really rename this to tintstage
/*0x3ac*/ int                TintIndex;
/*0x3b0*/ CTextureAnimation* SpellIconTexture;         // CTextureAnimation
/*0x3b8*/ CTextureAnimation* CustomIconTexture;        // CTextureAnimation
/*0x3c0*/ int                SpellSlot;
/*0x3c4*/ int                Percent;
/*0x3c8*/ CSpellGemDrawTemplate DrawTemplate;
/*0x3e8*/
};
...
// @sizeof(CTargetWnd) == 0x3e8 :: 2022-11-10 (live) @ 0x140158dfb
constexpr size_t CTargetWnd_size = 0x3e8;
...
/*0x2b0*/ CXWnd*                    pWndBuffs;                  // BuffWindow
/*0x2b8*/ CTextureAnimation*        pBuffGoodBackground;        // BlueIconBackground
/*0x2c0*/ CTextureAnimation*        pBuffBadBackground;         // RedIconBackground
/*0x2c8*/ CTextureAnimation*        pBuffBypassBackground;      // ellowIconBackground
/*0x2d0*/ SoeUtil::Array<CTextureAnimation*> ptaBuffIcons;      // Can go up to 400?
/*0x2e8*/ SoeUtil::Array<CButtonWnd*> pTargetBuff;
/*0x300*/ SoeUtil::Array<int>       BuffSpellID;                // -1 if no buff
/*0x318*/ SoeUtil::Array<int>       BuffTimer;
/*0x330*/ int                       LastBuffReceivedTime;
/*0x334*/ int                       Timer;
/*0x338*/ HashTable<CXStr>          Casters;
...
/*0x2ac*/ int          m_minLength;
/*0x2b0*/ int          m_maxLength;
/*0x2b8*/ CXStr        m_text;
/*0x2c0*/ CXWnd*       m_parent;
/*0x2c8*/ CEditWnd*    m_entry;
/*0x2d0*/ CLabel*      m_prompt;
/*0x2d8*/ CButtonWnd*  m_ok;
/*0x2e0*/ CButtonWnd*  m_cancel;
/*0x2e8*/
};
...
/*0x2a8*/ DWORD        Unknown0x148[0x1b];
/*0x318*/ TradeskillRecipe* SearchResults[0x64];
/*0x638*/ DWORD        Unknown0x344;
/*0x63c*/ DWORD        Unknown0x348;
/*0x640*/ DWORD        Unknown0x34c;
/*0x648*/ ItemPtr      Container;
...
/*0x2b0*/ bool               bInventoryWasOpen;
/*0x2b8*/ CButtonWnd*        HisMoneyButton[4];
/*0x2d8*/ CButtonWnd*        MyMoneyButton[4];
/*0x2f8*/ CButtonWnd*        TradeButton;
/*0x300*/ CButtonWnd*        CancelButton;
/*0x308*/ CLabel*            HisNameLabel;
/*0x310*/ CLabel*            MyNameLabel;
/*0x318*/ CInvSlotWnd*       pInvSlotWnd[MAX_TRADE_SLOTS];
/*0x398*/ long               HisMoney[4];
/*0x3a8*/ long               MyMoney[4];
/*0x3b8*/ ItemContainer      TradeItems;
/*0x3e0*/ bool               bHisReadyTrade;           // was HisTradeReady
/*0x3e1*/ bool               bMyReadyTrade;            // was MyTradeReady
/*0x3e2*/ bool               bIsTrading;               // was TradeWndOpen
/*0x3e4*/
...
public:
/*0x2b0*/ CVerticalLayoutWnd*     VerticalLayout;
/*0x2b8*/ CButtonWnd*             FilterMyLevelButton;
/*0x2c0*/ CButtonWnd*             FilterAllLevelsButton;
/*0x2c8*/ CButtonWnd*             FilterZonesActiveButton;
/*0x2d0*/ CButtonWnd*             FilterZonesInactiveButton;
/*0x2d8*/ CButtonWnd*             ZoneRunSearchButton;
/*0x2e0*/ CButtonWnd*             ZoneClearSearchButton;
/*0x2e8*/ CButtonWnd*             SelectCurrentZoneButton;
/*0x2f0*/ CEditWnd*               LevelFilterEdit;
/*0x2f8*/ CEditWnd*               ZoneSearchEdit;
/*0x300*/ CComboWnd*              TypeFilterCombo;
/*0x308*/ CComboWnd*              ContinentFilterCombo;
/*0x310*/ CListWnd*               ZonesList;
/*0x318*/ CLabelWnd*              ViewZoneConnectionsSelectedZoneLabel;
/*0x320*/ CLabelWnd*              ViewZoneConnectionsPreviewPathLabel;
/*0x328*/ CLabelWnd*              ViewZoneConnectionsActivePathLabel;
/*0x330*/ CLabelWnd*              ViewZoneConnectionsDisabledLabel;
/*0x338*/ CButtonWnd*             ViewZoneConnectionsSelectedZoneButton;
/*0x340*/ CButtonWnd*             ViewZoneConnectionsPreviewPathButton;
/*0x348*/ CButtonWnd*             ViewZoneConnectionsActivePathButton;
/*0x350*/ CButtonWnd*             ViewZoneConnectionsDisabledButton;
/*0x358*/ CButtonWnd*             DisableConnectionTemplateButton;
/*0x360*/ CListWnd*               ZoneConnectionsList;
/*0x368*/ CButtonWnd*             ResetPathStartZoneButton;
/*0x370*/ CButtonWnd*             SetPathStartZoneButton;
/*0x378*/ CButtonWnd*             SetPathEndZoneButton;
/*0x380*/ CButtonWnd*             ShowPathWndButton;
/*0x388*/ CButtonWnd*             HidePathWndButton;
/*0x390*/ CButtonWnd*             FindPathButton;
/*0x398*/ CButtonWnd*             EndFindButton;
/*0x3a0*/ CButtonWnd*             ClearPathWndButton;
/*0x3a8*/ CButtonWnd*             ActivatePathButton;
/*0x3b0*/ CButtonWnd*             IncludeBindZoneInPathGenerationButton;
/*0x3b8*/ CButtonWnd*             ShowPathWndOnPathActivationButton;
/*0x3c0*/ CButtonWnd*             AutoFindActivePathButton;
/*0x3c8*/ CEditWnd*               PathStartZoneEdit;
/*0x3d0*/ CEditWnd*               PathEndZoneEdit;
/*0x3d8*/ uint32_t                NextButtonRefreshTime;
/*0x3dc*/ EQZoneIndex             CurrentZone;
/*0x3e0*/ bool                    bFilterActive;
/*0x3e4*/ int                     FilterLevel;
/*0x3e8*/ int                     FilterContinentIndex;
/*0x3ec*/ int                     FilterZoneTypeIndex;
/*0x3f0*/ bool                    bSelectCurrentZone;
/*0x3f8*/ CXStr                   ZoneSearchString;
/*0x400*/ eZoneGuideConnectionsView eCurrConnectionsView;
/*0x404*/ EQZoneIndex             CurrConnectionsViewSelectedZone;
/*0x408*/ bool                    bCurrentConnectionsViewPreviewPathChanged;
/*0x409*/ bool                    bCurrentConnectionsViewActivePathChanged;
/*0x40a*/ bool                    bSetPathStartZoneToCurrentZone;
/*0x40c*/ EQZoneIndex             StartZone;
/*0x410*/ EQZoneIndex             EndZone;
/*0x414*/ bool                    bZoneGuideDataChanged;
/*0x415*/ bool                    bZoneListChanged;
/*0x416*/ bool                    bZoneConnectionsListChanged;
/*0x417*/ bool                    bPathStartZoneChanged;
/*0x418*/ int                     RightClickMenuID;
/*0x41c*/
};
...
{
public:
/*0x2dc*/ EQZoneIndex             currentZone;
/*0x2e0*/ bool                    zonePathDirty;
/*0x2e8*/ CListWnd*               listZones;
/*0x2f0*/
};
...
/*0x2d8*/ CButtonWnd*       EQButtonWnd;
/*0x2e0*/ CButtonWnd*       SCButtonWnd;
/*0x2e8*/ CButtonWnd*       FlashSaleButtonWnd;
/*0x2f0*/ CascadeItemArray* CascadeMenuItems;
/*0x2f8*/ int               MenuId;
/*0x2fc*/
};
