...
constexpr size_t CButtonWnd_size = 0x340; // @sizeof(CButtonWnd) :: 2024-11-27 (beta) @ 0x1405BC510
...
constexpr size_t CBuffWindow_size = 0x348; // @sizeof(CBuffWindow) :: 2024-11-27 (beta) @ 0x14018DA0F
...
constexpr size_t CCursorAttachment_size = 0x620; // @sizeof(CCursorAttachment) :: 2024-11-27 (beta) @ 0x14018CDA8
...
constexpr size_t CFindItemWnd_size = 0x3F0; // @sizeof(CFindItemWnd) :: 2024-11-27 (beta) @ 0x14018E436
...
constexpr size_t CFindLocationWnd_size = 0x7A0; // @sizeof(CFindLocationWnd) :: 2024-11-27 (beta) @ 0x14018EBF4
...
/*0x5b8*/ UIButtonComponent       filterRaidCheckBoxComponent;
/*0x658*/ UIStmlComponent         noneLabelComponent;
/*0x6f8*/ uint32_t                lastUpdateTime;
/*0x6fc*/ uint32_t                lastFindRequestTime;
/*0x700*/ bool                    didFindRequest;
/*0x708*/ PlayerDataArray         unfilteredPlayerList;
/*0x720*/ PlayerDataArray         filteredGroupPlayerList;
/*0x738*/ PlayerDataArray         unfilteredRaidPlayerList;
/*0x750*/ POIDataArray            unfilteredPOIDataList;
/*0x768*/ ZoneConnectionDataArray unfilteredZoneConnectionList;
/*0x780*/ FindableReferenceList   referenceList;
/*0x798*/ uint32_t                lastId;
/*0x79c*/ bool                    dataRequested;
/*0x79d*/ bool                    playerListDirty;
/*0x79e*/ bool                    zoneConnectionsRcvd;
/*0x7a0*/
};
...
constexpr size_t CGiveWnd_size = 0xB18; // @sizeof(CGiveWnd) :: 2024-11-27 (beta) @ 0x14018E6A6
...
/*0x690*/ UIButtonComponent  TradeButtonComponent;
/*0x730*/ UIButtonComponent  CancelButtonComponent;
/*0x7d0*/ UIStmlComponent    GiveNameComponent;
/*0x870*/ UIInvSlotComponent ItemSlotComponents[MAX_GIVE_SLOTS];
/*0xb10*/
};
...
constexpr size_t CGroupWnd_size = 0x6F8; // @sizeof(CGroupWnd) :: 2024-11-27 (beta) @ 0x14018D527
...
constexpr size_t CItemDisplayWnd_size = 0xAA0; // @sizeof(CItemDisplayWnd) :: 2024-11-27 (beta) @ 0x140414514
...
constexpr size_t CKeyRingWnd_size = 0x460; // @sizeof(CKeyRingWnd) :: 2024-11-27 (beta) @ 0x14018DE95
...
/*0x3c0*/ uint8_t       Unknown0x3b8[eNumPages];
/*0x3c6*/ uint8_t       Unknown0x3be[eNumPages];
/*0x3cc*/ int           Unknown0x3c4[eNumPages];
...
/*0x408*/ uint8_t       Unknown0x2b4[0x8];
...
constexpr size_t CLootWnd_size = 0xCB8; // @sizeof(CLootWnd) :: 2024-11-27 (beta) @ 0x14018E164
...
constexpr size_t CMapViewWnd_size = 0x848; // @sizeof(CMapViewWnd) :: 2024-11-27 (beta) @ 0x14018D889
...
constexpr size_t CPetInfoWnd_size = 0x3C8; // @sizeof(CPetInfoWnd) :: 2024-11-27 (beta) @ 0x14018D34F
...
constexpr size_t CPlayerWnd_size = 0x400; // @sizeof(CPlayerWnd) :: 2024-11-27 (beta) @ 0x14018DCBD
...
constexpr size_t CSpellDisplayWnd_size = 0x3B0; // @sizeof(CSpellDisplayWnd) :: 2024-11-27 (beta) @ 0x1404E3E8E
...
constexpr size_t CTargetWnd_size = 0x3C0; // @sizeof(CTargetWnd) :: 2024-11-27 (beta) @ 0x14018DB5E
...
constexpr size_t CTradeWnd_size = 0x16F0; // @sizeof(CTradeWnd) :: 2024-11-27 (beta) @ 0x14018E34C
...
/*0x0718*/ UIButtonComponent  MyMoneyComponent[eNumMoneySlotTypes];
/*0x0998*/ UIButtonComponent  TradeButtonComponent;
/*0x0a38*/ UIButtonComponent  CancelButtonComponent;
/*0x0ad8*/ UIStmlComponent    OtherNameComponent;
/*0x0b78*/ UIStmlComponent    SelfNameComponent;
/*0x0c18*/ UIInvSlotComponent TradeSlotComponent[16];

/*0x1698*/ long               HisMoney[eNumMoneySlotTypes];
/*0x16a8*/ long               MyMoney[eNumMoneySlotTypes];
/*0x16b8*/ ItemContainer      TradeItems;
/*0x16e0*/ bool               bHisReadyTrade;           // was HisTradeReady
/*0x16e1*/ bool               bMyReadyTrade;            // was MyTradeReady
/*0x16e2*/ bool               bIsTrading;               // was TradeWndOpen
/*0x16e4*/
...
constexpr size_t ZoneGuideManagerClient_size = 0xF7C8; // @sizeof(ZoneGuideManagerClient) :: 2024-11-27 (beta) @ 0x14033BFAF
