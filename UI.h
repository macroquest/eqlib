...
// @sizeof(CFindLocationWnd) == 0x3a8 :: 2022-02-10 (live) @ 0x1401C6A3A
...
// @sizeof(CItemDisplayWnd) == 0xAA0 :: 2022-02-10 (live) @ 0x14045712A
...
// @sizeof(CKeyRingWnd) == 0x438 :: 2022-02-10 (live) @ 0x1401C5D2F
...
// @sizeof(CLootWnd) == 0x518 :: 2022-02-10 (live) @ 0x1401C5FB1
...
// MapViewMap_size: 0x868 - 0x4c8 = 0x3a0

// @sizeof(MapViewMap) == 0x3a0 :: 2022-02-10 (live) @ 0x14047877C
constexpr size_t MapViewMap_size = 0x3a0;
...
// @sizeof(CMapViewWnd) == 0x868 :: 2022-02-10 (live) @ 0x1401C56FB
...
/*0x2e0*/ CCheckBoxWnd*      pButton[MAX_PET_BUTTONS];
...
/*0x368*/ CTextureAnimation* pBypassBuffBackground;             // YellowIconBackground
/*0x370*/ CTextureAnimation* pBuffIcons[MAX_TOTAL_BUFFS];
/*0x678*/ CButtonWnd*        pPetBuffBtns[MAX_TOTAL_BUFFS];     // PetBuff%d - was pWnd
/*0x980*/ int                Buff[MAX_TOTAL_BUFFS];             // Spell ID# of each buff
/*0xb08*/ HashTable<CXStr>   WhoCast;
/*0xb20*/ uint32_t           LastBuffDecTime;                   // last time buff counters were decremented
/*0xb24*/ bool               bHadPetLastTime;
/*0xb25*/ bool               bShowOnSummon;
/*0xb28*/ uint32_t           ListContextMenuID;
/*0xb30*/ CXWnd*             pRequestingWnd;
/*0xb38*/ unsigned int       PetBuffTimer[MAX_TOTAL_BUFFS];     // duration until buff fades, in milliseconds
/*0xcbc*/ bool               bRemovedBuffBlockMenuItem;
/*0xcc0*/ int                PetCommandSelectContextMenu;
/*0xcc8*/ CXWnd*             LastClickedButton;
/*0xcd0*/ bool               bPetButtonsDirty;
/*0xcd1*/ bool               Sit;
/*0xcd2*/ bool               Stop;
/*0xcd3*/ bool               ReGroup;
/*0xcd4*/ bool               Follow;
...
/*0x2e0*/ CXWnd*             pWndBuffs;
/*0x2e8*/ CTextureAnimation* pBuffGoodBackground;
/*0x2f0*/ CTextureAnimation* pBuffBadBackground;
/*0x2f8*/ CTextureAnimation* pBuffBypassBackground;
/*0x300*/ CTextureAnimation* ptaBuffIcons[MAX_TOTAL_BUFFS];
/*0x608*/ CButtonWnd*        pTargetBuff[MAX_TOTAL_BUFFS];
/*0x910*/ int                BuffSpellID[MAX_TOTAL_BUFFS]; // -1 if no buff
/*0xa94*/ int                BuffTimer[MAX_TOTAL_BUFFS];
/*0xc18*/ int                LastBuffReceivedTime;
/*0xc1c*/ int                Timer;
/*0xc20*/ HashTable<CXStr>   Casters;
/*0xc38*/ int                ContextMenuID;
/*0xc40*/ CXWnd*             RequestingWnd;
/*0xc48*/ bool               bRemovedBuffBlockMenuItem;
/*0xc4c*/ int                Type;                     // 1 = self, 4 = group member, 5 = PC, 7 = NPC
/*0xc50*/ uint8_t            Unknown0x884[0x4c];
/*0xc9c*/
};
