...
enum ALTCURRENCY
{
	...
	ALTCURRENCY_LAURIONINNVOUCHERS = 57, // LS
	ALTCURRENCY_SHALOWAINSPRIVATERESERVE = 58, // LS
	ALTCURRENCY_TIMELESSTOKENS = 59, // LS Anniversary
	ALTCURRENCY_SCALEWROUGHTEMBLEM = 60, // ToB
	ALTCURRENCY_BROODOFFICERSEMBLEM = 61, // ToB
	ALTCURRENCY_LOGOFVENTURES = 62, // ToB (June of 2025)
	ALTCURRENCY_RIFTTOUCHEDSIGILS = 63, // SOR (this is "RIFT-TOUCHEDSIGILS" in dbsrtr_texts)
	ALTCURRENCY_FORGOTTENRUINEDCOINS = 64, // SOR
