...
constexpr size_t CXWnd_size = 0x270; // @sizeof(CXWnd) :: 2025-12-01 (beta) @ 0x1405E9761
...
// @start: CXWnd Members
/*0x030*/ bool               Enabled;
/*0x031*/ bool               bScreenClipRectChanged;
/*0x034*/ int                Transition;
/*0x038*/ bool               bLeftAnchoredToLeft;
/*0x03c*/ int                VScrollPos;
/*0x040*/ bool               ValidCXWnd;
/*0x044*/ int                ParentAndContextMenuArrayIndex;
/*0x048*/ uint8_t            StartAlpha;
/*0x050*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x058*/ int                TopOffset;
/*0x060*/ CXStr              WindowText;
/*0x068*/ int                HScrollPos;
/*0x070*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x078*/ int                ZLayer;
/*0x080*/ CXStr              DataStr;
/*0x088*/ bool               bUseInLayoutVertical;
/*0x089*/ bool               bNeedsSaving;
/*0x08c*/ uint32_t           FadeDelay;
/*0x090*/ CXRect             Location;
/*0x0a0*/ bool               bIsTransitioning;
/*0x0a1*/ bool               bAction;
/*0x0a2*/ bool               bCaptureTitle;
/*0x0a3*/ bool               bMaximized;
/*0x0a8*/ CXStr              XMLToolTip;
/*0x0b0*/ CXRect             ClipRectScreen;
/*0x0c0*/ CTextObjectInterface* pTipTextObject;
/*0x0c8*/ COLORREF           DisabledBackground;
/*0x0cc*/ bool               bClipToParent;
/*0x0cd*/ bool               Unlockable;
/*0x0ce*/ bool               bTiled;
/*0x0cf*/ bool               bActive;
/*0x0d0*/ int                BottomOffset;
/*0x0d8*/ CTextureFont*      pFont;
/*0x0e0*/ uint8_t            TargetAlpha;
/*0x0e4*/ uint32_t           BlinkFadeDuration;
/*0x0e8*/ int                managerArrayIndex;
/*0x0ec*/ bool               bEnableShowBorder;
/*0x0ed*/ bool               bRightAnchoredToLeft;
/*0x0f0*/ COLORREF           CRNormal;
/*0x0f8*/ CTextObjectInterface* pTextObject;
/*0x100*/ bool               bUseInLayoutHorizontal;
/*0x104*/ uint32_t           WindowStyle;
/*0x108*/ bool               bHCenterTooltip;
/*0x110*/ int64_t            Data;
/*0x118*/ bool               bShowClickThroughMenuItem;
/*0x11c*/ CXRect             ClipRectClient;
/*0x12c*/ bool               Fades;
/*0x130*/ uint32_t           LastTimeMouseOver;
/*0x134*/ bool               bClickThrough;
/*0x135*/ bool               bEscapableLocked;
/*0x136*/ bool               bClientRectChanged;
/*0x138*/ CXWndDrawTemplate* DrawTemplate;
/*0x140*/ int                VScrollMax;
/*0x144*/ CXSize             MinClientSize;
/*0x14c*/ bool               MouseOver;
/*0x150*/ CLayoutStrategy*   pLayoutStrategy;
/*0x158*/ CXRect             TransitionRect;
/*0x168*/ uint32_t           BlinkFadeStartTime;
/*0x16c*/ bool               bMarkedForDelete;
/*0x170*/ uint32_t           TransitionStartTick;
/*0x174*/ CXRect             OldLocation;
/*0x188*/ CXStr              Tooltip;
/*0x190*/ bool               bFullyScreenClipped;
/*0x194*/ int                DeleteCount;
/*0x198*/ uint32_t           BlinkFadeFreq;
/*0x19c*/ COLORREF           BGColor;
/*0x1a0*/ int                RightOffset;
/*0x1a4*/ uint8_t            bResizableMask;
/*0x1a5*/ bool               Faded;
/*0x1a6*/ bool               bEscapable;
/*0x1a8*/ uint32_t           TransitionDuration;
/*0x1ac*/ int                LeftOffset;
/*0x1b0*/ bool               bMaximizable;
/*0x1b8*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x1d8*/ bool               bClickThroughMenuItemStatus;
/*0x1e0*/ CXWnd*             FocusProxy;
/*0x1e8*/ int                BlinkStartTimer;
/*0x1ec*/ uint32_t           BackgroundDrawType;
/*0x1f0*/ bool               bBringToTopWhenClicked;
/*0x1f1*/ bool               bClientClipRectChanged;
/*0x1f2*/ uint8_t            FadeAlpha;
/*0x1f3*/ bool               bClickThroughToBackground;
/*0x1f4*/ bool               bKeepOnScreen;
/*0x1f8*/ CXRect             ClientRect;
/*0x208*/ uint32_t           FadeDuration;
/*0x20c*/ uint8_t            Alpha;
/*0x210*/ CXSize             MaxClientSize;
/*0x218*/ uint32_t           BGType;
/*0x21c*/ uint8_t            FadeToAlpha;
/*0x220*/ CXWnd*             ParentWindow;
/*0x228*/ CTextureAnimation* IconTextureAnim;
/*0x230*/ int                BlinkState;
/*0x234*/ bool               bTopAnchoredToTop;
/*0x238*/ uint32_t           XMLIndex;
/*0x23c*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x240*/ bool               Locked;
/*0x244*/ int                HScrollMax;
/*0x248*/ int                BlinkDuration;
/*0x24c*/ bool               dShow;
/*0x24d*/ bool               Minimized;
/*0x24e*/ bool               bIsParentOrContextMenuWindow;
/*0x250*/ ControllerBase*    pController;
/*0x258*/ bool               bShowBorder;
/*0x25c*/ CXRect             IconRect;
/*0x26c*/ bool               bBottomAnchoredToTop;

// @end: CXWnd Members
/*0x26d*/ bool               bUsesClassicUI;
/*0x26e*/ bool               bMouseOverEvent;
/*0x270*/
...
constexpr size_t CSidlScreenWnd_size = 0x2D8; // @sizeof(CSidlScreenWnd) :: 2025-12-01 (beta) @ 0x1405E41B1
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2025-12-01 (beta) @ 0x14019BCF5
