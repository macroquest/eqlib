...
constexpr size_t CXWnd_size = 0x278; // @sizeof(CXWnd) :: 2025-11-27 (beta) @ 0x1405EA5A1
...
// @start: CXWnd Members
/*0x030*/ CXSize             MinClientSize;
/*0x038*/ CXRect             OldLocation;
/*0x048*/ bool               bEnableShowBorder;
/*0x050*/ CTextureAnimation* IconTextureAnim;
/*0x058*/ bool               bScreenClipRectChanged;
/*0x060*/ CXWnd*             ParentWindow;
/*0x068*/ bool               bIsParentOrContextMenuWindow;
/*0x069*/ bool               bHCenterTooltip;
/*0x06c*/ CXRect             Location;
/*0x080*/ CTextObjectInterface* pTipTextObject;
/*0x088*/ CXRect             IconRect;
/*0x098*/ uint8_t            bResizableMask;
/*0x0a0*/ CTextureFont*      pFont;
/*0x0a8*/ bool               bUseInLayoutHorizontal;
/*0x0ac*/ int                RightOffset;
/*0x0b0*/ int                VScrollMax;
/*0x0b4*/ int                HScrollMax;
/*0x0b8*/ uint32_t           BGType;
/*0x0bc*/ CXSize             MaxClientSize;
/*0x0c4*/ bool               bLeftAnchoredToLeft;
/*0x0c5*/ bool               bAction;
/*0x0c8*/ int                BlinkDuration;
/*0x0cc*/ COLORREF           CRNormal;
/*0x0d0*/ CXStr              WindowText;
/*0x0d8*/ uint32_t           BlinkFadeStartTime;
/*0x0dc*/ int                managerArrayIndex;
/*0x0e0*/ bool               bFullyScreenClipped;
/*0x0e4*/ uint32_t           BlinkFadeFreq;
/*0x0e8*/ bool               bRightAnchoredToLeft;
/*0x0e9*/ bool               bActive;
/*0x0ea*/ bool               Locked;
/*0x0eb*/ uint8_t            Alpha;
/*0x0ec*/ bool               bClientRectChanged;
/*0x0f0*/ int                BottomOffset;
/*0x0f4*/ CXRect             ClipRectClient;
/*0x104*/ bool               Enabled;
/*0x108*/ CXStr              Tooltip;
/*0x110*/ bool               Faded;
/*0x111*/ bool               MouseOver;
/*0x112*/ bool               bUseInLayoutVertical;
/*0x113*/ uint8_t            TargetAlpha;
/*0x114*/ int                ParentAndContextMenuArrayIndex;
/*0x118*/ bool               bClickThroughToBackground;
/*0x120*/ ControllerBase*    pController;
/*0x128*/ bool               bBringToTopWhenClicked;
/*0x130*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x138*/ int                BlinkState;
/*0x13c*/ uint32_t           LastTimeMouseOver;
/*0x140*/ bool               bNeedsSaving;
/*0x148*/ CLayoutStrategy*   pLayoutStrategy;
/*0x150*/ bool               bClickThroughMenuItemStatus;
/*0x151*/ uint8_t            StartAlpha;
/*0x152*/ bool               bIsTransitioning;
/*0x154*/ CXRect             ClientRect;
/*0x164*/ uint8_t            FadeAlpha;
/*0x168*/ CTextObjectInterface* pTextObject;
/*0x170*/ COLORREF           BGColor;
/*0x174*/ uint32_t           BackgroundDrawType;
/*0x178*/ bool               bClientClipRectChanged;
/*0x179*/ bool               bMaximized;
/*0x17a*/ bool               bBottomAnchoredToTop;
/*0x180*/ CXWndDrawTemplate* DrawTemplate;
/*0x188*/ int                VScrollPos;
/*0x18c*/ int                BlinkStartTimer;
/*0x190*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x1b0*/ uint32_t           FadeDelay;
/*0x1b4*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x1b8*/ bool               bMaximizable;
/*0x1bc*/ CXRect             ClipRectScreen;
/*0x1cc*/ uint32_t           FadeDuration;
/*0x1d0*/ bool               bClipToParent;
/*0x1d1*/ bool               Unlockable;
/*0x1d4*/ uint32_t           WindowStyle;
/*0x1d8*/ int                HScrollPos;
/*0x1e0*/ int64_t            Data;
/*0x1e8*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x1f0*/ CXStr              XMLToolTip;
/*0x1f8*/ bool               bClickThrough;
/*0x1fc*/ uint32_t           TransitionStartTick;
/*0x200*/ bool               bEscapableLocked;
/*0x204*/ int                DeleteCount;
/*0x208*/ bool               bShowClickThroughMenuItem;
/*0x20c*/ uint32_t           TransitionDuration;
/*0x210*/ bool               bCaptureTitle;
/*0x211*/ bool               Fades;
/*0x214*/ int                Transition;
/*0x218*/ uint32_t           BlinkFadeDuration;
/*0x21c*/ int                TopOffset;
/*0x220*/ int                LeftOffset;
/*0x224*/ bool               dShow;
/*0x228*/ CXRect             TransitionRect;
/*0x238*/ uint8_t            FadeToAlpha;
/*0x239*/ bool               bMarkedForDelete;
/*0x23c*/ uint32_t           XMLIndex;
/*0x240*/ bool               bShowBorder;
/*0x241*/ bool               bEscapable;
/*0x244*/ int                ZLayer;
/*0x248*/ bool               bTiled;
/*0x249*/ bool               Minimized;
/*0x24a*/ bool               bTopAnchoredToTop;
/*0x24c*/ COLORREF           DisabledBackground;
/*0x250*/ bool               ValidCXWnd;
/*0x258*/ CXWnd*             FocusProxy;
/*0x260*/ bool               bKeepOnScreen;
/*0x268*/ CXStr              DataStr;

// @end: CXWnd Members
/*0x270*/ bool               bUsesClassicUI;
/*0x271*/ bool               bMouseOverEvent;
/*0x274*/
...
constexpr size_t CSidlScreenWnd_size = 0x2E0; // @sizeof(CSidlScreenWnd) :: 2025-11-27 (beta) @ 0x1405E5001
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2025-11-27 (beta) @ 0x14019BE05
