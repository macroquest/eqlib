...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd) :: 2025-11-17 (beta) @ 0x1405E69A1
...
/*0x03c*/ uint8_t            FadeAlpha;
/*0x040*/ CXRect             ClipRectScreen;
/*0x050*/ uint32_t           FadeDuration;
/*0x054*/ bool               bMaximizable;
/*0x055*/ bool               bClickThroughToBackground;
/*0x058*/ uint32_t           TransitionDuration;
/*0x05c*/ COLORREF           CRNormal;
/*0x060*/ bool               bKeepOnScreen;
/*0x061*/ uint8_t            Alpha;
/*0x064*/ uint32_t           BlinkFadeStartTime;
/*0x068*/ int                HScrollMax;
/*0x06c*/ uint32_t           BGType;
/*0x070*/ bool               bUseInLayoutHorizontal;
/*0x071*/ bool               bShowBorder;
/*0x072*/ bool               bEscapableLocked;
/*0x074*/ int                VScrollPos;
/*0x078*/ uint32_t           LastTimeMouseOver;
/*0x07c*/ bool               bClientClipRectChanged;
/*0x07d*/ bool               bTopAnchoredToTop;
/*0x080*/ CXRect             OldLocation;
/*0x090*/ CXRect             ClientRect;
/*0x0a0*/ bool               bRightAnchoredToLeft;
/*0x0a1*/ bool               bIsTransitioning;
/*0x0a2*/ bool               bUseInLayoutVertical;
/*0x0a4*/ uint32_t           BackgroundDrawType;
/*0x0a8*/ bool               Locked;
/*0x0b0*/ CXWndDrawTemplate* DrawTemplate;
/*0x0b8*/ COLORREF           DisabledBackground;
/*0x0bc*/ CXSize             MinClientSize;
...
/*0x0ec*/ uint8_t            TargetAlpha;
/*0x0f0*/ int                BlinkState;
/*0x0f4*/ uint8_t            FadeToAlpha;
/*0x0f8*/ uint32_t           BlinkFadeDuration;
/*0x100*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x120*/ bool               bFullyScreenClipped;
/*0x121*/ uint8_t            bResizableMask;
/*0x128*/ CXWnd*             FocusProxy;
/*0x130*/ CTextObjectInterface* pTextObject;
/*0x138*/ bool               bClickThrough;
/*0x13c*/ int                BottomOffset;
/*0x140*/ COLORREF           BGColor;
/*0x148*/ int64_t            Data;
/*0x150*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x158*/ int                ParentAndContextMenuArrayIndex;
/*0x15c*/ uint32_t           TransitionStartTick;
/*0x160*/ int                managerArrayIndex;
/*0x164*/ int                VScrollMax;
/*0x168*/ CTextObjectInterface* pTipTextObject;
/*0x170*/ bool               Fades;
/*0x171*/ bool               bClickThroughMenuItemStatus;
/*0x174*/ int                RightOffset;
/*0x178*/ bool               Faded;
/*0x17c*/ uint32_t           WindowStyle;
/*0x180*/ uint32_t           FadeDelay;
/*0x184*/ bool               bShowClickThroughMenuItem;
/*0x185*/ bool               Enabled;
/*0x188*/ int                Transition;
/*0x190*/ CTextureFont*      pFont;
/*0x198*/ CXRect             IconRect;
/*0x1a8*/ int                HScrollPos;
/*0x1ac*/ bool               bClipToParent;
/*0x1b0*/ int                BlinkStartTimer;
/*0x1b4*/ bool               bAction;
/*0x1b5*/ bool               bEscapable;
/*0x1b6*/ bool               bMarkedForDelete;
/*0x1b7*/ bool               dShow;
/*0x1b8*/ CXRect             ClipRectClient;
/*0x1c8*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x1cc*/ bool               Unlockable;
/*0x1cd*/ bool               bLeftAnchoredToLeft;
/*0x1ce*/ bool               Minimized;
/*0x1d0*/ int                ZLayer;
/*0x1d4*/ bool               ValidCXWnd;
/*0x1d5*/ bool               bMaximized;
/*0x1d8*/ int                DeleteCount;
/*0x1e0*/ CXStr              Tooltip;
/*0x1e8*/ CXStr              DataStr;
/*0x1f0*/ bool               bIsParentOrContextMenuWindow;
/*0x1f1*/ bool               bCaptureTitle;
/*0x1f2*/ bool               bClientRectChanged;
/*0x1f8*/ CTextureAnimation* IconTextureAnim;
/*0x200*/ uint8_t            StartAlpha;
/*0x201*/ bool               bTiled;
/*0x204*/ int                BlinkDuration;
/*0x208*/ bool               bNeedsSaving;
/*0x209*/ bool               bHCenterTooltip;
/*0x210*/ CXWnd*             ParentWindow;
/*0x218*/ bool               bScreenClipRectChanged;
/*0x21c*/ int                TopOffset;
/*0x220*/ CXRect             Location;
/*0x230*/ bool               bActive;
/*0x238*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x240*/ CXStr              XMLToolTip;
/*0x248*/ ControllerBase*    pController;
/*0x250*/ uint32_t           XMLIndex;
/*0x254*/ bool               bBringToTopWhenClicked;
/*0x258*/ CXSize             MaxClientSize;
/*0x260*/ bool               bEnableShowBorder;
...
constexpr size_t CSidlScreenWnd_size = 0x2D0; // @sizeof(CSidlScreenWnd) :: 2025-11-17 (beta) @ 0x1405E1401
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2025-11-17 (beta) @ 0x14019A065
