...
constexpr size_t CXWnd_size = 0x288; // @sizeof(CXWnd) :: 2025-11-28 (beta) @ 0x1405E9B61
...
/*0x038*/ bool               ValidCXWnd;
/*0x039*/ bool               bKeepOnScreen;
/*0x03c*/ uint32_t           WindowStyle;
/*0x040*/ uint8_t            StartAlpha;
/*0x044*/ CXRect             ClipRectClient;
/*0x054*/ bool               bUseInLayoutVertical;
/*0x058*/ int                BlinkState;
/*0x05c*/ bool               bActive;
/*0x05d*/ bool               bMaximized;
/*0x05e*/ bool               bIsTransitioning;
/*0x05f*/ bool               bEscapableLocked;
/*0x060*/ bool               bTiled;
/*0x068*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x088*/ CXStr              Tooltip;
/*0x090*/ bool               bClickThrough;
/*0x094*/ CXRect             OldLocation;
/*0x0a4*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x0a8*/ uint8_t            bResizableMask;
/*0x0b0*/ CXStr              WindowText;
/*0x0b8*/ bool               Enabled;
/*0x0bc*/ int                ParentAndContextMenuArrayIndex;
/*0x0c0*/ CXRect             ClipRectScreen;
/*0x0d0*/ bool               Unlockable;
/*0x0d4*/ uint32_t           TransitionDuration;
/*0x0d8*/ bool               bTopAnchoredToTop;
/*0x0dc*/ int                TopOffset;
/*0x0e0*/ CXWndDrawTemplate* DrawTemplate;
/*0x0e8*/ CTextureAnimation* IconTextureAnim;
/*0x0f0*/ bool               bClickThroughToBackground;
/*0x0f8*/ CXWnd*             ParentWindow;
/*0x100*/ COLORREF           DisabledBackground;
/*0x108*/ CXWnd*             FocusProxy;
/*0x110*/ bool               bShowBorder;
/*0x114*/ CXSize             MaxClientSize;
/*0x11c*/ uint32_t           FadeDelay;
/*0x120*/ int64_t            Data;
/*0x128*/ bool               bShowClickThroughMenuItem;
/*0x130*/ CTextObjectInterface* pTipTextObject;
/*0x138*/ bool               bBringToTopWhenClicked;
/*0x13c*/ int                DeleteCount;
/*0x140*/ bool               bMaximizable;
/*0x144*/ CXRect             IconRect;
/*0x158*/ CLayoutStrategy*   pLayoutStrategy;
/*0x160*/ bool               bClientClipRectChanged;
/*0x164*/ CXSize             MinClientSize;
/*0x16c*/ int                VScrollMax;
/*0x170*/ bool               bBottomAnchoredToTop;
/*0x174*/ COLORREF           CRNormal;
/*0x178*/ bool               bIsParentOrContextMenuWindow;
/*0x17c*/ uint32_t           BackgroundDrawType;
/*0x180*/ int                VScrollPos;
/*0x184*/ uint8_t            FadeToAlpha;
/*0x188*/ uint32_t           BlinkFadeFreq;
/*0x18c*/ bool               bUseInLayoutHorizontal;
/*0x18d*/ bool               dShow;
/*0x18e*/ bool               bNeedsSaving;
/*0x18f*/ bool               bHCenterTooltip;
/*0x190*/ uint8_t            TargetAlpha;
/*0x194*/ int                LeftOffset;
/*0x198*/ uint32_t           BlinkFadeStartTime;
/*0x19c*/ COLORREF           BGColor;
/*0x1a0*/ CXRect             ClientRect;
/*0x1b0*/ bool               bClickThroughMenuItemStatus;
/*0x1b1*/ bool               bFullyScreenClipped;
/*0x1b2*/ bool               Faded;
/*0x1b3*/ bool               bLeftAnchoredToLeft;
/*0x1b4*/ bool               Locked;
/*0x1b8*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x1c0*/ uint8_t            FadeAlpha;
/*0x1c4*/ int                BlinkDuration;
/*0x1c8*/ bool               Minimized;
/*0x1cc*/ int                BottomOffset;
/*0x1d0*/ bool               bEscapable;
/*0x1d4*/ uint32_t           FadeDuration;
/*0x1d8*/ CTextObjectInterface* pTextObject;
/*0x1e0*/ bool               bClientRectChanged;
...
/*0x218*/ CXStr              XMLToolTip;
/*0x220*/ ControllerBase*    pController;
/*0x228*/ bool               bRightAnchoredToLeft;
/*0x229*/ bool               bAction;
/*0x22c*/ uint32_t           BlinkFadeDuration;
/*0x230*/ int                managerArrayIndex;
...
/*0x250*/ bool               bEnableShowBorder;
/*0x254*/ CXRect             Location;
/*0x264*/ uint32_t           BGType;
/*0x268*/ uint32_t           TransitionStartTick;
/*0x26c*/ uint32_t           XMLIndex;
/*0x270*/ uint8_t            Alpha;
/*0x274*/ int                ZLayer;
/*0x278*/ CXStr              DataStr;

// @end: CXWnd Members
/*0x280*/ bool               bUsesClassicUI;
/*0x281*/ bool               bMouseOverEvent;
/*0x284*/
...
constexpr size_t CSidlScreenWnd_size = 0x2F0; // @sizeof(CSidlScreenWnd) :: 2025-11-28 (beta) @ 0x1405E45F1
...
public:
	...
	//----------------------------------------------------------------------------
	// data members
/*0x288*/ bool                         bControlsCreated;
/*0x290*/ CXStr                        SidlText;
/*0x298*/ CScreenTemplate*             SidlPiece;
/*0x2a0*/ ArrayClass<CRadioGroup*>     RadioGroup;
/*0x2b8*/ bool                         bInitVisibility;
/*0x2b9*/ bool                         bVisibleBeforeResize;
/*0x2bc*/ int                          IniFlags;
/*0x2c0*/ CXStr                        IniStorageName;
/*0x2c8*/ int                          IniVersion;
/*0x2cc*/ int                          LastResX;
/*0x2d0*/ int                          LastResY;
/*0x2d4*/ bool                         bLastResFullscreen;
/*0x2d8*/ int                          ContextMenuID;
/*0x2e0*/ CXWnd*                       pFirstVScrollChild;
/*0x2e8*/ int                          ContextMenuTipID;
/*0x2ec*/ bool                         bHasActivatedFirstTimeAlert;
/*0x2f0*/
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2025-11-28 (beta) @ 0x14019BC85
