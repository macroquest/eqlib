...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-11-18 (beta) @ 0x14021DEE4
...
/*0x054*/ unsigned int          ItemHash;
/*0x058*/ bool                  bCopied;
/*0x05c*/ ItemGlobalIndex       GlobalIndex;
/*0x068*/ unsigned int          LastCastTime;
/*0x06c*/ unsigned int          NewArmorID;
/*0x070*/ int                   StackCount;
/*0x078*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x088*/ int                   Charges;
/*0x090*/ int64_t               MerchantSlot;
/*0x098*/ bool                  bRankDisabled;
/*0x0a0*/ ItemContainer         Contents;
/*0x0c8*/ int                   AugFlag;
/*0x0cc*/ int                   MerchantQuantity;
/*0x0d0*/ int                   NoteStatus;
/*0x0d4*/ bool                  bDisableAugTexture;
/*0x0d8*/ int64_t               Price;
/*0x0e0*/ int64_t               DontKnow;
/*0x0e8*/ int                   ActorTag2;
/*0x0ec*/ EqItemGuid            ItemGUID;
/*0x100*/ unsigned int          Tint;
/*0x104*/ unsigned int          RespawnTime;
/*0x108*/ bool                  bConvertable;
/*0x109*/ bool                  bCollected;
/*0x10c*/ int                   Power;
/*0x110*/ int                   ScriptIndex;
/*0x114*/ int                   NoDropFlag;
/*0x118*/ int                   Luck;
...
constexpr size_t ItemClient_size = 0x140; // @sizeof(ItemClient) :: 2025-11-18 (beta) @ 0x1401E5DD9
