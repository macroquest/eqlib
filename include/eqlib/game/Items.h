...
/*0x634*/
	...
	int GetMinLuck() const { return 0; }
	int GetMaxLuck() const { return 0; }
...
// @end: ItemBase Members
	...
	bool IsLoreEquipped(bool bIncludeSockets = false) const { return false; }
	...
	int GetAccuracy() const { return GetItemDefinition()->Accuracy; }
	int GetAvoidance() const { return GetItemDefinition()->Avoidance; }
	int GetCombatEffects() const { return GetItemDefinition()->CombatEffects; }
	int GetDamageShieldMitigation() const { return GetItemDefinition()->DamageShieldMitigation; }
	int GetDamShield() const { return GetItemDefinition()->DamShield; }
	int GetDoTShielding() const { return GetItemDefinition()->DoTShielding; }
	int GetShielding() const { return GetItemDefinition()->Shielding; }
	int GetSpellShield() const { return GetItemDefinition()->SpellShield; }
	int GetStrikeThrough() const { return GetItemDefinition()->StrikeThrough; }
	int GetStunResist() const { return GetItemDefinition()->StunResist; }

	// Heroic resists - in the live client these no longer exist
	int GetHeroicSvMagic() const { return GetItemDefinition()->HeroicSvMagic; }
	int GetHeroicSvFire() const { return GetItemDefinition()->HeroicSvFire; }
	int GetHeroicSvCold() const { return GetItemDefinition()->HeroicSvCold; }
	int GetHeroicSvDisease() const { return GetItemDefinition()->HeroicSvDisease; }
	int GetHeroicSvPoison() const { return GetItemDefinition()->HeroicSvPoison; }
	int GetHeroicSvCorruption() const { return GetItemDefinition()->HeroicSvCorruption; }

	// Convertible Item and Collection fields
	bool IsCollected() const { return false; }
	bool IsConvertible() const { return false; }
	...
	bool IsEvolvingExpOn() const { return EvolvingExpOn; }
