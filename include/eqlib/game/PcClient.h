...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-11-18 (beta) @ 0x1402E0230
...
constexpr size_t PcClient_size = 0x3288; // @sizeof(PcClient) :: 2025-11-18 (beta) @ 0x140286C2A
