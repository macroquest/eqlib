...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-12-01 (beta) @ 0x1402DFFB0
...
constexpr size_t PcClient_size = 0x3288; // @sizeof(PcClient) :: 2025-12-01 (beta) @ 0x1402869DB
