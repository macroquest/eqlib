...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-11-16 (beta) @ 0x1402DF1D0
...
constexpr size_t PcClient_size = 0x3288; // @sizeof(PcClient) :: 2025-11-16 (beta) @ 0x140285B6B
