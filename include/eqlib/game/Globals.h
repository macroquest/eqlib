...
EQLIB_VAR uintptr_t CGFScreenWnd__vftable;
EQLIB_VAR uintptr_t CGFScreenWnd__CGFScreenWnd;
EQLIB_VAR uintptr_t CGFScreenWnd__CGFScreenWnd1;
EQLIB_VAR uintptr_t CGFScreenWnd__dCGFScreenWnd;
...
EQLIB_VAR uintptr_t EQGroundItem__EQGroundItem;
EQLIB_VAR uintptr_t EQGroundItemListManager__Instance;
EQLIB_VAR uintptr_t EQGroundItemListManager__Add;
EQLIB_VAR uintptr_t EQGroundItemListManager__Clear;
EQLIB_VAR uintptr_t EQGroundItemListManager__Delete;
...
//----------------------------------------------------------------------------
// Global Functions imported from EQ
...
EQLIB_API IconCache* GetAnimationCache(int index);
...
EQLIB_API bool GetLabelFromEQ(int, CXStr*, bool*, COLORREF*);
