...
/*0x01cc*/ unsigned int             LastTrapDamageTime;
/*0x01d0*/ uint8_t                  HoldingAnimation;
/*0x01d4*/ int                      Deity;
/*0x01d8*/ unsigned int             Meditating;
/*0x01dc*/ unsigned int             SpellCooldownETA;
/*0x01e0*/ float                    MerchantGreed;
/*0x01e4*/ unsigned int             RespawnTimer;
/*0x01e8*/ bool                     bOfflineMode;
/*0x01e9*/ uint8_t                  Blind;
/*0x01ea*/ char                     Handle[0x20];
/*0x020a*/ uint8_t                  FishingEvent;
/*0x020b*/ bool                     bBetaBuffed;
/*0x020c*/ unsigned int             LastPrimaryUseTime;
/*0x0210*/ bool                     bTempPet;
/*0x0211*/ char                     DragNames[2][0x40];
/*0x0294*/ float                    CameraOffset;
/*0x0298*/ uint8_t                  CharClass;
/*0x029c*/ float                    FallingStartZ;
/*0x02a0*/ int                      ManaCurrent;
/*0x02a4*/ unsigned int             FishingETA;
/*0x02a8*/ int                      ManaMax;
/*0x02ac*/ int                      CurrIOState;
/*0x02b0*/ float                    BearingToTarget;
/*0x02b4*/ unsigned int             LastMealTime;
/*0x02b8*/ bool                     bStationary;
/*0x02c0*/ int64_t                  HPMax;
/*0x02c8*/ int                      AFK;
/*0x02cc*/ uint8_t                  Level;
/*0x02d0*/ float                    MyWalkSpeed;
/*0x02d4*/ int                      Anon;
/*0x02d8*/ int                      Unknown3;
/*0x02dc*/ int                      PrimaryTintIndex;
/*0x02e0*/ char                     GM;
/*0x02e4*/ LaunchSpellData          CastingData;
/*0x0328*/ int                      SomeData[2];
/*0x0330*/ bool                     Linkdead;
/*0x0334*/ unsigned int             LastResendAddPlayerPacket;
/*0x0338*/ char                     Title[0x80];
/*0x03b8*/ void*                    pTouchingSwitch;
/*0x03c0*/ int64_t                  GuildID;
/*0x03c8*/ int                      WarCry;
/*0x03cc*/ int                      DoSpecialMelee;
/*0x03d0*/ int                      PetID;
/*0x03d4*/ uint8_t                  InPvPArea;
/*0x03d8*/ float                    MissileRangeToTarget;
/*0x03e0*/ unsigned int**           ppUDP;
/*0x03e8*/ int                      RealEstateItemId;
/*0x03ec*/ EqItemGuid               realEstateItemGuid;
/*0x0400*/ int                      AltAttack;
/*0x0404*/ int                      EnduranceCurrent;
/*0x0408*/ int                      Birthdate;
/*0x040c*/ unsigned int             ACounter;
/*0x0410*/ bool                     bSwitchMoved;
/*0x0414*/ int                      HideMode;
/*0x0418*/ bool                     bAlwaysShowAura;
/*0x0419*/ bool                     bBuffTimersOnHold;
/*0x041c*/ unsigned int             NextIntimidateTime;
/*0x0420*/ int                      SecondaryTintIndex;
/*0x0424*/ bool                     PvPFlag;
/*0x0428*/ int64_t                  HPCurrent;
/*0x0430*/ int                      berserker;
/*0x0434*/ unsigned int             TimeStamp;
/*0x0438*/ bool                     bAttackRelated;
/*0x0439*/ uint8_t                  StandState;
/*0x043a*/ char                     LoginRelated[0x20];
/*0x045a*/ uint8_t                  FindBits;
/*0x045c*/ unsigned int             LastTimeStoodStill;
/*0x0460*/ uint8_t                  Original;
/*0x0464*/ unsigned int             Zone;
/*0x0468*/ int                      Buyer;
/*0x046c*/ char                     Suffix[0x80];
/*0x04ec*/ int                      Trader;
/*0x04f0*/ uint8_t                  GMRank;
/*0x04f1*/ uint8_t                  IsPassenger;
/*0x04f2*/ uint8_t                  Light;
/*0x04f4*/ unsigned int             EnduranceMax;
/*0x04f8*/ bool                     Sneak;
/*0x04fc*/ int                      IsAttacking;
/*0x0500*/ bool                     Mercenary;
/*0x0504*/ unsigned int             SpellGemETA[15];
/*0x0540*/ SPAWNINFO*               pViewPlayer;
/*0x0548*/ bool                     bSummoned;
/*0x054c*/ unsigned int             CorpseDragCount;
/*0x0550*/ char                     DraggingPlayer[0x40];
/*0x0590*/ uint8_t                  FD;
/*0x0598*/ CharacterZoneClient*     pCharacter;
/*0x05a0*/ float                    RunSpeed;
/*0x05a4*/ unsigned int             LastRangedUsedTime;
/*0x05a8*/ unsigned int             LoginSerial;
/*0x05ac*/ unsigned int             NextSwim;
/*0x05b0*/ unsigned int             LastTick;
/*0x05b4*/ unsigned int             StunTimer;
/*0x05b8*/ unsigned int             SitStartTime;
/*0x05bc*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05c4*/ unsigned int             LastRefresh;
/*0x05c8*/ float                    AnimationSpeedRelated;
/*0x05cc*/ bool                     bShowHelm;
/*0x05d0*/ unsigned int             MinuteTimer;
/*0x05d4*/ uint8_t                  TitleVisible;
/*0x05d5*/ bool                     LFG;
/*0x05d8*/ int                      Unknown1;
/*0x05dc*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05e4*/ bool                     bAnimationOnPop;
/*0x05e8*/ unsigned int             LastSecondaryUseTime;
/*0x05ec*/ uint8_t                  LastAttack;
/*0x05f0*/ int                      NpcTintIndex;
/*0x05f4*/ float                    GetMeleeRangeVar1;
/*0x05f8*/ uint8_t                  IntimidateCount;
/*0x0600*/ void*                    pRaceGenderInfo;
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-11-19 (beta) @ 0x1402FF89E
