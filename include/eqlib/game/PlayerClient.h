...
/*0x01cc*/ uint8_t                  FishingEvent;
/*0x01d0*/ unsigned int             EnduranceMax;
/*0x01d4*/ int                      RealEstateItemId;
/*0x01d8*/ LaunchSpellData          CastingData;
/*0x021c*/ float                    GetMeleeRangeVar1;
/*0x0220*/ int                      WarCry;
/*0x0224*/ unsigned int             LastTick;
/*0x0228*/ float                    CameraOffset;
/*0x022c*/ char                     Title[0x80];
/*0x02ac*/ EqItemGuid               realEstateItemGuid;
/*0x02c0*/ void*                    pRaceGenderInfo;
/*0x02c8*/ char                     DragNames[2][0x40];
/*0x0348*/ int64_t                  HPMax;
/*0x0350*/ unsigned int             StunTimer;
/*0x0354*/ uint8_t                  Level;
/*0x0358*/ int                      Deity;
/*0x035c*/ bool                     bSummoned;
/*0x035d*/ bool                     bAttackRelated;
/*0x0360*/ int                      berserker;
/*0x0364*/ int                      Trader;
/*0x0368*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0370*/ bool                     LFG;
/*0x0374*/ int                      SecondaryTintIndex;
/*0x0378*/ unsigned int             LoginSerial;
/*0x037c*/ int                      EnduranceCurrent;
/*0x0380*/ int                      ManaMax;
/*0x0384*/ bool                     bBetaBuffed;
/*0x0388*/ int                      PrimaryTintIndex;
/*0x038c*/ bool                     bShowHelm;
/*0x038d*/ uint8_t                  LastAttack;
/*0x0390*/ SPAWNINFO*               pViewPlayer;
/*0x0398*/ unsigned int             SpellGemETA[15];
/*0x03d4*/ unsigned int             RespawnTimer;
/*0x03d8*/ uint8_t                  IsPassenger;
/*0x03dc*/ unsigned int             LastTimeStoodStill;
/*0x03e0*/ uint8_t                  InPvPArea;
/*0x03e4*/ unsigned int             CorpseDragCount;
/*0x03e8*/ int                      Anon;
/*0x03ec*/ unsigned int             Meditating;
/*0x03f0*/ float                    MyWalkSpeed;
/*0x03f4*/ CPhysicsInfo             LastCollision;
/*0x0424*/ unsigned int             TimeStamp;
/*0x0428*/ unsigned int             LastSecondaryUseTime;
/*0x042c*/ unsigned int             Zone;
/*0x0430*/ uint8_t                  Original;
/*0x0431*/ bool                     PvPFlag;
/*0x0434*/ int                      Unknown1;
/*0x0438*/ bool                     bAlwaysShowAura;
/*0x043c*/ int                      CurrIOState;
/*0x0440*/ int                      AFK;
/*0x0444*/ bool                     Sneak;
/*0x0445*/ uint8_t                  FindBits;
/*0x0446*/ uint8_t                  CharClass;
/*0x0448*/ unsigned int             ACounter;
/*0x044c*/ uint8_t                  Blind;
/*0x044d*/ bool                     Mercenary;
/*0x0450*/ unsigned int**           ppUDP;
/*0x0458*/ unsigned int             LastResendAddPlayerPacket;
/*0x045c*/ bool                     bStationary;
/*0x0460*/ unsigned int             SitStartTime;
/*0x0464*/ int                      IsAttacking;
/*0x0468*/ int64_t                  GuildID;
/*0x0470*/ uint8_t                  Light;
/*0x0474*/ unsigned int             NextSwim;
/*0x0478*/ int                      AltAttack;
/*0x047c*/ unsigned int             LastRangedUsedTime;
/*0x0480*/ uint8_t                  IntimidateCount;
/*0x0484*/ float                    MissileRangeToTarget;
/*0x0488*/ bool                     Linkdead;
/*0x048c*/ float                    BearingToTarget;
/*0x0490*/ int                      PetID;
/*0x0494*/ uint8_t                  HoldingAnimation;
/*0x0495*/ uint8_t                  FD;
/*0x0498*/ int                      NpcTintIndex;
/*0x049c*/ bool                     bTempPet;
/*0x04a0*/ int                      SomeData[2];
/*0x04a8*/ uint8_t                  StandState;
/*0x04ac*/ unsigned int             SpellCooldownETA;
/*0x04b0*/ int64_t                  HPCurrent;
/*0x04b8*/ unsigned int             FishingETA;
/*0x04bc*/ unsigned int             LastMealTime;
/*0x04c0*/ int                      Birthdate;
/*0x04c4*/ int                      Buyer;
/*0x04c8*/ unsigned int             MasterID;
/*0x04cc*/ unsigned int             LastTrapDamageTime;
/*0x04d0*/ char                     GM;
/*0x04d1*/ char                     DraggingPlayer[0x40];
/*0x0514*/ unsigned int             LastPrimaryUseTime;
/*0x0518*/ float                    FallingStartZ;
/*0x051c*/ char                     Handle[0x20];
/*0x053c*/ bool                     bBuffTimersOnHold;
/*0x0540*/ float                    MerchantGreed;
/*0x0544*/ unsigned int             LastRefresh;
/*0x0548*/ int                      Unknown4;
/*0x054c*/ bool                     bSwitchMoved;
/*0x0550*/ CharacterZoneClient*     pCharacter;
/*0x0558*/ char                     Suffix[0x80];
/*0x05d8*/ bool                     bAnimationOnPop;
/*0x05e0*/ void*                    pTouchingSwitch;
/*0x05e8*/ int                      ManaCurrent;
/*0x05ec*/ unsigned int             NextIntimidateTime;
/*0x05f0*/ float                    AnimationSpeedRelated;
/*0x05f4*/ float                    RunSpeed;
/*0x05f8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0600*/ uint8_t                  GMRank;
/*0x0604*/ int                      HideMode;
...
/*0x0638*/ float                    ViewHeight;
/*0x063c*/ bool                     bOfflineMode;
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-11-17 (beta) @ 0x1402FE88E
