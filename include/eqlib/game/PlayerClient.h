...
/*0x01cc*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x01d4*/ char                     Suffix[0x80];
/*0x0254*/ float                    GetMeleeRangeVar1;
/*0x0258*/ int                      Unknown3;
/*0x025c*/ unsigned int             NextIntimidateTime;
/*0x0260*/ unsigned int             Meditating;
/*0x0264*/ float                    FallingStartZ;
/*0x0268*/ unsigned int**           ppUDP;
/*0x0270*/ int                      NpcTintIndex;
/*0x0274*/ uint8_t                  IntimidateCount;
/*0x0278*/ unsigned int             LastPrimaryUseTime;
/*0x027c*/ bool                     bStationary;
/*0x0280*/ unsigned int             LastTimeStoodStill;
/*0x0284*/ int                      RealEstateItemId;
/*0x0288*/ int                      CurrIOState;
/*0x028c*/ uint8_t                  HoldingAnimation;
/*0x028d*/ char                     Title[0x80];
/*0x0310*/ unsigned int             EnduranceMax;
/*0x0318*/ void*                    pTouchingSwitch;
/*0x0320*/ int                      SecondaryTintIndex;
/*0x0324*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x032c*/ CPhysicsInfo             LastCollision;
/*0x035c*/ int                      AFK;
/*0x0360*/ unsigned int             ACounter;
/*0x0364*/ unsigned int             LastRangedUsedTime;
/*0x0368*/ uint8_t                  Light;
/*0x0369*/ EqItemGuid               realEstateItemGuid;
/*0x037c*/ float                    ViewHeight;
/*0x0380*/ SPAWNINFO*               pViewPlayer;
/*0x0388*/ bool                     LFG;
/*0x0389*/ uint8_t                  LastAttack;
/*0x038c*/ unsigned int             NextSwim;
/*0x0390*/ uint8_t                  TitleVisible;
/*0x0398*/ void*                    pRaceGenderInfo;
/*0x03a0*/ unsigned int             LastMealTime;
/*0x03a4*/ float                    RunSpeed;
/*0x03a8*/ unsigned int             StunTimer;
/*0x03ac*/ int                      AltAttack;
/*0x03b0*/ float                    MerchantGreed;
/*0x03b4*/ bool                     bAttackRelated;
/*0x03b5*/ char                     DraggingPlayer[0x40];
/*0x03f8*/ unsigned int             MinuteTimer;
/*0x03fc*/ bool                     Linkdead;
/*0x03fd*/ char                     LoginRelated[0x20];
/*0x041d*/ uint8_t                  StandState;
/*0x0420*/ float                    MissileRangeToTarget;
/*0x0424*/ uint8_t                  InPvPArea;
/*0x0428*/ int                      PrimaryTintIndex;
/*0x042c*/ bool                     bBetaBuffed;
/*0x0430*/ unsigned int             LastRefresh;
/*0x0434*/ bool                     bOfflineMode;
/*0x0435*/ bool                     bBuffTimersOnHold;
/*0x0438*/ unsigned int             LoginSerial;
/*0x043c*/ unsigned int             LastTrapDamageTime;
/*0x0440*/ int                      Unknown1;
/*0x0444*/ bool                     PvPFlag;
/*0x0448*/ float                    MyWalkSpeed;
/*0x044c*/ bool                     bAnimationOnPop;
/*0x0450*/ int                      WarCry;
/*0x0454*/ int                      berserker;
/*0x0458*/ bool                     Sneak;
/*0x045c*/ int                      Birthdate;
/*0x0460*/ uint8_t                  Level;
/*0x0464*/ unsigned int             LastResendAddPlayerPacket;
/*0x0468*/ int                      ManaMax;
/*0x046c*/ bool                     bTempPet;
/*0x0470*/ int64_t                  HPMax;
/*0x0478*/ int                      Buyer;
/*0x047c*/ bool                     Mercenary;
/*0x047d*/ bool                     bSummoned;
/*0x047e*/ uint8_t                  FD;
/*0x0480*/ int                      EnduranceCurrent;
/*0x0484*/ char                     DragNames[2][0x40];
/*0x0508*/ int64_t                  HPCurrent;
/*0x0510*/ unsigned int             TimeStamp;
/*0x0514*/ unsigned int             RespawnTimer;
/*0x0518*/ int                      SomeData[2];
/*0x0520*/ int                      HideMode;
/*0x0524*/ uint8_t                  FindBits;
/*0x0528*/ int                      RealEstateID;
/*0x052c*/ float                    CameraOffset;
/*0x0530*/ unsigned int             MasterID;
/*0x0534*/ uint8_t                  Blind;
/*0x0538*/ int                      Deity;
/*0x053c*/ unsigned int             CorpseDragCount;
/*0x0540*/ int                      DoSpecialMelee;
/*0x0544*/ unsigned int             FishingETA;
/*0x0548*/ uint8_t                  Original;
/*0x054c*/ unsigned int             LastTick;
/*0x0550*/ int                      Unknown4;
/*0x0554*/ bool                     bAlwaysShowAura;
/*0x0558*/ unsigned int             SpellGemETA[15];
/*0x0594*/ unsigned int             SpellCooldownETA;
/*0x0598*/ CharacterZoneClient*     pCharacter;
/*0x05a0*/ char                     Handle[0x20];
/*0x05c0*/ int                      Trader;
/*0x05c4*/ unsigned int             Zone;
/*0x05c8*/ LaunchSpellData          CastingData;
/*0x0610*/ int64_t                  GuildID;
/*0x0618*/ uint8_t                  FishingEvent;
/*0x0619*/ uint8_t                  IsPassenger;
/*0x061c*/ int                      IsAttacking;
/*0x0620*/ unsigned int             SitStartTime;
/*0x0624*/ uint8_t                  GMRank;
/*0x0625*/ char                     GM;
/*0x0628*/ int                      ManaCurrent;
/*0x062c*/ bool                     bSwitchMoved;
/*0x0630*/ int                      PetID;
/*0x0634*/ int                      Anon;
/*0x0638*/ unsigned int             LastSecondaryUseTime;
/*0x063c*/ uint8_t                  CharClass;
/*0x0640*/ float                    AnimationSpeedRelated;
/*0x0644*/ float                    BearingToTarget;
/*0x0648*/ bool                     bShowHelm;
...
constexpr size_t PlayerClient_size = 0x20C8; // @sizeof(PlayerClient) :: 2025-11-22 (beta) @ 0x1402FFD9E
