...
/*0x01d4*/ int                      SomeData[2];
/*0x01dc*/ unsigned int             LastRangedUsedTime;
/*0x01e0*/ char                     GM;
/*0x01e4*/ int                      DoSpecialMelee;
/*0x01e8*/ unsigned int             Meditating;
/*0x01ec*/ float                    FallingStartZ;
/*0x01f0*/ uint8_t                  StandState;
/*0x01f4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x01fc*/ bool                     Mercenary;
/*0x0200*/ unsigned int             LastTick;
/*0x0204*/ uint8_t                  FD;
/*0x0208*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0210*/ uint8_t                  FishingEvent;
/*0x0211*/ uint8_t                  LastAttack;
/*0x0214*/ unsigned int             TimeStamp;
/*0x0218*/ int64_t                  GuildID;
/*0x0220*/ bool                     bOfflineMode;
/*0x0224*/ unsigned int             LoginSerial;
/*0x0228*/ unsigned int             LastMealTime;
/*0x022c*/ int                      Buyer;
/*0x0230*/ unsigned int             LastTimeStoodStill;
/*0x0234*/ unsigned int             FishingETA;
/*0x0238*/ unsigned int             SitStartTime;
/*0x023c*/ unsigned int             RespawnTimer;
/*0x0240*/ uint8_t                  GMRank;
/*0x0244*/ int                      Unknown1;
/*0x0248*/ char                     DraggingPlayer[0x40];
/*0x0288*/ int                      Deity;
/*0x028c*/ int                      PrimaryTintIndex;
/*0x0290*/ bool                     bAlwaysShowAura;
/*0x0294*/ int                      IsAttacking;
/*0x0298*/ int                      ManaCurrent;
/*0x029c*/ char                     DragNames[2][0x40];
/*0x031c*/ unsigned int             NextIntimidateTime;
/*0x0320*/ unsigned int             LastTrapDamageTime;
/*0x0324*/ int                      Trader;
/*0x0328*/ bool                     bTempPet;
/*0x032c*/ unsigned int             MasterID;
/*0x0330*/ int                      HideMode;
/*0x0334*/ int                      Anon;
/*0x0338*/ char                     Title[0x80];
/*0x03b8*/ uint8_t                  HoldingAnimation;
/*0x03bc*/ unsigned int             Zone;
/*0x03c0*/ unsigned int             SpellGemETA[15];
/*0x03fc*/ int                      AFK;
/*0x0400*/ int64_t                  HPMax;
/*0x0408*/ int                      EnduranceCurrent;
/*0x040c*/ CPhysicsInfo             LastCollision;
/*0x043c*/ float                    MyWalkSpeed;
/*0x0440*/ float                    GetMeleeRangeVar1;
/*0x0444*/ uint8_t                  Light;
/*0x0445*/ bool                     bBetaBuffed;
/*0x0448*/ int                      Unknown3;
/*0x044c*/ bool                     PvPFlag;
/*0x044d*/ char                     Handle[0x20];
/*0x0470*/ float                    MissileRangeToTarget;
/*0x0474*/ unsigned int             LastPrimaryUseTime;
/*0x0478*/ char                     Suffix[0x80];
/*0x04f8*/ SPAWNINFO*               pViewPlayer;
/*0x0500*/ int                      RealEstateID;
/*0x0504*/ unsigned int             CorpseDragCount;
/*0x0508*/ float                    CameraOffset;
/*0x0510*/ unsigned int**           ppUDP;
/*0x0518*/ bool                     bAttackRelated;
/*0x0519*/ EqItemGuid               realEstateItemGuid;
/*0x052c*/ int                      CurrIOState;
/*0x0530*/ float                    MerchantGreed;
/*0x0534*/ float                    ViewHeight;
/*0x0538*/ float                    BearingToTarget;
/*0x0540*/ void*                    pRaceGenderInfo;
/*0x0548*/ bool                     bShowHelm;
/*0x0549*/ char                     LoginRelated[0x20];
/*0x0569*/ bool                     Linkdead;
/*0x056c*/ int                      berserker;
/*0x0570*/ bool                     bAnimationOnPop;
/*0x0574*/ unsigned int             StunTimer;
/*0x0578*/ uint8_t                  IsPassenger;
/*0x057c*/ float                    AnimationSpeedRelated;
/*0x0580*/ unsigned int             LastRefresh;
/*0x0584*/ int                      Birthdate;
/*0x0588*/ int                      WarCry;
/*0x058c*/ uint8_t                  IntimidateCount;
/*0x0590*/ void*                    pTouchingSwitch;
/*0x0598*/ uint8_t                  InPvPArea;
/*0x0599*/ bool                     LFG;
/*0x059c*/ unsigned int             MinuteTimer;
/*0x05a0*/ int                      ManaMax;
/*0x05a4*/ int                      SecondaryTintIndex;
/*0x05a8*/ bool                     bBuffTimersOnHold;
/*0x05ac*/ int                      RealEstateItemId;
/*0x05b0*/ float                    RunSpeed;
/*0x05b4*/ int                      PetID;
/*0x05b8*/ LaunchSpellData          CastingData;
/*0x05fc*/ uint8_t                  FindBits;
/*0x05fd*/ bool                     Sneak;
/*0x0600*/ unsigned int             ACounter;
/*0x0604*/ unsigned int             EnduranceMax;
/*0x0608*/ uint8_t                  Level;
/*0x060c*/ int                      Unknown4;
/*0x0610*/ unsigned int             LastResendAddPlayerPacket;
/*0x0614*/ bool                     bSwitchMoved;
/*0x0618*/ unsigned int             LastSecondaryUseTime;
/*0x061c*/ int                      NpcTintIndex;
/*0x0620*/ unsigned int             SpellCooldownETA;
/*0x0624*/ uint8_t                  CharClass;
/*0x0625*/ uint8_t                  Blind;
/*0x0626*/ bool                     bSummoned;
/*0x0628*/ int64_t                  HPCurrent;
/*0x0630*/ int                      AltAttack;
/*0x0634*/ uint8_t                  TitleVisible;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2025-11-23 (beta) @ 0x1402FFA7E
