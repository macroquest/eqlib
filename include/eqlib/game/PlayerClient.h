...
/*0x01d0*/ int                      Anon;
/*0x01d4*/ int                      RealEstateID;
/*0x01d8*/ EqItemGuid               realEstateItemGuid;
/*0x01f0*/ SPAWNINFO*               pViewPlayer;
/*0x01f8*/ int                      AltAttack;
/*0x0200*/ unsigned int**           ppUDP;
/*0x0208*/ void*                    pTouchingSwitch;
/*0x0210*/ int                      CurrIOState;
/*0x0214*/ bool                     Sneak;
/*0x0218*/ unsigned int             LastSecondaryUseTime;
/*0x021c*/ unsigned int             LastTick;
/*0x0220*/ float                    MyWalkSpeed;
/*0x0224*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x022c*/ int                      berserker;
/*0x0230*/ LaunchSpellData          CastingData;
/*0x0274*/ char                     Handle[0x20];
/*0x0298*/ void*                    pRaceGenderInfo;
/*0x02a0*/ int                      WarCry;
/*0x02a4*/ CPhysicsInfo             LastCollision;
/*0x02d4*/ uint8_t                  HoldingAnimation;
/*0x02d5*/ bool                     bOfflineMode;
/*0x02d8*/ float                    MerchantGreed;
/*0x02dc*/ bool                     bSummoned;
/*0x02dd*/ uint8_t                  FishingEvent;
/*0x02de*/ uint8_t                  Level;
/*0x02e0*/ int                      PetID;
/*0x02e4*/ unsigned int             RespawnTimer;
/*0x02e8*/ unsigned int             LoginSerial;
/*0x02ec*/ unsigned int             FishingETA;
/*0x02f0*/ int                      AFK;
/*0x02f4*/ char                     DragNames[2][0x40];
/*0x0374*/ uint8_t                  Light;
/*0x0378*/ int                      PrimaryTintIndex;
/*0x037c*/ float                    MissileRangeToTarget;
/*0x0380*/ uint8_t                  StandState;
/*0x0384*/ int                      Unknown1;
/*0x0388*/ bool                     PvPFlag;
/*0x0390*/ int64_t                  HPMax;
/*0x0398*/ uint8_t                  IsPassenger;
/*0x0399*/ bool                     bBetaBuffed;
/*0x03a0*/ CharacterZoneClient*     pCharacter;
/*0x03a8*/ char                     LoginRelated[0x20];
/*0x03c8*/ int64_t                  GuildID;
/*0x03d0*/ bool                     bTempPet;
/*0x03d1*/ uint8_t                  InPvPArea;
/*0x03d2*/ uint8_t                  LastAttack;
/*0x03d4*/ unsigned int             LastTimeStoodStill;
/*0x03d8*/ unsigned int             EnduranceMax;
/*0x03dc*/ unsigned int             LastMealTime;
/*0x03e0*/ unsigned int             SpellGemETA[15];
/*0x041c*/ int                      DoSpecialMelee;
/*0x0420*/ unsigned int             LastPrimaryUseTime;
/*0x0424*/ int                      HideMode;
/*0x0428*/ uint8_t                  FD;
/*0x042c*/ int                      SecondaryTintIndex;
/*0x0430*/ unsigned int             MinuteTimer;
/*0x0434*/ bool                     LFG;
/*0x0438*/ int                      Unknown4;
/*0x043c*/ char                     DraggingPlayer[0x40];
/*0x047c*/ int                      IsAttacking;
/*0x0480*/ unsigned int             ACounter;
/*0x0484*/ char                     Suffix[0x80];
/*0x0504*/ unsigned int             Zone;
/*0x0508*/ bool                     bBuffTimersOnHold;
/*0x050c*/ unsigned int             StunTimer;
/*0x0510*/ int                      Unknown3;
/*0x0514*/ unsigned int             SitStartTime;
/*0x0518*/ int64_t                  HPCurrent;
/*0x0520*/ bool                     bStationary;
/*0x0521*/ bool                     bShowHelm;
/*0x0522*/ uint8_t                  GMRank;
/*0x0523*/ uint8_t                  TitleVisible;
/*0x0524*/ bool                     Mercenary;
/*0x0528*/ unsigned int             MasterID;
/*0x052c*/ int                      ManaCurrent;
/*0x0530*/ char                     Title[0x80];
/*0x05b0*/ uint8_t                  IntimidateCount;
/*0x05b4*/ int                      SomeData[2];
/*0x05bc*/ char                     GM;
/*0x05c0*/ unsigned int             LastRefresh;
/*0x05c4*/ int                      ManaMax;
/*0x05c8*/ unsigned int             SpellCooldownETA;
/*0x05cc*/ int                      Deity;
/*0x05d0*/ uint8_t                  Blind;
/*0x05d4*/ unsigned int             CorpseDragCount;
/*0x05d8*/ unsigned int             LastResendAddPlayerPacket;
/*0x05dc*/ bool                     bSwitchMoved;
/*0x05e0*/ int                      Buyer;
/*0x05e4*/ float                    CameraOffset;
/*0x05e8*/ int                      EnduranceCurrent;
/*0x05ec*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05f4*/ unsigned int             Meditating;
/*0x05f8*/ float                    GetMeleeRangeVar1;
/*0x05fc*/ bool                     bAttackRelated;
/*0x0600*/ int                      Birthdate;
/*0x0604*/ int                      Trader;
/*0x0608*/ unsigned int             NextSwim;
/*0x060c*/ bool                     Linkdead;
/*0x0610*/ int                      NpcTintIndex;
/*0x0614*/ float                    BearingToTarget;
/*0x0618*/ uint8_t                  CharClass;
/*0x061c*/ float                    ViewHeight;
/*0x0620*/ unsigned int             TimeStamp;
/*0x0624*/ int                      RealEstateItemId;
/*0x0628*/ uint8_t                  FindBits;
/*0x062c*/ float                    AnimationSpeedRelated;
/*0x0630*/ unsigned int             LastRangedUsedTime;
/*0x0634*/ float                    RunSpeed;
/*0x0638*/ float                    FallingStartZ;
/*0x063c*/ unsigned int             LastTrapDamageTime;
/*0x0640*/ uint8_t                  Original;
/*0x0641*/ bool                     bAlwaysShowAura;
/*0x0642*/ bool                     bAnimationOnPop;
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-11-13 (live) @ 0x1402FE28E
