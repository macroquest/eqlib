...
/*0x01cc*/ char                     GM;
/*0x01cd*/ EqItemGuid               realEstateItemGuid;
/*0x01df*/ uint8_t                  IsPassenger;
/*0x01e0*/ void*                    pTouchingSwitch;
/*0x01e8*/ char                     DragNames[2][0x40];
/*0x0268*/ unsigned int             Meditating;
/*0x026c*/ char                     DraggingPlayer[0x40];
/*0x02ac*/ bool                     bShowHelm;
/*0x02ad*/ uint8_t                  Level;
/*0x02b0*/ SPAWNINFO*               pViewPlayer;
/*0x02b8*/ int                      IsAttacking;
/*0x02bc*/ unsigned int             LastSecondaryUseTime;
/*0x02c0*/ uint8_t                  Blind;
/*0x02c4*/ unsigned int             NextIntimidateTime;
/*0x02c8*/ unsigned int             SitStartTime;
/*0x02cc*/ bool                     Sneak;
/*0x02d0*/ int                      berserker;
/*0x02d4*/ bool                     bAnimationOnPop;
/*0x02d8*/ unsigned int             LastRangedUsedTime;
/*0x02dc*/ uint8_t                  HoldingAnimation;
/*0x02e0*/ int                      CurrIOState;
/*0x02e4*/ uint8_t                  Light;
/*0x02e8*/ unsigned int             LastTrapDamageTime;
/*0x02ec*/ unsigned int             RespawnTimer;
/*0x02f0*/ int64_t                  HPCurrent;
/*0x02f8*/ bool                     bTempPet;
/*0x02fc*/ int                      NpcTintIndex;
/*0x0300*/ uint8_t                  FishingEvent;
/*0x0304*/ int                      Anon;
/*0x0308*/ int64_t                  GuildID;
/*0x0310*/ LaunchSpellData          CastingData;
/*0x0354*/ int                      Birthdate;
/*0x0358*/ unsigned int             LoginSerial;
/*0x0360*/ int64_t                  HPMax;
/*0x0368*/ int                      AltAttack;
/*0x036c*/ int                      WarCry;
/*0x0370*/ bool                     Mercenary;
/*0x0374*/ unsigned int             LastPrimaryUseTime;
/*0x0378*/ unsigned int             NextSwim;
/*0x037c*/ bool                     PvPFlag;
/*0x037d*/ uint8_t                  StandState;
/*0x0380*/ float                    AnimationSpeedRelated;
/*0x0388*/ unsigned int**           ppUDP;
/*0x0390*/ float                    FallingStartZ;
/*0x0394*/ bool                     bOfflineMode;
/*0x0395*/ bool                     bSummoned;
/*0x0398*/ unsigned int             LastMealTime;
/*0x039c*/ uint8_t                  Original;
/*0x03a0*/ int                      PrimaryTintIndex;
/*0x03a4*/ float                    BearingToTarget;
/*0x03a8*/ float                    ViewHeight;
/*0x03ac*/ int                      Deity;
/*0x03b0*/ int                      RealEstateItemId;
/*0x03b4*/ bool                     bAlwaysShowAura;
/*0x03b8*/ int                      Trader;
/*0x03bc*/ unsigned int             LastResendAddPlayerPacket;
/*0x03c0*/ bool                     bStationary;
/*0x03c4*/ float                    RunSpeed;
/*0x03c8*/ unsigned int             Zone;
/*0x03cc*/ int                      EnduranceCurrent;
/*0x03d0*/ int                      DoSpecialMelee;
/*0x03d4*/ unsigned int             LastTick;
/*0x03d8*/ int                      Unknown1;
/*0x03dc*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03e4*/ uint8_t                  GMRank;
/*0x03e5*/ bool                     LFG;
/*0x03e8*/ unsigned int             StunTimer;
/*0x03ec*/ unsigned int             LastRefresh;
/*0x03f0*/ CharacterZoneClient*     pCharacter;
/*0x03f8*/ char                     Suffix[0x80];
/*0x0478*/ unsigned int             SpellGemETA[15];
/*0x04b4*/ unsigned int             EnduranceMax;
/*0x04b8*/ unsigned int             SpellCooldownETA;
/*0x04bc*/ int                      Unknown3;
/*0x04c0*/ int                      RealEstateID;
/*0x04c4*/ float                    MerchantGreed;
/*0x04c8*/ unsigned int             MasterID;
/*0x04cc*/ float                    GetMeleeRangeVar1;
/*0x04d0*/ int                      ManaCurrent;
/*0x04d4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x04dc*/ char                     Title[0x80];
/*0x055c*/ char                     Handle[0x20];
/*0x057c*/ bool                     Linkdead;
/*0x057d*/ uint8_t                  InPvPArea;
/*0x0580*/ float                    MissileRangeToTarget;
/*0x0584*/ uint8_t                  LastAttack;
/*0x0588*/ int                      Buyer;
/*0x058c*/ unsigned int             LastTimeStoodStill;
/*0x0590*/ unsigned int             ACounter;
/*0x0594*/ uint8_t                  IntimidateCount;
/*0x0598*/ unsigned int             CorpseDragCount;
/*0x059c*/ unsigned int             TimeStamp;
/*0x05a0*/ int                      ManaMax;
/*0x05a4*/ bool                     bBetaBuffed;
/*0x05a8*/ void*                    pRaceGenderInfo;
/*0x05b0*/ uint8_t                  FD;
/*0x05b1*/ bool                     bAttackRelated;
/*0x05b4*/ int                      SomeData[2];
/*0x05bc*/ unsigned int             FishingETA;
/*0x05c0*/ int                      HideMode;
/*0x05c4*/ int                      AFK;
/*0x05c8*/ CPhysicsInfo             LastCollision;
/*0x05f8*/ float                    MyWalkSpeed;
/*0x05fc*/ bool                     bBuffTimersOnHold;
/*0x05fd*/ bool                     bSwitchMoved;
/*0x05fe*/ uint8_t                  CharClass;
/*0x0600*/ float                    CameraOffset;
/*0x0604*/ int                      SecondaryTintIndex;
/*0x0608*/ unsigned int             MinuteTimer;
/*0x060c*/ int                      Unknown4;
/*0x0610*/ char                     LoginRelated[0x20];
/*0x0630*/ uint8_t                  FindBits;
/*0x0634*/ int                      PetID;
/*0x0638*/ uint8_t                  TitleVisible;
...
constexpr size_t PlayerClient_size = 0x20B8; // @sizeof(PlayerClient) :: 2025-11-18 (beta) @ 0x1402FF94E
