...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2026-04-08 (test) @ 0x14026DCA6
...
constexpr size_t SkillManager_size = 0x399C80; // @sizeof(SkillManager) :: 2026-04-08 (test) @ 0x14026DDE6
