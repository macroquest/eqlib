...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2026-03-16 (test) @ 0x14026D2D6
...
constexpr size_t SkillManager_size = 0x399C80; // @sizeof(SkillManager) :: 2026-03-16 (test) @ 0x14026D416
