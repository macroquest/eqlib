...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2025-12-01 (beta) @ 0x1402674D0
...
constexpr size_t SkillManager_size = 0x399C80; // @sizeof(SkillManager) :: 2025-12-01 (beta) @ 0x140267610
