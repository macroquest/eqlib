...
constexpr size_t EQ_Spell_size = 0x218; // @sizeof(EQ_Spell) :: 2025-11-22 (beta) @ 0x1401DE0A7
...
constexpr size_t ClientSpellManager_size = 0x24A8; // @sizeof(ClientSpellManager) :: 2025-11-22 (beta) @ 0x140273190
