...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd, eqmain) :: 2026-03-16 (test) @ 0x1800D9FBB
...
/*0x040*/ CXWnd*             FocusProxy;
/*0x048*/ uint32_t           UNKNOWN_0x048;
/*0x04C*/ uint8_t            StartAlpha;
/*0x04D*/ bool               Minimized;
/*0x04E*/ bool               UNKNOWN_0x04E;
/*0x04F*/ bool               bActive;
/*0x050*/ bool               MouseOver;
/*0x051*/ uint8_t            UNKNOWN_0x051[7];
/*0x058*/ CXStr              WindowText;
/*0x060*/ ControllerBase*    pController;
/*0x068*/ CXRect             OldLocation;
/*0x078*/ CXWnd*             ParentWindow;
/*0x080*/ bool               UNKNOWN_0x080;
/*0x081*/ bool               ValidCXWnd;
/*0x082*/ uint8_t            UNKNOWN_0x082[2];
/*0x084*/ uint32_t           FadeDuration;
/*0x088*/ uint32_t           LastTimeMouseOver;
/*0x08C*/ bool               Faded;
/*0x08D*/ bool               Fades;
/*0x08E*/ bool               bTiled;
/*0x08F*/ bool               UNKNOWN_0x08F;
/*0x090*/ CXWndDrawTemplate* DrawTemplate;
/*0x098*/ COLORREF           CRNormal;
/*0x09C*/ bool               bClickThroughToBackground;
/*0x09D*/ bool               Enabled;
/*0x09E*/ bool               UNKNOWN_0x09E;
/*0x09F*/ bool               UNKNOWN_0x09F;
/*0x0A0*/ uint32_t           XMLIndex;
/*0x0A4*/ int                managerArrayIndex;
/*0x0A8*/ COLORREF           DisabledBackground;
/*0x0AC*/ uint32_t           UNKNOWN_0x0AC;
/*0x0B0*/ CXStr              Tooltip;
/*0x0B8*/ uint8_t            FadeToAlpha;
/*0x0B9*/ uint8_t            UNKNOWN_0x0B9[7];
/*0x0C0*/ bool               bShowClickThroughMenuItem;
/*0x0C1*/ bool               bClickThroughMenuItemStatus;
/*0x0C2*/ bool               bMarkedForDelete;
/*0x0C3*/ bool               bNeedsSaving;
/*0x0C4*/ bool               bKeepOnScreen;
/*0x0C5*/ bool               bEscapable;
/*0x0C6*/ bool               bEscapableLocked;
/*0x0C7*/ bool               bCaptureTitle;
/*0x0C8*/ uint32_t           UNKNOWN_0x0C8;
/*0x0CC*/ uint8_t            bUseInLayoutVertical;
/*0x0CD*/ bool               bUseInLayoutHorizontal;
/*0x0CE*/ uint8_t            UNKNOWN_0x0CE[2];
/*0x0D0*/ int                Transition;
/*0x0D4*/ int                ZLayer;
/*0x0D8*/ int64_t            Data;
/*0x0E0*/ uint32_t           UNKNOWN_0x0E0;
/*0x0E4*/ int                HScrollPos;
/*0x0E8*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x108*/ uint32_t           UNKNOWN_0x108;
/*0x10C*/ uint32_t           BlinkFadeFreq;
/*0x110*/ bool               bTopAnchoredToTop;
/*0x111*/ bool               Unlockable;
/*0x112*/ uint8_t            UNKNOWN_0x112[2];
/*0x114*/ uint32_t           BackgroundDrawType;
/*0x118*/ CXStr              XMLToolTip;
/*0x120*/ CXStr              DataStr;
/*0x128*/ int                ParentAndContextMenuArrayIndex;
/*0x12C*/ int                TopOffset;
/*0x130*/ int                BottomOffset;
/*0x134*/ int                LeftOffset;
/*0x138*/ int                RightOffset;
/*0x13C*/ bool               bBottomAnchoredToTop;
/*0x13D*/ bool               bRightAnchoredToLeft;
/*0x13E*/ bool               bIsTransitioning;
/*0x13F*/ bool               bIsParentOrContextMenuWindow;
/*0x140*/ uint32_t           FadeDelay;
/*0x144*/ bool               bLeftAnchoredToLeft;
/*0x145*/ bool               bBringToTopWhenClicked;
/*0x146*/ uint8_t            UNKNOWN_0x146[2];
/*0x148*/ bool               bClickThrough;
/*0x149*/ bool               bEnableShowBorder;
/*0x14A*/ bool               bMaximizable;
/*0x14B*/ bool               bAction;
/*0x14C*/ bool               bMaximized;
/*0x14D*/ bool               bFullyScreenClipped;
/*0x14E*/ bool               bScreenClipRectChanged;
/*0x14F*/ bool               bHCenterTooltip;
/*0x150*/ int                BlinkDuration;
/*0x154*/ int                BlinkState;
/*0x158*/ CTextObjectInterface* pTextObject;
/*0x160*/ bool               UNKNOWN_0x160;
/*0x161*/ uint8_t            UNKNOWN_0x161[7];
/*0x168*/ CTextObjectInterface* pTipTextObject;
/*0x170*/ uint32_t           TransitionStartTick;
/*0x174*/ uint8_t            bResizableMask;
/*0x175*/ bool               Locked;
/*0x176*/ uint8_t            UNKNOWN_0x176[2];
/*0x178*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x17C*/ uint32_t           BlinkFadeStartTime;
/*0x180*/ bool               bClipToParent;
/*0x181*/ uint8_t            UNKNOWN_0x181[3];
/*0x184*/ uint32_t           BlinkFadeDuration;
/*0x188*/ bool               UNKNOWN_0x188;
/*0x189*/ uint8_t            UNKNOWN_0x189[3];
/*0x18C*/ uint32_t           BGType;
/*0x190*/ CXSize             MaxClientSize;
/*0x198*/ bool               UNKNOWN_0x198;
/*0x199*/ bool               UNKNOWN_0x199;
/*0x19A*/ uint8_t            UNKNOWN_0x19A[6];
/*0x1A0*/ CXSize             MinClientSize;
/*0x1A8*/ CTextureAnimation* IconTextureAnim;
/*0x1B0*/ uint64_t           UNKNOWN_0x1B0;
/*0x1B8*/ bool               UNKNOWN_0x1B8;
/*0x1B9*/ uint8_t            UNKNOWN_0x1B9[3];
/*0x1BC*/ COLORREF           BGColor;
/*0x1C0*/ CTextureFont*      pFont;
/*0x1C8*/ CXRect             Location;
/*0x1D8*/ bool               UNKNOWN_0x1D8;
/*0x1D9*/ uint8_t            UNKNOWN_0x1D9[7];
/*0x1E0*/ CLayoutStrategy*   pLayoutStrategy;
/*0x1E8*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x1F0*/ bool               UNKNOWN_0x1F0;
/*0x1F1*/ uint8_t            UNKNOWN_0x1F1[7];
/*0x1F8*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x200*/ uint32_t           UNKNOWN_0x200;
/*0x204*/ CXRect             ClientRect;
/*0x214*/ uint8_t            UNKNOWN_0x214;
/*0x215*/ uint8_t            TargetAlpha;
/*0x216*/ bool               bShowBorder;
/*0x217*/ uint8_t            UNKNOWN_0x217;
/*0x218*/ int                VScrollMax;
/*0x21C*/ uint8_t            Alpha;
/*0x21D*/ uint8_t            UNKNOWN_0x21D[3];
/*0x220*/ uint32_t           VScrollPos;
/*0x224*/ bool               UNKNOWN_0x224;
/*0x225*/ uint8_t            UNKNOWN_0x225[3];
/*0x228*/ uint32_t           UNKNOWN_0x228;
/*0x22C*/ uint32_t           WindowStyle;
/*0x230*/ bool               bClientRectChanged;
/*0x231*/ uint8_t            FadeAlpha;
/*0x232*/ bool               UNKNOWN_0x232;
/*0x233*/ bool               dShow;
/*0x234*/ int                HScrollMax;
/*0x238*/ bool               UNKNOWN_0x238;
/*0x239*/ uint8_t            UNKNOWN_0x239[3];
/*0x23C*/ uint32_t           UNKNOWN_0x23C;
/*0x240*/ bool               UNKNOWN_0x240;
/*0x241*/ uint8_t            UNKNOWN_0x241[3];
/*0x244*/ uint32_t           UNKNOWN_0x244;
/*0x248*/ bool               UNKNOWN_0x248;
/*0x249*/ uint8_t            UNKNOWN_0x249[4];
/*0x24D*/ bool               bClientClipRectChanged;
/*0x24E*/ uint8_t            UNKNOWN_0x24E[2];
/*0x250*/ CXRect             TransitionRect;
/*0x260*/ bool               UNKNOWN_0x260;
/*0x261*/ bool               bUsesClassicUI;
/*0x262*/ bool               bMouseOverEvent;
/*0x263*/ uint8_t            UNKNOWN_0x263[5];
