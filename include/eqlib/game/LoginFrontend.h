...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd, eqmain) :: 2025-11-30 (beta) @ 0x1800D757B
...
/*0x040*/ bool               bClickThrough;
/*0x044*/ CXRect             ClientRect;
/*0x054*/ bool               bClickThroughToBackground;
/*0x058*/ int                BlinkStartTimer;
/*0x05c*/ bool               Minimized;
/*0x060*/ uint32_t           BlinkFadeFreq;
/*0x064*/ uint32_t           BlinkFadeStartTime;
/*0x068*/ CXRect             ClipRectClient;
/*0x078*/ bool               bShowClickThroughMenuItem;
/*0x080*/ CTextObjectInterface* pTipTextObject;
/*0x088*/ uint32_t           LastTimeMouseOver;
/*0x08c*/ uint8_t            TargetAlpha;
/*0x090*/ CXRect             Location;
/*0x0a0*/ CXSize             MinClientSize;
/*0x0a8*/ CXRect             IconRect;
/*0x0b8*/ CXWnd*             ParentWindow;
/*0x0c0*/ int                HScrollPos;
/*0x0c4*/ uint8_t            Alpha;
/*0x0c5*/ bool               Fades;
/*0x0c6*/ bool               bEscapableLocked;
/*0x0c7*/ bool               bClientRectChanged;
/*0x0c8*/ uint32_t           TransitionStartTick;
/*0x0cc*/ int                VScrollPos;
/*0x0d0*/ CTextureAnimation* IconTextureAnim;
/*0x0d8*/ CTextureFont*      pFont;
/*0x0e0*/ int64_t            Data;
/*0x0e8*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x0f0*/ bool               bCaptureTitle;
/*0x0f1*/ bool               bBringToTopWhenClicked;
/*0x0f4*/ COLORREF           CRNormal;
/*0x0f8*/ bool               bActive;
/*0x0fc*/ CXRect             OldLocation;
/*0x10c*/ bool               bUseInLayoutHorizontal;
/*0x110*/ uint32_t           BlinkFadeDuration;
/*0x114*/ bool               Enabled;
/*0x118*/ COLORREF           DisabledBackground;
/*0x11c*/ int                VScrollMax;
/*0x120*/ bool               Locked;
/*0x124*/ COLORREF           BGColor;
/*0x128*/ bool               MouseOver;
/*0x12c*/ uint32_t           BackgroundDrawType;
/*0x130*/ bool               bRightAnchoredToLeft;
/*0x138*/ CXWndDrawTemplate* DrawTemplate;
/*0x140*/ bool               bLeftAnchoredToLeft;
/*0x144*/ int                TopOffset;
/*0x148*/ CXStr              WindowText;
/*0x150*/ CXStr              Tooltip;
/*0x158*/ uint32_t           XMLIndex;
/*0x15c*/ bool               ValidCXWnd;
/*0x160*/ int                ParentAndContextMenuArrayIndex;
/*0x164*/ bool               bMarkedForDelete;
/*0x168*/ uint32_t           FadeDuration;
/*0x16c*/ bool               bUseInLayoutVertical;
/*0x16d*/ bool               bEscapable;
/*0x170*/ CXSize             MaxClientSize;
/*0x178*/ int                LeftOffset;
/*0x17c*/ bool               bScreenClipRectChanged;
/*0x17d*/ bool               bMaximized;
/*0x17e*/ bool               bIsParentOrContextMenuWindow;
/*0x180*/ int                BlinkDuration;
/*0x184*/ uint8_t            StartAlpha;
/*0x188*/ ControllerBase*    pController;
/*0x190*/ bool               bTopAnchoredToTop;
/*0x191*/ bool               bTiled;
/*0x194*/ int                Transition;
/*0x198*/ int                DeleteCount;
/*0x19c*/ bool               bIsTransitioning;
/*0x1a0*/ CXStr              XMLToolTip;
/*0x1a8*/ bool               bShowBorder;
/*0x1b0*/ CTextObjectInterface* pTextObject;
/*0x1b8*/ int                RightOffset;
/*0x1bc*/ bool               bClipToParent;
/*0x1c0*/ int                BlinkState;
/*0x1c4*/ uint32_t           BGType;
/*0x1c8*/ bool               Faded;
/*0x1cc*/ int                ZLayer;
/*0x1d0*/ bool               bHCenterTooltip;
/*0x1d4*/ CXRect             TransitionRect;
/*0x1e4*/ uint8_t            FadeAlpha;
/*0x1e5*/ bool               dShow;
/*0x1e8*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x1ec*/ uint8_t            FadeToAlpha;
/*0x1ed*/ uint8_t            bResizableMask;
/*0x1f0*/ uint32_t           FadeDelay;
/*0x1f4*/ bool               bKeepOnScreen;
/*0x1f5*/ bool               Unlockable;
/*0x1f6*/ bool               bAction;
/*0x1f7*/ bool               bBottomAnchoredToTop;
/*0x1f8*/ bool               bClickThroughMenuItemStatus;
/*0x1f9*/ bool               bEnableShowBorder;
/*0x200*/ CLayoutStrategy*   pLayoutStrategy;
/*0x208*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x228*/ bool               bMaximizable;
/*0x22c*/ uint32_t           TransitionDuration;
/*0x230*/ bool               bClientClipRectChanged;
/*0x231*/ bool               bFullyScreenClipped;
/*0x234*/ int                BottomOffset;
/*0x238*/ int                managerArrayIndex;
/*0x23c*/ uint32_t           WindowStyle;
/*0x240*/ CXStr              DataStr;
/*0x248*/ CXRect             ClipRectScreen;
