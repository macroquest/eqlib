...
FUNCTION_AT_ADDRESS(CEQGBitmap*, CEQGBitmap::GetFirstBitmap(), CEQGBitmap__GetFirstBitmap);
...
FUNCTION_AT_ADDRESS(void, CDisplay::SetActorSpriteTint(struct EQRGB*, struct T3D_tagACTORINSTANCE*), CDisplay__SetActorSpriteTint);
#endif
...
// CListWnd::AddColumn implemented ASM
#endif
