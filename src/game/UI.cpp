...
static std::unordered_multimap<std::string_view, ForeignPointer<CSidlScreenWnd>&> s_windowInitMap = {
	...
	{ "TargetWindow",                           pTargetWnd.ref<CSidlScreenWnd>() },
	{ "TaskOverlayWnd",                         pTaskOverlayWnd.ref<CSidlScreenWnd>() },
	{ "TaskSelectWnd",                          pTaskSelectWnd.ref<CSidlScreenWnd>() },
	{ "TaskTemplateSelectWnd",                  pTaskTemplateSelectWnd.ref<CSidlScreenWnd>() },
	{ "TaskWnd",                                pTaskWnd.ref<CSidlScreenWnd>() },
	{ "TextEntryWnd",                           pTextEntryWnd.ref<CSidlScreenWnd>() },
	{ "TipWindow",                              pTipOfDayWnd.ref<CSidlScreenWnd>() },
	{ "TipWindow",                              pContextTipWnd.ref<CSidlScreenWnd>() },
	{ "TitleWnd",                               pTitleWnd.ref<CSidlScreenWnd>() },
	{ "TrackingWnd",                            pTrackingWnd.ref<CSidlScreenWnd>() },
	{ "TradeskillDepotWnd",                     pTradeskillDepotWnd.ref<CSidlScreenWnd>() },
	{ "TradeskillWnd",                          pTradeskillWnd.ref<CSidlScreenWnd>() },
	{ "TradeWnd",                               pTradeWnd.ref<CSidlScreenWnd>() },
	{ "TrainWindow",                            pTrainWnd.ref<CSidlScreenWnd>() },
	{ "TributeBenefitWnd",                      pTributeBenefitWnd.ref<CSidlScreenWnd>() },
	{ "TributeMasterWnd",                       pTributeMasterWnd.ref<CSidlScreenWnd>() },
	{ "TributeTrophyWnd",                       pTributeTrophyWnd.ref<CSidlScreenWnd>() },
	{ "VideoModesWindow",                       pVideoModesWnd.ref<CSidlScreenWnd>() },
	{ "VoiceMacroWnd",                          pVoiceMacroWnd.ref<CSidlScreenWnd>() },
	{ "VoteResultsWnd",                         pVoteResultsWnd.ref<CSidlScreenWnd>() },
	{ "VoteWnd",                                pVoteWnd.ref<CSidlScreenWnd>() },
	{ "ZoneGuideWnd",                           pZoneGuideWnd.ref<CSidlScreenWnd>() },
	{ "ZonePathWnd",                            pZonePathWnd.ref<CSidlScreenWnd>() },
};
...
void InitializeInGameUI()
{
	...
	if (!initOnce)
	{
		...
		for (int i = 0; i < MAX_HOTBUTTON_WNDS; ++i)
		{
			...
			s_windowInitMap.emplace(hotbuttonNames[i], pHotButtonWnds[i].ref<CSidlScreenWnd>());
		}
	}
