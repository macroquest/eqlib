...
/*0x01cc*/ unsigned int             LastTimeStoodStill;
/*0x01d0*/ uint8_t                  GMRank;
/*0x01d4*/ unsigned int             SitStartTime;
/*0x01d8*/ unsigned int             RespawnTimer;
/*0x01dc*/ int                      CurrIOState;
/*0x01e0*/ uint8_t                  StandState;
/*0x01e4*/ int                      PrimaryTintIndex;
/*0x01e8*/ unsigned int             MasterID;
/*0x01ec*/ int                      berserker;
/*0x01f0*/ unsigned int             CorpseDragCount;
/*0x01f4*/ float                    MyWalkSpeed;
/*0x01f8*/ unsigned int             ACounter;
/*0x01fc*/ uint8_t                  FishingEvent;
/*0x01fd*/ bool                     bAnimationOnPop;
/*0x0200*/ int64_t                  HPMax;
/*0x0208*/ int                      AltAttack;
/*0x020c*/ uint8_t                  IsPassenger;
/*0x0210*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0218*/ uint8_t                  Blind;
/*0x021c*/ int                      Unknown4;
/*0x0220*/ uint8_t                  FindBits;
/*0x0224*/ float                    GetMeleeRangeVar1;
/*0x0228*/ float                    MerchantGreed;
/*0x022c*/ bool                     bSummoned;
/*0x0230*/ unsigned int             MinuteTimer;
/*0x0234*/ CPhysicsInfo             LastCollision;
/*0x0264*/ unsigned int             Zone;
/*0x0268*/ uint8_t                  LastAttack;
/*0x0269*/ uint8_t                  TitleVisible;
/*0x026c*/ int                      ManaCurrent;
/*0x0270*/ char                     Handle[0x20];
/*0x0290*/ uint8_t                  InPvPArea;
/*0x0294*/ int                      Deity;
/*0x0298*/ unsigned int             LastMealTime;
/*0x029c*/ int                      Unknown3;
/*0x02a0*/ bool                     Mercenary;
/*0x02a4*/ unsigned int             NextIntimidateTime;
/*0x02a8*/ void*                    pTouchingSwitch;
/*0x02b0*/ int                      ManaMax;
/*0x02b4*/ unsigned int             LastRangedUsedTime;
/*0x02b8*/ unsigned int             StunTimer;
/*0x02bc*/ float                    ViewHeight;
/*0x02c0*/ bool                     Linkdead;
/*0x02c8*/ unsigned int**           ppUDP;
/*0x02d0*/ unsigned int             LastTrapDamageTime;
/*0x02d4*/ unsigned int             LastRefresh;
/*0x02d8*/ bool                     PvPFlag;
/*0x02dc*/ int                      HideMode;
/*0x02e0*/ float                    CameraOffset;
/*0x02e4*/ bool                     bSwitchMoved;
/*0x02e8*/ unsigned int             LastResendAddPlayerPacket;
/*0x02ec*/ int                      EnduranceCurrent;
/*0x02f0*/ uint8_t                  Original;
/*0x02f4*/ int                      SecondaryTintIndex;
/*0x02f8*/ int                      DoSpecialMelee;
/*0x0300*/ int64_t                  GuildID;
/*0x0308*/ int                      NpcTintIndex;
/*0x030c*/ char                     DragNames[2][0x40];
/*0x038c*/ int                      SomeData[2];
/*0x0394*/ unsigned int             LoginSerial;
/*0x0398*/ bool                     bStationary;
/*0x03a0*/ int64_t                  HPCurrent;
/*0x03a8*/ bool                     bAlwaysShowAura;
/*0x03ac*/ unsigned int             SpellCooldownETA;
/*0x03b0*/ char                     Title[0x80];
/*0x0430*/ bool                     bBetaBuffed;
/*0x0431*/ uint8_t                  IntimidateCount;
/*0x0432*/ char                     DraggingPlayer[0x40];
/*0x0474*/ float                    RunSpeed;
/*0x0478*/ bool                     bOfflineMode;
/*0x0480*/ void*                    pRaceGenderInfo;
/*0x0488*/ LaunchSpellData          CastingData;
/*0x04cc*/ int                      Buyer;
/*0x04d0*/ bool                     bTempPet;
/*0x04d4*/ int                      Unknown1;
/*0x04d8*/ unsigned int             FishingETA;
/*0x04dc*/ unsigned int             LastTick;
/*0x04e0*/ uint8_t                  HoldingAnimation;
/*0x04e4*/ float                    MissileRangeToTarget;
/*0x04e8*/ int                      Birthdate;
/*0x04ec*/ unsigned int             EnduranceMax;
/*0x04f0*/ unsigned int             TimeStamp;
/*0x04f4*/ int                      Trader;
/*0x04f8*/ uint8_t                  Light;
/*0x04f9*/ bool                     bShowHelm;
/*0x04fc*/ unsigned int             LastSecondaryUseTime;
/*0x0500*/ bool                     LFG;
/*0x0501*/ uint8_t                  Level;
/*0x0504*/ int                      WarCry;
/*0x0508*/ bool                     Sneak;
/*0x050c*/ unsigned int             Meditating;
/*0x0510*/ unsigned int             NextSwim;
/*0x0514*/ int                      IsAttacking;
/*0x0518*/ uint8_t                  FD;
/*0x051c*/ float                    BearingToTarget;
/*0x0520*/ float                    AnimationSpeedRelated;
/*0x0524*/ char                     Suffix[0x80];
/*0x05a4*/ bool                     bBuffTimersOnHold;
/*0x05a8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05b0*/ SPAWNINFO*               pViewPlayer;
/*0x05b8*/ int                      Anon;
/*0x05bc*/ char                     GM;
/*0x05bd*/ EqItemGuid               realEstateItemGuid;
/*0x05d0*/ unsigned int             SpellGemETA[15];
/*0x0610*/ CharacterZoneClient*     pCharacter;
/*0x0618*/ int                      RealEstateItemId;
/*0x061c*/ int                      RealEstateID;
/*0x0620*/ unsigned int             LastPrimaryUseTime;
/*0x0624*/ bool                     bAttackRelated;
/*0x0628*/ int                      PetID;
/*0x062c*/ char                     LoginRelated[0x20];
/*0x064c*/ uint8_t                  CharClass;
/*0x0650*/ int                      AFK;
/*0x0654*/ float                    FallingStartZ;
...
// @sizeof(PlayerClient) == 0x1f78 :: 2023-06-27 (test) @ 0x1402dc16e
