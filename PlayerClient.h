...
/*0x01e8*/ uint8_t                  InPvPArea;
/*0x01e9*/ uint8_t                  IsPassenger;
/*0x01ea*/ char                     Title[0x80];
/*0x026c*/ int                      berserker;
/*0x0270*/ uint8_t                  HoldingAnimation;
/*0x0271*/ uint8_t                  Level;
/*0x0272*/ bool                     bSwitchMoved;
/*0x0274*/ unsigned int             LastRangedUsedTime;
/*0x0278*/ int                      Deity;
/*0x027c*/ bool                     Sneak;
/*0x0280*/ int                      Anon;
/*0x0284*/ char                     LoginRelated[0x20];
/*0x02a4*/ uint8_t                  GMRank;
/*0x02a8*/ unsigned int             SpellCooldownETA;
/*0x02ac*/ bool                     PvPFlag;
/*0x02b0*/ int                      PetID;
/*0x02b4*/ int                      RealEstateID;
/*0x02b8*/ uint8_t                  Light;
/*0x02bc*/ unsigned int             MinuteTimer;
/*0x02c0*/ uint8_t                  FD;
/*0x02c4*/ float                    AnimationSpeedRelated;
/*0x02c8*/ uint8_t                  IntimidateCount;
/*0x02cc*/ int                      Dontknowyet2;
/*0x02d0*/ int                      WarCry;
/*0x02d4*/ int                      NpcTintIndex;
/*0x02d8*/ void*                    pRaceGenderInfo;
/*0x02e0*/ uint8_t                  LastAttack;
/*0x02e4*/ int                      AFK;
/*0x02e8*/ bool                     bTempPet;
/*0x02ec*/ unsigned int             LastPrimaryUseTime;
/*0x02f0*/ unsigned int             Meditating;
/*0x02f4*/ int                      Trader;
/*0x02f8*/ float                    CameraOffset;
/*0x02fc*/ unsigned int             SpellGemETA[15];
/*0x0338*/ bool                     bBuffTimersOnHold;
/*0x0339*/ char                     Suffix[0x80];
/*0x03b9*/ bool                     Mercenary;
/*0x03ba*/ bool                     bStationary;
/*0x03bb*/ char                     GM;
/*0x03bc*/ bool                     bAnimationOnPop;
/*0x03c0*/ unsigned int             CorpseDragCount;
/*0x03c4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03cc*/ bool                     bShowHelm;
/*0x03cd*/ uint8_t                  Blind;
/*0x03d0*/ unsigned int             MasterID;
/*0x03d4*/ unsigned int             LastTrapDamageTime;
/*0x03d8*/ int                      SomeData[2];
/*0x03e0*/ bool                     LFG;
/*0x03e4*/ unsigned int             SitStartTime;
/*0x03e8*/ uint8_t                  TitleVisible;
/*0x03ec*/ unsigned int             NextSwim;
/*0x03f0*/ unsigned int**           ppUDP;
/*0x03f8*/ float                    GetMeleeRangeVar1;
/*0x03fc*/ unsigned int             RespawnTimer;
/*0x0400*/ float                    MerchantGreed;
/*0x0404*/ unsigned int             LastResendAddPlayerPacket;
/*0x0408*/ int                      Stuff;
/*0x040c*/ float                    MyWalkSpeed;
/*0x0410*/ int                      EnduranceCurrent;
/*0x0414*/ float                    RunSpeed;
/*0x0418*/ int                      ManaMax;
/*0x041c*/ unsigned int             LastTick;
/*0x0420*/ int                      IsAttacking;
/*0x0424*/ unsigned int             Zone;
/*0x0428*/ int64_t                  HPMax;
/*0x0430*/ uint8_t                  HmmWhat;
/*0x0431*/ uint8_t                  StandState;
/*0x0432*/ uint8_t                  CharClass;
/*0x0438*/ SPAWNINFO*               pViewPlayer;
/*0x0440*/ bool                     bBetaBuffed;
/*0x0444*/ unsigned int             FishingETA;
/*0x0448*/ EqItemGuid               realEstateItemGuid;
/*0x045c*/ int                      HideMode;
/*0x0460*/ unsigned int             LastRefresh;
/*0x0468*/ void*                    pTouchingSwitch;
/*0x0470*/ int                      RealEstateItemId;
/*0x0474*/ bool                     bAttackRelated;
/*0x0478*/ int                      PrimaryTintIndex;
/*0x047c*/ uint8_t                  Type2;
/*0x0480*/ unsigned int             ACounter;
/*0x0484*/ unsigned int             LastTimeStoodStill;
/*0x0488*/ unsigned int             StunTimer;
/*0x048c*/ unsigned int             NextIntimidateTime;
/*0x0490*/ bool                     Linkdead;
/*0x0498*/ int64_t                  GuildID;
/*0x04a0*/ int                      DoSpecialMelee;
/*0x04a4*/ unsigned int             LastMealTime;
/*0x04a8*/ unsigned int             EnduranceMax;
/*0x04ac*/ float                    MissileRangeToTarget;
/*0x04b0*/ unsigned int             LoginSerial;
/*0x04b8*/ int64_t                  HPCurrent;
/*0x04c0*/ CPhysicsInfo             LastCollision;
/*0x04f0*/ bool                     bSummoned;
/*0x04f4*/ int                      SomethingElse;
/*0x04f8*/ int                      SecondaryTintIndex;
/*0x04fc*/ int                      ManaCurrent;
/*0x0500*/ char                     DraggingPlayer[0x40];
/*0x0540*/ int                      DontKnowYet;
/*0x0544*/ int                      CurrIOState;
/*0x0548*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0550*/ int                      Buyer;
/*0x0554*/ LaunchSpellData          CastingData;
/*0x05ac*/ uint8_t                  FishingEvent;
/*0x05b0*/ float                    ViewHeight;
/*0x05b4*/ float                    BearingToTarget;
/*0x05b8*/ float                    FallingStartZ;
/*0x05bc*/ uint8_t                  FindBits;
/*0x05bd*/ bool                     bOfflineMode;
/*0x05be*/ char                     DragNames[2][0x40];
/*0x0640*/ int                      AltAttack;
/*0x0644*/ unsigned int             LastSecondaryUseTime;
/*0x0648*/ unsigned int             TimeStamp;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2022-09-12 (test) @ 0x1402a261e
