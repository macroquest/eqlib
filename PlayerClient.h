...
/*0x01e0*/ unsigned int             TimeStamp;
/*0x01e4*/ bool                     bBetaBuffed;
/*0x01e8*/ int                      Anon;
/*0x01ec*/ char                     GM;
/*0x01f0*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x01f8*/ unsigned int             MasterID;
/*0x01fc*/ unsigned int             LastTick;
/*0x0200*/ char                     Suffix[0x80];
/*0x0280*/ CharacterZoneClient*     pCharacter;
/*0x0288*/ unsigned int**           ppUDP;
/*0x0290*/ float                    ViewHeight;
/*0x0294*/ uint8_t                  Level;
/*0x0298*/ unsigned int             EnduranceMax;
/*0x02a0*/ int64_t                  HPCurrent;
/*0x02a8*/ unsigned int             LastTimeStoodStill;
/*0x02ac*/ char                     Handle[0x20];
/*0x02cc*/ int                      DoSpecialMelee;
/*0x02d0*/ unsigned int             RespawnTimer;
/*0x02d4*/ CPhysicsInfo             LastCollision;
/*0x0304*/ unsigned int             LastMealTime;
/*0x0308*/ unsigned int             FishingETA;
/*0x030c*/ LaunchSpellData          CastingData;
/*0x0350*/ int                      HideMode;
/*0x0354*/ bool                     Mercenary;
/*0x0358*/ unsigned int             Meditating;
/*0x035c*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0364*/ float                    GetMeleeRangeVar1;
/*0x0368*/ int                      SecondaryTintIndex;
/*0x036c*/ float                    CameraOffset;
/*0x0370*/ int                      Buyer;
/*0x0374*/ bool                     Sneak;
/*0x0378*/ float                    BearingToTarget;
/*0x037c*/ unsigned int             CorpseDragCount;
/*0x0380*/ char                     Title[0x80];
/*0x0400*/ uint8_t                  GMRank;
/*0x0408*/ int64_t                  HPMax;
/*0x0410*/ unsigned int             StunTimer;
/*0x0414*/ bool                     bOfflineMode;
/*0x0418*/ unsigned int             LastRefresh;
/*0x041c*/ int                      WarCry;
/*0x0420*/ bool                     bAttackRelated;
/*0x0421*/ bool                     LFG;
/*0x0424*/ unsigned int             LastRangedUsedTime;
/*0x0428*/ EqItemGuid               realEstateItemGuid;
/*0x0440*/ SPAWNINFO*               pViewPlayer;
/*0x0448*/ int                      Unknown3;
/*0x044c*/ int                      IsAttacking;
/*0x0450*/ uint8_t                  Original;
/*0x0454*/ float                    FallingStartZ;
/*0x0458*/ unsigned int             SpellGemETA[15];
/*0x0494*/ int                      NpcTintIndex;
/*0x0498*/ int                      CurrIOState;
/*0x049c*/ float                    AnimationSpeedRelated;
/*0x04a0*/ bool                     PvPFlag;
/*0x04a4*/ unsigned int             LoginSerial;
/*0x04a8*/ bool                     bStationary;
/*0x04ac*/ unsigned int             LastTrapDamageTime;
/*0x04b0*/ bool                     bSwitchMoved;
/*0x04b4*/ int                      PetID;
/*0x04b8*/ unsigned int             ACounter;
/*0x04bc*/ int                      SomeData[2];
/*0x04c4*/ unsigned int             LastResendAddPlayerPacket;
/*0x04c8*/ unsigned int             NextSwim;
/*0x04cc*/ bool                     bTempPet;
/*0x04cd*/ uint8_t                  Light;
/*0x04d0*/ int                      Unknown1;
/*0x04d4*/ int                      berserker;
/*0x04d8*/ int                      Deity;
/*0x04dc*/ uint8_t                  IsPassenger;
/*0x04dd*/ uint8_t                  LastAttack;
/*0x04e0*/ int                      Trader;
/*0x04e4*/ unsigned int             SitStartTime;
/*0x04e8*/ unsigned int             LastSecondaryUseTime;
/*0x04ec*/ float                    MissileRangeToTarget;
/*0x04f0*/ int                      AltAttack;
/*0x04f4*/ char                     DragNames[2][0x40];
/*0x0574*/ bool                     Linkdead;
/*0x0575*/ char                     DraggingPlayer[0x40];
/*0x05b8*/ unsigned int             Zone;
/*0x05c0*/ void*                    pRaceGenderInfo;
/*0x05c8*/ uint8_t                  FD;
/*0x05cc*/ int                      EnduranceCurrent;
/*0x05d0*/ int                      Unknown2;
/*0x05d4*/ int                      ManaCurrent;
/*0x05d8*/ uint8_t                  HoldingAnimation;
/*0x05d9*/ uint8_t                  FishingEvent;
/*0x05dc*/ int                      RealEstateItemId;
/*0x05e0*/ bool                     bBuffTimersOnHold;
/*0x05e4*/ unsigned int             LastPrimaryUseTime;
/*0x05e8*/ int                      RealEstateID;
/*0x05ec*/ uint8_t                  InPvPArea;
/*0x05f0*/ int                      ManaMax;
/*0x05f4*/ uint8_t                  FindBits;
/*0x05f8*/ float                    MerchantGreed;
/*0x05fc*/ uint8_t                  CharClass;
/*0x05fd*/ uint8_t                  IntimidateCount;
/*0x05fe*/ bool                     bAlwaysShowAura;
/*0x0600*/ unsigned int             MinuteTimer;
/*0x0604*/ bool                     bShowHelm;
/*0x0605*/ bool                     bSummoned;
/*0x0608*/ int                      Unknown4;
/*0x060c*/ uint8_t                  Blind;
/*0x0610*/ int                      PrimaryTintIndex;
/*0x0614*/ uint8_t                  TitleVisible;
/*0x0615*/ uint8_t                  StandState;
/*0x0618*/ float                    RunSpeed;
/*0x061c*/ float                    MyWalkSpeed;
/*0x0620*/ bool                     bAnimationOnPop;
/*0x0624*/ unsigned int             SpellCooldownETA;
/*0x0628*/ unsigned int             NextIntimidateTime;
/*0x0630*/ int64_t                  GuildID;
/*0x0638*/ void*                    pTouchingSwitch;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-01-11 (live) @ 0x1402a895e
