...
/*0x01c0*/ unsigned int**           ppUDP;
/*0x01c8*/ bool                     bStationary;
/*0x01cc*/ int                      Deity;
/*0x01d0*/ uint8_t                  InPvPArea;
/*0x01d4*/ int                      RealEstateItemId;
/*0x01d8*/ bool                     Linkdead;
/*0x01dc*/ int                      ManaCurrent;
/*0x01e0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x01e8*/ int                      AFK;
/*0x01ec*/ uint8_t                  StandState;
/*0x01f0*/ unsigned int             TimeStamp;
/*0x01f4*/ uint8_t                  LastAttack;
/*0x01f8*/ int                      HideMode;
/*0x01fc*/ unsigned int             LastRefresh;
/*0x0200*/ float                    MissileRangeToTarget;
/*0x0204*/ bool                     LFG;
/*0x0208*/ float                    MerchantGreed;
/*0x020c*/ float                    RunSpeed;
/*0x0210*/ CharacterZoneClient*     pCharacter;
/*0x0218*/ int                      Anon;
/*0x021c*/ int                      ManaMax;
/*0x0220*/ unsigned int             ACounter;
/*0x0224*/ unsigned int             EnduranceMax;
/*0x0228*/ bool                     bAlwaysShowAura;
/*0x0229*/ uint8_t                  FindBits;
/*0x022c*/ unsigned int             RespawnTimer;
/*0x0230*/ uint8_t                  Blind;
/*0x0231*/ bool                     Sneak;
/*0x0232*/ char                     Suffix[0x80];
/*0x02b4*/ int                      berserker;
/*0x02b8*/ bool                     bAttackRelated;
/*0x02bc*/ int                      DoSpecialMelee;
/*0x02c0*/ unsigned int             LastSecondaryUseTime;
/*0x02c4*/ unsigned int             LastTimeStoodStill;
/*0x02c8*/ float                    GetMeleeRangeVar1;
/*0x02cc*/ bool                     bSwitchMoved;
/*0x02cd*/ char                     DragNames[2][0x40];
/*0x034d*/ char                     Title[0x80];
/*0x03cd*/ EqItemGuid               realEstateItemGuid;
/*0x03df*/ bool                     bAnimationOnPop;
/*0x03e0*/ unsigned int             FishingETA;
/*0x03e4*/ unsigned int             LastPrimaryUseTime;
/*0x03e8*/ uint8_t                  IntimidateCount;
/*0x03e9*/ uint8_t                  Light;
/*0x03ec*/ unsigned int             LastResendAddPlayerPacket;
/*0x03f0*/ int                      Buyer;
/*0x03f4*/ LaunchSpellData          CastingData;
/*0x044c*/ unsigned int             LastRangedUsedTime;
/*0x0450*/ uint8_t                  Type2;
/*0x0451*/ uint8_t                  FishingEvent;
/*0x0452*/ uint8_t                  GMRank;
/*0x0454*/ int                      DontKnowYet;
/*0x0458*/ bool                     bBuffTimersOnHold;
/*0x045c*/ int                      SecondaryTintIndex;
/*0x0460*/ unsigned int             LastCastTime;
/*0x0468*/ int64_t                  GuildID;
/*0x0470*/ bool                     Mercenary;
/*0x0474*/ int                      WarCry;
/*0x0478*/ char                     LoginRelated[0x20];
/*0x0498*/ unsigned int             LastTick;
/*0x049c*/ unsigned int             LoginSerial;
/*0x04a0*/ uint8_t                  CharClass;
/*0x04a4*/ int                      LastCastNum;
/*0x04a8*/ unsigned int             NextSwim;
/*0x04ac*/ unsigned int             SpellGemETA[15];
/*0x04e8*/ unsigned int             Zone;
/*0x04ec*/ bool                     bTempPet;
/*0x04f0*/ float                    CameraOffset;
/*0x04f8*/ void*                    pRaceGenderInfo;
/*0x0500*/ bool                     PvPFlag;
/*0x0504*/ unsigned int             CorpseDragCount;
/*0x0508*/ SPAWNINFO*               pViewPlayer;
/*0x0510*/ uint8_t                  TitleVisible;
/*0x0511*/ uint8_t                  HoldingAnimation;
/*0x0512*/ char                     Handle[0x20];
/*0x0534*/ float                    ViewHeight;
/*0x0538*/ unsigned int             MasterID;
/*0x053c*/ int                      Trader;
/*0x0540*/ unsigned int             SpellCooldownETA;
/*0x0544*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x054c*/ int                      PetID;
/*0x0550*/ int                      PrimaryTintIndex;
/*0x0554*/ CPhysicsInfo             LastCollision;
/*0x0584*/ char                     GM;
/*0x0588*/ float                    MyWalkSpeed;
/*0x058c*/ uint8_t                  Level;
/*0x0590*/ unsigned int             StunTimer;
/*0x0598*/ void*                    pTouchingSwitch;
/*0x05a0*/ unsigned int             LastTrapDamageTime;
/*0x05a4*/ int                      CurrIOState;
/*0x05a8*/ int                      SomeData[2];
/*0x05b0*/ int64_t                  HPMax;
/*0x05b8*/ bool                     bOfflineMode;
/*0x05b9*/ char                     DraggingPlayer[0x40];
/*0x05fc*/ unsigned int             Meditating;
/*0x0600*/ uint8_t                  FD;
/*0x0604*/ int                      IsAttacking;
/*0x0608*/ float                    BearingToTarget;
/*0x060c*/ int                      RealEstateID;
/*0x0610*/ bool                     bBetaBuffed;
/*0x0614*/ unsigned int             LastMealTime;
/*0x0618*/ int                      NpcTintIndex;
/*0x061c*/ int                      SomethingElse;
/*0x0620*/ unsigned int             MinuteTimer;
/*0x0624*/ int                      EnduranceCurrent;
/*0x0628*/ bool                     bShowHelm;
/*0x062c*/ float                    AnimationSpeedRelated;
/*0x0630*/ bool                     bSummoned;
/*0x0631*/ uint8_t                  HmmWhat;
/*0x0634*/ int                      Dontknowyet2;
/*0x0638*/ unsigned int             SitStartTime;
/*0x063c*/ unsigned int             NextIntimidateTime;
/*0x0640*/ int                      AltAttack;
/*0x0644*/ uint8_t                  IsPassenger;
/*0x0648*/ float                    FallingStartZ;
/*0x0650*/ int64_t                  HPCurrent;
/*0x0658*/ int                      Stuff;
...
/*0x0fe0*/ ActorClient        mActorClient; // fc8
...
// @sizeof(PlayerClient) == 0x1f80 :: 2022-08-15 (live) @ 0x1402a0cae
