...
/*0x0250*/ uint8_t                  FD;
/*0x0254*/ unsigned int             LastSecondaryUseTime;
/*0x0258*/ uint8_t                  Original;
/*0x0259*/ bool                     bSummoned;
/*0x025c*/ float                    AnimationSpeedRelated;
/*0x0260*/ unsigned int             SitStartTime;
/*0x0264*/ uint8_t                  LastAttack;
/*0x0268*/ unsigned int**           ppUDP;
/*0x0270*/ uint8_t                  Blind;
/*0x0278*/ int64_t                  HPCurrent;
/*0x0280*/ unsigned int             StunTimer;
/*0x0284*/ int                      RealEstateID;
/*0x0288*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0290*/ bool                     bOfflineMode;
/*0x0294*/ int                      EnduranceCurrent;
/*0x0298*/ char                     LoginRelated[0x20];
/*0x02b8*/ bool                     bShowHelm;
/*0x02bc*/ int                      Unknown3;
/*0x02c0*/ bool                     bTempPet;
/*0x02c4*/ float                    BearingToTarget;
/*0x02c8*/ uint8_t                  IsPassenger;
/*0x02c9*/ uint8_t                  CharClass;
/*0x02d0*/ void*                    pTouchingSwitch;
/*0x02d8*/ bool                     Mercenary;
/*0x02d9*/ bool                     bBetaBuffed;
/*0x02da*/ bool                     Sneak;
/*0x02dc*/ int                      WarCry;
/*0x02e0*/ int                      PrimaryTintIndex;
/*0x02e4*/ uint8_t                  Light;
/*0x02e5*/ uint8_t                  StandState;
/*0x02e8*/ int                      Unknown4;
/*0x02ec*/ unsigned int             SpellGemETA[15];
/*0x0328*/ int                      AFK;
/*0x032c*/ int                      ManaMax;
/*0x0330*/ unsigned int             Zone;
/*0x0334*/ unsigned int             RespawnTimer;
/*0x0338*/ bool                     bStationary;
/*0x0339*/ bool                     bAttackRelated;
/*0x033c*/ float                    FallingStartZ;
/*0x0340*/ unsigned int             LastRangedUsedTime;
/*0x0344*/ uint8_t                  TitleVisible;
/*0x0345*/ uint8_t                  GMRank;
/*0x0346*/ char                     DraggingPlayer[0x40];
/*0x0388*/ unsigned int             TimeStamp;
/*0x038c*/ unsigned int             CorpseDragCount;
/*0x0390*/ unsigned int             LastTrapDamageTime;
/*0x0394*/ bool                     PvPFlag;
/*0x0398*/ int                      NpcTintIndex;
/*0x039c*/ unsigned int             MasterID;
/*0x03a0*/ float                    MerchantGreed;
/*0x03a4*/ int                      SecondaryTintIndex;
/*0x03a8*/ unsigned int             NextIntimidateTime;
/*0x03ac*/ char                     DragNames[2][0x40];
/*0x042c*/ unsigned int             LastRefresh;
/*0x0430*/ int                      PetID;
/*0x0434*/ EqItemGuid               realEstateItemGuid;
/*0x0446*/ bool                     Linkdead;
/*0x0448*/ int                      CurrIOState;
/*0x044c*/ uint8_t                  IntimidateCount;
/*0x0450*/ unsigned int             Meditating;
/*0x0458*/ int64_t                  GuildID;
/*0x0460*/ int                      Unknown1;
/*0x0464*/ uint8_t                  HoldingAnimation;
/*0x0468*/ unsigned int             LoginSerial;
/*0x046c*/ float                    MissileRangeToTarget;
/*0x0470*/ unsigned int             FishingETA;
/*0x0474*/ int                      HideMode;
/*0x0478*/ float                    ViewHeight;
/*0x047c*/ bool                     bAnimationOnPop;
/*0x0480*/ int                      DoSpecialMelee;
/*0x0484*/ unsigned int             EnduranceMax;
/*0x0488*/ int                      Anon;
/*0x048c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0490*/ int                      Birthdate;
/*0x0494*/ unsigned int             MinuteTimer;
/*0x0498*/ float                    GetMeleeRangeVar1;
/*0x049c*/ int                      berserker;
/*0x04a0*/ unsigned int             ACounter;
/*0x04a4*/ uint8_t                  Level;
/*0x04a8*/ CPhysicsInfo             LastCollision;
/*0x04d8*/ int                      Trader;
/*0x04dc*/ char                     Handle[0x20];
/*0x04fc*/ unsigned int             LastMealTime;
/*0x0500*/ unsigned int             SpellCooldownETA;
/*0x0504*/ bool                     bBuffTimersOnHold;
/*0x0508*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0510*/ char                     Suffix[0x80];
/*0x0590*/ uint8_t                  InPvPArea;
/*0x0598*/ int64_t                  HPMax;
/*0x05a0*/ int                      RealEstateItemId;
/*0x05a4*/ unsigned int             NextSwim;
/*0x05a8*/ float                    RunSpeed;
/*0x05ac*/ int                      Deity;
/*0x05b0*/ bool                     bSwitchMoved;
/*0x05b1*/ bool                     bAlwaysShowAura;
/*0x05b4*/ int                      AltAttack;
/*0x05b8*/ float                    MyWalkSpeed;
/*0x05bc*/ unsigned int             LastTick;
/*0x05c0*/ char                     GM;
/*0x05c1*/ uint8_t                  FishingEvent;
/*0x05c8*/ CharacterZoneClient*     pCharacter;
/*0x05d0*/ int                      IsAttacking;
/*0x05d8*/ SPAWNINFO*               pViewPlayer;
/*0x05e0*/ void*                    pRaceGenderInfo;
/*0x05e8*/ int                      SomeData[2];
/*0x05f0*/ int                      Buyer;
/*0x05f4*/ uint8_t                  FindBits;
/*0x05f8*/ unsigned int             LastTimeStoodStill;
/*0x05fc*/ unsigned int             LastPrimaryUseTime;
/*0x0600*/ bool                     LFG;
/*0x0604*/ LaunchSpellData          CastingData;
/*0x0648*/ float                    CameraOffset;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-04-16 (live) @ 0x1402e81fe
