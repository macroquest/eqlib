...
/*0x01d0*/ int                      ManaCurrent;
/*0x01d4*/ uint8_t                  InPvPArea;
/*0x01d8*/ int                      SomeData[2];
/*0x01e0*/ char                     DragNames[2][0x40];
/*0x0260*/ float                    BearingToTarget;
/*0x0264*/ uint8_t                  FishingEvent;
/*0x0265*/ bool                     bAnimationOnPop;
/*0x0268*/ LaunchSpellData          CastingData;
/*0x02ac*/ unsigned int             SpellGemETA[15];
/*0x02e8*/ int                      HideMode;
/*0x02ec*/ int                      NpcTintIndex;
/*0x02f0*/ bool                     bSwitchMoved;
/*0x02f8*/ void*                    pRaceGenderInfo;
/*0x0300*/ unsigned int             MinuteTimer;
/*0x0304*/ unsigned int             MasterID;
/*0x0308*/ char                     LoginRelated[0x20];
/*0x0328*/ bool                     bBetaBuffed;
/*0x0329*/ bool                     Sneak;
/*0x032c*/ float                    RunSpeed;
...
/*0x0358*/ char                     Handle[0x20];
/*0x0378*/ int                      berserker;
/*0x037c*/ uint8_t                  FD;
/*0x037d*/ uint8_t                  Light;
/*0x037e*/ uint8_t                  StandState;
/*0x037f*/ bool                     Mercenary;
/*0x0380*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0388*/ unsigned int             FishingETA;
/*0x038c*/ unsigned int             LoginSerial;
/*0x0390*/ bool                     bShowHelm;
/*0x0391*/ char                     GM;
/*0x0394*/ float                    FallingStartZ;
/*0x0398*/ unsigned int             LastTimeStoodStill;
/*0x039c*/ bool                     bOfflineMode;
/*0x03a0*/ int                      PetID;
/*0x03a4*/ EqItemGuid               realEstateItemGuid;
/*0x03b6*/ uint8_t                  IntimidateCount;
/*0x03b7*/ char                     DraggingPlayer[0x40];
/*0x03f7*/ bool                     Linkdead;
/*0x03f8*/ SPAWNINFO*               pViewPlayer;
/*0x0400*/ int                      EnduranceCurrent;
/*0x0404*/ uint8_t                  Blind;
/*0x0408*/ int                      Deity;
/*0x0410*/ CharacterZoneClient*     pCharacter;
/*0x0418*/ unsigned int             LastTick;
/*0x041c*/ unsigned int             Zone;
/*0x0420*/ unsigned int             Meditating;
/*0x0424*/ float                    MissileRangeToTarget;
/*0x0428*/ uint8_t                  Level;
/*0x0429*/ uint8_t                  GMRank;
/*0x042c*/ float                    MerchantGreed;
/*0x0430*/ unsigned int             SitStartTime;
/*0x0434*/ float                    CameraOffset;
/*0x0438*/ unsigned int             NextSwim;
/*0x043c*/ unsigned int             NextIntimidateTime;
/*0x0440*/ int                      Unknown1;
/*0x0444*/ unsigned int             TimeStamp;
/*0x0448*/ uint8_t                  TitleVisible;
/*0x0450*/ int64_t                  HPCurrent;
/*0x0458*/ unsigned int             EnduranceMax;
/*0x045c*/ CPhysicsInfo             LastCollision;
/*0x048c*/ int                      CurrIOState;
/*0x0490*/ bool                     bAttackRelated;
/*0x0494*/ int                      PrimaryTintIndex;
/*0x0498*/ unsigned int             LastResendAddPlayerPacket;
/*0x049c*/ int                      RealEstateItemId;
/*0x04a0*/ unsigned int             SpellCooldownETA;
/*0x04a4*/ int                      DoSpecialMelee;
/*0x04a8*/ uint8_t                  IsPassenger;
/*0x04ac*/ unsigned int             LastTrapDamageTime;
/*0x04b0*/ float                    MyWalkSpeed;
/*0x04b4*/ uint8_t                  CharClass;
/*0x04b5*/ char                     Suffix[0x80];
/*0x0535*/ char                     Title[0x80];
/*0x05b5*/ uint8_t                  HoldingAnimation;
/*0x05b6*/ uint8_t                  Original;
/*0x05b8*/ unsigned int             LastRangedUsedTime;
/*0x05bc*/ int                      ManaMax;
/*0x05c0*/ int                      Unknown4;
/*0x05c4*/ int                      IsAttacking;
/*0x05c8*/ uint8_t                  LastAttack;
/*0x05cc*/ float                    GetMeleeRangeVar1;
/*0x05d0*/ unsigned int             CorpseDragCount;
...
/*0x05f0*/ int                      Buyer;
/*0x05f4*/ bool                     bTempPet;
/*0x05f8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0600*/ int                      Birthdate;
/*0x0604*/ int                      AFK;
/*0x0608*/ int                      Anon;
/*0x060c*/ unsigned int             LastPrimaryUseTime;
/*0x0610*/ unsigned int             RespawnTimer;
/*0x0614*/ bool                     bAlwaysShowAura;
/*0x0618*/ unsigned int**           ppUDP;
/*0x0620*/ int                      WarCry;
/*0x0624*/ int                      Trader;
/*0x0628*/ int                      AltAttack;
/*0x062c*/ uint8_t                  FindBits;
/*0x062d*/ bool                     bStationary;
/*0x062e*/ bool                     LFG;
/*0x0630*/ int                      Unknown3;
/*0x0634*/ float                    ViewHeight;
/*0x0638*/ unsigned int             ACounter;
/*0x063c*/ unsigned int             StunTimer;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2024-07-22 (live) @ 0x1402eb13e
