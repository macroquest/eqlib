...
/*0x01e0*/ CharacterZoneClient*     pCharacter;
/*0x01e8*/ float                    CameraOffset;
/*0x01ec*/ bool                     bStationary;
/*0x01f0*/ unsigned int             MasterID;
/*0x01f4*/ unsigned int             LastRangedUsedTime;
/*0x01f8*/ int                      RealEstateItemId;
/*0x01fc*/ uint8_t                  FD;
/*0x01fd*/ bool                     bSwitchMoved;
/*0x0200*/ unsigned int             CorpseDragCount;
/*0x0204*/ unsigned int             LastTick;
/*0x0208*/ int                      NpcTintIndex;
/*0x020c*/ uint8_t                  FishingEvent;
/*0x020d*/ uint8_t                  Level;
/*0x020e*/ uint8_t                  IsPassenger;
/*0x0210*/ unsigned int             LastTimeStoodStill;
/*0x0214*/ int                      Unknown4;
/*0x0218*/ unsigned int             EnduranceMax;
/*0x021c*/ int                      Trader;
/*0x0220*/ unsigned int             Zone;
/*0x0224*/ bool                     bTempPet;
/*0x0228*/ float                    MyWalkSpeed;
/*0x022c*/ bool                     bBetaBuffed;
/*0x0230*/ int                      berserker;
/*0x0234*/ int                      Birthdate;
/*0x0238*/ int                      WarCry;
/*0x023c*/ int                      Unknown3;
/*0x0240*/ bool                     bSummoned;
/*0x0244*/ unsigned int             LastResendAddPlayerPacket;
/*0x0248*/ int                      ManaMax;
/*0x024c*/ unsigned int             MinuteTimer;
/*0x0250*/ uint8_t                  StandState;
/*0x0251*/ uint8_t                  CharClass;
/*0x0252*/ char                     DragNames[2][0x40];
/*0x02d4*/ int                      Unknown1;
/*0x02d8*/ unsigned int             ACounter;
/*0x02dc*/ int                      PetID;
/*0x02e0*/ int                      RealEstateID;
/*0x02e4*/ bool                     LFG;
/*0x02e8*/ int                      Deity;
/*0x02ec*/ int                      SecondaryTintIndex;
/*0x02f0*/ int64_t                  HPMax;
/*0x02f8*/ float                    MissileRangeToTarget;
/*0x02fc*/ float                    MerchantGreed;
/*0x0300*/ uint8_t                  Light;
/*0x0301*/ EqItemGuid               realEstateItemGuid;
/*0x0314*/ int                      IsAttacking;
/*0x0318*/ unsigned int             LastSecondaryUseTime;
/*0x031c*/ unsigned int             NextSwim;
/*0x0320*/ uint8_t                  LastAttack;
/*0x0324*/ unsigned int             LoginSerial;
/*0x0328*/ uint8_t                  Blind;
/*0x032c*/ int                      ManaCurrent;
/*0x0330*/ unsigned int             LastPrimaryUseTime;
/*0x0334*/ float                    AnimationSpeedRelated;
/*0x0338*/ float                    RunSpeed;
/*0x033c*/ int                      Anon;
/*0x0340*/ unsigned int             SpellCooldownETA;
/*0x0344*/ unsigned int             LastRefresh;
/*0x0348*/ uint8_t                  GMRank;
/*0x034c*/ float                    BearingToTarget;
/*0x0350*/ unsigned int             StunTimer;
/*0x0354*/ unsigned int             SitStartTime;
/*0x0358*/ int                      EnduranceCurrent;
/*0x035c*/ int                      SomeData[2];
/*0x0364*/ bool                     bShowHelm;
/*0x0368*/ LaunchSpellData          CastingData;
/*0x03ac*/ bool                     Sneak;
/*0x03b0*/ unsigned int             FishingETA;
/*0x03b4*/ bool                     bAlwaysShowAura;
/*0x03b8*/ void*                    pRaceGenderInfo;
/*0x03c0*/ uint8_t                  HoldingAnimation;
/*0x03c1*/ bool                     bAttackRelated;
/*0x03c2*/ uint8_t                  TitleVisible;
/*0x03c8*/ int64_t                  HPCurrent;
/*0x03d0*/ bool                     PvPFlag;
/*0x03d4*/ int                      Buyer;
/*0x03d8*/ char                     GM;
/*0x03dc*/ float                    GetMeleeRangeVar1;
/*0x03e0*/ unsigned int             Meditating;
/*0x03e8*/ unsigned int**           ppUDP;
/*0x03f0*/ uint8_t                  FindBits;
/*0x03f1*/ bool                     Mercenary;
/*0x03f2*/ char                     Title[0x80];
/*0x0472*/ bool                     bOfflineMode;
/*0x0478*/ int64_t                  GuildID;
/*0x0480*/ unsigned int             SpellGemETA[15];
/*0x04bc*/ unsigned int             TimeStamp;
/*0x04c0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x04c8*/ CPhysicsInfo             LastCollision;
/*0x04f8*/ int                      DoSpecialMelee;
/*0x04fc*/ bool                     Linkdead;
/*0x0500*/ int                      PrimaryTintIndex;
/*0x0504*/ unsigned int             LastMealTime;
/*0x0508*/ void*                    pTouchingSwitch;
/*0x0510*/ bool                     bAnimationOnPop;
/*0x0511*/ uint8_t                  IntimidateCount;
/*0x0512*/ char                     Handle[0x20];
/*0x0534*/ unsigned int             NextIntimidateTime;
/*0x0538*/ float                    FallingStartZ;
/*0x053c*/ int                      AFK;
/*0x0540*/ uint8_t                  InPvPArea;
/*0x0541*/ char                     DraggingPlayer[0x40];
/*0x0584*/ unsigned int             LastTrapDamageTime;
/*0x0588*/ uint8_t                  Original;
/*0x0589*/ char                     LoginRelated[0x20];
/*0x05ac*/ float                    ViewHeight;
/*0x05b0*/ bool                     bBuffTimersOnHold;
/*0x05b4*/ int                      AltAttack;
/*0x05b8*/ char                     Suffix[0x80];
/*0x0638*/ unsigned int             RespawnTimer;
/*0x063c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
...
// @sizeof(PlayerClient) == 0x1f60 :: 2024-06-24 (live) @ 0x1402e95fe
