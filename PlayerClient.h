...
/*0x01d4*/ int                      Anon;
/*0x01d8*/ CharacterZoneClient*     pCharacter;
/*0x01e0*/ unsigned int             CorpseDragCount;
/*0x01e4*/ int                      Unknown1;
/*0x01e8*/ unsigned int             NextSwim;
/*0x01ec*/ uint8_t                  Blind;
/*0x01f0*/ float                    MyWalkSpeed;
/*0x01f4*/ int                      AltAttack;
/*0x01f8*/ bool                     bSummoned;
/*0x01fc*/ unsigned int             LastSecondaryUseTime;
/*0x0200*/ int64_t                  HPCurrent;
/*0x0208*/ bool                     bOfflineMode;
/*0x020c*/ float                    FallingStartZ;
/*0x0210*/ int                      EnduranceCurrent;
/*0x0214*/ float                    RunSpeed;
/*0x0218*/ int                      WarCry;
/*0x021c*/ unsigned int             EnduranceMax;
/*0x0220*/ int                      RealEstateItemId;
/*0x0224*/ bool                     PvPFlag;
/*0x0228*/ int                      NpcTintIndex;
/*0x022c*/ float                    CameraOffset;
/*0x0230*/ uint8_t                  InPvPArea;
/*0x0234*/ unsigned int             SpellCooldownETA;
/*0x0238*/ int                      PrimaryTintIndex;
/*0x023c*/ unsigned int             Zone;
/*0x0240*/ unsigned int             LoginSerial;
/*0x0244*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x024c*/ unsigned int             SpellGemETA[15];
/*0x0288*/ char                     GM;
/*0x028c*/ int                      ManaMax;
/*0x0290*/ uint8_t                  Light;
/*0x0294*/ unsigned int             RespawnTimer;
/*0x0298*/ char                     Handle[0x20];
/*0x02b8*/ char                     Title[0x80];
/*0x0338*/ uint8_t                  LastAttack;
/*0x0339*/ uint8_t                  TitleVisible;
/*0x033c*/ int                      ManaCurrent;
/*0x0340*/ unsigned int             MasterID;
/*0x0344*/ EqItemGuid               realEstateItemGuid;
/*0x0358*/ unsigned int             SitStartTime;
/*0x035c*/ uint8_t                  Level;
/*0x035d*/ bool                     bAttackRelated;
/*0x0360*/ int                      SomeData[2];
/*0x0368*/ uint8_t                  HoldingAnimation;
/*0x036c*/ unsigned int             LastTrapDamageTime;
/*0x0370*/ int                      PetID;
/*0x0374*/ uint8_t                  IntimidateCount;
/*0x0378*/ int                      berserker;
/*0x037c*/ int                      Buyer;
/*0x0380*/ unsigned int             LastMealTime;
/*0x0384*/ bool                     Linkdead;
/*0x0385*/ bool                     bShowHelm;
/*0x0388*/ void*                    pRaceGenderInfo;
/*0x0390*/ float                    ViewHeight;
/*0x0394*/ bool                     LFG;
/*0x0398*/ unsigned int             LastTick;
/*0x039c*/ uint8_t                  FishingEvent;
/*0x039d*/ char                     DraggingPlayer[0x40];
/*0x03e0*/ unsigned int             Meditating;
/*0x03e4*/ CPhysicsInfo             LastCollision;
/*0x0414*/ int                      SecondaryTintIndex;
/*0x0418*/ uint8_t                  StandState;
/*0x041c*/ LaunchSpellData          CastingData;
/*0x0460*/ char                     LoginRelated[0x20];
/*0x0480*/ uint8_t                  FindBits;
/*0x0484*/ unsigned int             LastPrimaryUseTime;
/*0x0488*/ float                    BearingToTarget;
/*0x048c*/ bool                     bSwitchMoved;
/*0x0490*/ float                    MissileRangeToTarget;
/*0x0494*/ bool                     bTempPet;
/*0x0498*/ float                    MerchantGreed;
/*0x049c*/ int                      DoSpecialMelee;
/*0x04a0*/ bool                     bAlwaysShowAura;
/*0x04a4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x04ac*/ uint8_t                  Original;
/*0x04b0*/ int                      HideMode;
/*0x04b4*/ unsigned int             LastRefresh;
/*0x04b8*/ int                      Deity;
/*0x04bc*/ unsigned int             MinuteTimer;
/*0x04c0*/ int                      CurrIOState;
/*0x04c8*/ SPAWNINFO*               pViewPlayer;
/*0x04d0*/ unsigned int**           ppUDP;
/*0x04d8*/ char                     DragNames[2][0x40];
/*0x0558*/ int64_t                  HPMax;
/*0x0560*/ unsigned int             LastTimeStoodStill;
/*0x0564*/ float                    GetMeleeRangeVar1;
/*0x0568*/ uint8_t                  IsPassenger;
/*0x056c*/ unsigned int             TimeStamp;
/*0x0570*/ uint8_t                  FD;
/*0x0571*/ bool                     bBuffTimersOnHold;
/*0x0574*/ int                      Unknown4;
/*0x0578*/ char                     Suffix[0x80];
/*0x05f8*/ unsigned int             FishingETA;
/*0x05fc*/ bool                     bBetaBuffed;
/*0x05fd*/ bool                     Mercenary;
/*0x0600*/ int                      Trader;
/*0x0604*/ uint8_t                  GMRank;
/*0x0605*/ bool                     bStationary;
/*0x0608*/ unsigned int             StunTimer;
/*0x060c*/ int                      Unknown3;
/*0x0610*/ int                      RealEstateID;
/*0x0614*/ unsigned int             LastResendAddPlayerPacket;
/*0x0618*/ void*                    pTouchingSwitch;
/*0x0620*/ int                      Birthdate;
/*0x0624*/ uint8_t                  CharClass;
/*0x0628*/ unsigned int             NextIntimidateTime;
/*0x062c*/ bool                     bAnimationOnPop;
/*0x0630*/ unsigned int             ACounter;
/*0x0638*/ int64_t                  GuildID;
/*0x0640*/ int                      IsAttacking;
/*0x0644*/ float                    AnimationSpeedRelated;
/*0x0648*/ int                      AFK;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2023-12-13 (test) @ 0x1402e182e
