...
/*0x01d8*/ int64_t                  HPCurrent;
/*0x01e0*/ int                      Birthdate;
/*0x01e4*/ int                      SecondaryTintIndex;
/*0x01e8*/ unsigned int             LastSecondaryUseTime;
/*0x01f0*/ void*                    pRaceGenderInfo;
/*0x01f8*/ uint8_t                  IsPassenger;
/*0x01f9*/ bool                     bTempPet;
/*0x01fa*/ bool                     bSwitchMoved;
/*0x0200*/ unsigned int**           ppUDP;
/*0x0208*/ uint8_t                  Blind;
/*0x020c*/ unsigned int             MasterID;
/*0x0210*/ int64_t                  HPMax;
/*0x0218*/ unsigned int             FishingETA;
/*0x021c*/ unsigned int             NextSwim;
/*0x0220*/ unsigned int             LastRefresh;
/*0x0224*/ unsigned int             LastTrapDamageTime;
/*0x0228*/ unsigned int             NextIntimidateTime;
/*0x022c*/ bool                     bShowHelm;
/*0x022d*/ char                     Suffix[0x80];
/*0x02b0*/ unsigned int             StunTimer;
/*0x02b8*/ CharacterZoneClient*     pCharacter;
/*0x02c0*/ unsigned int             EnduranceMax;
/*0x02c4*/ char                     LoginRelated[0x20];
/*0x02e4*/ int                      Deity;
/*0x02e8*/ unsigned int             CorpseDragCount;
/*0x02ec*/ uint8_t                  Original;
/*0x02f0*/ unsigned int             SitStartTime;
/*0x02f4*/ int                      PrimaryTintIndex;
/*0x02f8*/ SPAWNINFO*               pViewPlayer;
/*0x0300*/ uint8_t                  StandState;
/*0x0301*/ char                     GM;
/*0x0302*/ char                     Handle[0x20];
/*0x0324*/ CPhysicsInfo             LastCollision;
/*0x0354*/ int                      Anon;
/*0x0358*/ uint8_t                  FD;
/*0x0359*/ bool                     bAnimationOnPop;
/*0x035c*/ int                      CurrIOState;
/*0x0360*/ unsigned int             SpellGemETA[15];
/*0x039c*/ bool                     LFG;
/*0x039d*/ uint8_t                  FishingEvent;
/*0x039e*/ uint8_t                  IntimidateCount;
/*0x03a0*/ void*                    pTouchingSwitch;
/*0x03a8*/ int                      SomeData[2];
/*0x03b0*/ char                     DragNames[2][0x40];
/*0x0430*/ unsigned int             LastTick;
/*0x0434*/ unsigned int             LastMealTime;
/*0x0438*/ bool                     bSummoned;
/*0x043c*/ int                      ManaCurrent;
/*0x0440*/ int                      PetID;
/*0x0444*/ float                    MyWalkSpeed;
/*0x0448*/ unsigned int             ACounter;
/*0x044c*/ float                    ViewHeight;
/*0x0450*/ unsigned int             LastTimeStoodStill;
/*0x0454*/ int                      berserker;
/*0x0458*/ uint8_t                  HoldingAnimation;
/*0x045c*/ unsigned int             TimeStamp;
/*0x0460*/ int                      HideMode;
/*0x0464*/ int                      RealEstateItemId;
/*0x0468*/ float                    MissileRangeToTarget;
/*0x046c*/ uint8_t                  GMRank;
/*0x0470*/ float                    AnimationSpeedRelated;
/*0x0474*/ int                      Unknown4;
/*0x0478*/ int                      AFK;
/*0x047c*/ int                      AltAttack;
/*0x0480*/ uint8_t                  CharClass;
/*0x0484*/ int                      NpcTintIndex;
/*0x0488*/ uint8_t                  Level;
/*0x048c*/ int                      Trader;
/*0x0490*/ int                      Unknown3;
/*0x0494*/ int                      WarCry;
/*0x0498*/ uint8_t                  InPvPArea;
/*0x049c*/ unsigned int             LoginSerial;
/*0x04a0*/ bool                     PvPFlag;
/*0x04a4*/ unsigned int             Meditating;
/*0x04a8*/ bool                     bOfflineMode;
/*0x04ac*/ unsigned int             LastRangedUsedTime;
/*0x04b0*/ int                      IsAttacking;
/*0x04b8*/ int64_t                  GuildID;
/*0x04c0*/ char                     DraggingPlayer[0x40];
/*0x0500*/ bool                     Mercenary;
/*0x0504*/ float                    MerchantGreed;
/*0x0508*/ bool                     Linkdead;
/*0x050c*/ int                      DoSpecialMelee;
/*0x0510*/ int                      RealEstateID;
/*0x0514*/ float                    BearingToTarget;
/*0x0518*/ float                    FallingStartZ;
/*0x051c*/ uint8_t                  Light;
/*0x051d*/ bool                     bStationary;
/*0x0520*/ int                      EnduranceCurrent;
/*0x0524*/ int                      Unknown1;
/*0x0528*/ bool                     bAlwaysShowAura;
/*0x052c*/ unsigned int             SpellCooldownETA;
/*0x0530*/ float                    RunSpeed;
/*0x0534*/ float                    CameraOffset;
/*0x0538*/ bool                     bAttackRelated;
/*0x053c*/ float                    GetMeleeRangeVar1;
/*0x0540*/ unsigned int             RespawnTimer;
/*0x0544*/ char                     Title[0x80];
/*0x05c4*/ unsigned int             MinuteTimer;
/*0x05c8*/ uint8_t                  LastAttack;
/*0x05c9*/ uint8_t                  FindBits;
/*0x05cc*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05d4*/ uint8_t                  TitleVisible;
/*0x05d8*/ unsigned int             LastPrimaryUseTime;
/*0x05dc*/ int                      ManaMax;
/*0x05e0*/ unsigned int             Zone;
/*0x05e4*/ EqItemGuid               realEstateItemGuid;
/*0x05f8*/ unsigned int             LastResendAddPlayerPacket;
/*0x05fc*/ int                      Buyer;
/*0x0600*/ LaunchSpellData          CastingData;
/*0x0644*/ bool                     bBuffTimersOnHold;
/*0x0645*/ bool                     bBetaBuffed;
/*0x0646*/ bool                     Sneak;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-01-23 (test) @ 0x1402e294e
