...
/*0x01c0*/ char                     LoginRelated[0x20];
/*0x01e0*/ unsigned int             LastRefresh;                  // last 18 sec tick
/*0x01e4*/ unsigned int             SpellGemETA[0xf];             // InnateETA is now the last member in this array
/*0x0220*/ bool                     bSummoned;                    // by a PC or by anyone? need to investigate
/*0x0221*/ uint8_t                  Level;
/*0x0228*/ int64_t                  HPMax;
/*0x0230*/ bool                     Mercenary;
/*0x0238*/ unsigned int**           ppUDP;                        // UdpLibrary::UdpConnection
/*0x0240*/ float                    MerchantGreed;
/*0x0244*/ bool                     bSwitchMoved;                 // true when a door moves near the spawn
/*0x0245*/ uint8_t                  LastAttack;
/*0x0248*/ unsigned int             Meditating;
/*0x024c*/ LaunchSpellData          CastingData;                  // size: 0x58
/*0x02a4*/ int                      PrimaryTintIndex;
/*0x02a8*/ int                      CurrIOState;
/*0x02ac*/ float                    ViewHeight;
/*0x02b0*/ char                     Suffix[0x80];
/*0x0330*/ bool                     bOfflineMode;
/*0x0331*/ uint8_t                  StandState;
/*0x0334*/ unsigned int             ACounter;                     // not sure what this one is for (m_uHibernatingCount)
/*0x0338*/ unsigned int             Zone;
/*0x033c*/ int                      SomethingElse;
/*0x0340*/ unsigned int             LastPrimaryUseTime;
/*0x0344*/ bool                     Sneak;
/*0x0345*/ uint8_t                  Light;
/*0x0348*/ unsigned int             LastTick;
/*0x034c*/ char                     Title[0x80];
/*0x03cc*/ int                      ManaCurrent;
/*0x03d0*/ uint8_t                  FindBits;
/*0x03d1*/ uint8_t                  IntimidateCount;
/*0x03d4*/ float                    MyWalkSpeed;
/*0x03d8*/ bool                     bAlwaysShowAura;
/*0x03dc*/ float                    FallingStartZ;
/*0x03e0*/ CharacterZoneClient*     pCharacter;
/*0x03e8*/ uint8_t                  GMRank;
/*0x03e9*/ uint8_t                  HoldingAnimation;             // todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7
/*0x03ea*/ bool                     bAnimationOnPop;
/*0x03f0*/ SPAWNINFO*               pViewPlayer;
/*0x03f8*/ uint8_t                  Type2;
/*0x03fc*/ int                      Deity;
/*0x0400*/ int                      SomeData[0x2];
/*0x0408*/ bool                     bShowHelm;
/*0x040c*/ unsigned int             CorpseDragCount;
/*0x0410*/ uint8_t                  CharClass;                    // Im pretty sure this isnt working
/*0x0414*/ int                      Buyer;
/*0x0418*/ unsigned int             MasterID;
/*0x041c*/ int                      IsAttacking;                  // need to investigate
/*0x0420*/ CPhysicsInfo             LastCollision;
/*0x0450*/ unsigned int             RespawnTimer;                 // its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive
/*0x0454*/ uint8_t                  InPvPArea;                    // are we in a PvP area?
/*0x0455*/ bool                     PvPFlag;
/*0x0458*/ void*                    pRaceGenderInfo;              // todo this is not a void* so... map the CRaceGenderInfo class
/*0x0460*/ int                      PetID;
/*0x0464*/ EqItemGuid               realEstateItemGuid;
/*0x0478*/ unsigned int             LastResendAddPlayerPacket;
/*0x047c*/ int                      RealEstateID;
/*0x0480*/ unsigned int             SpellCooldownETA;
/*0x0484*/ unsigned int             LastCastTime;
/*0x0488*/ unsigned int             LastSecondaryUseTime;
/*0x048c*/ int                      berserker;
/*0x0490*/ int                      Anon;                         // found in EQPlayer__SetNameSpriteTint_x
/*0x0494*/ uint8_t                  IsPassenger;                  // if u are on a boat or airship or whatever
/*0x0495*/ bool                     LFG;
/*0x0498*/ unsigned int             TimeStamp;                    // updates all the time including when on a mount
/*0x049c*/ int                      SecondaryTintIndex;
/*0x04a0*/ unsigned int             SitStartTime;
/*0x04a4*/ int                      AFK;
/*0x04a8*/ unsigned int             LastRangedUsedTime;
/*0x04ac*/ unsigned int             LastTrapDamageTime;
/*0x04b0*/ char                     DragNames[0x2][0x40];
/*0x0530*/ float                    GetMeleeRangeVar1;            // used by GetMeleeRange (fScaleFactor)
/*0x0534*/ bool                     bStationary;
/*0x0538*/ unsigned int             LoginSerial;
/*0x053c*/ uint8_t                  FD;
/*0x053d*/ bool                     bAttackRelated;
/*0x0540*/ int                      NpcTintIndex;
/*0x0544*/ int                      AARank;                       // this really is the title id
/*0x0548*/ int                      LastCastNum;
/*0x054c*/ unsigned int             CombatSkillTicks[0x2];
/*0x0554*/ float                    MissileRangeToTarget;
/*0x0558*/ void*                    pTouchingSwitch;              // need to get that in here : struct _EQSWITCH
/*0x0560*/ unsigned int             NextSwim;
/*0x0564*/ unsigned int             NextIntimidateTime;
/*0x0568*/ unsigned int             LastTimeStoodStill;
/*0x056c*/ int                      Dontknowyet2;
/*0x0570*/ int                      DoSpecialMelee;
/*0x0574*/ float                    BearingToTarget;
/*0x0578*/ unsigned int             StunTimer;
/*0x057c*/ bool                     Linkdead;
/*0x0580*/ int64_t                  HPCurrent;
/*0x0588*/ int                      Stuff;
/*0x058c*/ char                     Handle[0x20];
/*0x05ac*/ unsigned int             FishingETA;
/*0x05b0*/ int                      Trader;                       // found in CEverQuest__RightClickedOnPlayer_x
/*0x05b4*/ int                      RealEstateItemId;
/*0x05b8*/ unsigned int             LastMealTime;                 // last time we eat or drank
/*0x05bc*/ unsigned int             MinuteTimer;
/*0x05c0*/ bool                     bBuffTimersOnHold;            // no you can't control this client side so unless you want to get banned leave it alone
/*0x05c4*/ int                      WarCry;
/*0x05c8*/ char                     DraggingPlayer[0x40];
/*0x0608*/ int                      AltAttack;
/*0x060c*/ uint8_t                  HmmWhat;
/*0x060d*/ char                     GM;
/*0x0610*/ float                    RunSpeed;                     // 0.70 on runspeed 5...
/*0x0614*/ unsigned int             CombatSkillUsed[0x2];
/*0x061c*/ uint8_t                  FishingEvent;
/*0x0620*/ int                      DontKnowYet;
/*0x0624*/ int                      EnduranceCurrent;
/*0x0628*/ float                    CameraOffset;
/*0x062c*/ int                      HideMode;
/*0x0630*/ int                      ManaMax;
/*0x0634*/ uint8_t                  Blind;
/*0x0635*/ bool                     bBetaBuffed;
/*0x0636*/ bool                     bTempPet;
/*0x0637*/ uint8_t                  TitleVisible;
/*0x0638*/ int64_t                  GuildID;
/*0x0640*/ unsigned int             EnduranceMax;
...
// @sizeof(PlayerClient) == 0x1F70 :: 2022-02-23 (test) @ 0x140319DAE
...
/*0x1344*/ bool              bRemoveCorpseAfterDeathAnim;  // 0x1274 for sure used by /hidecorpse
...
/*0x1ed8*/ unsigned int      LastHistorySentTime;
