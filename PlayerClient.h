...
/*0x01cc*/ unsigned int             RespawnTimer;
/*0x01d0*/ uint8_t                  Level;
/*0x01d4*/ float                    BearingToTarget;
/*0x01d8*/ CharacterZoneClient*     pCharacter;
/*0x01e0*/ float                    MissileRangeToTarget;
/*0x01e4*/ char                     Title[0x80];
/*0x0264*/ uint8_t                  LastAttack;
/*0x0265*/ bool                     bSwitchMoved;
/*0x0268*/ int                      Unknown1;
/*0x026c*/ int                      PrimaryTintIndex;
/*0x0270*/ int                      WarCry;
/*0x0274*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x027c*/ int                      AltAttack;
/*0x0280*/ int                      ManaCurrent;
/*0x0288*/ int64_t                  HPMax;
/*0x0290*/ int                      SecondaryTintIndex;
/*0x0294*/ unsigned int             CorpseDragCount;
/*0x0298*/ bool                     Sneak;
/*0x029c*/ float                    FallingStartZ;
/*0x02a0*/ uint8_t                  FindBits;
/*0x02a4*/ unsigned int             LastPrimaryUseTime;
/*0x02a8*/ char                     Handle[0x20];
/*0x02c8*/ int                      RealEstateID;
/*0x02cc*/ float                    AnimationSpeedRelated;
/*0x02d0*/ int                      HideMode;
/*0x02d4*/ uint8_t                  IntimidateCount;
/*0x02d8*/ float                    GetMeleeRangeVar1;
/*0x02dc*/ int                      RealEstateItemId;
/*0x02e0*/ unsigned int             TimeStamp;
/*0x02e4*/ uint8_t                  GMRank;
/*0x02e5*/ bool                     PvPFlag;
/*0x02e8*/ int                      DoSpecialMelee;
/*0x02ec*/ unsigned int             StunTimer;
/*0x02f0*/ bool                     bAlwaysShowAura;
/*0x02f4*/ unsigned int             NextSwim;
/*0x02f8*/ uint8_t                  InPvPArea;
/*0x02fc*/ int                      Unknown4;
/*0x0300*/ char                     DragNames[2][0x40];
/*0x0380*/ float                    RunSpeed;
/*0x0384*/ bool                     bTempPet;
/*0x0388*/ int                      berserker;
/*0x038c*/ unsigned int             FishingETA;
/*0x0390*/ uint8_t                  Original;
/*0x0394*/ int                      ManaMax;
/*0x0398*/ char                     LoginRelated[0x20];
/*0x03b8*/ unsigned int             MasterID;
/*0x03bc*/ char                     GM;
/*0x03c0*/ SPAWNINFO*               pViewPlayer;
/*0x03c8*/ int                      PetID;
/*0x03cc*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03d4*/ unsigned int             LoginSerial;
/*0x03d8*/ int                      Anon;
/*0x03dc*/ CPhysicsInfo             LastCollision;
/*0x040c*/ float                    MyWalkSpeed;
/*0x0410*/ unsigned int             EnduranceMax;
/*0x0414*/ unsigned int             NextIntimidateTime;
/*0x0418*/ bool                     bBetaBuffed;
/*0x0419*/ uint8_t                  FishingEvent;
/*0x041a*/ bool                     Linkdead;
/*0x041b*/ uint8_t                  Blind;
/*0x041c*/ int                      Birthdate;
/*0x0420*/ bool                     bAttackRelated;
/*0x0424*/ unsigned int             ACounter;
/*0x0428*/ uint8_t                  Light;
/*0x042c*/ unsigned int             LastTimeStoodStill;
/*0x0430*/ char                     Suffix[0x80];
/*0x04b0*/ void*                    pTouchingSwitch;
/*0x04b8*/ unsigned int             SpellGemETA[15];
/*0x04f4*/ int                      CurrIOState;
/*0x04f8*/ int                      NpcTintIndex;
/*0x04fc*/ int                      Unknown3;
/*0x0500*/ bool                     bOfflineMode;
/*0x0504*/ unsigned int             LastResendAddPlayerPacket;
/*0x0508*/ unsigned int             SpellCooldownETA;
/*0x050c*/ unsigned int             Meditating;
/*0x0510*/ uint8_t                  TitleVisible;
/*0x0514*/ float                    ViewHeight;
/*0x0518*/ bool                     bStationary;
/*0x051c*/ int                      IsAttacking;
/*0x0520*/ unsigned int             LastMealTime;
/*0x0524*/ uint8_t                  StandState;
/*0x0528*/ unsigned int             SitStartTime;
/*0x052c*/ unsigned int             Zone;
/*0x0530*/ int64_t                  HPCurrent;
/*0x0538*/ LaunchSpellData          CastingData;
/*0x057c*/ unsigned int             LastRangedUsedTime;
/*0x0580*/ uint8_t                  FD;
/*0x0581*/ uint8_t                  CharClass;
/*0x0584*/ int                      SomeData[2];
/*0x058c*/ bool                     Mercenary;
/*0x058d*/ bool                     bSummoned;
/*0x058e*/ bool                     bShowHelm;
/*0x0590*/ int64_t                  GuildID;
/*0x0598*/ int                      Deity;
/*0x059c*/ float                    MerchantGreed;
/*0x05a0*/ unsigned int             MinuteTimer;
/*0x05a4*/ int                      EnduranceCurrent;
/*0x05a8*/ bool                     bBuffTimersOnHold;
/*0x05ac*/ unsigned int             LastTrapDamageTime;
/*0x05b0*/ uint8_t                  IsPassenger;
/*0x05b4*/ int                      AFK;
/*0x05b8*/ float                    CameraOffset;
/*0x05bc*/ unsigned int             LastTick;
/*0x05c0*/ bool                     LFG;
/*0x05c8*/ unsigned int**           ppUDP;
/*0x05d0*/ void*                    pRaceGenderInfo;
/*0x05d8*/ char                     DraggingPlayer[0x40];
/*0x0618*/ bool                     bAnimationOnPop;
/*0x0619*/ EqItemGuid               realEstateItemGuid;
/*0x062b*/ uint8_t                  HoldingAnimation;
/*0x062c*/ unsigned int             LastRefresh;
/*0x0630*/ unsigned int             LastSecondaryUseTime;
/*0x0634*/ int                      Trader;
/*0x0638*/ int                      Buyer;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-08-14 (live) @ 0x1402de03e
