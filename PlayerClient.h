...
/*0x01cc*/ float                    FallingStartZ;
/*0x01d0*/ int                      RealEstateItemId;
/*0x01d4*/ int                      PrimaryTintIndex;
/*0x01d8*/ int                      Deity;
/*0x01dc*/ float                    RunSpeed;
/*0x01e0*/ CharacterZoneClient*     pCharacter;
/*0x01e8*/ int                      DoSpecialMelee;
/*0x01ec*/ unsigned int             SpellGemETA[15];
/*0x0228*/ int                      ManaMax;
/*0x022c*/ int                      Anon;
/*0x0230*/ uint8_t                  FishingEvent;
/*0x0234*/ unsigned int             TimeStamp;
/*0x0238*/ bool                     bOfflineMode;
/*0x023c*/ unsigned int             SpellCooldownETA;
/*0x0240*/ int                      IsAttacking;
/*0x0248*/ int64_t                  GuildID;
/*0x0250*/ int                      Buyer;
/*0x0258*/ SPAWNINFO*               pViewPlayer;
/*0x0260*/ uint8_t                  IntimidateCount;
/*0x0261*/ bool                     bTempPet;
/*0x0264*/ unsigned int             LastMealTime;
/*0x0268*/ int                      HideMode;
/*0x026c*/ int                      SecondaryTintIndex;
/*0x0270*/ void*                    pTouchingSwitch;
/*0x0278*/ int64_t                  HPCurrent;
/*0x0280*/ float                    CameraOffset;
/*0x0284*/ float                    AnimationSpeedRelated;
/*0x0288*/ char                     Title[0x80];
/*0x0308*/ bool                     bBuffTimersOnHold;
/*0x030c*/ unsigned int             LoginSerial;
/*0x0310*/ int                      Birthdate;
/*0x0314*/ unsigned int             LastRangedUsedTime;
/*0x0318*/ unsigned int             SitStartTime;
/*0x031c*/ int                      RealEstateID;
/*0x0320*/ char                     LoginRelated[0x20];
/*0x0340*/ bool                     PvPFlag;
/*0x0344*/ int                      berserker;
/*0x0348*/ unsigned int             NextIntimidateTime;
/*0x034c*/ unsigned int             FishingETA;
/*0x0350*/ unsigned int**           ppUDP;
/*0x0358*/ char                     Suffix[0x80];
/*0x03d8*/ bool                     Linkdead;
/*0x03dc*/ float                    BearingToTarget;
/*0x03e0*/ uint8_t                  FindBits;
/*0x03e4*/ unsigned int             MasterID;
/*0x03e8*/ uint8_t                  Original;
/*0x03ec*/ float                    MerchantGreed;
/*0x03f0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03f8*/ uint8_t                  StandState;
/*0x03f9*/ bool                     Sneak;
/*0x03fa*/ char                     DraggingPlayer[0x40];
/*0x043c*/ int                      SomeData[2];
/*0x0444*/ unsigned int             ACounter;
/*0x0448*/ uint8_t                  FD;
/*0x0449*/ uint8_t                  Light;
/*0x044a*/ bool                     bShowHelm;
/*0x044c*/ int                      EnduranceCurrent;
/*0x0450*/ float                    MyWalkSpeed;
/*0x0454*/ uint8_t                  TitleVisible;
/*0x0455*/ char                     DragNames[2][0x40];
/*0x04d5*/ bool                     bAttackRelated;
/*0x04d6*/ bool                     bAlwaysShowAura;
/*0x04d7*/ uint8_t                  IsPassenger;
/*0x04d8*/ float                    GetMeleeRangeVar1;
/*0x04dc*/ CPhysicsInfo             LastCollision;
/*0x050c*/ int                      Unknown4;
/*0x0510*/ int                      WarCry;
/*0x0514*/ int                      ManaCurrent;
/*0x0518*/ uint8_t                  LastAttack;
/*0x051c*/ unsigned int             StunTimer;
/*0x0520*/ uint8_t                  HoldingAnimation;
/*0x0524*/ int                      NpcTintIndex;
/*0x0528*/ bool                     bStationary;
/*0x052c*/ unsigned int             LastTick;
/*0x0530*/ bool                     bSummoned;
/*0x0531*/ bool                     bSwitchMoved;
/*0x0534*/ unsigned int             LastTrapDamageTime;
/*0x0538*/ uint8_t                  GMRank;
/*0x0539*/ bool                     bAnimationOnPop;
/*0x053c*/ unsigned int             RespawnTimer;
/*0x0540*/ float                    MissileRangeToTarget;
/*0x0544*/ unsigned int             LastSecondaryUseTime;
/*0x0548*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0550*/ float                    ViewHeight;
/*0x0554*/ int                      Trader;
/*0x0558*/ unsigned int             CorpseDragCount;
/*0x055c*/ bool                     LFG;
/*0x055d*/ EqItemGuid               realEstateItemGuid;
/*0x0570*/ int                      AltAttack;
/*0x0574*/ unsigned int             MinuteTimer;
/*0x0578*/ uint8_t                  Blind;
/*0x0579*/ bool                     Mercenary;
/*0x057c*/ int                      Unknown3;
/*0x0580*/ uint8_t                  InPvPArea;
/*0x0584*/ unsigned int             EnduranceMax;
/*0x0588*/ int                      CurrIOState;
/*0x058c*/ unsigned int             Meditating;
/*0x0590*/ unsigned int             LastPrimaryUseTime;
/*0x0594*/ uint8_t                  Level;
/*0x0598*/ int64_t                  HPMax;
/*0x05a0*/ unsigned int             LastRefresh;
/*0x05a4*/ LaunchSpellData          CastingData;
/*0x05e8*/ unsigned int             NextSwim;
/*0x05ec*/ unsigned int             LastResendAddPlayerPacket;
/*0x05f0*/ uint8_t                  CharClass;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2024-04-08 (test) @ 0x1402e7e9e
