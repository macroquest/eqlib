...
/*0x01cc*/ bool                     bSwitchMoved;
/*0x01cd*/ bool                     bBuffTimersOnHold;
/*0x01ce*/ char                     Handle[0x20];
/*0x01ee*/ bool                     bAnimationOnPop;
/*0x01ef*/ uint8_t                  InPvPArea;
/*0x01f0*/ uint8_t                  GMRank;
/*0x01f8*/ CharacterZoneClient*     pCharacter;
/*0x0200*/ uint8_t                  FishingEvent;
/*0x0204*/ unsigned int             Zone;
/*0x0208*/ unsigned int             LastTick;
/*0x020c*/ unsigned int             Meditating;
/*0x0210*/ unsigned int             LoginSerial;
/*0x0214*/ float                    ViewHeight;
/*0x0218*/ float                    CameraOffset;
/*0x021c*/ bool                     bSummoned;
/*0x0220*/ unsigned int             LastTimeStoodStill;
/*0x0224*/ int                      DoSpecialMelee;
/*0x0228*/ bool                     bAlwaysShowAura;
/*0x022c*/ int                      AltAttack;
/*0x0230*/ EqItemGuid               realEstateItemGuid;
/*0x0242*/ uint8_t                  CharClass;
/*0x0243*/ bool                     bShowHelm;
/*0x0244*/ unsigned int             FishingETA;
/*0x0248*/ uint8_t                  TitleVisible;
/*0x0249*/ bool                     Mercenary;
/*0x024c*/ LaunchSpellData          CastingData;
/*0x0290*/ unsigned int             LastRefresh;
/*0x0294*/ int                      SecondaryTintIndex;
/*0x0298*/ unsigned int             SitStartTime;
/*0x029c*/ int                      EnduranceCurrent;
/*0x02a0*/ unsigned int             RespawnTimer;
/*0x02a4*/ bool                     bStationary;
/*0x02a5*/ uint8_t                  LastAttack;
/*0x02a8*/ float                    BearingToTarget;
/*0x02ac*/ float                    RunSpeed;
/*0x02b0*/ unsigned int             MasterID;
/*0x02b4*/ char                     LoginRelated[0x20];
/*0x02d4*/ uint8_t                  Original;
/*0x02d8*/ int                      RealEstateID;
/*0x02dc*/ bool                     LFG;
/*0x02e0*/ unsigned int             ACounter;
/*0x02e4*/ bool                     Sneak;
/*0x02e5*/ uint8_t                  FD;
/*0x02e8*/ int64_t                  HPCurrent;
/*0x02f0*/ int                      berserker;
/*0x02f4*/ int                      Anon;
/*0x02f8*/ unsigned int             LastTrapDamageTime;
/*0x02fc*/ uint8_t                  Level;
/*0x0300*/ void*                    pRaceGenderInfo;
/*0x0308*/ int                      Trader;
/*0x030c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0314*/ uint8_t                  Light;
/*0x0315*/ char                     Title[0x80];
/*0x0398*/ unsigned int             SpellGemETA[15];
/*0x03d4*/ int                      PetID;
/*0x03d8*/ unsigned int             MinuteTimer;
/*0x03dc*/ int                      NpcTintIndex;
/*0x03e0*/ unsigned int             CorpseDragCount;
/*0x03e4*/ bool                     PvPFlag;
/*0x03e8*/ float                    FallingStartZ;
/*0x03ec*/ int                      HideMode;
/*0x03f0*/ char                     GM;
/*0x03f1*/ bool                     Linkdead;
/*0x03f4*/ float                    MerchantGreed;
/*0x03f8*/ int                      ManaMax;
/*0x03fc*/ unsigned int             LastMealTime;
/*0x0400*/ unsigned int             LastRangedUsedTime;
/*0x0404*/ unsigned int             TimeStamp;
/*0x0408*/ bool                     bTempPet;
/*0x040c*/ float                    MissileRangeToTarget;
/*0x0410*/ uint8_t                  HoldingAnimation;
/*0x0414*/ int                      Birthdate;
/*0x0418*/ uint8_t                  Blind;
/*0x041c*/ int                      Unknown1;
/*0x0420*/ int                      IsAttacking;
/*0x0424*/ char                     DragNames[2][0x40];
/*0x04a4*/ uint8_t                  IsPassenger;
/*0x04a8*/ unsigned int             LastResendAddPlayerPacket;
/*0x04ac*/ float                    MyWalkSpeed;
/*0x04b0*/ char                     DraggingPlayer[0x40];
/*0x04f0*/ unsigned int             LastSecondaryUseTime;
/*0x04f4*/ int                      RealEstateItemId;
/*0x04f8*/ int                      Unknown3;
/*0x04fc*/ unsigned int             LastPrimaryUseTime;
/*0x0500*/ uint8_t                  StandState;
/*0x0501*/ bool                     bOfflineMode;
/*0x0508*/ int64_t                  GuildID;
/*0x0510*/ unsigned int             EnduranceMax;
/*0x0514*/ unsigned int             NextSwim;
/*0x0518*/ int                      ManaCurrent;
/*0x051c*/ int                      Buyer;
/*0x0520*/ int                      Deity;
/*0x0524*/ int                      CurrIOState;
/*0x0528*/ uint8_t                  FindBits;
/*0x052c*/ int                      Unknown4;
/*0x0530*/ unsigned int             SpellCooldownETA;
/*0x0538*/ void*                    pTouchingSwitch;
/*0x0540*/ bool                     bAttackRelated;
/*0x0544*/ unsigned int             StunTimer;
/*0x0548*/ SPAWNINFO*               pViewPlayer;
/*0x0550*/ uint8_t                  IntimidateCount;
/*0x0554*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x055c*/ char                     Suffix[0x80];
/*0x05dc*/ int                      PrimaryTintIndex;
/*0x05e0*/ unsigned int**           ppUDP;
/*0x05e8*/ int                      AFK;
/*0x05ec*/ float                    AnimationSpeedRelated;
/*0x05f0*/ float                    GetMeleeRangeVar1;
/*0x05f4*/ unsigned int             NextIntimidateTime;
/*0x05f8*/ int                      WarCry;
/*0x05fc*/ bool                     bBetaBuffed;
/*0x0600*/ int                      SomeData[2];
/*0x0608*/ int64_t                  HPMax;
/*0x0610*/ CPhysicsInfo             LastCollision;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-05-09 (test) @ 0x140300e4e
