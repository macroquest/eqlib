...
/*0x01d0*/ int64_t                  HPCurrent;
/*0x01d8*/ unsigned int             LastRefresh;
/*0x01dc*/ bool                     bAnimationOnPop;
/*0x01e0*/ CharacterZoneClient*     pCharacter;
/*0x01e8*/ unsigned int             TimeStamp;
/*0x01ec*/ unsigned int             LastPrimaryUseTime;
/*0x01f0*/ int                      Deity;
/*0x01f8*/ void*                    pTouchingSwitch;
/*0x0200*/ uint8_t                  Original;
/*0x0201*/ bool                     Mercenary;
/*0x0202*/ uint8_t                  StandState;
/*0x0203*/ bool                     bTempPet;
/*0x0208*/ int64_t                  GuildID;
/*0x0210*/ bool                     bAttackRelated;
/*0x0211*/ bool                     Linkdead;
/*0x0214*/ unsigned int             SpellCooldownETA;
/*0x0218*/ unsigned int             LastMealTime;
/*0x021c*/ uint8_t                  Light;
/*0x0220*/ int                      NpcTintIndex;
/*0x0224*/ float                    ViewHeight;
/*0x0228*/ bool                     bBuffTimersOnHold;
/*0x0229*/ EqItemGuid               realEstateItemGuid;
/*0x023c*/ float                    GetMeleeRangeVar1;
/*0x0240*/ uint8_t                  HoldingAnimation;
/*0x0241*/ uint8_t                  InPvPArea;
/*0x0244*/ unsigned int             StunTimer;
/*0x0248*/ bool                     PvPFlag;
/*0x024c*/ float                    MerchantGreed;
/*0x0250*/ unsigned int             LastTick;
/*0x0254*/ int                      DoSpecialMelee;
/*0x0258*/ bool                     bStationary;
/*0x025c*/ unsigned int             NextSwim;
/*0x0260*/ CPhysicsInfo             LastCollision;
/*0x0290*/ int                      Buyer;
/*0x0294*/ uint8_t                  TitleVisible;
/*0x0298*/ float                    FallingStartZ;
/*0x02a0*/ unsigned int**           ppUDP;
/*0x02a8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x02b0*/ char                     LoginRelated[0x20];
/*0x02d0*/ unsigned int             FishingETA;
/*0x02d4*/ uint8_t                  GMRank;
/*0x02d8*/ int                      Trader;
/*0x02dc*/ int                      Anon;
/*0x02e0*/ uint8_t                  FishingEvent;
/*0x02e4*/ unsigned int             Zone;
/*0x02e8*/ bool                     bSwitchMoved;
/*0x02e9*/ bool                     bOfflineMode;
/*0x02ec*/ float                    CameraOffset;
/*0x02f0*/ unsigned int             LastSecondaryUseTime;
/*0x02f4*/ bool                     Sneak;
/*0x02f5*/ char                     DragNames[2][0x40];
/*0x0378*/ unsigned int             LoginSerial;
/*0x037c*/ char                     DraggingPlayer[0x40];
/*0x03bc*/ bool                     bAlwaysShowAura;
/*0x03bd*/ bool                     bBetaBuffed;
/*0x03c0*/ int                      Unknown4;
/*0x03c4*/ char                     Suffix[0x80];
/*0x0444*/ float                    RunSpeed;
/*0x0448*/ char                     GM;
/*0x0449*/ bool                     bSummoned;
/*0x044c*/ int                      ManaCurrent;
/*0x0450*/ uint8_t                  CharClass;
/*0x0454*/ unsigned int             MasterID;
/*0x0458*/ int                      PrimaryTintIndex;
/*0x045c*/ char                     Title[0x80];
/*0x04dc*/ unsigned int             LastTimeStoodStill;
/*0x04e0*/ int                      SomeData[2];
/*0x04e8*/ int                      AFK;
/*0x04ec*/ unsigned int             ACounter;
/*0x04f0*/ unsigned int             Meditating;
/*0x04f4*/ unsigned int             MinuteTimer;
/*0x04f8*/ unsigned int             EnduranceMax;
/*0x04fc*/ uint8_t                  FD;
/*0x04fd*/ uint8_t                  IntimidateCount;
/*0x0500*/ float                    AnimationSpeedRelated;
/*0x0504*/ uint8_t                  Level;
/*0x0505*/ bool                     bShowHelm;
/*0x0508*/ unsigned int             CorpseDragCount;
/*0x050c*/ char                     Handle[0x20];
/*0x052c*/ int                      IsAttacking;
/*0x0530*/ unsigned int             LastRangedUsedTime;
/*0x0538*/ int64_t                  HPMax;
/*0x0540*/ void*                    pRaceGenderInfo;
/*0x0548*/ int                      Unknown1;
/*0x054c*/ int                      PetID;
/*0x0550*/ unsigned int             LastResendAddPlayerPacket;
/*0x0554*/ int                      WarCry;
/*0x0558*/ unsigned int             SpellGemETA[15];
/*0x0594*/ int                      RealEstateItemId;
/*0x0598*/ int                      AltAttack;
/*0x059c*/ int                      Unknown3;
/*0x05a0*/ float                    MissileRangeToTarget;
/*0x05a4*/ unsigned int             SitStartTime;
/*0x05a8*/ int                      HideMode;
/*0x05ac*/ int                      RealEstateID;
/*0x05b0*/ int                      EnduranceCurrent;
/*0x05b4*/ unsigned int             RespawnTimer;
/*0x05b8*/ float                    BearingToTarget;
/*0x05bc*/ int                      CurrIOState;
/*0x05c0*/ unsigned int             NextIntimidateTime;
/*0x05c4*/ LaunchSpellData          CastingData;
/*0x0608*/ bool                     LFG;
/*0x0610*/ SPAWNINFO*               pViewPlayer;
/*0x0618*/ int                      SecondaryTintIndex;
/*0x061c*/ unsigned int             LastTrapDamageTime;
/*0x0620*/ int                      berserker;
/*0x0624*/ int                      ManaMax;
/*0x0628*/ uint8_t                  FindBits;
/*0x062c*/ float                    MyWalkSpeed;
/*0x0630*/ uint8_t                  LastAttack;
/*0x0634*/ int                      Birthdate;
/*0x0638*/ uint8_t                  IsPassenger;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-05-20 (test) @ 0x1402e983e
