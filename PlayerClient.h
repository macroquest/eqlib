...
/*0x01cc*/ unsigned int             FishingETA;
/*0x01d0*/ uint8_t                  Blind;
/*0x01d1*/ bool                     LFG;
/*0x01d4*/ float                    AnimationSpeedRelated;
/*0x01d8*/ float                    BearingToTarget;
/*0x01dc*/ EqItemGuid               realEstateItemGuid;
/*0x01f0*/ unsigned int             LoginSerial;
/*0x01f4*/ unsigned int             LastSecondaryUseTime;
/*0x01f8*/ float                    MerchantGreed;
/*0x01fc*/ int                      Unknown3;
/*0x0200*/ int                      berserker;
/*0x0204*/ uint8_t                  Original;
/*0x0205*/ bool                     bBuffTimersOnHold;
/*0x0208*/ unsigned int             LastPrimaryUseTime;
/*0x020c*/ uint8_t                  GMRank;
/*0x0210*/ unsigned int             StunTimer;
/*0x0214*/ int                      Anon;
/*0x0218*/ float                    CameraOffset;
/*0x021c*/ unsigned int             LastTrapDamageTime;
/*0x0220*/ uint8_t                  FishingEvent;
/*0x0224*/ int                      RealEstateID;
/*0x0228*/ unsigned int             LastTimeStoodStill;
/*0x022c*/ unsigned int             SpellGemETA[15];
/*0x0268*/ bool                     bOfflineMode;
/*0x0269*/ bool                     bSummoned;
/*0x026c*/ unsigned int             MasterID;
/*0x0270*/ int                      Unknown4;
/*0x0274*/ int                      CurrIOState;
/*0x0278*/ int                      PetID;
/*0x027c*/ int                      NpcTintIndex;
/*0x0280*/ unsigned int**           ppUDP;
/*0x0288*/ char                     DraggingPlayer[0x40];
/*0x02c8*/ float                    FallingStartZ;
/*0x02cc*/ bool                     Linkdead;
/*0x02d0*/ unsigned int             LastMealTime;
/*0x02d4*/ char                     Suffix[0x80];
/*0x0354*/ unsigned int             RespawnTimer;
/*0x0358*/ unsigned int             NextIntimidateTime;
/*0x035c*/ int                      Trader;
/*0x0360*/ float                    ViewHeight;
/*0x0368*/ int64_t                  HPCurrent;
/*0x0370*/ int                      EnduranceCurrent;
/*0x0374*/ bool                     bBetaBuffed;
/*0x0378*/ int                      AltAttack;
/*0x037c*/ unsigned int             LastTick;
/*0x0380*/ int                      Buyer;
/*0x0384*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x038c*/ uint8_t                  FindBits;
/*0x038d*/ bool                     bAttackRelated;
/*0x0390*/ int                      Deity;
/*0x0394*/ uint8_t                  IsPassenger;
/*0x0398*/ int                      PrimaryTintIndex;
/*0x039c*/ bool                     bAnimationOnPop;
/*0x03a0*/ int                      WarCry;
/*0x03a4*/ bool                     bStationary;
/*0x03a8*/ unsigned int             Meditating;
/*0x03ac*/ uint8_t                  Light;
/*0x03b0*/ int64_t                  HPMax;
/*0x03b8*/ char                     DragNames[2][0x40];
/*0x0438*/ unsigned int             Zone;
/*0x043c*/ unsigned int             SpellCooldownETA;
/*0x0440*/ uint8_t                  InPvPArea;
/*0x0444*/ int                      DoSpecialMelee;
/*0x0448*/ CharacterZoneClient*     pCharacter;
/*0x0450*/ float                    GetMeleeRangeVar1;
/*0x0454*/ uint8_t                  CharClass;
/*0x0458*/ unsigned int             NextSwim;
/*0x045c*/ char                     Title[0x80];
/*0x04dc*/ uint8_t                  LastAttack;
/*0x04e0*/ unsigned int             EnduranceMax;
/*0x04e4*/ float                    MissileRangeToTarget;
/*0x04e8*/ int                      IsAttacking;
/*0x04ec*/ bool                     PvPFlag;
/*0x04ed*/ bool                     Sneak;
/*0x04f0*/ unsigned int             LastRangedUsedTime;
/*0x04f4*/ uint8_t                  Level;
/*0x04f8*/ int                      AFK;
/*0x0500*/ void*                    pTouchingSwitch;
/*0x0508*/ unsigned int             SitStartTime;
/*0x050c*/ bool                     Mercenary;
/*0x0510*/ int                      SecondaryTintIndex;
/*0x0514*/ uint8_t                  FD;
/*0x0518*/ unsigned int             ACounter;
/*0x051c*/ float                    MyWalkSpeed;
/*0x0520*/ int                      SomeData[2];
/*0x0528*/ char                     Handle[0x20];
/*0x0548*/ bool                     bSwitchMoved;
/*0x0549*/ uint8_t                  IntimidateCount;
/*0x054a*/ uint8_t                  HoldingAnimation;
/*0x054c*/ CPhysicsInfo             LastCollision;
/*0x057c*/ int                      ManaCurrent;
/*0x0580*/ int                      Birthdate;
/*0x0588*/ int64_t                  GuildID;
/*0x0590*/ unsigned int             CorpseDragCount;
/*0x0594*/ uint8_t                  StandState;
/*0x0598*/ int                      ManaMax;
/*0x059c*/ bool                     bAlwaysShowAura;
/*0x059d*/ char                     GM;
/*0x05a0*/ int                      Unknown1;
/*0x05a4*/ bool                     bShowHelm;
/*0x05a8*/ int                      HideMode;
/*0x05b0*/ SPAWNINFO*               pViewPlayer;
/*0x05b8*/ float                    RunSpeed;
/*0x05bc*/ unsigned int             TimeStamp;
/*0x05c0*/ int                      RealEstateItemId;
/*0x05c4*/ unsigned int             LastResendAddPlayerPacket;
/*0x05c8*/ uint8_t                  TitleVisible;
/*0x05cc*/ unsigned int             MinuteTimer;
/*0x05d0*/ void*                    pRaceGenderInfo;
/*0x05d8*/ unsigned int             LastRefresh;
/*0x05dc*/ bool                     bTempPet;
/*0x05e0*/ LaunchSpellData          CastingData;
/*0x0624*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
...
// @sizeof(PlayerClient) == 0x1f70 :: 2024-02-16 (test) @ 0x1402e2a2e
