...
/*0x01cc*/ int                      HideMode;
/*0x01d0*/ uint8_t                  IsPassenger;
/*0x01d4*/ unsigned int             MinuteTimer;
/*0x01d8*/ unsigned int             TimeStamp;
/*0x01dc*/ int                      EnduranceCurrent;
/*0x01e0*/ float                    RunSpeed;
/*0x01e4*/ float                    MissileRangeToTarget;
/*0x01e8*/ LaunchSpellData          CastingData;
/*0x022c*/ unsigned int             LastMealTime;
/*0x0230*/ unsigned int             LastResendAddPlayerPacket;
/*0x0234*/ unsigned int             NextIntimidateTime;
/*0x0238*/ void*                    pRaceGenderInfo;
/*0x0240*/ char                     DragNames[2][0x40];
/*0x02c0*/ unsigned int**           ppUDP;
/*0x02c8*/ int                      Unknown4;
/*0x02cc*/ int                      Unknown3;
/*0x02d0*/ unsigned int             LastSecondaryUseTime;
/*0x02d4*/ float                    GetMeleeRangeVar1;
/*0x02d8*/ unsigned int             NextSwim;
/*0x02dc*/ uint8_t                  InPvPArea;
/*0x02e0*/ int                      Buyer;
/*0x02e4*/ int                      berserker;
/*0x02e8*/ int                      Anon;
/*0x02ec*/ int                      RealEstateItemId;
/*0x02f0*/ unsigned int             LastTrapDamageTime;
/*0x02f4*/ int                      Unknown1;
/*0x02f8*/ int                      Deity;
/*0x02fc*/ uint8_t                  FD;
/*0x0300*/ int                      PetID;
/*0x0304*/ int                      RealEstateID;
/*0x0308*/ void*                    pTouchingSwitch;
/*0x0310*/ uint8_t                  LastAttack;
/*0x0314*/ int                      PrimaryTintIndex;
/*0x0318*/ bool                     bSwitchMoved;
/*0x031c*/ float                    MerchantGreed;
/*0x0320*/ unsigned int             Meditating;
/*0x0324*/ unsigned int             MasterID;
/*0x0328*/ unsigned int             SpellCooldownETA;
/*0x0330*/ int64_t                  GuildID;
/*0x0338*/ unsigned int             ACounter;
/*0x033c*/ unsigned int             LastRefresh;
/*0x0340*/ float                    BearingToTarget;
/*0x0344*/ uint8_t                  IntimidateCount;
/*0x0345*/ char                     GM;
/*0x0346*/ bool                     bTempPet;
/*0x0348*/ int                      IsAttacking;
/*0x034c*/ bool                     bAlwaysShowAura;
/*0x034d*/ char                     DraggingPlayer[0x40];
/*0x038d*/ bool                     Sneak;
/*0x0390*/ int                      AFK;
/*0x0394*/ unsigned int             CorpseDragCount;
/*0x0398*/ unsigned int             LastRangedUsedTime;
/*0x039c*/ bool                     LFG;
/*0x039d*/ uint8_t                  TitleVisible;
/*0x039e*/ bool                     bStationary;
/*0x03a0*/ int                      Birthdate;
/*0x03a4*/ bool                     bAttackRelated;
/*0x03a8*/ unsigned int             SitStartTime;
/*0x03ac*/ unsigned int             StunTimer;
/*0x03b0*/ uint8_t                  Light;
/*0x03b4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03c0*/ CharacterZoneClient*     pCharacter;
/*0x03c8*/ int                      WarCry;
/*0x03cc*/ char                     Handle[0x20];
/*0x03ec*/ float                    CameraOffset;
/*0x03f0*/ char                     Title[0x80];
/*0x0470*/ unsigned int             EnduranceMax;
/*0x0474*/ unsigned int             LastTick;
/*0x0478*/ uint8_t                  CharClass;
/*0x047c*/ int                      NpcTintIndex;
/*0x0480*/ uint8_t                  FishingEvent;
/*0x0484*/ unsigned int             LoginSerial;
/*0x0488*/ int                      Trader;
/*0x048c*/ char                     LoginRelated[0x20];
/*0x04ac*/ uint8_t                  Level;
/*0x04b0*/ int64_t                  HPCurrent;
/*0x04b8*/ int                      ManaMax;
/*0x04bc*/ CPhysicsInfo             LastCollision;
/*0x04ec*/ bool                     PvPFlag;
/*0x04ed*/ bool                     Mercenary;
/*0x04f0*/ unsigned int             RespawnTimer;
/*0x04f4*/ int                      AltAttack;
/*0x04f8*/ bool                     bBetaBuffed;
/*0x04f9*/ bool                     bAnimationOnPop;
/*0x04fc*/ float                    ViewHeight;
/*0x0500*/ int                      CurrIOState;
/*0x0504*/ bool                     bOfflineMode;
/*0x0505*/ uint8_t                  Original;
/*0x0508*/ unsigned int             FishingETA;
/*0x050c*/ bool                     bSummoned;
/*0x050d*/ bool                     bShowHelm;
/*0x050e*/ EqItemGuid               realEstateItemGuid;
/*0x0520*/ float                    MyWalkSpeed;
/*0x0524*/ float                    FallingStartZ;
/*0x0528*/ int                      SomeData[2];
/*0x0530*/ char                     Suffix[0x80];
/*0x05b0*/ bool                     bBuffTimersOnHold;
/*0x05b4*/ float                    AnimationSpeedRelated;
/*0x05b8*/ int                      ManaCurrent;
/*0x05bc*/ unsigned int             LastPrimaryUseTime;
/*0x05c0*/ unsigned int             SpellGemETA[15];
/*0x05fc*/ int                      SecondaryTintIndex;
/*0x0600*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0608*/ uint8_t                  HoldingAnimation;
/*0x0609*/ uint8_t                  GMRank;
/*0x0610*/ SPAWNINFO*               pViewPlayer;
/*0x0618*/ unsigned int             Zone;
/*0x0620*/ int64_t                  HPMax;
/*0x0628*/ uint8_t                  Blind;
/*0x0629*/ uint8_t                  FindBits;
/*0x062c*/ unsigned int             LastTimeStoodStill;
/*0x0630*/ bool                     Linkdead;
/*0x0634*/ int                      DoSpecialMelee;
/*0x0638*/ uint8_t                  StandState;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-10-09 (test) @ 0x1402dd14e
