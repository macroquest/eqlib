...
/*0x01cc*/ bool                     bBuffTimersOnHold;
/*0x01d0*/ int                      Unknown1;
/*0x01d4*/ bool                     PvPFlag;
/*0x01d5*/ char                     DragNames[2][0x40];
/*0x0258*/ unsigned int             Zone;
/*0x025c*/ bool                     bShowHelm;
/*0x0260*/ unsigned int             LastMealTime;
/*0x0264*/ uint8_t                  FD;
/*0x0268*/ int                      PetID;
/*0x026c*/ int                      Unknown4;
/*0x0270*/ int                      berserker;
/*0x0274*/ unsigned int             LastResendAddPlayerPacket;
/*0x0278*/ int64_t                  HPMax;
/*0x0280*/ bool                     bSummoned;
/*0x0284*/ int                      RealEstateItemId;
/*0x0288*/ unsigned int             RespawnTimer;
/*0x0290*/ void*                    pRaceGenderInfo;
/*0x0298*/ int                      AltAttack;
/*0x029c*/ uint8_t                  LastAttack;
/*0x029d*/ uint8_t                  StandState;
/*0x02a0*/ unsigned int             SpellCooldownETA;
/*0x02a4*/ unsigned int             MinuteTimer;
/*0x02a8*/ bool                     bOfflineMode;
/*0x02ac*/ unsigned int             CorpseDragCount;
/*0x02b0*/ float                    BearingToTarget;
/*0x02b4*/ char                     Title[0x80];
/*0x0334*/ int                      HideMode;
/*0x0338*/ unsigned int             FishingETA;
/*0x033c*/ bool                     bAnimationOnPop;
/*0x0340*/ int                      Anon;
/*0x0344*/ uint8_t                  Original;
/*0x0348*/ int                      EnduranceCurrent;
/*0x034c*/ int                      NpcTintIndex;
/*0x0350*/ float                    CameraOffset;
/*0x0354*/ bool                     Sneak;
/*0x0358*/ unsigned int             TimeStamp;
/*0x035c*/ uint8_t                  Level;
/*0x0360*/ int                      WarCry;
/*0x0364*/ uint8_t                  InPvPArea;
/*0x0368*/ unsigned int             LastSecondaryUseTime;
/*0x036c*/ bool                     bSwitchMoved;
/*0x0370*/ float                    MyWalkSpeed;
/*0x0374*/ bool                     LFG;
/*0x0378*/ int64_t                  GuildID;
/*0x0380*/ uint8_t                  FishingEvent;
/*0x0381*/ char                     LoginRelated[0x20];
/*0x03a4*/ unsigned int             EnduranceMax;
/*0x03a8*/ bool                     bBetaBuffed;
/*0x03ac*/ float                    AnimationSpeedRelated;
/*0x03b0*/ int                      SomeData[2];
/*0x03b8*/ int                      Birthdate;
/*0x03bc*/ LaunchSpellData          CastingData;
/*0x0400*/ uint8_t                  Light;
/*0x0401*/ uint8_t                  IsPassenger;
/*0x0404*/ float                    RunSpeed;
/*0x0408*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0410*/ unsigned int             MasterID;
/*0x0414*/ unsigned int             NextSwim;
/*0x0418*/ char                     DraggingPlayer[0x40];
/*0x0458*/ float                    MerchantGreed;
/*0x045c*/ uint8_t                  CharClass;
/*0x0460*/ unsigned int**           ppUDP;
/*0x0468*/ uint8_t                  TitleVisible;
/*0x046c*/ int                      CurrIOState;
/*0x0470*/ SPAWNINFO*               pViewPlayer;
/*0x0478*/ int                      SecondaryTintIndex;
/*0x047c*/ unsigned int             LastTimeStoodStill;
/*0x0480*/ int                      Trader;
/*0x0484*/ int                      DoSpecialMelee;
/*0x0488*/ unsigned int             ACounter;
/*0x048c*/ bool                     Linkdead;
/*0x0490*/ int                      RealEstateID;
/*0x0494*/ EqItemGuid               realEstateItemGuid;
/*0x04a6*/ char                     GM;
/*0x04a8*/ unsigned int             LastRangedUsedTime;
/*0x04ac*/ unsigned int             NextIntimidateTime;
/*0x04b0*/ unsigned int             LastTrapDamageTime;
/*0x04b4*/ unsigned int             Meditating;
/*0x04b8*/ unsigned int             LastTick;
/*0x04bc*/ bool                     Mercenary;
/*0x04bd*/ uint8_t                  Blind;
/*0x04c0*/ unsigned int             LoginSerial;
/*0x04c4*/ int                      Buyer;
/*0x04c8*/ int                      Unknown3;
/*0x04cc*/ int                      ManaMax;
/*0x04d0*/ float                    MissileRangeToTarget;
/*0x04d4*/ char                     Handle[0x20];
/*0x04f4*/ bool                     bAttackRelated;
/*0x04f8*/ unsigned int             StunTimer;
/*0x04fc*/ float                    FallingStartZ;
/*0x0500*/ bool                     bAlwaysShowAura;
/*0x0501*/ uint8_t                  GMRank;
/*0x0504*/ float                    ViewHeight;
/*0x0508*/ void*                    pTouchingSwitch;
/*0x0510*/ unsigned int             LastRefresh;
/*0x0514*/ int                      ManaCurrent;
/*0x0518*/ unsigned int             LastPrimaryUseTime;
/*0x051c*/ uint8_t                  IntimidateCount;
/*0x051d*/ uint8_t                  FindBits;
/*0x0520*/ unsigned int             SpellGemETA[15];
/*0x055c*/ CPhysicsInfo             LastCollision;
/*0x0590*/ CharacterZoneClient*     pCharacter;
/*0x0598*/ int                      IsAttacking;
/*0x059c*/ bool                     bTempPet;
/*0x05a0*/ int                      Deity;
/*0x05a4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05ac*/ int                      AFK;
/*0x05b0*/ bool                     bStationary;
/*0x05b1*/ uint8_t                  HoldingAnimation;
/*0x05b4*/ float                    GetMeleeRangeVar1;
/*0x05b8*/ char                     Suffix[0x80];
/*0x0638*/ unsigned int             SitStartTime;
/*0x0640*/ int64_t                  HPCurrent;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2023-06-13 (test) @ 0x1402dba5e
