...
/*0x01bc*/ EqItemGuid               realEstateItemGuid;
/*0x01d0*/ float                    FallingStartZ;
/*0x01d4*/ uint8_t                  InPvPArea;
/*0x01d8*/ int                      Unknown2;
/*0x01dc*/ unsigned int             LastRefresh;
/*0x01e0*/ int                      RealEstateItemId;
/*0x01e4*/ int                      WarCry;
/*0x01e8*/ float                    MissileRangeToTarget;
/*0x01ec*/ char                     Suffix[0x80];
/*0x026c*/ uint8_t                  GMRank;
/*0x0270*/ LaunchSpellData          CastingData;
/*0x02b4*/ uint8_t                  StandState;
/*0x02b5*/ uint8_t                  IntimidateCount;
/*0x02b8*/ unsigned int             ACounter;
/*0x02bc*/ int                      RealEstateID;
/*0x02c0*/ bool                     bOfflineMode;
/*0x02c1*/ bool                     bTempPet;
/*0x02c2*/ bool                     bBetaBuffed;
/*0x02c4*/ int                      berserker;
/*0x02c8*/ bool                     bSwitchMoved;
/*0x02c9*/ bool                     bSummoned;
/*0x02ca*/ char                     LoginRelated[0x20];
/*0x02ea*/ char                     Handle[0x20];
/*0x030c*/ int                      Trader;
/*0x0310*/ uint8_t                  Light;
/*0x0314*/ unsigned int             LoginSerial;
/*0x0318*/ float                    BearingToTarget;
/*0x031c*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0324*/ unsigned int             NextSwim;
/*0x0328*/ float                    ViewHeight;
/*0x032c*/ uint8_t                  Blind;
/*0x0330*/ unsigned int             LastTimeStoodStill;
/*0x0334*/ float                    MerchantGreed;
/*0x0338*/ char                     DraggingPlayer[0x40];
/*0x0378*/ int                      SomeData[2];
...
/*0x03dc*/ float                    AnimationSpeedRelated;
/*0x03e0*/ unsigned int             MinuteTimer;
/*0x03e4*/ unsigned int             LastTick;
/*0x03e8*/ unsigned int             TimeStamp;
/*0x03ec*/ unsigned int             LastSecondaryUseTime;
/*0x03f0*/ int                      DoSpecialMelee;
/*0x03f4*/ unsigned int             Meditating;
/*0x03f8*/ uint8_t                  FishingEvent;
/*0x03f9*/ char                     GM;
/*0x03fc*/ unsigned int             LastResendAddPlayerPacket;
/*0x0400*/ CPhysicsInfo             LastCollision;
/*0x0430*/ CharacterZoneClient*     pCharacter;
/*0x0438*/ int                      NpcTintIndex;
/*0x043c*/ uint8_t                  FindBits;
/*0x0440*/ unsigned int             LastPrimaryUseTime;
/*0x0444*/ unsigned int             SpellCooldownETA;
/*0x0448*/ int                      HideMode;
...
/*0x0468*/ char                     DragNames[2][0x40];
/*0x04e8*/ float                    CameraOffset;
/*0x04ec*/ bool                     bAttackRelated;
/*0x04f0*/ unsigned int**           ppUDP;
/*0x04f8*/ unsigned int             FishingETA;
/*0x0500*/ int64_t                  HPCurrent;
/*0x0508*/ bool                     Mercenary;
/*0x0510*/ void*                    pTouchingSwitch;
/*0x0518*/ int                      SecondaryTintIndex;
/*0x051c*/ uint8_t                  HoldingAnimation;
/*0x051d*/ uint8_t                  Original;
/*0x0520*/ unsigned int             LastMealTime;
/*0x0524*/ float                    MyWalkSpeed;
/*0x0528*/ uint8_t                  TitleVisible;
/*0x0529*/ bool                     bAlwaysShowAura;
/*0x052a*/ bool                     LFG;
/*0x052b*/ bool                     PvPFlag;
/*0x052c*/ unsigned int             SitStartTime;
/*0x0530*/ unsigned int             CorpseDragCount;
/*0x0534*/ int                      Buyer;
/*0x0538*/ bool                     bAnimationOnPop;
/*0x053c*/ unsigned int             Zone;
/*0x0540*/ int                      AltAttack;
/*0x0544*/ unsigned int             NextIntimidateTime;
/*0x0548*/ uint8_t                  CharClass;
/*0x0549*/ uint8_t                  Level;
/*0x054c*/ unsigned int             RespawnTimer;
/*0x0550*/ int                      Deity;
/*0x0554*/ int                      Anon;
/*0x0558*/ bool                     Sneak;
/*0x055c*/ int                      Unknown1;
/*0x0560*/ bool                     bBuffTimersOnHold;
/*0x0564*/ int                      IsAttacking;
/*0x0568*/ int                      AFK;
/*0x056c*/ unsigned int             EnduranceMax;
/*0x0570*/ bool                     bShowHelm;
/*0x0574*/ float                    GetMeleeRangeVar1;
/*0x0578*/ float                    RunSpeed;
/*0x057c*/ char                     Title[0x80];
/*0x05fc*/ int                      Unknown3;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2023-01-09 (test) @ 0x1402a859e
