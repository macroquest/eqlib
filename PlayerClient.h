...
/*0x01bc*/ int                      PetID;
/*0x01c0*/ unsigned int             RespawnTimer;
/*0x01c4*/ uint8_t                  FindBits;
/*0x01c8*/ unsigned int             NextSwim;
/*0x01cc*/ unsigned int             NextIntimidateTime;
/*0x01d0*/ uint8_t                  Blind;
/*0x01d4*/ unsigned int             CorpseDragCount;
/*0x01d8*/ uint8_t                  IsPassenger;
/*0x01dc*/ int                      AltAttack;
/*0x01e0*/ float                    MissileRangeToTarget;
/*0x01e4*/ unsigned int             LastMealTime;
/*0x01e8*/ unsigned int             LastSecondaryUseTime;
/*0x01ec*/ int                      HideMode;
/*0x01f0*/ unsigned int             SpellGemETA[15];
/*0x022c*/ unsigned int             LastRangedUsedTime;
/*0x0230*/ LaunchSpellData          CastingData;
/*0x0278*/ int64_t                  GuildID;
/*0x0280*/ bool                     bShowHelm;
/*0x0284*/ unsigned int             MinuteTimer;
/*0x0288*/ float                    AnimationSpeedRelated;
/*0x028c*/ int                      Unknown3;
/*0x0290*/ bool                     bAnimationOnPop;
/*0x0294*/ float                    MerchantGreed;
/*0x0298*/ char                     Title[0x80];
/*0x0318*/ int64_t                  HPMax;
/*0x0320*/ bool                     bAlwaysShowAura;
/*0x0328*/ unsigned int**           ppUDP;
/*0x0330*/ int                      DoSpecialMelee;
/*0x0334*/ bool                     bOfflineMode;
/*0x0338*/ float                    GetMeleeRangeVar1;
/*0x033c*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0344*/ uint8_t                  LastAttack;
/*0x0348*/ CharacterZoneClient*     pCharacter;
/*0x0350*/ int                      CurrIOState;
/*0x0354*/ unsigned int             TimeStamp;
/*0x0358*/ char                     Suffix[0x80];
/*0x03d8*/ int                      Unknown1;
/*0x03dc*/ int                      PrimaryTintIndex;
/*0x03e0*/ uint8_t                  FishingEvent;
/*0x03e1*/ uint8_t                  Original;
/*0x03e4*/ unsigned int             LastTrapDamageTime;
/*0x03e8*/ uint8_t                  FD;
/*0x03ec*/ int                      berserker;
/*0x03f0*/ unsigned int             StunTimer;
/*0x03f8*/ void*                    pTouchingSwitch;
/*0x0400*/ unsigned int             LoginSerial;
/*0x0404*/ int                      Deity;
/*0x0408*/ unsigned int             Meditating;
/*0x040c*/ int                      Unknown4;
/*0x0410*/ bool                     PvPFlag;
/*0x0411*/ char                     Handle[0x20];
/*0x0431*/ uint8_t                  TitleVisible;
/*0x0434*/ float                    CameraOffset;
/*0x0438*/ bool                     bSwitchMoved;
/*0x043c*/ unsigned int             EnduranceMax;
/*0x0440*/ int                      Unknown2;
/*0x0448*/ SPAWNINFO*               pViewPlayer;
/*0x0450*/ char                     DraggingPlayer[0x40];
/*0x0490*/ float                    ViewHeight;
/*0x0494*/ unsigned int             LastRefresh;
/*0x0498*/ int                      SomeData[2];
/*0x04a0*/ int                      ManaCurrent;
/*0x04a4*/ unsigned int             LastResendAddPlayerPacket;
/*0x04a8*/ unsigned int             FishingETA;
/*0x04ac*/ unsigned int             ACounter;
/*0x04b0*/ uint8_t                  InPvPArea;
/*0x04b1*/ bool                     bStationary;
/*0x04b2*/ bool                     Mercenary;
/*0x04b3*/ bool                     bTempPet;
/*0x04b4*/ int                      Trader;
/*0x04b8*/ bool                     LFG;
/*0x04bc*/ unsigned int             SpellCooldownETA;
/*0x04c0*/ uint8_t                  CharClass;
/*0x04c1*/ char                     GM;
/*0x04c4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x04cc*/ int                      ManaMax;
/*0x04d0*/ int                      EnduranceCurrent;
/*0x04d4*/ int                      RealEstateItemId;
/*0x04d8*/ bool                     bBuffTimersOnHold;
/*0x04d9*/ bool                     Sneak;
/*0x04dc*/ int                      SecondaryTintIndex;
/*0x04e0*/ bool                     Linkdead;
/*0x04e4*/ CPhysicsInfo             LastCollision;
/*0x0514*/ bool                     bAttackRelated;
/*0x0515*/ uint8_t                  Light;
/*0x0518*/ int                      Anon;
/*0x051c*/ int                      WarCry;
/*0x0520*/ int                      IsAttacking;
/*0x0524*/ EqItemGuid               realEstateItemGuid;
/*0x0538*/ unsigned int             LastTimeStoodStill;
/*0x053c*/ uint8_t                  GMRank;
/*0x053d*/ uint8_t                  StandState;
/*0x053e*/ uint8_t                  Level;
/*0x0540*/ unsigned int             SitStartTime;
/*0x0544*/ float                    FallingStartZ;
/*0x0548*/ void*                    pRaceGenderInfo;
/*0x0550*/ int                      AFK;
/*0x0554*/ char                     LoginRelated[0x20];
/*0x0574*/ float                    MyWalkSpeed;
/*0x0578*/ unsigned int             LastPrimaryUseTime;
/*0x057c*/ int                      NpcTintIndex;
/*0x0580*/ unsigned int             MasterID;
/*0x0584*/ unsigned int             Zone;
/*0x0588*/ bool                     bBetaBuffed;
/*0x0589*/ char                     DragNames[2][0x40];
/*0x060c*/ float                    BearingToTarget;
/*0x0610*/ uint8_t                  IntimidateCount;
/*0x0614*/ int                      Buyer;
/*0x0618*/ int64_t                  HPCurrent;
/*0x0620*/ uint8_t                  HoldingAnimation;
/*0x0624*/ int                      RealEstateID;
/*0x0628*/ bool                     bSummoned;
/*0x062c*/ float                    RunSpeed;
/*0x0630*/ unsigned int             LastTick;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2022-12-07 (live) @ 0x1402a769e
