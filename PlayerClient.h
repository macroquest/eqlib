...
/*0x01cc*/ unsigned int             ACounter;
/*0x01d0*/ unsigned int             EnduranceMax;
/*0x01d4*/ int                      Trader;
/*0x01d8*/ int                      Buyer;
/*0x01dc*/ char                     DragNames[2][0x40];
/*0x025c*/ char                     Suffix[0x80];
/*0x02dc*/ float                    BearingToTarget;
/*0x02e0*/ CharacterZoneClient*     pCharacter;
/*0x02e8*/ bool                     bTempPet;
/*0x02e9*/ bool                     bSwitchMoved;
/*0x02ec*/ int                      Unknown4;
/*0x02f0*/ uint8_t                  FishingEvent;
/*0x02f4*/ unsigned int             TimeStamp;
/*0x02f8*/ int                      Deity;
/*0x02fc*/ LaunchSpellData          CastingData;
/*0x0340*/ unsigned int             Meditating;
/*0x0344*/ unsigned int             NextIntimidateTime;
/*0x0348*/ unsigned int             StunTimer;
/*0x034c*/ bool                     bStationary;
/*0x034d*/ char                     DraggingPlayer[0x40];
/*0x0390*/ unsigned int             LastTrapDamageTime;
/*0x0394*/ unsigned int             LastRangedUsedTime;
/*0x0398*/ unsigned int             LastTimeStoodStill;
/*0x039c*/ bool                     PvPFlag;
/*0x039d*/ bool                     bBuffTimersOnHold;
/*0x03a0*/ int                      CurrIOState;
/*0x03a4*/ int                      SomeData[2];
/*0x03ac*/ float                    CameraOffset;
/*0x03b0*/ int64_t                  HPMax;
/*0x03b8*/ int                      DoSpecialMelee;
/*0x03bc*/ unsigned int             LoginSerial;
/*0x03c0*/ uint8_t                  Original;
/*0x03c1*/ uint8_t                  Level;
/*0x03c8*/ unsigned int**           ppUDP;
/*0x03d0*/ int                      Unknown1;
/*0x03d4*/ uint8_t                  IntimidateCount;
/*0x03d8*/ int                      berserker;
/*0x03dc*/ int                      Anon;
/*0x03e0*/ bool                     Sneak;
/*0x03e4*/ int                      ManaMax;
/*0x03e8*/ float                    MerchantGreed;
/*0x03ec*/ int                      RealEstateItemId;
/*0x03f0*/ unsigned int             NextSwim;
/*0x03f4*/ char                     GM;
/*0x03f5*/ uint8_t                  StandState;
/*0x03f8*/ int64_t                  GuildID;
/*0x0400*/ int                      SecondaryTintIndex;
/*0x0404*/ uint8_t                  FD;
/*0x0405*/ bool                     bBetaBuffed;
/*0x0408*/ unsigned int             FishingETA;
/*0x040c*/ unsigned int             SitStartTime;
/*0x0410*/ bool                     Mercenary;
/*0x0414*/ unsigned int             CorpseDragCount;
/*0x0418*/ char                     LoginRelated[0x20];
/*0x0438*/ uint8_t                  TitleVisible;
/*0x0439*/ bool                     bOfflineMode;
/*0x043c*/ unsigned int             LastMealTime;
/*0x0440*/ uint8_t                  IsPassenger;
/*0x0448*/ SPAWNINFO*               pViewPlayer;
/*0x0450*/ int64_t                  HPCurrent;
/*0x0458*/ EqItemGuid               realEstateItemGuid;
/*0x046a*/ bool                     bAnimationOnPop;
/*0x046c*/ int                      WarCry;
/*0x0470*/ int                      PetID;
/*0x0474*/ char                     Title[0x80];
/*0x04f4*/ int                      Birthdate;
/*0x04f8*/ bool                     bSummoned;
/*0x0500*/ void*                    pRaceGenderInfo;
/*0x0508*/ float                    FallingStartZ;
/*0x050c*/ uint8_t                  LastAttack;
/*0x0510*/ unsigned int             MinuteTimer;
/*0x0514*/ unsigned int             SpellGemETA[15];
/*0x0550*/ unsigned int             Zone;
/*0x0554*/ int                      PrimaryTintIndex;
/*0x0558*/ float                    GetMeleeRangeVar1;
/*0x055c*/ uint8_t                  InPvPArea;
/*0x055d*/ bool                     LFG;
/*0x055e*/ uint8_t                  FindBits;
/*0x0560*/ float                    AnimationSpeedRelated;
/*0x0564*/ bool                     bAlwaysShowAura;
/*0x0568*/ CPhysicsInfo             LastCollision;
/*0x0598*/ int                      AFK;
/*0x059c*/ unsigned int             LastSecondaryUseTime;
/*0x05a0*/ uint8_t                  Light;
/*0x05a4*/ float                    RunSpeed;
/*0x05a8*/ float                    MyWalkSpeed;
/*0x05ac*/ unsigned int             LastResendAddPlayerPacket;
/*0x05b0*/ int                      HideMode;
/*0x05b4*/ int                      IsAttacking;
/*0x05b8*/ int                      Unknown3;
/*0x05bc*/ uint8_t                  CharClass;
/*0x05c0*/ int                      AltAttack;
/*0x05c4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05cc*/ unsigned int             RespawnTimer;
/*0x05d0*/ uint8_t                  GMRank;
/*0x05d4*/ int                      ManaCurrent;
/*0x05d8*/ unsigned int             SpellCooldownETA;
/*0x05dc*/ int                      EnduranceCurrent;
/*0x05e0*/ bool                     bAttackRelated;
/*0x05e1*/ bool                     bShowHelm;
/*0x05e4*/ int                      RealEstateID;
/*0x05e8*/ unsigned int             MasterID;
/*0x05ec*/ bool                     Linkdead;
/*0x05f0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05f8*/ void*                    pTouchingSwitch;
/*0x0600*/ float                    ViewHeight;
/*0x0604*/ uint8_t                  HoldingAnimation;
/*0x0608*/ int                      NpcTintIndex;
/*0x060c*/ float                    MissileRangeToTarget;
/*0x0610*/ unsigned int             LastTick;
/*0x0614*/ char                     Handle[0x20];
/*0x0634*/ unsigned int             LastPrimaryUseTime;
/*0x0638*/ uint8_t                  Blind;
/*0x063c*/ unsigned int             LastRefresh;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-05-24 (live) @ 0x1403011de
