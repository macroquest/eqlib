...
/*0x0194*/ bool                     bShowHelm;
/*0x0195*/ bool                     bSummoned;                    // by a PC or by anyone? need to investigate
/*0x0196*/ uint8_t                  StandState;
/*0x0198*/ CPhysicsInfo             LastCollision;
/*0x01c8*/ uint8_t                  FD;
/*0x01cc*/ unsigned int             NextSwim;
/*0x01d0*/ int                      EnduranceCurrent;
/*0x01d4*/ char                     Title[0x80];
/*0x0254*/ int                      DontKnowYet;
/*0x0258*/ float                    MissileRangeToTarget;
/*0x025c*/ bool                     bOfflineMode;
/*0x0260*/ int64_t                  HPMax;
/*0x0268*/ int                      Deity;
/*0x026c*/ unsigned int             LastCastTime;
/*0x0270*/ int                      berserker;
/*0x0274*/ bool                     bAttackRelated;
/*0x0275*/ char                     Suffix[0x80];
...
/*0x02fd*/ bool                     Sneak;
/*0x0300*/ float                    FallingStartZ;
/*0x0304*/ uint8_t                  Type2;
/*0x0308*/ unsigned int             CorpseDragCount;
/*0x030c*/ unsigned int             NextIntimidateTime;
/*0x0310*/ int                      Stuff;
/*0x0314*/ float                    MyWalkSpeed;
/*0x0318*/ unsigned int             FishingETA;
/*0x031c*/ unsigned int             MinuteTimer;
/*0x0320*/ float                    CameraOffset;
/*0x0324*/ char                     DragNames[0x2][0x40];
/*0x03a4*/ int                      PetID;
/*0x03a8*/ char                     DraggingPlayer[0x40];
/*0x03e8*/ int                      SomeData[0x2];
/*0x03f0*/ unsigned int             LastTimeStoodStill;
/*0x03f4*/ SPAWNINFO*               pViewPlayer;
/*0x03f8*/ unsigned int             ACounter;                     // not sure what this one is for (m_uHibernatingCount)
/*0x03fc*/ int                      WarCry;
/*0x0400*/ int                      DoSpecialMelee;
/*0x0404*/ unsigned int             SpellGemETA[0xf];             // InnateETA is now the last member in this array
/*0x0440*/ int                      LastCastNum;
/*0x0444*/ unsigned int             LastRangedUsedTime;
/*0x0448*/ unsigned int             LastTrapDamageTime;
/*0x044c*/ bool                     bBetaBuffed;
/*0x044d*/ char                     GM;
/*0x0450*/ unsigned int             LastSecondaryUseTime;
/*0x0454*/ uint8_t                  Light;
/*0x0455*/ uint8_t                  CharClass;                    // Im pretty sure this isnt working
/*0x0458*/ unsigned int             CombatSkillTicks[0x2];
/*0x0460*/ LaunchSpellData          CastingData;                  // size: 0x58
/*0x04b8*/ bool                     bAlwaysShowAura;
/*0x04b9*/ uint8_t                  Level;
/*0x04ba*/ bool                     Linkdead;
/*0x04bc*/ unsigned int             EnduranceMax;
/*0x04c0*/ int                      AARank;                       // this really is the title id
...
/*0x04d0*/ int64_t                  HPCurrent;
/*0x04d8*/ unsigned int             LastResendAddPlayerPacket;
/*0x04dc*/ unsigned int             LastTick;
/*0x04e0*/ unsigned int             StunTimer;
/*0x04e4*/ unsigned int             SitStartTime;
/*0x04e8*/ unsigned int             LastMealTime;                 // last time we eat or drank
/*0x04ec*/ unsigned int             Meditating;
/*0x04f0*/ int                      NpcTintIndex;
/*0x04f4*/ int                      RealEstateID;
/*0x04f8*/ bool                     bBuffTimersOnHold;            // no you can't control this client side so unless you want to get banned leave it alone
/*0x0500*/ int64_t                  GuildID;
/*0x0508*/ unsigned int             SpellCooldownETA;
/*0x050c*/ void*                    pRaceGenderInfo;              // todo this is not a void* so... map the CRaceGenderInfo class
/*0x0510*/ bool                     bAnimationOnPop;
/*0x0511*/ uint8_t                  GMRank;
/*0x0512*/ EqItemGuid               realEstateItemGuid;
/*0x0524*/ uint8_t                  InPvPArea;                    // are we in a PvP area?
/*0x0525*/ bool                     LFG;
/*0x0526*/ uint8_t                  FishingEvent;
/*0x0527*/ uint8_t                  IntimidateCount;
/*0x0528*/ unsigned int             LastPrimaryUseTime;
/*0x052c*/ int                      HideMode;
/*0x0530*/ unsigned int             CombatSkillUsed[0x2];
/*0x0538*/ bool                     bStationary;
/*0x0539*/ uint8_t                  LastAttack;
/*0x053c*/ int                      AFK;
...
/*0x054c*/ int                      ManaCurrent;
/*0x0550*/ void*                    pTouchingSwitch;              // need to get that in here : struct _EQSWITCH
/*0x0554*/ uint8_t                  HmmWhat;
/*0x0555*/ uint8_t                  FindBits;
/*0x0556*/ bool                     bTempPet;
/*0x0558*/ int                      IsAttacking;                  // need to investigate
/*0x055c*/ int                      SomethingElse;
/*0x0560*/ uint8_t                  Blind;
/*0x0561*/ bool                     PvPFlag;
/*0x0562*/ char                     LoginRelated[0x20];
/*0x0584*/ int                      Dontknowyet2;
/*0x0588*/ char                     Handle[0x20];
/*0x05a8*/ int                      Trader;                       // found in CEverQuest__RightClickedOnPlayer_x
/*0x05ac*/ int                      AltAttack;
/*0x05b0*/ bool                     bSwitchMoved;                 // true when a door moves near the spawn
/*0x05b4*/ unsigned int             LoginSerial;
/*0x05b8*/ int                      ManaMax;
/*0x05bc*/ unsigned int**           ppUDP;                        // UdpLibrary::UdpConnection
/*0x05c0*/ float                    AnimationSpeedRelated;
/*0x05c4*/ CharacterZoneClient*     pCharacter;
/*0x05c8*/ int                      Anon;                         // found in EQPlayer__SetNameSpriteTint_x
/*0x05cc*/ int                      SecondaryTintIndex;
/*0x05d0*/ unsigned int             MasterID;
/*0x05d4*/ uint8_t                  IsPassenger;                  // if u are on a boat or airship or whatever
/*0x05d8*/ int                      PrimaryTintIndex;
/*0x05dc*/ int                      Buyer;
/*0x05e0*/ int                      CurrIOState;
/*0x05e4*/ float                    MerchantGreed;
/*0x05e8*/ unsigned int             LastRefresh;                  // last 18 sec tick
/*0x05ec*/ bool                     Mercenary;
/*0x05f0*/ float                    GetMeleeRangeVar1;            // used by GetMeleeRange (fScaleFactor)
/*0x05f4*/ int                      RealEstateItemId;
/*0x05f8*/ float                    BearingToTarget;
...
/*0x0f44*/ PZCPhysicsInfo     PZCLastPhysics;
...
// @sizeof(PlayerClient) == 0x1E88 :: 2021-11-12 (live) @ 0x69D210
constexpr size_t PlayerClient_size = 0x1E88;
