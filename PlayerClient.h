...
/*0x01cc*/ int                      AltAttack;
/*0x01d0*/ uint8_t                  StandState;
/*0x01d4*/ int                      WarCry;
/*0x01d8*/ bool                     bAttackRelated;
/*0x01dc*/ unsigned int             FishingETA;
/*0x01e0*/ uint8_t                  IsPassenger;
/*0x01e4*/ int                      RealEstateID;
/*0x01e8*/ bool                     Mercenary;
/*0x01ec*/ unsigned int             LastTimeStoodStill;
/*0x01f0*/ uint8_t                  CharClass;
/*0x01f4*/ int                      SecondaryTintIndex;
/*0x01f8*/ CharacterZoneClient*     pCharacter;
/*0x0200*/ float                    MissileRangeToTarget;
/*0x0204*/ bool                     bBuffTimersOnHold;
/*0x0208*/ float                    RunSpeed;
/*0x020c*/ int                      EnduranceCurrent;
/*0x0210*/ unsigned int             LastRangedUsedTime;
/*0x0214*/ unsigned int             LastRefresh;
/*0x0218*/ bool                     Sneak;
/*0x021c*/ int                      IsAttacking;
/*0x0220*/ unsigned int             Meditating;
/*0x0224*/ unsigned int             LastTrapDamageTime;
/*0x0228*/ int                      NpcTintIndex;
/*0x0230*/ void*                    pTouchingSwitch;
/*0x0238*/ unsigned int             LastPrimaryUseTime;
/*0x023c*/ bool                     bOfflineMode;
/*0x0240*/ float                    MyWalkSpeed;
/*0x0244*/ float                    ViewHeight;
/*0x0248*/ int                      Deity;
/*0x024c*/ char                     Title[0x80];
/*0x02cc*/ float                    FallingStartZ;
/*0x02d0*/ int                      SomeData[2];
/*0x02d8*/ unsigned int**           ppUDP;
/*0x02e0*/ unsigned int             MinuteTimer;
/*0x02e4*/ int                      Unknown1;
/*0x02e8*/ int64_t                  GuildID;
/*0x02f0*/ uint8_t                  FindBits;
/*0x02f1*/ uint8_t                  TitleVisible;
/*0x02f2*/ uint8_t                  GMRank;
/*0x02f3*/ char                     Suffix[0x80];
/*0x0373*/ bool                     LFG;
/*0x0374*/ int                      HideMode;
/*0x0378*/ unsigned int             SpellCooldownETA;
/*0x037c*/ uint8_t                  InPvPArea;
/*0x0380*/ float                    CameraOffset;
/*0x0384*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x038c*/ char                     DragNames[2][0x40];
/*0x040c*/ float                    GetMeleeRangeVar1;
/*0x0410*/ float                    BearingToTarget;
/*0x0414*/ CPhysicsInfo             LastCollision;
/*0x0444*/ unsigned int             LastResendAddPlayerPacket;
/*0x0448*/ uint8_t                  FD;
/*0x044c*/ int                      Anon;
/*0x0450*/ unsigned int             Zone;
/*0x0454*/ int                      ManaCurrent;
/*0x0458*/ bool                     bTempPet;
/*0x0460*/ SPAWNINFO*               pViewPlayer;
/*0x0468*/ unsigned int             LoginSerial;
/*0x046c*/ uint8_t                  Original;
/*0x0470*/ int64_t                  HPCurrent;
/*0x0478*/ unsigned int             LastTick;
/*0x047c*/ unsigned int             MasterID;
/*0x0480*/ bool                     bAlwaysShowAura;
/*0x0484*/ unsigned int             SpellGemETA[15];
/*0x04c0*/ unsigned int             RespawnTimer;
/*0x04c4*/ int                      RealEstateItemId;
/*0x04c8*/ int                      Trader;
/*0x04cc*/ uint8_t                  HoldingAnimation;
/*0x04cd*/ uint8_t                  Blind;
/*0x04d0*/ int                      DoSpecialMelee;
/*0x04d4*/ int                      ManaMax;
/*0x04d8*/ uint8_t                  Level;
/*0x04d9*/ bool                     bShowHelm;
/*0x04da*/ char                     DraggingPlayer[0x40];
/*0x051a*/ char                     LoginRelated[0x20];
/*0x053c*/ int                      Unknown4;
/*0x0540*/ int                      PrimaryTintIndex;
/*0x0544*/ char                     Handle[0x20];
/*0x0564*/ float                    AnimationSpeedRelated;
/*0x0568*/ unsigned int             SitStartTime;
/*0x056c*/ unsigned int             ACounter;
/*0x0570*/ bool                     Linkdead;
/*0x0574*/ int                      Buyer;
/*0x0578*/ float                    MerchantGreed;
/*0x057c*/ int                      PetID;
/*0x0580*/ unsigned int             TimeStamp;
/*0x0584*/ uint8_t                  LastAttack;
/*0x0588*/ void*                    pRaceGenderInfo;
/*0x0590*/ bool                     bSwitchMoved;
/*0x0591*/ bool                     bSummoned;
/*0x0592*/ bool                     bStationary;
/*0x0594*/ unsigned int             NextSwim;
/*0x0598*/ char                     GM;
/*0x059c*/ int                      berserker;
/*0x05a0*/ LaunchSpellData          CastingData;
/*0x05e4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05ec*/ EqItemGuid               realEstateItemGuid;
/*0x0600*/ int64_t                  HPMax;
/*0x0608*/ uint8_t                  FishingEvent;
/*0x060c*/ unsigned int             CorpseDragCount;
/*0x0610*/ uint8_t                  Light;
/*0x0614*/ unsigned int             LastMealTime;
/*0x0618*/ int                      Unknown3;
/*0x061c*/ unsigned int             EnduranceMax;
/*0x0620*/ int                      AFK;
/*0x0624*/ uint8_t                  IntimidateCount;
/*0x0628*/ unsigned int             StunTimer;
/*0x062c*/ bool                     bAnimationOnPop;
/*0x0630*/ unsigned int             NextIntimidateTime;
/*0x0634*/ bool                     bBetaBuffed;
/*0x0638*/ int                      CurrIOState;
/*0x063c*/ int                      Birthdate;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-08-13 (test) @ 0x1402ea95e
