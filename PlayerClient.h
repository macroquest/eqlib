...
/*0x01d0*/ int                      Anon;
/*0x01d4*/ uint8_t                  StandState;
/*0x01d8*/ int                      SecondaryTintIndex;
/*0x01dc*/ uint8_t                  IntimidateCount;
/*0x01e0*/ int                      Unknown1;
/*0x01e4*/ unsigned int             EnduranceMax;
/*0x01e8*/ void*                    pRaceGenderInfo;
/*0x01f0*/ int                      ManaCurrent;
/*0x01f4*/ uint8_t                  LastAttack;
/*0x01f8*/ int                      NpcTintIndex;
/*0x01fc*/ char                     Title[0x80];
/*0x027c*/ bool                     LFG;
/*0x0280*/ float                    MyWalkSpeed;
/*0x0284*/ unsigned int             FishingETA;
/*0x0288*/ int                      WarCry;
/*0x028c*/ int                      Trader;
/*0x0290*/ int                      DoSpecialMelee;
/*0x0294*/ char                     DragNames[2][0x40];
/*0x0318*/ void*                    pTouchingSwitch;
/*0x0320*/ bool                     bBetaBuffed;
/*0x0324*/ int                      Buyer;
/*0x0328*/ char                     Handle[0x20];
/*0x0348*/ uint8_t                  Original;
/*0x0349*/ bool                     bStationary;
/*0x034c*/ float                    CameraOffset;
/*0x0350*/ unsigned int             SpellCooldownETA;
/*0x0354*/ int                      PrimaryTintIndex;
/*0x0358*/ LaunchSpellData          CastingData;
/*0x039c*/ int                      PetID;
/*0x03a0*/ bool                     Sneak;
/*0x03a4*/ unsigned int             LastResendAddPlayerPacket;
/*0x03a8*/ bool                     bSwitchMoved;
/*0x03b0*/ int64_t                  HPMax;
/*0x03b8*/ int                      ManaMax;
/*0x03bc*/ EqItemGuid               realEstateItemGuid;
/*0x03ce*/ char                     Suffix[0x80];
/*0x044e*/ bool                     bShowHelm;
/*0x0450*/ unsigned int             Meditating;
/*0x0454*/ int                      EnduranceCurrent;
/*0x0458*/ uint8_t                  FishingEvent;
/*0x0459*/ uint8_t                  Blind;
/*0x045c*/ unsigned int             LastTick;
/*0x0460*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0468*/ bool                     bAnimationOnPop;
/*0x046c*/ unsigned int             RespawnTimer;
/*0x0470*/ int                      Birthdate;
/*0x0474*/ unsigned int             LastRefresh;
/*0x0478*/ unsigned int             MasterID;
/*0x047c*/ unsigned int             CorpseDragCount;
/*0x0480*/ char                     GM;
/*0x0481*/ char                     DraggingPlayer[0x40];
/*0x04c4*/ unsigned int             LastRangedUsedTime;
/*0x04c8*/ unsigned int**           ppUDP;
/*0x04d0*/ int                      Deity;
/*0x04d4*/ unsigned int             LoginSerial;
/*0x04d8*/ uint8_t                  FindBits;
/*0x04dc*/ CPhysicsInfo             LastCollision;
/*0x050c*/ bool                     bOfflineMode;
/*0x0510*/ float                    MissileRangeToTarget;
/*0x0514*/ char                     LoginRelated[0x20];
/*0x0534*/ int                      AFK;
/*0x0538*/ int64_t                  HPCurrent;
/*0x0540*/ unsigned int             LastTrapDamageTime;
/*0x0544*/ unsigned int             StunTimer;
/*0x0548*/ uint8_t                  FD;
/*0x0549*/ bool                     bSummoned;
/*0x054a*/ bool                     PvPFlag;
/*0x0550*/ int64_t                  GuildID;
/*0x0558*/ int                      Unknown4;
/*0x055c*/ int                      berserker;
/*0x0560*/ unsigned int             LastMealTime;
/*0x0564*/ int                      RealEstateItemId;
/*0x0568*/ int                      AltAttack;
/*0x056c*/ unsigned int             LastSecondaryUseTime;
/*0x0570*/ unsigned int             ACounter;
/*0x0574*/ float                    GetMeleeRangeVar1;
/*0x0578*/ unsigned int             LastTimeStoodStill;
/*0x057c*/ unsigned int             NextSwim;
/*0x0580*/ uint8_t                  InPvPArea;
/*0x0584*/ float                    ViewHeight;
/*0x0588*/ uint8_t                  TitleVisible;
/*0x0590*/ SPAWNINFO*               pViewPlayer;
/*0x0598*/ uint8_t                  Light;
/*0x059c*/ unsigned int             MinuteTimer;
/*0x05a0*/ float                    AnimationSpeedRelated;
/*0x05a4*/ uint8_t                  GMRank;
/*0x05a8*/ CharacterZoneClient*     pCharacter;
/*0x05b0*/ bool                     Mercenary;
/*0x05b4*/ float                    RunSpeed;
/*0x05b8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05c0*/ int                      RealEstateID;
/*0x05c4*/ int                      CurrIOState;
/*0x05c8*/ bool                     bAttackRelated;
/*0x05cc*/ float                    BearingToTarget;
/*0x05d0*/ bool                     Linkdead;
/*0x05d1*/ uint8_t                  CharClass;
/*0x05d4*/ int                      HideMode;
/*0x05d8*/ bool                     bTempPet;
/*0x05dc*/ unsigned int             SitStartTime;
/*0x05e0*/ bool                     bAlwaysShowAura;
/*0x05e1*/ uint8_t                  IsPassenger;
/*0x05e4*/ int                      Unknown3;
/*0x05e8*/ unsigned int             TimeStamp;
/*0x05ec*/ bool                     bBuffTimersOnHold;
/*0x05ed*/ uint8_t                  HoldingAnimation;
/*0x05f0*/ unsigned int             LastPrimaryUseTime;
/*0x05f4*/ unsigned int             Zone;
/*0x05f8*/ unsigned int             SpellGemETA[15];
/*0x0634*/ int                      SomeData[2];
/*0x063c*/ float                    MerchantGreed;
/*0x0640*/ int                      IsAttacking;
/*0x0644*/ unsigned int             NextIntimidateTime;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2023-07-13 (live) @ 0x1402dcdee
