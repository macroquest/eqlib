...
/*0x01cc*/ bool                     Mercenary;
/*0x01d0*/ int                      AltAttack;
/*0x01d4*/ unsigned int             ACounter;
/*0x01d8*/ unsigned int**           ppUDP;
/*0x01e0*/ char                     LoginRelated[0x20];
/*0x0200*/ CharacterZoneClient*     pCharacter;
/*0x0208*/ int                      Unknown4;
/*0x020c*/ int                      DoSpecialMelee;
/*0x0210*/ bool                     bBetaBuffed;
/*0x0214*/ float                    GetMeleeRangeVar1;
/*0x0218*/ uint8_t                  FishingEvent;
/*0x021c*/ unsigned int             RespawnTimer;
/*0x0220*/ float                    MerchantGreed;
/*0x0224*/ char                     Handle[0x20];
/*0x0244*/ float                    FallingStartZ;
/*0x0248*/ int                      Deity;
/*0x024c*/ int                      Unknown3;
/*0x0250*/ int                      ManaMax;
/*0x0254*/ int                      Anon;
/*0x0258*/ bool                     bTempPet;
/*0x025c*/ unsigned int             CorpseDragCount;
/*0x0260*/ unsigned int             LastRangedUsedTime;
/*0x0264*/ uint8_t                  InPvPArea;
/*0x0268*/ unsigned int             EnduranceMax;
/*0x026c*/ int                      RealEstateID;
/*0x0270*/ unsigned int             LastTimeStoodStill;
/*0x0274*/ unsigned int             LastResendAddPlayerPacket;
/*0x0278*/ int                      IsAttacking;
/*0x027c*/ unsigned int             SpellGemETA[15];
/*0x02b8*/ float                    RunSpeed;
/*0x02bc*/ bool                     Linkdead;
/*0x02c0*/ int                      Birthdate;
/*0x02c4*/ float                    AnimationSpeedRelated;
/*0x02c8*/ bool                     Sneak;
/*0x02cc*/ unsigned int             LastTrapDamageTime;
/*0x02d0*/ uint8_t                  Original;
/*0x02d4*/ unsigned int             MinuteTimer;
/*0x02d8*/ int                      ManaCurrent;
/*0x02dc*/ unsigned int             LastPrimaryUseTime;
/*0x02e0*/ uint8_t                  IntimidateCount;
/*0x02e4*/ float                    CameraOffset;
/*0x02e8*/ unsigned int             SpellCooldownETA;
/*0x02ec*/ bool                     bBuffTimersOnHold;
/*0x02f0*/ int                      NpcTintIndex;
/*0x02f4*/ uint8_t                  Light;
/*0x02f5*/ uint8_t                  TitleVisible;
/*0x02f8*/ int64_t                  HPCurrent;
/*0x0300*/ uint8_t                  FindBits;
/*0x0304*/ unsigned int             StunTimer;
/*0x0308*/ unsigned int             LastRefresh;
/*0x030c*/ uint8_t                  GMRank;
/*0x0310*/ int                      Buyer;
/*0x0314*/ unsigned int             Zone;
/*0x0318*/ unsigned int             MasterID;
/*0x031c*/ float                    MissileRangeToTarget;
/*0x0320*/ int                      PetID;
/*0x0324*/ int                      CurrIOState;
/*0x0328*/ SPAWNINFO*               pViewPlayer;
/*0x0330*/ char                     Suffix[0x80];
/*0x03b0*/ int                      Unknown1;
/*0x03b4*/ bool                     bStationary;
/*0x03b5*/ char                     Title[0x80];
/*0x0438*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0440*/ void*                    pRaceGenderInfo;
/*0x0448*/ char                     GM;
/*0x044c*/ int                      berserker;
/*0x0450*/ bool                     PvPFlag;
/*0x0454*/ unsigned int             FishingETA;
/*0x0458*/ unsigned int             TimeStamp;
/*0x045c*/ bool                     bSwitchMoved;
/*0x0460*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0468*/ int                      HideMode;
/*0x046c*/ float                    BearingToTarget;
/*0x0470*/ uint8_t                  HoldingAnimation;
/*0x0471*/ uint8_t                  Level;
/*0x0474*/ int                      Trader;
/*0x0478*/ int                      PrimaryTintIndex;
/*0x047c*/ EqItemGuid               realEstateItemGuid;
/*0x0490*/ CPhysicsInfo             LastCollision;
/*0x04c0*/ uint8_t                  CharClass;
/*0x04c1*/ bool                     bAttackRelated;
/*0x04c4*/ int                      SecondaryTintIndex;
/*0x04c8*/ char                     DragNames[2][0x40];
/*0x0548*/ bool                     bSummoned;
/*0x0549*/ bool                     LFG;
/*0x054c*/ int                      RealEstateItemId;
/*0x0550*/ unsigned int             NextIntimidateTime;
/*0x0554*/ bool                     bOfflineMode;
/*0x0558*/ unsigned int             Meditating;
/*0x055c*/ char                     DraggingPlayer[0x40];
/*0x059c*/ unsigned int             LoginSerial;
/*0x05a0*/ unsigned int             SitStartTime;
/*0x05a4*/ unsigned int             LastMealTime;
/*0x05a8*/ uint8_t                  StandState;
/*0x05a9*/ uint8_t                  IsPassenger;
/*0x05ac*/ unsigned int             NextSwim;
/*0x05b0*/ LaunchSpellData          CastingData;
/*0x05f4*/ float                    ViewHeight;
/*0x05f8*/ uint8_t                  LastAttack;
/*0x0600*/ int64_t                  HPMax;
/*0x0608*/ int64_t                  GuildID;
/*0x0610*/ int                      EnduranceCurrent;
/*0x0614*/ float                    MyWalkSpeed;
/*0x0618*/ int                      WarCry;
/*0x0620*/ void*                    pTouchingSwitch;
/*0x0628*/ bool                     bShowHelm;
/*0x062c*/ unsigned int             LastSecondaryUseTime;
/*0x0630*/ int                      SomeData[2];
/*0x0638*/ uint8_t                  FD;
/*0x0639*/ uint8_t                  Blind;
/*0x063a*/ bool                     bAnimationOnPop;
/*0x063c*/ int                      AFK;
/*0x0640*/ unsigned int             LastTick;
/*0x0644*/ bool                     bAlwaysShowAura;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-07-11 (test) @ 0x1402ea87e
