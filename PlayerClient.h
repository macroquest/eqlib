...
/*0x01cc*/ int                      WarCry;
/*0x01d0*/ int                      Unknown3;
/*0x01d4*/ unsigned int             LastPrimaryUseTime;
/*0x01d8*/ uint8_t                  Light;
/*0x01d9*/ bool                     bAttackRelated;
/*0x01da*/ bool                     bBetaBuffed;
/*0x01dc*/ unsigned int             LoginSerial;
/*0x01e0*/ uint8_t                  Level;
/*0x01e1*/ char                     Suffix[0x80];
/*0x0261*/ char                     DragNames[2][0x40];
/*0x02e1*/ uint8_t                  IsPassenger;
/*0x02e2*/ bool                     bSummoned;
/*0x02e4*/ unsigned int             LastTrapDamageTime;
/*0x02e8*/ char                     GM;
/*0x02e9*/ uint8_t                  Blind;
/*0x02ec*/ int                      Birthdate;
/*0x02f0*/ float                    CameraOffset;
/*0x02f4*/ EqItemGuid               realEstateItemGuid;
/*0x0308*/ int                      EnduranceCurrent;
/*0x030c*/ bool                     Sneak;
/*0x0310*/ int                      PetID;
/*0x0314*/ int                      Unknown4;
/*0x0318*/ uint8_t                  LastAttack;
/*0x0319*/ char                     DraggingPlayer[0x40];
/*0x0359*/ char                     LoginRelated[0x20];
/*0x0379*/ bool                     bAlwaysShowAura;
/*0x0380*/ int64_t                  GuildID;
/*0x0388*/ float                    RunSpeed;
/*0x038c*/ int                      RealEstateItemId;
/*0x0390*/ void*                    pRaceGenderInfo;
/*0x0398*/ LaunchSpellData          CastingData;
/*0x03dc*/ uint8_t                  FindBits;
/*0x03e0*/ int                      Buyer;
/*0x03e4*/ int                      ManaMax;
/*0x03e8*/ unsigned int             LastSecondaryUseTime;
/*0x03ec*/ bool                     bBuffTimersOnHold;
/*0x03f0*/ int                      IsAttacking;
/*0x03f4*/ float                    BearingToTarget;
/*0x03f8*/ unsigned int             SpellGemETA[15];
/*0x0434*/ unsigned int             MinuteTimer;
/*0x0438*/ int                      CurrIOState;
/*0x043c*/ int                      Unknown1;
/*0x0440*/ float                    MissileRangeToTarget;
/*0x0444*/ uint8_t                  TitleVisible;
/*0x0445*/ bool                     bStationary;
/*0x0446*/ bool                     bOfflineMode;
/*0x0448*/ int                      berserker;
/*0x044c*/ float                    AnimationSpeedRelated;
/*0x0450*/ uint8_t                  CharClass;
/*0x0451*/ uint8_t                  InPvPArea;
/*0x0452*/ uint8_t                  Original;
/*0x0458*/ void*                    pTouchingSwitch;
/*0x0460*/ int                      ManaCurrent;
/*0x0464*/ float                    FallingStartZ;
/*0x0468*/ unsigned int             LastTimeStoodStill;
/*0x0470*/ SPAWNINFO*               pViewPlayer;
/*0x0478*/ int                      AltAttack;
/*0x0480*/ unsigned int**           ppUDP;
...
/*0x049c*/ unsigned int             RespawnTimer;
...
/*0x04b0*/ uint8_t                  IntimidateCount;
/*0x04b4*/ float                    GetMeleeRangeVar1;
/*0x04b8*/ uint8_t                  FD;
/*0x04b9*/ bool                     PvPFlag;
/*0x04bc*/ int                      SomeData[2];
/*0x04c4*/ unsigned int             ACounter;
/*0x04c8*/ unsigned int             LastTick;
/*0x04d0*/ int64_t                  HPMax;
/*0x04d8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x04e0*/ unsigned int             StunTimer;
/*0x04e4*/ bool                     bAnimationOnPop;
/*0x04e8*/ int                      SecondaryTintIndex;
/*0x04ec*/ bool                     Mercenary;
/*0x04ed*/ uint8_t                  GMRank;
/*0x04ee*/ bool                     bTempPet;
/*0x04f0*/ int                      AFK;
/*0x04f4*/ unsigned int             Zone;
/*0x04f8*/ uint8_t                  StandState;
/*0x04fc*/ unsigned int             NextIntimidateTime;
/*0x0500*/ float                    MyWalkSpeed;
/*0x0504*/ int                      HideMode;
/*0x0508*/ unsigned int             LastRefresh;
/*0x050c*/ char                     Handle[0x20];
/*0x052c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0530*/ CharacterZoneClient*     pCharacter;
/*0x0538*/ bool                     LFG;
/*0x053c*/ unsigned int             SpellCooldownETA;
/*0x0540*/ int                      NpcTintIndex;
/*0x0544*/ float                    ViewHeight;
/*0x0548*/ unsigned int             NextSwim;
/*0x054c*/ unsigned int             CorpseDragCount;
/*0x0550*/ char                     Title[0x80];
/*0x05d0*/ int                      Anon;
/*0x05d4*/ int                      PrimaryTintIndex;
/*0x05d8*/ float                    MerchantGreed;
/*0x05dc*/ int                      Deity;
/*0x05e0*/ uint8_t                  HoldingAnimation;
/*0x05e8*/ int64_t                  HPCurrent;
/*0x05f0*/ bool                     bSwitchMoved;
/*0x05f4*/ int                      DoSpecialMelee;
/*0x05f8*/ int                      Trader;
/*0x05fc*/ CPhysicsInfo             LastCollision;
/*0x062c*/ unsigned int             SitStartTime;
/*0x0630*/ bool                     bShowHelm;
/*0x0631*/ uint8_t                  FishingEvent;
/*0x0634*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-05-15 (test) @ 0x14030140e
