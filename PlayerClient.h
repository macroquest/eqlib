...
/*0x01d0*/ int                      SomeData[2];
/*0x01d8*/ char                     DragNames[2][0x40];
/*0x0258*/ bool                     Linkdead;
/*0x025c*/ unsigned int             MinuteTimer;
/*0x0260*/ bool                     bBetaBuffed;
/*0x0264*/ unsigned int             LastRangedUsedTime;
/*0x0268*/ float                    RunSpeed;
/*0x026c*/ uint8_t                  TitleVisible;
/*0x0270*/ unsigned int             EnduranceMax;
/*0x0274*/ int                      ManaMax;
/*0x0278*/ float                    CameraOffset;
/*0x027c*/ uint8_t                  Level;
/*0x0280*/ int                      CurrIOState;
/*0x0284*/ unsigned int             LastPrimaryUseTime;
/*0x0288*/ unsigned int             TimeStamp;
/*0x028c*/ unsigned int             NextIntimidateTime;
/*0x0290*/ unsigned int             LastTimeStoodStill;
/*0x0298*/ int64_t                  GuildID;
/*0x02a0*/ int                      berserker;
/*0x02a4*/ char                     DraggingPlayer[0x40];
/*0x02e4*/ unsigned int             SitStartTime;
/*0x02e8*/ int                      WarCry;
/*0x02ec*/ bool                     Sneak;
/*0x02f0*/ unsigned int             CorpseDragCount;
/*0x02f4*/ unsigned int             LastRefresh;
/*0x02f8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0300*/ bool                     bShowHelm;
/*0x0304*/ int                      SecondaryTintIndex;
/*0x0308*/ int                      PetID;
/*0x0310*/ SPAWNINFO*               pViewPlayer;
/*0x0318*/ int64_t                  HPMax;
/*0x0320*/ float                    MyWalkSpeed;
/*0x0324*/ char                     Title[0x80];
/*0x03a4*/ int                      AFK;
/*0x03a8*/ int                      Buyer;
/*0x03ac*/ uint8_t                  FD;
/*0x03ad*/ bool                     Mercenary;
/*0x03b0*/ unsigned int             LoginSerial;
/*0x03b4*/ bool                     bOfflineMode;
/*0x03b5*/ bool                     bSummoned;
/*0x03b8*/ unsigned int             ACounter;
/*0x03bc*/ unsigned int             LastMealTime;
/*0x03c0*/ unsigned int             StunTimer;
/*0x03c4*/ int                      Unknown4;
/*0x03c8*/ int                      EnduranceCurrent;
/*0x03cc*/ bool                     PvPFlag;
/*0x03cd*/ EqItemGuid               realEstateItemGuid;
/*0x03e0*/ unsigned int             LastSecondaryUseTime;
/*0x03e4*/ int                      NpcTintIndex;
/*0x03e8*/ char                     GM;
/*0x03ec*/ int                      AltAttack;
/*0x03f0*/ uint8_t                  Original;
/*0x03f4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x03fc*/ unsigned int             NextSwim;
/*0x0400*/ float                    MerchantGreed;
/*0x0404*/ int                      Deity;
/*0x0408*/ uint8_t                  StandState;
/*0x0410*/ int64_t                  HPCurrent;
/*0x0418*/ LaunchSpellData          CastingData;
/*0x045c*/ uint8_t                  InPvPArea;
/*0x0460*/ unsigned int             RespawnTimer;
/*0x0464*/ int                      RealEstateID;
/*0x0468*/ bool                     bBuffTimersOnHold;
/*0x0469*/ bool                     bSwitchMoved;
/*0x046c*/ int                      IsAttacking;
/*0x0470*/ unsigned int             FishingETA;
/*0x0474*/ uint8_t                  FindBits;
/*0x0478*/ int                      DoSpecialMelee;
/*0x047c*/ char                     Handle[0x20];
/*0x049c*/ int                      RealEstateItemId;
/*0x04a0*/ unsigned int             SpellGemETA[15];
/*0x04e0*/ void*                    pRaceGenderInfo;
/*0x04e8*/ unsigned int**           ppUDP;
/*0x04f0*/ float                    ViewHeight;
/*0x04f4*/ float                    AnimationSpeedRelated;
/*0x04f8*/ float                    BearingToTarget;
/*0x04fc*/ uint8_t                  LastAttack;
/*0x0500*/ CPhysicsInfo             LastCollision;
/*0x0530*/ unsigned int             LastTick;
/*0x0534*/ char                     LoginRelated[0x20];
/*0x0554*/ unsigned int             Zone;
/*0x0558*/ bool                     LFG;
/*0x0559*/ uint8_t                  Light;
/*0x055c*/ int                      Anon;
/*0x0560*/ unsigned int             MasterID;
/*0x0568*/ void*                    pTouchingSwitch;
/*0x0570*/ int                      HideMode;
/*0x0574*/ bool                     bTempPet;
/*0x0578*/ int                      Unknown1;
/*0x057c*/ uint8_t                  FishingEvent;
/*0x0580*/ unsigned int             LastResendAddPlayerPacket;
/*0x0584*/ float                    MissileRangeToTarget;
/*0x0588*/ bool                     bStationary;
/*0x058c*/ float                    GetMeleeRangeVar1;
/*0x0590*/ int                      PrimaryTintIndex;
/*0x0594*/ float                    FallingStartZ;
/*0x0598*/ int                      Trader;
/*0x059c*/ uint8_t                  HoldingAnimation;
/*0x059d*/ uint8_t                  IsPassenger;
/*0x059e*/ uint8_t                  Blind;
/*0x059f*/ bool                     bAnimationOnPop;
/*0x05a0*/ unsigned int             LastTrapDamageTime;
/*0x05a4*/ bool                     bAttackRelated;
/*0x05a5*/ char                     Suffix[0x80];
/*0x0628*/ CharacterZoneClient*     pCharacter;
/*0x0630*/ uint8_t                  CharClass;
/*0x0631*/ bool                     bAlwaysShowAura;
/*0x0634*/ unsigned int             SpellCooldownETA;
/*0x0638*/ unsigned int             Meditating;
/*0x063c*/ uint8_t                  GMRank;
/*0x0640*/ int                      Unknown3;
/*0x0644*/ int                      Birthdate;
/*0x0648*/ uint8_t                  IntimidateCount;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2023-08-25 (test) @ 0x1402ddfbe
