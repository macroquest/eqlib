...
/*0x01bc*/ unsigned int             StunTimer;
/*0x01c0*/ unsigned int             LastResendAddPlayerPacket;
/*0x01c4*/ unsigned int             MinuteTimer;
/*0x01c8*/ int                      NpcTintIndex;
/*0x01d0*/ SPAWNINFO*               pViewPlayer;
/*0x01d8*/ unsigned int             Meditating;
/*0x01dc*/ float                    AnimationSpeedRelated;
/*0x01e0*/ unsigned int             SpellGemETA[15];
/*0x021c*/ float                    FallingStartZ;
/*0x0220*/ int                      RealEstateID;
/*0x0224*/ bool                     bAttackRelated;
/*0x0225*/ uint8_t                  HmmWhat;
/*0x0228*/ int                      Anon;
/*0x022c*/ char                     GM;
/*0x022d*/ bool                     LFG;
/*0x0230*/ unsigned int             ACounter;
/*0x0234*/ bool                     Mercenary;
/*0x0238*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0240*/ unsigned int             LastMealTime;
/*0x0244*/ int                      DoSpecialMelee;
/*0x0248*/ bool                     bBetaBuffed;
/*0x024c*/ unsigned int             Zone;
/*0x0250*/ float                    BearingToTarget;
/*0x0254*/ float                    RunSpeed;
/*0x0258*/ unsigned int             EnduranceMax;
/*0x025c*/ int                      LastCastNum;
/*0x0260*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0268*/ unsigned int             SitStartTime;
/*0x0270*/ int64_t                  HPCurrent;
/*0x0278*/ unsigned int             NextIntimidateTime;
/*0x027c*/ uint8_t                  GMRank;
/*0x0280*/ float                    ViewHeight;
/*0x0284*/ bool                     bAnimationOnPop;
/*0x0288*/ int                      SomethingElse;
/*0x028c*/ int                      Dontknowyet2;
/*0x0290*/ char                     LoginRelated[0x20];
/*0x02b0*/ bool                     bTempPet;
/*0x02b4*/ int                      HideMode;
/*0x02b8*/ unsigned int             MasterID;
/*0x02bc*/ unsigned int             NextSwim;
/*0x02c0*/ int                      berserker;
/*0x02c4*/ unsigned int             RespawnTimer;
/*0x02c8*/ char                     Title[0x80];
/*0x0348*/ bool                     bOfflineMode;
/*0x034c*/ CPhysicsInfo             LastCollision;
/*0x037c*/ bool                     bSwitchMoved;
/*0x0380*/ unsigned int             LoginSerial;
/*0x0384*/ unsigned int             SpellCooldownETA;
/*0x0388*/ int                      PrimaryTintIndex;
/*0x0390*/ void*                    pRaceGenderInfo;
/*0x0398*/ uint8_t                  IntimidateCount;
/*0x039c*/ float                    MyWalkSpeed;
/*0x03a0*/ bool                     bSummoned;
/*0x03a4*/ unsigned int             LastTimeStoodStill;
/*0x03a8*/ float                    CameraOffset;
/*0x03ac*/ uint8_t                  FD;
/*0x03ad*/ bool                     bStationary;
/*0x03b0*/ unsigned int**           ppUDP;
/*0x03b8*/ int                      Buyer;
/*0x03bc*/ int                      ManaCurrent;
/*0x03c0*/ CharacterZoneClient*     pCharacter;
/*0x03c8*/ bool                     PvPFlag;
/*0x03c9*/ char                     Handle[0x20];
/*0x03ec*/ unsigned int             LastSecondaryUseTime;
/*0x03f0*/ char                     DragNames[2][0x40];
/*0x0470*/ char                     Suffix[0x80];
/*0x04f0*/ int                      CurrIOState;
/*0x04f4*/ int                      Trader;
/*0x04f8*/ unsigned int             LastRangedUsedTime;
/*0x04fc*/ uint8_t                  Type2;
/*0x04fd*/ uint8_t                  CharClass;
/*0x04fe*/ uint8_t                  FindBits;
/*0x04ff*/ uint8_t                  StandState;
/*0x0500*/ bool                     Sneak;
/*0x0504*/ int                      AltAttack;
/*0x0508*/ float                    MerchantGreed;
/*0x050c*/ int                      WarCry;
/*0x0510*/ float                    GetMeleeRangeVar1;
/*0x0514*/ unsigned int             LastRefresh;
/*0x0518*/ int                      RealEstateItemId;
/*0x0520*/ int64_t                  HPMax;
/*0x0528*/ uint8_t                  Blind;
/*0x052c*/ int                      SomeData[2];
/*0x0534*/ uint8_t                  HoldingAnimation;
/*0x0535*/ bool                     bShowHelm;
/*0x0538*/ int                      DontKnowYet;
/*0x053c*/ int                      PetID;
/*0x0540*/ int                      Stuff;
/*0x0544*/ LaunchSpellData          CastingData;
/*0x059c*/ int                      SecondaryTintIndex;
/*0x05a0*/ char                     DraggingPlayer[0x40];
/*0x05e0*/ uint8_t                  FishingEvent;
/*0x05e1*/ uint8_t                  Level;
/*0x05e2*/ bool                     bAlwaysShowAura;
/*0x05e4*/ unsigned int             LastCastTime;
/*0x05e8*/ unsigned int             TimeStamp;
/*0x05ec*/ unsigned int             LastTick;
/*0x05f0*/ bool                     bBuffTimersOnHold;
/*0x05f1*/ uint8_t                  LastAttack;
/*0x05f4*/ unsigned int             FishingETA;
/*0x05f8*/ unsigned int             LastPrimaryUseTime;
/*0x05fc*/ float                    MissileRangeToTarget;
/*0x0600*/ int                      ManaMax;
/*0x0604*/ uint8_t                  IsPassenger;
/*0x0605*/ uint8_t                  TitleVisible;
/*0x0608*/ int                      EnduranceCurrent;
/*0x060c*/ bool                     Linkdead;
/*0x060d*/ uint8_t                  Light;
/*0x0610*/ int                      AFK;
/*0x0614*/ uint8_t                  InPvPArea;
/*0x0618*/ int64_t                  GuildID;
/*0x0620*/ void*                    pTouchingSwitch;
/*0x0628*/ unsigned int             CorpseDragCount;
/*0x062c*/ int                      Deity;
/*0x0630*/ unsigned int             LastTrapDamageTime;
/*0x0634*/ EqItemGuid               realEstateItemGuid;
/*0x0648*/ int                      IsAttacking;
...
/*0x0fd0*/ ActorClient        mActorClient; // fc8
...
// @sizeof(PlayerClient) == 0x1f70 :: 2022-08-26 (test) @ 0x1402a119e
