...
/*0x01cc*/ unsigned int             StunTimer;
/*0x01d0*/ uint8_t                  GMRank;
/*0x01d4*/ unsigned int             LastRangedUsedTime;
/*0x01d8*/ uint8_t                  LastAttack;
/*0x01d9*/ bool                     bBetaBuffed;
/*0x01e0*/ int64_t                  HPMax;
/*0x01e8*/ uint8_t                  FD;
/*0x01e9*/ uint8_t                  FishingEvent;
/*0x01ea*/ uint8_t                  IntimidateCount;
/*0x01eb*/ bool                     bSummoned;
/*0x01ec*/ bool                     bAlwaysShowAura;
/*0x01f0*/ float                    ViewHeight;
/*0x01f4*/ float                    GetMeleeRangeVar1;
/*0x01f8*/ int                      PrimaryTintIndex;
/*0x01fc*/ char                     Handle[0x20];
/*0x021c*/ unsigned int             SitStartTime;
/*0x0220*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0228*/ int                      IsAttacking;
/*0x022c*/ int                      RealEstateItemId;
/*0x0230*/ unsigned int             NextSwim;
/*0x0234*/ bool                     PvPFlag;
/*0x0238*/ int                      Unknown1;
/*0x023c*/ int                      DoSpecialMelee;
/*0x0240*/ uint8_t                  InPvPArea;
/*0x0241*/ EqItemGuid               realEstateItemGuid;
/*0x0253*/ bool                     bShowHelm;
/*0x0258*/ unsigned int**           ppUDP;
/*0x0260*/ float                    MyWalkSpeed;
/*0x0264*/ bool                     LFG;
/*0x0268*/ float                    MerchantGreed;
/*0x026c*/ unsigned int             LastTick;
/*0x0270*/ unsigned int             LastMealTime;
/*0x0274*/ uint8_t                  CharClass;
/*0x0275*/ bool                     bAnimationOnPop;
/*0x0278*/ unsigned int             ACounter;
/*0x027c*/ bool                     Sneak;
/*0x0280*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0288*/ int                      AltAttack;
/*0x028c*/ unsigned int             RespawnTimer;
/*0x0290*/ uint8_t                  Blind;
/*0x0294*/ int                      ManaCurrent;
/*0x0298*/ int                      SomeData[2];
/*0x02a0*/ int                      Buyer;
/*0x02a4*/ float                    AnimationSpeedRelated;
/*0x02a8*/ char                     Title[0x80];
/*0x0328*/ float                    FallingStartZ;
/*0x032c*/ int                      Birthdate;
/*0x0330*/ uint8_t                  Original;
/*0x0331*/ bool                     bOfflineMode;
/*0x0334*/ unsigned int             CorpseDragCount;
/*0x0338*/ bool                     Linkdead;
/*0x033c*/ unsigned int             LastTrapDamageTime;
/*0x0340*/ int                      NpcTintIndex;
/*0x0344*/ float                    CameraOffset;
/*0x0348*/ char                     DraggingPlayer[0x40];
/*0x0388*/ int                      SecondaryTintIndex;
/*0x038c*/ unsigned int             LastTimeStoodStill;
/*0x0390*/ int                      ManaMax;
/*0x0394*/ char                     Suffix[0x80];
/*0x0414*/ unsigned int             LastSecondaryUseTime;
/*0x0418*/ LaunchSpellData          CastingData;
/*0x045c*/ unsigned int             LoginSerial;
/*0x0460*/ bool                     Mercenary;
/*0x0464*/ unsigned int             LastPrimaryUseTime;
/*0x0468*/ char                     DragNames[2][0x40];
/*0x04e8*/ unsigned int             MasterID;
/*0x04ec*/ int                      HideMode;
/*0x04f0*/ int                      EnduranceCurrent;
/*0x04f4*/ CPhysicsInfo             LastCollision;
/*0x0524*/ unsigned int             LastRefresh;
/*0x0528*/ unsigned int             TimeStamp;
/*0x052c*/ uint8_t                  Light;
/*0x0530*/ unsigned int             NextIntimidateTime;
/*0x0534*/ unsigned int             Zone;
/*0x0538*/ int                      berserker;
/*0x053c*/ unsigned int             MinuteTimer;
/*0x0540*/ unsigned int             FishingETA;
/*0x0544*/ uint8_t                  Level;
/*0x0548*/ int64_t                  GuildID;
/*0x0550*/ uint8_t                  TitleVisible;
/*0x0554*/ unsigned int             SpellGemETA[15];
/*0x0590*/ int                      CurrIOState;
/*0x0594*/ unsigned int             SpellCooldownETA;
/*0x0598*/ int                      PetID;
/*0x059c*/ uint8_t                  StandState;
/*0x059d*/ bool                     bTempPet;
/*0x05a0*/ int64_t                  HPCurrent;
/*0x05a8*/ float                    MissileRangeToTarget;
/*0x05b0*/ CharacterZoneClient*     pCharacter;
/*0x05b8*/ unsigned int             EnduranceMax;
/*0x05bc*/ uint8_t                  FindBits;
/*0x05bd*/ bool                     bStationary;
/*0x05be*/ char                     GM;
/*0x05c0*/ unsigned int             Meditating;
/*0x05c4*/ bool                     bAttackRelated;
/*0x05c8*/ int                      Anon;
/*0x05cc*/ int                      WarCry;
/*0x05d0*/ char                     LoginRelated[0x20];
/*0x05f0*/ void*                    pTouchingSwitch;
/*0x05f8*/ int                      RealEstateID;
/*0x05fc*/ int                      Trader;
/*0x0600*/ int                      Deity;
/*0x0604*/ bool                     bBuffTimersOnHold;
/*0x0608*/ int                      Unknown4;
/*0x060c*/ uint8_t                  HoldingAnimation;
/*0x0610*/ int                      Unknown3;
/*0x0618*/ SPAWNINFO*               pViewPlayer;
/*0x0620*/ float                    RunSpeed;
/*0x0624*/ float                    BearingToTarget;
/*0x0628*/ int                      AFK;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2023-08-08 (test) @ 0x1402de12e
