...
/*0x0258*/ char                     Suffix[0x80];
/*0x02d8*/ unsigned int             MasterID;
/*0x02dc*/ unsigned int             LoginSerial;
/*0x02e0*/ bool                     bAlwaysShowAura;
/*0x02e1*/ uint8_t                  IsPassenger;
/*0x02e2*/ uint8_t                  TitleVisible;
/*0x02e4*/ float                    GetMeleeRangeVar1;
/*0x02e8*/ EqItemGuid               realEstateItemGuid;
/*0x02fc*/ unsigned int             LastTrapDamageTime;
/*0x0300*/ unsigned int             LastRangedUsedTime;
/*0x0304*/ float                    MerchantGreed;
/*0x0308*/ int                      Unknown3;
/*0x030c*/ bool                     Sneak;
/*0x0310*/ float                    MyWalkSpeed;
/*0x0314*/ unsigned int             FishingETA;
/*0x0318*/ uint8_t                  CharClass;
/*0x031c*/ int                      SecondaryTintIndex;
/*0x0320*/ bool                     bAnimationOnPop;
/*0x0321*/ uint8_t                  GMRank;
/*0x0322*/ uint8_t                  FishingEvent;
/*0x0324*/ unsigned int             LastMealTime;
/*0x0328*/ bool                     bBuffTimersOnHold;
/*0x032c*/ int                      Trader;
/*0x0330*/ uint8_t                  Level;
/*0x0338*/ CharacterZoneClient*     pCharacter;
/*0x0340*/ int                      RealEstateID;
/*0x0344*/ unsigned int             Meditating;
/*0x0348*/ bool                     Linkdead;
/*0x034c*/ unsigned int             RespawnTimer;
/*0x0350*/ int64_t                  HPCurrent;
/*0x0358*/ int                      AFK;
/*0x035c*/ unsigned int             SpellGemETA[15];
/*0x0398*/ unsigned int             NextIntimidateTime;
/*0x039c*/ unsigned int             TimeStamp;
/*0x03a0*/ unsigned int             LastResendAddPlayerPacket;
/*0x03a4*/ int                      AltAttack;
/*0x03a8*/ unsigned int             SitStartTime;
/*0x03ac*/ int                      Unknown1;
/*0x03b0*/ bool                     PvPFlag;
/*0x03b4*/ int                      DoSpecialMelee;
/*0x03b8*/ uint8_t                  LastAttack;
/*0x03b9*/ uint8_t                  InPvPArea;
/*0x03bc*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x03c4*/ float                    ViewHeight;
/*0x03c8*/ unsigned int             LastTimeStoodStill;
/*0x03cc*/ int                      CurrIOState;
/*0x03d0*/ SPAWNINFO*               pViewPlayer;
/*0x03d8*/ int                      Unknown4;
/*0x03dc*/ unsigned int             CorpseDragCount;
/*0x03e0*/ int                      ManaMax;
/*0x03e4*/ uint8_t                  FD;
/*0x03e8*/ CPhysicsInfo             LastCollision;
/*0x0418*/ int                      IsAttacking;
/*0x041c*/ LaunchSpellData          CastingData;
/*0x0460*/ unsigned int             LastTick;
/*0x0464*/ uint8_t                  StandState;
/*0x0465*/ char                     Handle[0x20];
/*0x0485*/ bool                     bBetaBuffed;
/*0x0488*/ float                    MissileRangeToTarget;
/*0x048c*/ int                      ManaCurrent;
/*0x0490*/ int                      WarCry;
/*0x0494*/ bool                     LFG;
/*0x0498*/ int                      Birthdate;
/*0x049c*/ bool                     bAttackRelated;
/*0x04a0*/ void*                    pTouchingSwitch;
/*0x04a8*/ unsigned int**           ppUDP;
/*0x04b0*/ void*                    pRaceGenderInfo;
/*0x04b8*/ bool                     bSummoned;
/*0x04bc*/ unsigned int             MinuteTimer;
/*0x04c0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x04c8*/ int                      EnduranceCurrent;
/*0x04cc*/ char                     DraggingPlayer[0x40];
/*0x050c*/ char                     DragNames[2][0x40];
/*0x058c*/ int                      berserker;
/*0x0590*/ uint8_t                  IntimidateCount;
/*0x0594*/ int                      RealEstateItemId;
/*0x0598*/ float                    AnimationSpeedRelated;
/*0x059c*/ bool                     bSwitchMoved;
/*0x059d*/ uint8_t                  FindBits;
/*0x05a0*/ int                      PrimaryTintIndex;
/*0x05a4*/ uint8_t                  Light;
/*0x05a5*/ bool                     bShowHelm;
/*0x05a8*/ int                      NpcTintIndex;
/*0x05ac*/ uint8_t                  HoldingAnimation;
/*0x05b0*/ unsigned int             LastRefresh;
/*0x05b4*/ unsigned int             StunTimer;
/*0x05b8*/ unsigned int             NextSwim;
/*0x05c0*/ int64_t                  HPMax;
/*0x05c8*/ int                      Anon;
/*0x05cc*/ int                      SomeData[2];
/*0x05d4*/ float                    FallingStartZ;
/*0x05d8*/ int                      Buyer;
/*0x05dc*/ bool                     bOfflineMode;
/*0x05e0*/ unsigned int             LastSecondaryUseTime;
/*0x05e4*/ uint8_t                  Original;
/*0x05e8*/ unsigned int             ACounter;
/*0x05ec*/ bool                     bStationary;
/*0x05f0*/ float                    BearingToTarget;
/*0x05f4*/ char                     GM;
/*0x05f5*/ bool                     Mercenary;
/*0x05f8*/ unsigned int             LastPrimaryUseTime;
/*0x05fc*/ uint8_t                  Blind;
/*0x0600*/ int                      HideMode;
/*0x0604*/ int                      Deity;
/*0x0608*/ bool                     bTempPet;
/*0x0609*/ char                     LoginRelated[0x20];
/*0x062c*/ float                    RunSpeed;
/*0x0630*/ unsigned int             EnduranceMax;
/*0x0634*/ float                    CameraOffset;
/*0x0638*/ unsigned int             Zone;
/*0x063c*/ unsigned int             SpellCooldownETA;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2024-02-27 (test) @ 0x1402e1ffe
