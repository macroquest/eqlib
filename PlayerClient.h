...
/*0x01cc*/ int                      berserker;
/*0x01d0*/ SPAWNINFO*               pViewPlayer;
/*0x01d8*/ uint8_t                  CharClass;
/*0x01dc*/ int                      Trader;
/*0x01e0*/ int                      AFK;
/*0x01e4*/ bool                     bBetaBuffed;
/*0x01e8*/ int                      EnduranceCurrent;
/*0x01ec*/ unsigned int             LastRangedUsedTime;
/*0x01f0*/ uint8_t                  Original;
/*0x01f1*/ char                     Suffix[0x80];
/*0x0274*/ int                      SomeData[2];
/*0x027c*/ unsigned int             FishingETA;
/*0x0280*/ uint8_t                  LastAttack;
/*0x0281*/ uint8_t                  IntimidateCount;
/*0x0284*/ unsigned int             LastMealTime;
/*0x0288*/ bool                     Mercenary;
/*0x028c*/ int                      RealEstateID;
/*0x0290*/ int                      Deity;
/*0x0294*/ float                    MerchantGreed;
/*0x0298*/ unsigned int             NextIntimidateTime;
/*0x029c*/ unsigned int             CorpseDragCount;
/*0x02a0*/ unsigned int             LastTick;
/*0x02a4*/ float                    GetMeleeRangeVar1;
/*0x02a8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x02b0*/ uint8_t                  FD;
/*0x02b8*/ void*                    pRaceGenderInfo;
...
/*0x02e0*/ unsigned int             StunTimer;
/*0x02e4*/ uint8_t                  TitleVisible;
/*0x02e8*/ int                      Unknown4;
/*0x02ec*/ unsigned int             LastResendAddPlayerPacket;
/*0x02f0*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x02f8*/ unsigned int             LastPrimaryUseTime;
/*0x02fc*/ unsigned int             Meditating;
/*0x0300*/ bool                     LFG;
/*0x0301*/ EqItemGuid               realEstateItemGuid;
/*0x0318*/ void*                    pTouchingSwitch;
/*0x0320*/ uint8_t                  Level;
/*0x0324*/ int                      DoSpecialMelee;
/*0x0328*/ unsigned int**           ppUDP;
/*0x0330*/ unsigned int             SitStartTime;
/*0x0334*/ float                    MissileRangeToTarget;
/*0x0338*/ uint8_t                  FindBits;
/*0x0339*/ uint8_t                  StandState;
/*0x033c*/ int                      WarCry;
/*0x0340*/ int                      Buyer;
/*0x0344*/ int                      SecondaryTintIndex;
/*0x0348*/ unsigned int             LastTrapDamageTime;
/*0x034c*/ uint8_t                  FishingEvent;
/*0x034d*/ uint8_t                  InPvPArea;
/*0x0350*/ float                    BearingToTarget;
/*0x0354*/ int                      ManaCurrent;
/*0x0358*/ unsigned int             EnduranceMax;
/*0x035c*/ float                    MyWalkSpeed;
/*0x0360*/ float                    CameraOffset;
/*0x0364*/ bool                     bAnimationOnPop;
/*0x0368*/ int                      Unknown1;
/*0x036c*/ int                      Birthdate;
/*0x0370*/ char                     Handle[0x20];
/*0x0390*/ unsigned int             LoginSerial;
/*0x0398*/ int64_t                  GuildID;
/*0x03a0*/ unsigned int             MinuteTimer;
/*0x03a4*/ CPhysicsInfo             LastCollision;
/*0x03d4*/ int                      PrimaryTintIndex;
/*0x03d8*/ bool                     bBuffTimersOnHold;
/*0x03d9*/ bool                     bAttackRelated;
/*0x03dc*/ int                      Unknown3;
/*0x03e0*/ unsigned int             LastTimeStoodStill;
/*0x03e4*/ unsigned int             ACounter;
/*0x03e8*/ unsigned int             Zone;
/*0x03ec*/ uint8_t                  Blind;
/*0x03f0*/ unsigned int             MasterID;
/*0x03f4*/ float                    FallingStartZ;
/*0x03f8*/ char                     GM;
/*0x03f9*/ uint8_t                  HoldingAnimation;
/*0x03fc*/ unsigned int             NextSwim;
/*0x0400*/ unsigned int             SpellGemETA[15];
/*0x043c*/ unsigned int             TimeStamp;
/*0x0440*/ bool                     bStationary;
/*0x0441*/ bool                     bSwitchMoved;
/*0x0442*/ char                     DragNames[2][0x40];
/*0x04c4*/ LaunchSpellData          CastingData;
/*0x0508*/ int64_t                  HPMax;
/*0x0510*/ char                     LoginRelated[0x20];
/*0x0530*/ unsigned int             SpellCooldownETA;
/*0x0534*/ float                    ViewHeight;
/*0x0538*/ bool                     Sneak;
/*0x0540*/ int64_t                  HPCurrent;
/*0x0548*/ int                      RealEstateItemId;
/*0x054c*/ bool                     PvPFlag;
/*0x054d*/ bool                     bTempPet;
/*0x0550*/ int                      Anon;
/*0x0554*/ int                      NpcTintIndex;
/*0x0558*/ uint8_t                  IsPassenger;
/*0x0559*/ char                     Title[0x80];
/*0x05dc*/ int                      CurrIOState;
/*0x05e0*/ bool                     bAlwaysShowAura;
/*0x05e1*/ uint8_t                  GMRank;
/*0x05e4*/ unsigned int             RespawnTimer;
/*0x05e8*/ int                      HideMode;
/*0x05ec*/ bool                     bSummoned;
/*0x05ed*/ bool                     Linkdead;
/*0x05f0*/ unsigned int             LastRefresh;
/*0x05f4*/ char                     DraggingPlayer[0x40];
/*0x0634*/ float                    AnimationSpeedRelated;
/*0x0638*/ bool                     bShowHelm;
/*0x0639*/ bool                     bOfflineMode;
/*0x063c*/ int                      IsAttacking;
/*0x0640*/ unsigned int             LastSecondaryUseTime;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2024-02-20 (live) @ 0x1402e28de
