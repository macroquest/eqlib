...
/*0x01bc*/ int                      AFK;
/*0x01c0*/ bool                     bShowHelm;
/*0x01c4*/ float                    MyWalkSpeed;
/*0x01c8*/ int                      Unknown1;
/*0x01cc*/ uint8_t                  Original;
/*0x01d0*/ SPAWNINFO*               pViewPlayer;
/*0x01d8*/ float                    CameraOffset;
/*0x01dc*/ unsigned int             StunTimer;
/*0x01e0*/ int                      DoSpecialMelee;
/*0x01e4*/ uint8_t                  LastAttack;
/*0x01e5*/ bool                     bAttackRelated;
/*0x01e6*/ bool                     bTempPet;
/*0x01e8*/ void*                    pRaceGenderInfo;
/*0x01f0*/ char                     Suffix[0x80];
/*0x0270*/ char                     DraggingPlayer[0x40];
/*0x02b0*/ bool                     PvPFlag;
/*0x02b4*/ unsigned int             ACounter;
/*0x02b8*/ unsigned int             NextIntimidateTime;
/*0x02bc*/ unsigned int             SitStartTime;
/*0x02c0*/ CharacterZoneClient*     pCharacter;
/*0x02c8*/ int                      Unknown4;
/*0x02cc*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x02d8*/ int64_t                  HPMax;
/*0x02e0*/ unsigned int             LastTick;
/*0x02e4*/ int                      Anon;
/*0x02e8*/ int                      IsAttacking;
/*0x02ec*/ unsigned int             LastSecondaryUseTime;
/*0x02f0*/ uint8_t                  FishingEvent;
/*0x02f4*/ int                      PetID;
/*0x02f8*/ bool                     bBuffTimersOnHold;
/*0x02fc*/ unsigned int             LastRefresh;
/*0x0300*/ EqItemGuid               realEstateItemGuid;
/*0x0314*/ int                      EnduranceCurrent;
/*0x0318*/ bool                     Sneak;
/*0x0319*/ char                     Handle[0x20];
/*0x033c*/ int                      ManaCurrent;
/*0x0340*/ char                     DragNames[2][0x40];
/*0x03c0*/ int                      PrimaryTintIndex;
/*0x03c4*/ uint8_t                  Blind;
/*0x03c8*/ CPhysicsInfo             LastCollision;
/*0x03f8*/ int64_t                  GuildID;
/*0x0400*/ unsigned int             LastMealTime;
/*0x0404*/ unsigned int             Meditating;
/*0x0408*/ unsigned int             MasterID;
/*0x040c*/ bool                     Mercenary;
/*0x040d*/ uint8_t                  GMRank;
/*0x0410*/ unsigned int             NextSwim;
/*0x0414*/ bool                     bSummoned;
/*0x0418*/ int                      RealEstateItemId;
/*0x041c*/ char                     Title[0x80];
/*0x049c*/ int                      SomeData[2];
/*0x04a4*/ uint8_t                  IsPassenger;
/*0x04a8*/ int                      RealEstateID;
/*0x04ac*/ int                      AltAttack;
/*0x04b0*/ int                      berserker;
/*0x04b4*/ unsigned int             LastTimeStoodStill;
/*0x04b8*/ int                      CurrIOState;
/*0x04bc*/ bool                     bSwitchMoved;
/*0x04c0*/ float                    RunSpeed;
/*0x04c4*/ char                     GM;
/*0x04c8*/ int                      HideMode;
/*0x04cc*/ uint8_t                  IntimidateCount;
/*0x04d0*/ int                      NpcTintIndex;
/*0x04d4*/ uint8_t                  Level;
/*0x04d8*/ int                      WarCry;
/*0x04dc*/ int                      Deity;
/*0x04e0*/ unsigned int             CorpseDragCount;
/*0x04e4*/ unsigned int             LastResendAddPlayerPacket;
/*0x04e8*/ uint8_t                  InPvPArea;
/*0x04e9*/ char                     LoginRelated[0x20];
/*0x050c*/ unsigned int             LastPrimaryUseTime;
/*0x0510*/ uint8_t                  CharClass;
/*0x0514*/ float                    ViewHeight;
/*0x0518*/ uint8_t                  HoldingAnimation;
/*0x051c*/ float                    MerchantGreed;
/*0x0520*/ unsigned int             LastRangedUsedTime;
/*0x0524*/ int                      Unknown3;
/*0x0528*/ bool                     bAnimationOnPop;
/*0x052c*/ unsigned int             FishingETA;
...
/*0x0544*/ unsigned int             SpellCooldownETA;
/*0x0548*/ unsigned int             MinuteTimer;
/*0x054c*/ int                      Buyer;
/*0x0550*/ uint8_t                  StandState;
/*0x0551*/ uint8_t                  Light;
/*0x0554*/ int                      SecondaryTintIndex;
/*0x0558*/ float                    GetMeleeRangeVar1;
/*0x0560*/ int64_t                  HPCurrent;
/*0x0568*/ void*                    pTouchingSwitch;
/*0x0570*/ int                      Trader;
/*0x0574*/ unsigned int             SpellGemETA[15];
/*0x05b0*/ int                      ManaMax;
/*0x05b8*/ unsigned int**           ppUDP;
/*0x05c0*/ unsigned int             RespawnTimer;
/*0x05c4*/ float                    FallingStartZ;
/*0x05c8*/ int                      Unknown2;
/*0x05cc*/ bool                     bOfflineMode;
/*0x05cd*/ uint8_t                  TitleVisible;
/*0x05d0*/ unsigned int             LastTrapDamageTime;
/*0x05d4*/ uint8_t                  FD;
/*0x05d8*/ unsigned int             TimeStamp;
/*0x05dc*/ bool                     bAlwaysShowAura;
/*0x05e0*/ float                    MissileRangeToTarget;
/*0x05e4*/ bool                     bStationary;
/*0x05e5*/ bool                     Linkdead;
/*0x05e6*/ bool                     LFG;
/*0x05e8*/ LaunchSpellData          CastingData;
/*0x062c*/ uint8_t                  FindBits;
/*0x0630*/ float                    AnimationSpeedRelated;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2022-11-22 (test) @ 0x1402a781e
