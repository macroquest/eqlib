...
/*0x01bc*/ bool                     bBuffTimersOnHold;
/*0x01bd*/ bool                     bStationary;
/*0x01c0*/ unsigned int**           ppUDP;
/*0x01c8*/ unsigned int             NextIntimidateTime;
/*0x01cc*/ int                      WarCry;
/*0x01d0*/ int                      DoSpecialMelee;
/*0x01d4*/ LaunchSpellData          CastingData;
/*0x0218*/ unsigned int             LastRangedUsedTime;
/*0x021c*/ int                      Deity;
/*0x0220*/ uint8_t                  FindBits;
/*0x0224*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x022c*/ uint8_t                  StandState;
/*0x0230*/ int                      ManaCurrent;
/*0x0234*/ int                      CurrIOState;
/*0x0238*/ int                      RealEstateItemId;
/*0x0240*/ void*                    pRaceGenderInfo;
/*0x0248*/ bool                     bAlwaysShowAura;
/*0x024c*/ unsigned int             EnduranceMax;
/*0x0250*/ int64_t                  GuildID;
/*0x0258*/ bool                     Mercenary;
/*0x025c*/ unsigned int             Meditating;
/*0x0260*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0268*/ int                      Buyer;
/*0x026c*/ uint8_t                  TitleVisible;
/*0x0270*/ float                    ViewHeight;
/*0x0274*/ unsigned int             StunTimer;
/*0x0278*/ unsigned int             NextSwim;
/*0x027c*/ unsigned int             SpellCooldownETA;
/*0x0280*/ float                    MyWalkSpeed;
/*0x0284*/ uint8_t                  FishingEvent;
/*0x0285*/ uint8_t                  InPvPArea;
/*0x0286*/ bool                     bBetaBuffed;
/*0x0288*/ unsigned int             LastSecondaryUseTime;
/*0x028c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0290*/ uint8_t                  GMRank;
/*0x0294*/ int                      Unknown4;
/*0x0298*/ int                      Trader;
/*0x029c*/ bool                     bSummoned;
/*0x029d*/ bool                     bTempPet;
/*0x029e*/ bool                     Linkdead;
/*0x02a0*/ unsigned int             RespawnTimer;
/*0x02a4*/ int                      Unknown3;
/*0x02a8*/ int                      SomeData[2];
/*0x02b0*/ bool                     bAnimationOnPop;
/*0x02b4*/ float                    MissileRangeToTarget;
/*0x02b8*/ unsigned int             MinuteTimer;
/*0x02bc*/ int                      IsAttacking;
/*0x02c0*/ bool                     bSwitchMoved;
/*0x02c4*/ unsigned int             LastTick;
/*0x02c8*/ bool                     PvPFlag;
/*0x02cc*/ float                    AnimationSpeedRelated;
/*0x02d0*/ uint8_t                  Light;
/*0x02d4*/ int                      RealEstateID;
/*0x02d8*/ void*                    pTouchingSwitch;
/*0x02e0*/ int                      NpcTintIndex;
/*0x02e4*/ int                      PetID;
/*0x02e8*/ int64_t                  HPMax;
/*0x02f0*/ bool                     bOfflineMode;
/*0x02f1*/ bool                     LFG;
/*0x02f2*/ bool                     bShowHelm;
/*0x02f4*/ unsigned int             FishingETA;
/*0x02f8*/ int                      Anon;
/*0x02fc*/ uint8_t                  HoldingAnimation;
/*0x0300*/ int                      berserker;
/*0x0304*/ unsigned int             LastTrapDamageTime;
/*0x0308*/ uint8_t                  Level;
/*0x0309*/ uint8_t                  FD;
/*0x030c*/ unsigned int             TimeStamp;
/*0x0310*/ bool                     bAttackRelated;
/*0x0314*/ unsigned int             CorpseDragCount;
/*0x0318*/ int64_t                  HPCurrent;
/*0x0320*/ unsigned int             LastRefresh;
/*0x0324*/ char                     LoginRelated[0x20];
/*0x0348*/ CharacterZoneClient*     pCharacter;
/*0x0350*/ unsigned int             MasterID;
/*0x0354*/ unsigned int             Zone;
/*0x0358*/ char                     Title[0x80];
/*0x03d8*/ char                     Suffix[0x80];
/*0x0458*/ uint8_t                  IntimidateCount;
/*0x0459*/ uint8_t                  LastAttack;
/*0x045a*/ char                     GM;
/*0x045b*/ uint8_t                  IsPassenger;
/*0x045c*/ uint8_t                  Type2;
/*0x0460*/ float                    GetMeleeRangeVar1;
/*0x0464*/ CPhysicsInfo             LastCollision;
/*0x0494*/ uint8_t                  Original;
/*0x0498*/ int                      ManaMax;
/*0x049c*/ int                      PrimaryTintIndex;
/*0x04a0*/ char                     DragNames[2][0x40];
/*0x0520*/ unsigned int             SitStartTime;
/*0x0524*/ unsigned int             LastTimeStoodStill;
/*0x0528*/ uint8_t                  CharClass;
/*0x052c*/ int                      AltAttack;
/*0x0530*/ unsigned int             LoginSerial;
/*0x0534*/ float                    BearingToTarget;
/*0x0538*/ float                    RunSpeed;
/*0x053c*/ unsigned int             ACounter;
/*0x0540*/ unsigned int             SpellGemETA[15];
/*0x057c*/ float                    MerchantGreed;
/*0x0580*/ bool                     Sneak;
/*0x0584*/ int                      SecondaryTintIndex;
/*0x0588*/ int                      EnduranceCurrent;
/*0x058c*/ int                      HideMode;
/*0x0590*/ float                    FallingStartZ;
/*0x0594*/ uint8_t                  Blind;
/*0x0595*/ char                     DraggingPlayer[0x40];
/*0x05d8*/ float                    CameraOffset;
/*0x05dc*/ unsigned int             LastPrimaryUseTime;
/*0x05e0*/ int                      Unknown1;
/*0x05e4*/ char                     Handle[0x20];
/*0x0604*/ unsigned int             LastMealTime;
/*0x0608*/ int                      Unknown2;
/*0x0610*/ SPAWNINFO*               pViewPlayer;
/*0x0618*/ EqItemGuid               realEstateItemGuid;
/*0x062c*/ int                      AFK;

// @end: PlayerZoneClient Members

/*0x0630*/ TCircularBuffer<SDoCollisionMovementStats, MAX_MOVEMENT_STATS> MovementStats;
...
// @sizeof(PlayerClient) == 0x1f50 :: 2022-11-02 (test) @ 0x1402a331e
