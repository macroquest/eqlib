...
/*0x01bc*/ unsigned int             TimeStamp;
/*0x01c0*/ bool                     Mercenary;
/*0x01c4*/ int                      Unknown3;
/*0x01c8*/ bool                     bBuffTimersOnHold;
/*0x01c9*/ uint8_t                  HoldingAnimation;
/*0x01cc*/ int                      DoSpecialMelee;
/*0x01d0*/ int                      Trader;
/*0x01d4*/ unsigned int             LastTrapDamageTime;
/*0x01d8*/ unsigned int             Zone;
/*0x01dc*/ float                    RunSpeed;
/*0x01e0*/ unsigned int             LastResendAddPlayerPacket;
/*0x01e4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x01ec*/ unsigned int             FishingETA;
/*0x01f0*/ unsigned int             LastMealTime;
/*0x01f4*/ int                      SomeData[2];
/*0x01fc*/ unsigned int             LastRangedUsedTime;
/*0x0200*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0208*/ char                     Handle[0x20];
/*0x0228*/ int                      HideMode;
/*0x022c*/ char                     Suffix[0x80];
/*0x02ac*/ char                     GM;
/*0x02b0*/ int                      Anon;
/*0x02b4*/ int                      AFK;
/*0x02b8*/ unsigned int             SitStartTime;
/*0x02bc*/ bool                     Sneak;
/*0x02bd*/ uint8_t                  TitleVisible;
/*0x02be*/ uint8_t                  FishingEvent;
/*0x02c0*/ SPAWNINFO*               pViewPlayer;
/*0x02c8*/ unsigned int             SpellGemETA[15];
/*0x0304*/ unsigned int             LoginSerial;
/*0x0308*/ float                    FallingStartZ;
/*0x030c*/ float                    MyWalkSpeed;
/*0x0310*/ uint8_t                  CharClass;
/*0x0314*/ unsigned int             ACounter;
/*0x0318*/ int                      IsAttacking;
/*0x0320*/ int64_t                  HPMax;
/*0x0328*/ uint8_t                  Blind;
/*0x032c*/ unsigned int             Meditating;
/*0x0330*/ unsigned int             LastTick;
/*0x0334*/ int                      Unknown1;
/*0x0338*/ float                    CameraOffset;
/*0x033c*/ int                      WarCry;
/*0x0340*/ int                      PrimaryTintIndex;
/*0x0344*/ float                    MerchantGreed;
/*0x0348*/ bool                     bSwitchMoved;
/*0x0349*/ bool                     LFG;
/*0x034c*/ int                      CurrIOState;
/*0x0350*/ int                      Unknown4;
/*0x0354*/ uint8_t                  InPvPArea;
/*0x0358*/ int64_t                  GuildID;
/*0x0360*/ int                      AltAttack;
/*0x0368*/ void*                    pRaceGenderInfo;
/*0x0370*/ bool                     bBetaBuffed;
/*0x0374*/ CPhysicsInfo             LastCollision;
/*0x03a4*/ int                      ManaCurrent;
/*0x03a8*/ float                    AnimationSpeedRelated;
/*0x03ac*/ int                      SecondaryTintIndex;
/*0x03b0*/ char                     DraggingPlayer[0x40];
/*0x03f0*/ unsigned int             SpellCooldownETA;
/*0x03f8*/ CharacterZoneClient*     pCharacter;
/*0x0400*/ int                      ManaMax;
/*0x0404*/ int                      EnduranceCurrent;
/*0x0408*/ bool                     bAnimationOnPop;
/*0x040c*/ int                      RealEstateItemId;
/*0x0410*/ unsigned int             NextSwim;
/*0x0414*/ unsigned int             NextIntimidateTime;
/*0x0418*/ bool                     bTempPet;
/*0x041c*/ unsigned int             MinuteTimer;
/*0x0420*/ int                      Unknown2;
/*0x0424*/ unsigned int             StunTimer;
/*0x0428*/ bool                     bAlwaysShowAura;
/*0x042c*/ LaunchSpellData          CastingData;
/*0x0470*/ float                    BearingToTarget;
/*0x0474*/ uint8_t                  Original;
/*0x0475*/ bool                     bStationary;
/*0x0478*/ int64_t                  HPCurrent;
/*0x0480*/ char                     LoginRelated[0x20];
/*0x04a0*/ int                      NpcTintIndex;
/*0x04a4*/ uint8_t                  IsPassenger;
/*0x04a8*/ unsigned int             RespawnTimer;
/*0x04ac*/ bool                     bSummoned;
/*0x04ad*/ bool                     bAttackRelated;
/*0x04b0*/ unsigned int             LastRefresh;
/*0x04b4*/ int                      Deity;
/*0x04b8*/ int                      berserker;
/*0x04bc*/ uint8_t                  IntimidateCount;
/*0x04bd*/ uint8_t                  GMRank;
/*0x04be*/ char                     Title[0x80];
/*0x053e*/ uint8_t                  Light;
/*0x0540*/ unsigned int             CorpseDragCount;
/*0x0544*/ int                      RealEstateID;
/*0x0548*/ char                     DragNames[2][0x40];
/*0x05c8*/ bool                     Linkdead;
/*0x05cc*/ int                      PetID;
/*0x05d0*/ unsigned int**           ppUDP;
/*0x05d8*/ int                      Buyer;
/*0x05dc*/ unsigned int             LastPrimaryUseTime;
/*0x05e0*/ float                    ViewHeight;
/*0x05e8*/ void*                    pTouchingSwitch;
/*0x05f0*/ EqItemGuid               realEstateItemGuid;
/*0x0602*/ uint8_t                  LastAttack;
/*0x0604*/ float                    MissileRangeToTarget;
/*0x0608*/ unsigned int             LastTimeStoodStill;
/*0x060c*/ uint8_t                  StandState;
/*0x060d*/ bool                     PvPFlag;
/*0x060e*/ bool                     bShowHelm;
/*0x0610*/ unsigned int             MasterID;
/*0x0614*/ bool                     bOfflineMode;
/*0x0618*/ float                    GetMeleeRangeVar1;
/*0x061c*/ uint8_t                  Level;
/*0x061d*/ uint8_t                  FD;
/*0x0620*/ unsigned int             EnduranceMax;
/*0x0624*/ unsigned int             LastSecondaryUseTime;
/*0x0628*/ uint8_t                  FindBits;

// @end: PlayerZoneClient Members

/*0x062c*/ TCircularBuffer<SDoCollisionMovementStats, MAX_MOVEMENT_STATS> MovementStats;
/*0x0f48*/ PlayerClient*      WhoFollowing;                       // NULL if autofollow off
/*0x0f50*/ unsigned int       GroupAssistNPC[MAX_GROUP_ASSISTS];
/*0x0f54*/ unsigned int       RaidAssistNPC[MAX_RAID_ASSISTS];
/*0x0f60*/ unsigned int       GroupMarkNPC[MAX_GROUP_MARK_TARGETS];
/*0x0f6c*/ unsigned int       RaidMarkNPC[MAX_RAID_MARK_TARGETS];
/*0x0f78*/ unsigned int       TargetOfTarget;
/*0x0f7c*/ PZCPhysicsInfo     PZCLastPhysics;
/*0x0fa0*/ unsigned int       ParticleCastStartTime;
/*0x0fa4*/ unsigned int       ParticleCastDuration;
/*0x0fa8*/ int                ParticleVisualSpellNum;
...
// @sizeof(PlayerClient) == 0x1f50 :: 2023-03-21 (test) @ 0x1402fd35e
constexpr size_t PlayerClient_size = 0x1f50;
