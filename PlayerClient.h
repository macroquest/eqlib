...
/*0x01bc*/ unsigned int             LastSecondaryUseTime;
/*0x01c0*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x01c8*/ bool                     bAttackRelated;
/*0x01cc*/ int                      DoSpecialMelee;
/*0x01d0*/ LaunchSpellData          CastingData;
/*0x0218*/ void*                    pTouchingSwitch;
/*0x0220*/ float                    BearingToTarget;
/*0x0224*/ int                      Unknown3;
/*0x0228*/ unsigned int             TimeStamp;
/*0x022c*/ bool                     bSwitchMoved;
/*0x022d*/ uint8_t                  FD;
/*0x0230*/ unsigned int             LastTimeStoodStill;
/*0x0234*/ int                      RealEstateID;
/*0x0238*/ CPhysicsInfo             LastCollision;
/*0x0268*/ int                      AltAttack;
/*0x026c*/ int                      HideMode;
/*0x0270*/ int                      Buyer;
/*0x0274*/ unsigned int             MinuteTimer;
/*0x0278*/ bool                     bAnimationOnPop;
/*0x027c*/ unsigned int             RespawnTimer;
/*0x0280*/ unsigned int             SitStartTime;
/*0x0284*/ int                      PrimaryTintIndex;
/*0x0288*/ float                    MerchantGreed;
/*0x028c*/ float                    CameraOffset;
/*0x0290*/ int                      Unknown1;
/*0x0294*/ bool                     Mercenary;
/*0x0298*/ float                    RunSpeed;
/*0x029c*/ uint8_t                  IntimidateCount;
/*0x02a0*/ unsigned int             LoginSerial;
/*0x02a4*/ uint8_t                  TitleVisible;
/*0x02a5*/ uint8_t                  GMRank;
/*0x02a6*/ bool                     bTempPet;
/*0x02a7*/ bool                     LFG;
/*0x02a8*/ unsigned int             Zone;
/*0x02b0*/ int64_t                  HPMax;
/*0x02b8*/ unsigned int             LastResendAddPlayerPacket;
...
/*0x02dc*/ int                      WarCry;
/*0x02e0*/ int                      AFK;
/*0x02e4*/ float                    FallingStartZ;
/*0x02e8*/ int                      Anon;
/*0x02f0*/ int64_t                  GuildID;
/*0x02f8*/ bool                     bBetaBuffed;
/*0x02fc*/ int                      berserker;
/*0x0300*/ uint8_t                  CharClass;
/*0x0308*/ unsigned int**           ppUDP;
/*0x0310*/ int                      IsAttacking;
/*0x0314*/ bool                     bShowHelm;
/*0x0318*/ float                    GetMeleeRangeVar1;
/*0x031c*/ unsigned int             FishingETA;
/*0x0320*/ float                    AnimationSpeedRelated;
/*0x0324*/ uint8_t                  HoldingAnimation;
/*0x0328*/ float                    ViewHeight;
/*0x032c*/ unsigned int             LastMealTime;
/*0x0330*/ unsigned int             LastPrimaryUseTime;
/*0x0334*/ char                     DraggingPlayer[0x40];
/*0x0374*/ int                      ManaCurrent;
/*0x0378*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0380*/ float                    MyWalkSpeed;
/*0x0384*/ bool                     bOfflineMode;
/*0x0388*/ int                      CurrIOState;
/*0x038c*/ uint8_t                  Type2;
/*0x0390*/ unsigned int             CorpseDragCount;
/*0x0394*/ unsigned int             LastTick;
/*0x0398*/ uint8_t                  Original;
/*0x039c*/ int                      ManaMax;
/*0x03a0*/ bool                     PvPFlag;
/*0x03a4*/ unsigned int             StunTimer;
/*0x03a8*/ int                      SomeData[2];
/*0x03b0*/ unsigned int             SpellGemETA[15];
/*0x03ec*/ uint8_t                  FindBits;
/*0x03ed*/ uint8_t                  IsPassenger;
/*0x03f0*/ int                      EnduranceCurrent;
/*0x03f4*/ unsigned int             NextIntimidateTime;
/*0x03f8*/ char                     GM;
/*0x03f9*/ char                     LoginRelated[0x20];
/*0x0419*/ uint8_t                  FishingEvent;
/*0x041a*/ uint8_t                  StandState;
/*0x041c*/ int                      PetID;
/*0x0420*/ int                      SecondaryTintIndex;
/*0x0424*/ bool                     bStationary;
/*0x0425*/ char                     Title[0x80];
/*0x04a5*/ bool                     Linkdead;
/*0x04a8*/ unsigned int             EnduranceMax;
/*0x04ac*/ unsigned int             Meditating;
/*0x04b0*/ int                      Deity;
/*0x04b4*/ uint8_t                  Level;
/*0x04b5*/ bool                     bAlwaysShowAura;
/*0x04b6*/ char                     DragNames[2][0x40];
/*0x0538*/ unsigned int             LastTrapDamageTime;
/*0x053c*/ bool                     Sneak;
/*0x0540*/ int64_t                  HPCurrent;
/*0x0548*/ char                     Suffix[0x80];
/*0x05c8*/ unsigned int             MasterID;
/*0x05cc*/ bool                     bSummoned;
/*0x05d0*/ void*                    pRaceGenderInfo;
/*0x05d8*/ uint8_t                  Blind;
/*0x05d9*/ uint8_t                  LastAttack;
/*0x05dc*/ int                      RealEstateItemId;
/*0x05e0*/ uint8_t                  InPvPArea;
/*0x05e4*/ unsigned int             LastRefresh;
/*0x05e8*/ unsigned int             LastRangedUsedTime;
/*0x05ec*/ unsigned int             NextSwim;
/*0x05f0*/ int                      Unknown4;
/*0x05f4*/ unsigned int             SpellCooldownETA;
/*0x05f8*/ int                      NpcTintIndex;
/*0x05fc*/ float                    MissileRangeToTarget;
/*0x0600*/ unsigned int             ACounter;
/*0x0604*/ char                     Handle[0x20];
/*0x0624*/ int                      Trader;
/*0x0628*/ bool                     bBuffTimersOnHold;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2022-11-10 (live) @ 0x1402a355e
