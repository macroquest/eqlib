...
/*0x01d0*/ unsigned int             SpellGemETA[15];
/*0x020c*/ unsigned int             TimeStamp;
/*0x0210*/ int                      berserker;
/*0x0218*/ CharacterZoneClient*     pCharacter;
/*0x0220*/ void*                    pTouchingSwitch;
/*0x0228*/ unsigned int             Meditating;
/*0x022c*/ unsigned int             LastTick;
/*0x0230*/ SPAWNINFO*               pViewPlayer;
/*0x0238*/ uint8_t                  HoldingAnimation;
/*0x023c*/ unsigned int             Zone;
/*0x0240*/ unsigned int             LastTrapDamageTime;
/*0x0244*/ unsigned int             LastResendAddPlayerPacket;
/*0x0248*/ int                      Unknown1;
/*0x024c*/ unsigned int             RespawnTimer;
/*0x0250*/ int                      RealEstateID;
/*0x0254*/ uint8_t                  Blind;
/*0x0258*/ int                      ManaMax;
/*0x025c*/ unsigned int             LastRefresh;
/*0x0260*/ bool                     bBetaBuffed;
/*0x0264*/ float                    BearingToTarget;
/*0x0268*/ unsigned int             LastTimeStoodStill;
/*0x026c*/ uint8_t                  IntimidateCount;
/*0x026d*/ char                     Suffix[0x80];
/*0x02ed*/ uint8_t                  Original;
/*0x02f0*/ float                    GetMeleeRangeVar1;
/*0x02f4*/ unsigned int             EnduranceMax;
/*0x02f8*/ void*                    pRaceGenderInfo;
/*0x0300*/ int                      Unknown3;
/*0x0304*/ unsigned int             CorpseDragCount;
/*0x0308*/ int                      Birthdate;
/*0x0310*/ unsigned int**           ppUDP;
/*0x0318*/ float                    MyWalkSpeed;
/*0x031c*/ bool                     bOfflineMode;
/*0x0320*/ unsigned int             LastPrimaryUseTime;
/*0x0324*/ unsigned int             SpellCooldownETA;
/*0x0328*/ int                      SomeData[2];
/*0x0330*/ int                      IsAttacking;
/*0x0334*/ char                     LoginRelated[0x20];
/*0x0354*/ unsigned int             MasterID;
/*0x0358*/ int                      RealEstateItemId;
/*0x035c*/ unsigned int             LastMealTime;
/*0x0360*/ EqItemGuid               realEstateItemGuid;
/*0x0372*/ uint8_t                  IsPassenger;
/*0x0374*/ int                      DoSpecialMelee;
/*0x0378*/ uint8_t                  LastAttack;
/*0x037c*/ float                    AnimationSpeedRelated;
/*0x0380*/ int                      AltAttack;
/*0x0384*/ int                      Trader;
/*0x0388*/ unsigned int             NextIntimidateTime;
/*0x0390*/ int64_t                  HPCurrent;
/*0x0398*/ bool                     bShowHelm;
/*0x0399*/ char                     Title[0x80];
/*0x0419*/ uint8_t                  Light;
/*0x041c*/ int                      HideMode;
/*0x0420*/ char                     GM;
/*0x0421*/ bool                     Linkdead;
/*0x0422*/ char                     Handle[0x20];
/*0x0444*/ float                    RunSpeed;
/*0x0448*/ int                      AFK;
/*0x044c*/ int                      CurrIOState;
/*0x0450*/ bool                     bSummoned;
/*0x0454*/ int                      PrimaryTintIndex;
/*0x0458*/ unsigned int             ACounter;
/*0x045c*/ unsigned int             NextSwim;
/*0x0460*/ float                    MerchantGreed;
/*0x0464*/ int                      Buyer;
/*0x0468*/ unsigned int             FishingETA;
/*0x046c*/ int                      NpcTintIndex;
/*0x0470*/ int                      Deity;
/*0x0474*/ unsigned int             LastSecondaryUseTime;
/*0x0478*/ bool                     bSwitchMoved;
/*0x0480*/ int64_t                  GuildID;
/*0x0488*/ int                      WarCry;
/*0x048c*/ unsigned int             LastRangedUsedTime;
/*0x0490*/ uint8_t                  GMRank;
/*0x0494*/ int                      Anon;
/*0x0498*/ bool                     bTempPet;
/*0x0499*/ char                     DragNames[2][0x40];
/*0x051c*/ float                    ViewHeight;
/*0x0520*/ float                    FallingStartZ;
/*0x0524*/ uint8_t                  FishingEvent;
/*0x0528*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0530*/ int                      ManaCurrent;
/*0x0534*/ uint8_t                  StandState;
/*0x0538*/ unsigned int             StunTimer;
/*0x053c*/ float                    CameraOffset;
/*0x0540*/ uint8_t                  Level;
/*0x0541*/ uint8_t                  TitleVisible;
/*0x0542*/ uint8_t                  FD;
/*0x0544*/ CPhysicsInfo             LastCollision;
/*0x0574*/ uint8_t                  CharClass;
/*0x0578*/ int                      PetID;
/*0x057c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0584*/ unsigned int             SitStartTime;
/*0x0588*/ bool                     Mercenary;
/*0x0589*/ bool                     bStationary;
/*0x058a*/ bool                     bAlwaysShowAura;
/*0x058b*/ bool                     bAnimationOnPop;
/*0x058c*/ char                     DraggingPlayer[0x40];
/*0x05cc*/ uint8_t                  InPvPArea;
/*0x05d0*/ unsigned int             LoginSerial;
/*0x05d4*/ int                      Unknown4;
/*0x05d8*/ bool                     bBuffTimersOnHold;
/*0x05d9*/ bool                     bAttackRelated;
/*0x05da*/ bool                     Sneak;
/*0x05e0*/ int64_t                  HPMax;
/*0x05e8*/ int                      EnduranceCurrent;
/*0x05ec*/ bool                     PvPFlag;
/*0x05f0*/ float                    MissileRangeToTarget;
/*0x05f4*/ int                      SecondaryTintIndex;
/*0x05f8*/ uint8_t                  FindBits;
/*0x05fc*/ LaunchSpellData          CastingData;
/*0x0640*/ bool                     LFG;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-09-14 (live) @ 0x1402de2ae
