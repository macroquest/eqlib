...
/*0x01bc*/ unsigned int             Zone;
/*0x01c0*/ float                    BearingToTarget;
/*0x01c8*/ void*                    pTouchingSwitch;
/*0x01d0*/ unsigned int             LastRefresh;
/*0x01d4*/ unsigned int             LastSecondaryUseTime;
/*0x01d8*/ bool                     bShowHelm;
/*0x01d9*/ uint8_t                  TitleVisible;
/*0x01dc*/ int                      RealEstateID;
/*0x01e0*/ unsigned int             ACounter;
/*0x01e4*/ bool                     bAttackRelated;
/*0x01e5*/ uint8_t                  FD;
/*0x01e6*/ char                     DragNames[2][0x40];
/*0x0266*/ char                     GM;
/*0x0268*/ int                      SecondaryTintIndex;
/*0x026c*/ uint8_t                  FindBits;
/*0x0270*/ float                    MerchantGreed;
/*0x0274*/ bool                     bAnimationOnPop;
/*0x0278*/ int                      Unknown4;
/*0x027c*/ unsigned int             StunTimer;
/*0x0280*/ bool                     bOfflineMode;
/*0x0284*/ unsigned int             SpellGemETA[15];
/*0x02c0*/ int                      ManaMax;
/*0x02c8*/ void*                    pRaceGenderInfo;
/*0x02d0*/ unsigned int             LastTimeStoodStill;
/*0x02d8*/ int64_t                  GuildID;
/*0x02e0*/ float                    MyWalkSpeed;
/*0x02e4*/ int                      IsAttacking;
/*0x02e8*/ float                    AnimationSpeedRelated;
/*0x02ec*/ unsigned int             LoginSerial;
/*0x02f0*/ uint8_t                  Level;
/*0x02f1*/ uint8_t                  FishingEvent;
/*0x02f4*/ unsigned int             RespawnTimer;
/*0x02f8*/ unsigned int             FishingETA;
/*0x02fc*/ unsigned int             EnduranceMax;
/*0x0300*/ int                      RealEstateItemId;
/*0x0304*/ char                     LoginRelated[0x20];
/*0x0324*/ uint8_t                  Type2;
/*0x0328*/ unsigned int             LastPrimaryUseTime;
/*0x032c*/ int                      PetID;
/*0x0330*/ bool                     bBetaBuffed;
/*0x0338*/ int64_t                  HPCurrent;
/*0x0340*/ int                      NpcTintIndex;
/*0x0344*/ unsigned int             LastRangedUsedTime;
/*0x0348*/ EqItemGuid               realEstateItemGuid;
/*0x035c*/ int                      WarCry;
/*0x0360*/ bool                     bSwitchMoved;
/*0x0361*/ bool                     bTempPet;
/*0x0362*/ bool                     bAlwaysShowAura;
/*0x0363*/ bool                     bStationary;
/*0x0364*/ uint8_t                  IntimidateCount;
/*0x0365*/ uint8_t                  GMRank;
/*0x0368*/ int                      berserker;
/*0x036c*/ int                      AFK;
/*0x0370*/ char                     Handle[0x20];
/*0x0390*/ int                      Unknown2;
/*0x0394*/ unsigned int             Meditating;
/*0x0398*/ unsigned int             SpellCooldownETA;
/*0x039c*/ float                    ViewHeight;
/*0x03a0*/ int                      Deity;
/*0x03a4*/ uint8_t                  Blind;
/*0x03a5*/ char                     Title[0x80];
/*0x0428*/ float                    CameraOffset;
/*0x042c*/ unsigned int             SitStartTime;
/*0x0430*/ float                    RunSpeed;
/*0x0434*/ bool                     bSummoned;
/*0x0438*/ unsigned int             LastTick;
/*0x043c*/ int                      Anon;
/*0x0440*/ int                      Trader;
/*0x0444*/ unsigned int             LastMealTime;
/*0x0448*/ int64_t                  HPMax;
/*0x0450*/ uint8_t                  HoldingAnimation;
/*0x0454*/ int                      Buyer;
/*0x0458*/ unsigned int             MasterID;
/*0x045c*/ int                      AltAttack;
/*0x0460*/ unsigned int             LastResendAddPlayerPacket;
/*0x0464*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x046c*/ uint8_t                  IsPassenger;
/*0x046d*/ bool                     Mercenary;
/*0x0470*/ int                      CurrIOState;
/*0x0474*/ unsigned int             LastTrapDamageTime;
/*0x0478*/ unsigned int             MinuteTimer;
/*0x047c*/ bool                     PvPFlag;
/*0x0480*/ CPhysicsInfo             LastCollision;
/*0x04b0*/ int                      DoSpecialMelee;
/*0x04b4*/ char                     Suffix[0x80];
/*0x0534*/ float                    MissileRangeToTarget;
/*0x0538*/ int                      PrimaryTintIndex;
/*0x053c*/ float                    FallingStartZ;
/*0x0540*/ uint8_t                  Original;
/*0x0541*/ uint8_t                  LastAttack;
/*0x0542*/ uint8_t                  CharClass;
/*0x0543*/ uint8_t                  StandState;
/*0x0544*/ int                      Unknown1;
/*0x0548*/ bool                     LFG;
/*0x0549*/ uint8_t                  Light;
/*0x054a*/ bool                     Sneak;
/*0x054c*/ unsigned int             CorpseDragCount;
/*0x0550*/ unsigned int             NextSwim;
/*0x0554*/ bool                     bBuffTimersOnHold;
/*0x0558*/ int                      EnduranceCurrent;
/*0x0560*/ CharacterZoneClient*     pCharacter;
/*0x0568*/ int                      ManaCurrent;
/*0x056c*/ unsigned int             NextIntimidateTime;
/*0x0570*/ LaunchSpellData          CastingData;
/*0x05b4*/ char                     DraggingPlayer[0x40];
/*0x05f4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05fc*/ int                      SomeData[2];
/*0x0604*/ int                      Unknown3;
/*0x0608*/ SPAWNINFO*               pViewPlayer;
/*0x0610*/ bool                     Linkdead;
/*0x0614*/ int                      HideMode;
/*0x0618*/ float                    GetMeleeRangeVar1;
/*0x061c*/ uint8_t                  InPvPArea;
/*0x0620*/ unsigned int**           ppUDP;
...
// @sizeof(PlayerClient) == 0x1f50 :: 2022-10-24 (live) @ 0x1402a320e
