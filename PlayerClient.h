...
/*0x01d0*/ void*                    pRaceGenderInfo;
/*0x01d8*/ int                      SomeData[2];
/*0x01e0*/ uint8_t                  Blind;
/*0x01e8*/ void*                    pTouchingSwitch;
/*0x01f0*/ unsigned int             LastSecondaryUseTime;
/*0x01f4*/ unsigned int             LastRangedUsedTime;
/*0x01f8*/ int                      EnduranceCurrent;
/*0x01fc*/ unsigned int             SpellCooldownETA;
/*0x0200*/ int                      Trader;
/*0x0204*/ bool                     bSummoned;
/*0x0205*/ uint8_t                  IntimidateCount;
/*0x0208*/ int                      AFK;
/*0x020c*/ LaunchSpellData          CastingData;
/*0x0250*/ int64_t                  GuildID;
/*0x0258*/ unsigned int             CorpseDragCount;
/*0x025c*/ uint8_t                  FindBits;
/*0x0260*/ int                      PrimaryTintIndex;
/*0x0264*/ bool                     bOfflineMode;
/*0x0268*/ unsigned int             MasterID;
/*0x026c*/ bool                     bBetaBuffed;
/*0x0270*/ int                      IsAttacking;
/*0x0274*/ bool                     bAttackRelated;
/*0x0278*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0280*/ char                     GM;
/*0x0288*/ int64_t                  HPCurrent;
/*0x0290*/ unsigned int**           ppUDP;
/*0x0298*/ unsigned int             LastTimeStoodStill;
/*0x029c*/ bool                     bStationary;
/*0x02a0*/ unsigned int             SitStartTime;
/*0x02a4*/ bool                     bTempPet;
/*0x02a8*/ unsigned int             LastResendAddPlayerPacket;
/*0x02ac*/ uint8_t                  FishingEvent;
/*0x02ad*/ bool                     bAnimationOnPop;
/*0x02ae*/ uint8_t                  CharClass;
/*0x02b0*/ int                      DoSpecialMelee;
/*0x02b4*/ unsigned int             NextIntimidateTime;
/*0x02b8*/ uint8_t                  Original;
/*0x02bc*/ unsigned int             Zone;
/*0x02c0*/ unsigned int             RespawnTimer;
/*0x02c4*/ unsigned int             TimeStamp;
/*0x02c8*/ uint8_t                  Light;
/*0x02cc*/ int                      Unknown4;
/*0x02d0*/ int                      AltAttack;
/*0x02d4*/ uint8_t                  HoldingAnimation;
/*0x02d8*/ int64_t                  HPMax;
/*0x02e0*/ CharacterZoneClient*     pCharacter;
/*0x02e8*/ uint8_t                  TitleVisible;
/*0x02e9*/ bool                     LFG;
/*0x02ea*/ char                     DragNames[2][0x40];
/*0x036c*/ unsigned int             LastPrimaryUseTime;
/*0x0370*/ int                      ManaCurrent;
/*0x0374*/ int                      berserker;
/*0x0378*/ float                    MerchantGreed;
/*0x037c*/ unsigned int             LastMealTime;
/*0x0380*/ int                      SecondaryTintIndex;
/*0x0384*/ bool                     Linkdead;
/*0x0388*/ int                      RealEstateID;
/*0x038c*/ float                    FallingStartZ;
/*0x0390*/ bool                     Sneak;
/*0x0394*/ unsigned int             LastRefresh;
/*0x0398*/ int                      CurrIOState;
/*0x039c*/ uint8_t                  LastAttack;
/*0x039d*/ uint8_t                  FD;
/*0x039e*/ uint8_t                  StandState;
/*0x03a0*/ unsigned int             ACounter;
/*0x03a4*/ unsigned int             LoginSerial;
/*0x03a8*/ unsigned int             EnduranceMax;
/*0x03ac*/ float                    MissileRangeToTarget;
/*0x03b0*/ char                     Title[0x80];
/*0x0430*/ bool                     Mercenary;
/*0x0434*/ unsigned int             NextSwim;
/*0x0438*/ float                    MyWalkSpeed;
/*0x043c*/ unsigned int             SpellGemETA[15];
/*0x0478*/ bool                     bBuffTimersOnHold;
/*0x047c*/ int                      PetID;
/*0x0480*/ int                      HideMode;
/*0x0484*/ bool                     PvPFlag;
/*0x0488*/ int                      Anon;
/*0x048c*/ int                      Unknown3;
/*0x0490*/ float                    GetMeleeRangeVar1;
/*0x0494*/ float                    AnimationSpeedRelated;
/*0x0498*/ unsigned int             LastTrapDamageTime;
/*0x049c*/ float                    RunSpeed;
/*0x04a0*/ EqItemGuid               realEstateItemGuid;
/*0x04b2*/ bool                     bAlwaysShowAura;
/*0x04b3*/ uint8_t                  GMRank;
/*0x04b4*/ unsigned int             LastTick;
/*0x04b8*/ unsigned int             StunTimer;
/*0x04bc*/ CPhysicsInfo             LastCollision;
/*0x04ec*/ uint8_t                  InPvPArea;
/*0x04f0*/ int                      WarCry;
/*0x04f4*/ int                      Birthdate;
/*0x04f8*/ int                      Buyer;
/*0x04fc*/ unsigned int             MinuteTimer;
/*0x0500*/ float                    BearingToTarget;
/*0x0504*/ float                    ViewHeight;
/*0x0508*/ float                    CameraOffset;
/*0x050c*/ bool                     bSwitchMoved;
/*0x0510*/ int                      Deity;
/*0x0514*/ char                     Suffix[0x80];
/*0x0594*/ unsigned int             Meditating;
/*0x0598*/ unsigned int             FishingETA;
/*0x05a0*/ SPAWNINFO*               pViewPlayer;
/*0x05a8*/ char                     Handle[0x20];
/*0x05c8*/ int                      Unknown1;
/*0x05cc*/ char                     DraggingPlayer[0x40];
/*0x060c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0614*/ int                      NpcTintIndex;
/*0x0618*/ char                     LoginRelated[0x20];
/*0x0638*/ bool                     bShowHelm;
/*0x063c*/ int                      RealEstateItemId;
/*0x0640*/ uint8_t                  IsPassenger;
/*0x0644*/ int                      ManaMax;
/*0x0648*/ uint8_t                  Level;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2023-11-06 (test) @ 0x1402ddcce
