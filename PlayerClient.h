...
/*0x01cc*/ int                      SecondaryTintIndex;
/*0x01d0*/ unsigned int             MasterID;
/*0x01d4*/ unsigned int             LastRefresh;
/*0x01d8*/ float                    MissileRangeToTarget;
/*0x01dc*/ unsigned int             LoginSerial;
/*0x01e0*/ uint8_t                  Level;
/*0x01e8*/ void*                    pTouchingSwitch;
/*0x01f0*/ uint8_t                  Blind;
/*0x01f8*/ void*                    pRaceGenderInfo;
/*0x0200*/ uint8_t                  FindBits;
/*0x0204*/ unsigned int             SpellCooldownETA;
/*0x0208*/ unsigned int             LastMealTime;
/*0x020c*/ unsigned int             MinuteTimer;
/*0x0210*/ int64_t                  GuildID;
/*0x0218*/ bool                     bAnimationOnPop;
/*0x0219*/ uint8_t                  HoldingAnimation;
/*0x021a*/ EqItemGuid               realEstateItemGuid;
/*0x022c*/ int                      Trader;
/*0x0230*/ int                      IsAttacking;
/*0x0234*/ bool                     bSummoned;
/*0x0238*/ int                      RealEstateID;
/*0x023c*/ int                      PrimaryTintIndex;
/*0x0240*/ int                      NpcTintIndex;
/*0x0244*/ float                    MerchantGreed;
/*0x0248*/ unsigned int**           ppUDP;
/*0x0250*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0258*/ bool                     bShowHelm;
/*0x0260*/ SPAWNINFO*               pViewPlayer;
/*0x0268*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0270*/ unsigned int             Meditating;
/*0x0274*/ unsigned int             LastPrimaryUseTime;
/*0x0278*/ int                      AltAttack;
/*0x027c*/ float                    FallingStartZ;
/*0x0280*/ uint8_t                  InPvPArea;
/*0x0284*/ int                      Anon;
/*0x0288*/ int                      HideMode;
/*0x028c*/ bool                     LFG;
/*0x028d*/ uint8_t                  IntimidateCount;
/*0x028e*/ bool                     bSwitchMoved;
/*0x028f*/ char                     DraggingPlayer[0x40];
/*0x02d0*/ unsigned int             TimeStamp;
/*0x02d4*/ bool                     bAlwaysShowAura;
/*0x02d5*/ bool                     bStationary;
/*0x02d6*/ bool                     bAttackRelated;
/*0x02d8*/ unsigned int             CorpseDragCount;
/*0x02dc*/ uint8_t                  FD;
/*0x02e0*/ unsigned int             SpellGemETA[15];
/*0x031c*/ int                      ManaMax;
/*0x0320*/ int                      WarCry;
/*0x0324*/ bool                     Sneak;
/*0x0328*/ unsigned int             EnduranceMax;
/*0x0330*/ int64_t                  HPMax;
/*0x0338*/ float                    MyWalkSpeed;
/*0x033c*/ uint8_t                  LastAttack;
/*0x0340*/ float                    RunSpeed;
/*0x0344*/ bool                     bOfflineMode;
/*0x0348*/ int                      berserker;
/*0x034c*/ int                      PetID;
/*0x0350*/ int                      Unknown4;
/*0x0354*/ unsigned int             LastRangedUsedTime;
/*0x0358*/ unsigned int             LastTick;
/*0x035c*/ unsigned int             LastTrapDamageTime;
/*0x0360*/ int                      Unknown3;
/*0x0364*/ float                    ViewHeight;
/*0x0368*/ uint8_t                  StandState;
/*0x0369*/ uint8_t                  Original;
/*0x036a*/ uint8_t                  IsPassenger;
/*0x036b*/ char                     LoginRelated[0x20];
/*0x038c*/ unsigned int             LastTimeStoodStill;
/*0x0390*/ uint8_t                  CharClass;
/*0x0391*/ bool                     bBuffTimersOnHold;
/*0x0394*/ float                    CameraOffset;
/*0x0398*/ float                    GetMeleeRangeVar1;
/*0x039c*/ char                     DragNames[2][0x40];
/*0x041c*/ CPhysicsInfo             LastCollision;
/*0x044c*/ int                      RealEstateItemId;
/*0x0450*/ char                     Suffix[0x80];
/*0x04d0*/ uint8_t                  Light;
/*0x04d1*/ uint8_t                  FishingEvent;
/*0x04d8*/ CharacterZoneClient*     pCharacter;
/*0x04e0*/ char                     Title[0x80];
/*0x0560*/ unsigned int             SitStartTime;
/*0x0564*/ bool                     Mercenary;
/*0x0568*/ float                    AnimationSpeedRelated;
/*0x056c*/ int                      Deity;
/*0x0570*/ int                      ManaCurrent;
/*0x0574*/ unsigned int             StunTimer;
/*0x0578*/ bool                     PvPFlag;
/*0x057c*/ int                      Buyer;
/*0x0580*/ int                      DoSpecialMelee;
/*0x0584*/ LaunchSpellData          CastingData;
/*0x05c8*/ int                      CurrIOState;
/*0x05d0*/ int64_t                  HPCurrent;
/*0x05d8*/ char                     Handle[0x20];
/*0x05f8*/ bool                     bTempPet;
/*0x05fc*/ unsigned int             FishingETA;
/*0x0600*/ int                      AFK;
/*0x0604*/ unsigned int             Zone;
/*0x0608*/ unsigned int             NextIntimidateTime;
/*0x060c*/ uint8_t                  GMRank;
/*0x0610*/ unsigned int             ACounter;
/*0x0614*/ unsigned int             NextSwim;
/*0x0618*/ int                      EnduranceCurrent;
/*0x061c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0620*/ uint8_t                  TitleVisible;
/*0x0624*/ int                      Birthdate;
/*0x0628*/ bool                     Linkdead;
/*0x0629*/ char                     GM;
/*0x062a*/ bool                     bBetaBuffed;
/*0x062c*/ unsigned int             LastSecondaryUseTime;
/*0x0630*/ int                      SomeData[2];
/*0x0638*/ float                    BearingToTarget;
/*0x063c*/ unsigned int             RespawnTimer;
/*0x0640*/ int                      Unknown1;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2023-07-10 (test) @ 0x1402dc3ae
