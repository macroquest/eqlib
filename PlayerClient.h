...
/*0x01cc*/ bool                     bSummoned;
/*0x01d0*/ unsigned int             SitStartTime;
/*0x01d4*/ uint8_t                  StandState;
/*0x01d8*/ unsigned int             FishingETA;
/*0x01dc*/ unsigned int             LastPrimaryUseTime;
/*0x01e0*/ float                    BearingToTarget;
/*0x01e4*/ unsigned int             LastTrapDamageTime;
/*0x01e8*/ unsigned int             SpellGemETA[15];
/*0x0224*/ int                      SomeData[2];
/*0x022c*/ float                    CameraOffset;
/*0x0230*/ int64_t                  GuildID;
/*0x0238*/ bool                     bStationary;
/*0x023c*/ unsigned int             RespawnTimer;
/*0x0240*/ CharacterZoneClient*     pCharacter;
/*0x0248*/ float                    MerchantGreed;
/*0x024c*/ int                      Unknown3;
/*0x0250*/ uint8_t                  IntimidateCount;
/*0x0258*/ void*                    pTouchingSwitch;
/*0x0260*/ unsigned int             NextIntimidateTime;
/*0x0264*/ char                     Handle[0x20];
/*0x0284*/ char                     Suffix[0x80];
/*0x0304*/ bool                     bAttackRelated;
/*0x0305*/ bool                     bTempPet;
/*0x0308*/ int                      Trader;
/*0x030c*/ int                      Birthdate;
/*0x0310*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0318*/ EqItemGuid               realEstateItemGuid;
/*0x032c*/ unsigned int             StunTimer;
/*0x0330*/ unsigned int             SpellCooldownETA;
/*0x0338*/ void*                    pRaceGenderInfo;
/*0x0340*/ uint8_t                  TitleVisible;
/*0x0341*/ bool                     bAlwaysShowAura;
/*0x0344*/ int                      WarCry;
/*0x0348*/ uint8_t                  CharClass;
/*0x034c*/ float                    GetMeleeRangeVar1;
/*0x0350*/ unsigned int             CorpseDragCount;
/*0x0354*/ int                      AFK;
/*0x0358*/ bool                     Sneak;
/*0x0360*/ SPAWNINFO*               pViewPlayer;
/*0x0368*/ uint8_t                  Blind;
/*0x036c*/ int                      DoSpecialMelee;
/*0x0370*/ bool                     bAnimationOnPop;
/*0x0374*/ unsigned int             LastResendAddPlayerPacket;
/*0x0378*/ unsigned int             MinuteTimer;
/*0x037c*/ int                      PetID;
/*0x0380*/ uint8_t                  Level;
/*0x0381*/ bool                     bBetaBuffed;
...
/*0x0399*/ uint8_t                  GMRank;
/*0x039c*/ int                      Unknown1;
/*0x03a0*/ int                      RealEstateItemId;
/*0x03a4*/ int                      CurrIOState;
/*0x03a8*/ int                      berserker;
/*0x03ac*/ int                      IsAttacking;
/*0x03b0*/ int                      HideMode;
/*0x03b4*/ int                      RealEstateID;
/*0x03b8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03c0*/ float                    ViewHeight;
/*0x03c4*/ int                      NpcTintIndex;
/*0x03c8*/ int                      AltAttack;
/*0x03cc*/ bool                     PvPFlag;
/*0x03d0*/ CPhysicsInfo             LastCollision;
/*0x0400*/ unsigned int             LastMealTime;
/*0x0404*/ float                    RunSpeed;
/*0x0408*/ char                     LoginRelated[0x20];
/*0x0428*/ int64_t                  HPCurrent;
/*0x0430*/ unsigned int             NextSwim;
/*0x0434*/ int                      SecondaryTintIndex;
/*0x0438*/ int                      ManaCurrent;
/*0x043c*/ int                      ManaMax;
/*0x0440*/ uint8_t                  HoldingAnimation;
/*0x0441*/ uint8_t                  FD;
/*0x0442*/ uint8_t                  FindBits;
/*0x0443*/ bool                     bBuffTimersOnHold;
/*0x0444*/ unsigned int             LastTimeStoodStill;
/*0x0448*/ float                    AnimationSpeedRelated;
/*0x044c*/ int                      Unknown4;
/*0x0450*/ uint8_t                  LastAttack;
/*0x0458*/ int64_t                  HPMax;
/*0x0460*/ unsigned int             ACounter;
/*0x0464*/ LaunchSpellData          CastingData;
/*0x04a8*/ uint8_t                  FishingEvent;
/*0x04ac*/ float                    MyWalkSpeed;
/*0x04b0*/ bool                     Linkdead;
/*0x04b1*/ bool                     LFG;
/*0x04b4*/ unsigned int             LoginSerial;
/*0x04b8*/ uint8_t                  Light;
/*0x04bc*/ unsigned int             LastRangedUsedTime;
/*0x04c0*/ unsigned int             LastTick;
/*0x04c4*/ unsigned int             TimeStamp;
/*0x04c8*/ bool                     Mercenary;
/*0x04cc*/ unsigned int             Zone;
/*0x04d0*/ int                      Anon;
/*0x04d4*/ unsigned int             LastSecondaryUseTime;
/*0x04d8*/ int                      Deity;
/*0x04dc*/ char                     GM;
/*0x04dd*/ uint8_t                  IsPassenger;
/*0x04de*/ bool                     bSwitchMoved;
/*0x04df*/ char                     DragNames[2][0x40];
/*0x0560*/ float                    MissileRangeToTarget;
/*0x0564*/ unsigned int             MasterID;
/*0x0568*/ unsigned int**           ppUDP;
/*0x0570*/ char                     DraggingPlayer[0x40];
/*0x05b0*/ unsigned int             LastRefresh;
/*0x05b4*/ int                      EnduranceCurrent;
/*0x05b8*/ bool                     bShowHelm;
/*0x05b9*/ char                     Title[0x80];
/*0x063c*/ unsigned int             Meditating;
/*0x0640*/ uint8_t                  InPvPArea;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2023-09-18 (test) @ 0x1402de3ce
