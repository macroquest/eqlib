...
/*0x01f4*/ int                      EnduranceCurrent;
/*0x01f8*/ LaunchSpellData          CastingData;
/*0x023c*/ unsigned int             StunTimer;
/*0x0240*/ float                    GetMeleeRangeVar1;
/*0x0244*/ unsigned int             SpellCooldownETA;
/*0x0248*/ unsigned int             TimeStamp;
/*0x024c*/ float                    MyWalkSpeed;
/*0x0250*/ int                      berserker;
/*0x0254*/ bool                     bBuffTimersOnHold;
/*0x0255*/ uint8_t                  FindBits;
/*0x0258*/ int                      WarCry;
/*0x025c*/ bool                     bAnimationOnPop;
/*0x0260*/ unsigned int             CorpseDragCount;
/*0x0264*/ int                      Buyer;
/*0x0268*/ uint8_t                  InPvPArea;
/*0x026c*/ unsigned int             MinuteTimer;
/*0x0270*/ int64_t                  HPCurrent;
/*0x0278*/ int                      ManaCurrent;
/*0x027c*/ unsigned int             Meditating;
/*0x0280*/ uint8_t                  StandState;
/*0x0284*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x028c*/ int                      RealEstateItemId;
/*0x0290*/ unsigned int             SpellGemETA[15];
/*0x02cc*/ uint8_t                  CharClass;
/*0x02d0*/ unsigned int**           ppUDP;
/*0x02d8*/ int                      SecondaryTintIndex;
/*0x02dc*/ unsigned int             LoginSerial;
/*0x02e0*/ char                     DraggingPlayer[0x40];
/*0x0320*/ unsigned int             LastResendAddPlayerPacket;
/*0x0324*/ unsigned int             LastTrapDamageTime;
/*0x0328*/ float                    AnimationSpeedRelated;
/*0x032c*/ unsigned int             RespawnTimer;
/*0x0330*/ float                    MerchantGreed;
/*0x0334*/ float                    BearingToTarget;
/*0x0338*/ uint8_t                  FD;
/*0x033c*/ int                      DoSpecialMelee;
/*0x0340*/ char                     LoginRelated[0x20];
/*0x0360*/ int64_t                  GuildID;
/*0x0368*/ int                      Unknown4;
/*0x036c*/ unsigned int             Zone;
/*0x0370*/ uint8_t                  IntimidateCount;
/*0x0374*/ int                      Trader;
/*0x0378*/ void*                    pRaceGenderInfo;
/*0x0380*/ char                     GM;
/*0x0384*/ unsigned int             EnduranceMax;
/*0x0388*/ int                      PrimaryTintIndex;
/*0x038c*/ unsigned int             LastPrimaryUseTime;
/*0x0390*/ char                     Suffix[0x80];
/*0x0410*/ bool                     bOfflineMode;
/*0x0418*/ int64_t                  HPMax;
/*0x0420*/ int                      Deity;
/*0x0424*/ float                    RunSpeed;
/*0x0428*/ bool                     Mercenary;
/*0x042c*/ float                    MissileRangeToTarget;
/*0x0430*/ int                      Birthdate;
/*0x0434*/ int                      AFK;
/*0x0438*/ unsigned int             NextIntimidateTime;
/*0x043c*/ unsigned int             FishingETA;
/*0x0440*/ void*                    pTouchingSwitch;
/*0x0448*/ unsigned int             NextSwim;
/*0x044c*/ uint8_t                  Original;
/*0x0450*/ int                      AltAttack;
/*0x0454*/ uint8_t                  TitleVisible;
/*0x0458*/ int                      SomeData[2];
/*0x0460*/ bool                     bSummoned;
/*0x0461*/ bool                     bTempPet;
/*0x0464*/ CPhysicsInfo             LastCollision;
/*0x0494*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x049c*/ bool                     Linkdead;
/*0x049d*/ uint8_t                  HoldingAnimation;
/*0x049e*/ bool                     bBetaBuffed;
/*0x04a0*/ float                    CameraOffset;
/*0x04a4*/ bool                     PvPFlag;
/*0x04a8*/ int                      CurrIOState;
/*0x04ac*/ int                      ManaMax;
/*0x04b0*/ uint8_t                  Blind;
/*0x04b1*/ char                     Title[0x80];
/*0x0534*/ int                      Anon;
/*0x0538*/ unsigned int             LastTick;
/*0x053c*/ float                    FallingStartZ;
/*0x0540*/ char                     Handle[0x20];
/*0x0560*/ bool                     bAlwaysShowAura;
/*0x0564*/ unsigned int             LastRefresh;
/*0x0568*/ unsigned int             ACounter;
/*0x056c*/ uint8_t                  Level;
/*0x056d*/ bool                     LFG;
/*0x0570*/ int                      HideMode;
/*0x0574*/ unsigned int             LastMealTime;
/*0x0578*/ unsigned int             LastTimeStoodStill;
/*0x057c*/ int                      RealEstateID;
/*0x0580*/ uint8_t                  GMRank;
/*0x0581*/ bool                     bStationary;
/*0x0584*/ float                    ViewHeight;
/*0x0588*/ int                      NpcTintIndex;
/*0x058c*/ EqItemGuid               realEstateItemGuid;
/*0x059e*/ uint8_t                  IsPassenger;
/*0x059f*/ uint8_t                  LastAttack;
/*0x05a0*/ uint8_t                  FishingEvent;
/*0x05a4*/ unsigned int             MasterID;
/*0x05a8*/ bool                     bSwitchMoved;
/*0x05ac*/ int                      Unknown1;
/*0x05b0*/ unsigned int             LastRangedUsedTime;
/*0x05b4*/ char                     DragNames[2][0x40];
/*0x0634*/ bool                     bAttackRelated;
/*0x0635*/ uint8_t                  Light;
/*0x0638*/ int                      IsAttacking;
...
// @sizeof(PlayerClient) == 0x1f60 :: 2024-07-24 (test) @ 0x1402ea69e
