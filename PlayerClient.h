...
/*0x01c0*/ int                      PrimaryTintIndex;
/*0x01c4*/ int                      SomethingElse;
/*0x01c8*/ float                    AnimationSpeedRelated;
/*0x01cc*/ EqItemGuid               realEstateItemGuid;
/*0x01e0*/ int                      ManaCurrent;
/*0x01e4*/ uint8_t                  CharClass;                    // Im pretty sure this isnt working
/*0x01e8*/ unsigned int             ACounter;                     // not sure what this one is for (m_uHibernatingCount)
/*0x01ec*/ int                      IsAttacking;                  // need to investigate
/*0x01f0*/ int64_t                  HPMax;
/*0x01f8*/ unsigned int             LastRefresh;                  // last 18 sec tick
/*0x01fc*/ bool                     bStationary;
/*0x0200*/ int                      RealEstateItemId;
/*0x0204*/ float                    RunSpeed;                     // 0.70 on runspeed 5...
/*0x0208*/ bool                     bSummoned;                    // by a PC or by anyone? need to investigate
/*0x0209*/ char                     GM;
/*0x020c*/ int                      HideMode;
/*0x0210*/ uint8_t                  GMRank;
/*0x0218*/ void*                    pRaceGenderInfo;              // todo this is not a void* so... map the CRaceGenderInfo class
/*0x0220*/ char                     Title[0x80];
/*0x02a0*/ unsigned int             LastCastTime;
/*0x02a4*/ bool                     bShowHelm;
/*0x02a8*/ int                      Deity;
/*0x02ac*/ uint8_t                  Light;
/*0x02b0*/ unsigned int             LastTick;
/*0x02b4*/ bool                     bAttackRelated;
/*0x02b8*/ unsigned int             EnduranceMax;
/*0x02bc*/ unsigned int             SpellCooldownETA;
/*0x02c0*/ unsigned int             CombatSkillTicks[0x2];
/*0x02c8*/ float                    BearingToTarget;
/*0x02cc*/ bool                     bAlwaysShowAura;
/*0x02d0*/ void*                    pTouchingSwitch;              // need to get that in here : struct _EQSWITCH
/*0x02d8*/ bool                     Sneak;
/*0x02dc*/ int                      ManaMax;
/*0x02e0*/ unsigned int             LastRangedUsedTime;
/*0x02e4*/ char                     LoginRelated[0x20];
/*0x0304*/ int                      CurrIOState;
/*0x0308*/ unsigned int             FishingETA;
/*0x030c*/ unsigned int             LastPrimaryUseTime;
/*0x0310*/ unsigned int             NextSwim;
/*0x0314*/ bool                     bAnimationOnPop;
/*0x0318*/ unsigned int             LastResendAddPlayerPacket;
/*0x0320*/ int64_t                  HPCurrent;
/*0x0328*/ int                      Buyer;
/*0x032c*/ unsigned int             Meditating;
/*0x0330*/ uint8_t                  HmmWhat;
/*0x0334*/ unsigned int             SitStartTime;
/*0x0338*/ int                      NpcTintIndex;
/*0x033c*/ unsigned int             LastTrapDamageTime;
/*0x0340*/ int                      EnduranceCurrent;
/*0x0348*/ unsigned int**           ppUDP;                        // UdpLibrary::UdpConnection
/*0x0350*/ char                     Handle[0x20];
/*0x0370*/ unsigned int             LastSecondaryUseTime;
/*0x0374*/ uint8_t                  IntimidateCount;
/*0x0375*/ bool                     Mercenary;
/*0x0376*/ char                     Suffix[0x80];
/*0x03f8*/ unsigned int             CombatSkillUsed[0x2];
/*0x0400*/ unsigned int             SpellGemETA[0xf];             // InnateETA is now the last member in this array
/*0x043c*/ int                      AltAttack;
/*0x0440*/ float                    MyWalkSpeed;
/*0x0444*/ unsigned int             MinuteTimer;
/*0x0448*/ float                    FallingStartZ;
/*0x044c*/ int                      berserker;
/*0x0450*/ float                    GetMeleeRangeVar1;            // used by GetMeleeRange (fScaleFactor)
/*0x0454*/ LaunchSpellData          CastingData;                  // size: 0x58
/*0x04b0*/ CharacterZoneClient*     pCharacter;
/*0x04b8*/ SPAWNINFO*               pViewPlayer;
/*0x04c0*/ float                    CameraOffset;
/*0x04c4*/ uint8_t                  LastAttack;
/*0x04c5*/ uint8_t                  FindBits;
/*0x04c8*/ unsigned int             RespawnTimer;                 // its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive
/*0x04cc*/ uint8_t                  FishingEvent;
/*0x04cd*/ uint8_t                  StandState;
/*0x04d0*/ int                      AFK;
/*0x04d4*/ int                      PetID;
/*0x04d8*/ bool                     bTempPet;
/*0x04d9*/ bool                     LFG;
/*0x04dc*/ int                      LastCastNum;
/*0x04e0*/ int                      DoSpecialMelee;
/*0x04e4*/ unsigned int             MasterID;
/*0x04e8*/ unsigned int             LastTimeStoodStill;
/*0x04ec*/ int                      RealEstateID;
/*0x04f0*/ float                    ViewHeight;
/*0x04f4*/ CPhysicsInfo             LastCollision;
/*0x0524*/ float                    MissileRangeToTarget;
/*0x0528*/ uint8_t                  HoldingAnimation;             // todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7
/*0x052c*/ int                      Stuff;
/*0x0530*/ bool                     Linkdead;
/*0x0534*/ int                      Anon;                         // found in EQPlayer__SetNameSpriteTint_x
/*0x0538*/ bool                     bBetaBuffed;
/*0x053c*/ unsigned int             StunTimer;
/*0x0540*/ unsigned int             LoginSerial;
/*0x0544*/ float                    MerchantGreed;
/*0x0548*/ int                      WarCry;
/*0x054c*/ unsigned int             LastMealTime;                 // last time we eat or drank
/*0x0550*/ int                      DontKnowYet;
/*0x0554*/ unsigned int             Zone;
/*0x0558*/ bool                     bOfflineMode;
/*0x0559*/ uint8_t                  InPvPArea;                    // are we in a PvP area?
/*0x055c*/ int                      Dontknowyet2;
/*0x0560*/ int                      SomeData[0x2];
/*0x0568*/ bool                     PvPFlag;
/*0x0569*/ uint8_t                  Type2;
/*0x0570*/ int64_t                  GuildID;
/*0x0578*/ bool                     bBuffTimersOnHold;            // no you can't control this client side so unless you want to get banned leave it alone
/*0x0579*/ uint8_t                  Blind;
/*0x057a*/ uint8_t                  IsPassenger;                  // if u are on a boat or airship or whatever
/*0x057b*/ char                     DraggingPlayer[0x40];
/*0x05bc*/ int                      Trader;                       // found in CEverQuest__RightClickedOnPlayer_x
/*0x05c0*/ int                      AARank;                       // this really is the title id
/*0x05c4*/ char                     DragNames[0x2][0x40];
/*0x0644*/ unsigned int             TimeStamp;                    // updates all the time including when on a mount
/*0x0648*/ bool                     bSwitchMoved;                 // true when a door moves near the spawn
/*0x064c*/ unsigned int             NextIntimidateTime;
/*0x0650*/ int                      SecondaryTintIndex;
/*0x0654*/ uint8_t                  Level;
/*0x0655*/ uint8_t                  FD;
/*0x0656*/ uint8_t                  TitleVisible;
...
// @sizeof(PlayerClient) == 0x1f78 :: 2022-04-14 (test) @ 0x14029fc8e
...
/*0x1df0*/ TSafeArrayStatic<int, 3> SeeInvis; // 1df0
...
/*0x1ee8*/ ArrayClass2<unsigned int> BardTwistSpells; // 1ef8 -> 1ee8
