...
/*0x01bc*/ float                    BearingToTarget;
/*0x01c0*/ bool                     bSummoned;
/*0x01c4*/ int                      EnduranceCurrent;
/*0x01c8*/ unsigned int             MinuteTimer;
/*0x01cc*/ uint8_t                  InPvPArea;
/*0x01d0*/ int                      Unknown3;
/*0x01d4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x01dc*/ unsigned int             LastRefresh;
/*0x01e0*/ EqItemGuid               realEstateItemGuid;
/*0x01f4*/ int                      HideMode;
/*0x01f8*/ uint8_t                  TitleVisible;
/*0x01f9*/ bool                     PvPFlag;
/*0x01fc*/ int                      PrimaryTintIndex;
/*0x0200*/ SPAWNINFO*               pViewPlayer;
/*0x0208*/ bool                     Linkdead;
/*0x020c*/ unsigned int             LastMealTime;
/*0x0210*/ float                    MerchantGreed;
/*0x0218*/ int64_t                  HPCurrent;
/*0x0220*/ int                      Unknown4;
/*0x0224*/ bool                     bSwitchMoved;
/*0x0225*/ bool                     bAnimationOnPop;
/*0x0228*/ int                      RealEstateItemId;
/*0x022c*/ unsigned int             LastRangedUsedTime;
/*0x0230*/ char                     LoginRelated[0x20];
/*0x0250*/ unsigned int             StunTimer;
/*0x0254*/ int                      AltAttack;
/*0x0258*/ void*                    pTouchingSwitch;
/*0x0260*/ int                      DoSpecialMelee;
/*0x0264*/ unsigned int             NextIntimidateTime;
/*0x0268*/ int                      Anon;
/*0x026c*/ uint8_t                  IntimidateCount;
/*0x0270*/ float                    MissileRangeToTarget;
/*0x0274*/ uint8_t                  FishingEvent;
/*0x0278*/ CPhysicsInfo             LastCollision;
/*0x02a8*/ float                    ViewHeight;
/*0x02ac*/ int                      berserker;
/*0x02b0*/ unsigned int             FishingETA;
/*0x02b8*/ int64_t                  HPMax;
/*0x02c0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x02c8*/ uint8_t                  FindBits;
/*0x02cc*/ float                    GetMeleeRangeVar1;
/*0x02d0*/ unsigned int             Meditating;
/*0x02d4*/ unsigned int             RespawnTimer;
/*0x02d8*/ float                    MyWalkSpeed;
/*0x02dc*/ int                      Trader;
/*0x02e0*/ bool                     bAttackRelated;
/*0x02e1*/ uint8_t                  CharClass;
/*0x02e4*/ unsigned int             NextSwim;
/*0x02e8*/ uint8_t                  Original;
/*0x02e9*/ char                     DraggingPlayer[0x40];
/*0x032c*/ unsigned int             SpellCooldownETA;
/*0x0330*/ char                     Handle[0x20];
/*0x0350*/ unsigned int             EnduranceMax;
/*0x0354*/ unsigned int             LastSecondaryUseTime;
/*0x0358*/ unsigned int             LastResendAddPlayerPacket;
/*0x035c*/ float                    FallingStartZ;
/*0x0360*/ uint8_t                  LastAttack;
/*0x0364*/ unsigned int             SpellGemETA[15];
/*0x03a0*/ bool                     bStationary;
/*0x03a1*/ bool                     bShowHelm;
/*0x03a4*/ unsigned int             LastTick;
...
/*0x0448*/ char                     Suffix[0x80];
/*0x04c8*/ unsigned int             ACounter;
/*0x04cc*/ uint8_t                  HoldingAnimation;
/*0x04cd*/ uint8_t                  IsPassenger;
/*0x04d0*/ unsigned int             LastTrapDamageTime;
/*0x04d4*/ int                      PetID;
/*0x04d8*/ float                    AnimationSpeedRelated;
/*0x04dc*/ bool                     bAlwaysShowAura;
/*0x04e0*/ unsigned int             LoginSerial;
/*0x04e4*/ float                    RunSpeed;
/*0x04e8*/ int                      SomeData[2];
/*0x04f0*/ unsigned int             CorpseDragCount;
/*0x04f8*/ CharacterZoneClient*     pCharacter;
/*0x0500*/ uint8_t                  Level;
/*0x0501*/ bool                     bBetaBuffed;
/*0x0504*/ int                      Unknown2;
/*0x0508*/ int                      AFK;
/*0x050c*/ int                      ManaCurrent;
/*0x0510*/ uint8_t                  StandState;
/*0x0514*/ int                      IsAttacking;
/*0x0518*/ unsigned int             MasterID;
/*0x051c*/ bool                     bBuffTimersOnHold;
/*0x0520*/ unsigned int             TimeStamp;
/*0x0524*/ bool                     bOfflineMode;
/*0x0528*/ float                    CameraOffset;
/*0x052c*/ char                     GM;
/*0x0530*/ int                      WarCry;
/*0x0534*/ int                      ManaMax;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2022-12-13 (test) @ 0x1402a7b0e
