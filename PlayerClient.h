...
/*0x01bc*/ bool                     Mercenary;
/*0x01bd*/ bool                     LFG;
/*0x01c0*/ unsigned int             LastRangedUsedTime;
/*0x01c8*/ int64_t                  HPCurrent;
/*0x01d0*/ bool                     Sneak;
/*0x01d4*/ unsigned int             FishingETA;
/*0x01d8*/ LaunchSpellData          CastingData;
/*0x0230*/ unsigned int             LastMealTime;
/*0x0234*/ bool                     bSummoned;
/*0x0238*/ int                      Trader;
/*0x023c*/ uint8_t                  InPvPArea;
/*0x0240*/ int                      SomeData[2];
/*0x0248*/ CharacterZoneClient*     pCharacter;
/*0x0250*/ uint8_t                  HmmWhat;
/*0x0254*/ int                      LastCastNum;
/*0x0258*/ int64_t                  GuildID;
/*0x0260*/ int                      NpcTintIndex;
/*0x0264*/ int                      DoSpecialMelee;
/*0x0268*/ uint8_t                  Type2;
/*0x0269*/ uint8_t                  FD;
/*0x026c*/ float                    AnimationSpeedRelated;
/*0x0270*/ uint8_t                  IntimidateCount;
/*0x0274*/ unsigned int             Zone;
/*0x0278*/ int                      AFK;
/*0x027c*/ bool                     bStationary;
/*0x027d*/ bool                     bShowHelm;
/*0x0280*/ int                      HideMode;
/*0x0284*/ uint8_t                  TitleVisible;
/*0x0288*/ int64_t                  HPMax;
/*0x0290*/ unsigned int             SitStartTime;
/*0x0294*/ unsigned int             LoginSerial;
/*0x0298*/ float                    GetMeleeRangeVar1;
/*0x029c*/ float                    CameraOffset;
/*0x02a0*/ int                      SecondaryTintIndex;
/*0x02a4*/ uint8_t                  GMRank;
/*0x02a5*/ char                     Suffix[0x80];
/*0x0328*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0330*/ unsigned int             MasterID;
/*0x0334*/ unsigned int             SpellGemETA[15];
/*0x0370*/ float                    MissileRangeToTarget;
/*0x0374*/ uint8_t                  LastAttack;
/*0x0378*/ int                      PrimaryTintIndex;
/*0x037c*/ int                      ManaMax;
/*0x0380*/ unsigned int             CorpseDragCount;
/*0x0384*/ uint8_t                  Light;
/*0x0385*/ bool                     bAttackRelated;
/*0x0388*/ unsigned int             LastResendAddPlayerPacket;
/*0x038c*/ EqItemGuid               realEstateItemGuid;
/*0x039e*/ char                     DragNames[2][0x40];
/*0x0420*/ float                    ViewHeight;
/*0x0424*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x042c*/ int                      IsAttacking;
/*0x0430*/ SPAWNINFO*               pViewPlayer;
/*0x0438*/ float                    FallingStartZ;
/*0x043c*/ int                      Buyer;
/*0x0440*/ unsigned int             NextSwim;
/*0x0444*/ bool                     Linkdead;
/*0x0448*/ int                      WarCry;
/*0x044c*/ uint8_t                  Blind;
/*0x0450*/ int                      PetID;
/*0x0454*/ int                      berserker;
/*0x0458*/ bool                     bAnimationOnPop;
/*0x045c*/ unsigned int             NextIntimidateTime;
/*0x0460*/ unsigned int             SpellCooldownETA;
/*0x0464*/ unsigned int             LastRefresh;
/*0x0468*/ uint8_t                  CharClass;
/*0x046c*/ unsigned int             RespawnTimer;
/*0x0470*/ unsigned int             EnduranceMax;
/*0x0474*/ int                      RealEstateItemId;
/*0x0478*/ uint8_t                  FishingEvent;
/*0x047c*/ unsigned int             LastPrimaryUseTime;
/*0x0480*/ char                     Handle[0x20];
/*0x04a0*/ float                    MerchantGreed;
/*0x04a4*/ unsigned int             LastSecondaryUseTime;
/*0x04a8*/ int                      RealEstateID;
/*0x04ac*/ char                     GM;
/*0x04ad*/ bool                     bBetaBuffed;
/*0x04ae*/ bool                     bTempPet;
/*0x04b0*/ void*                    pRaceGenderInfo;
/*0x04b8*/ int                      CurrIOState;
/*0x04bc*/ uint8_t                  StandState;
/*0x04c0*/ void*                    pTouchingSwitch;
/*0x04c8*/ unsigned int             LastTimeStoodStill;
/*0x04cc*/ uint8_t                  HoldingAnimation;
/*0x04cd*/ uint8_t                  IsPassenger;
/*0x04d0*/ int                      AltAttack;
/*0x04d4*/ int                      SomethingElse;
/*0x04d8*/ float                    RunSpeed;
/*0x04dc*/ char                     DraggingPlayer[0x40];
/*0x051c*/ bool                     bOfflineMode;
/*0x0520*/ int                      Deity;
/*0x0524*/ int                      Dontknowyet2;
/*0x0528*/ int                      DontKnowYet;
/*0x052c*/ bool                     bBuffTimersOnHold;
/*0x0530*/ int                      Anon;
/*0x0534*/ char                     Title[0x80];
/*0x05b4*/ int                      ManaCurrent;
/*0x05b8*/ unsigned int             MinuteTimer;
/*0x05bc*/ uint8_t                  FindBits;
/*0x05c0*/ unsigned int             TimeStamp;
/*0x05c4*/ int                      Stuff;
/*0x05c8*/ unsigned int             ACounter;
/*0x05cc*/ unsigned int             LastTrapDamageTime;
/*0x05d0*/ unsigned int             LastCastTime;
/*0x05d4*/ bool                     PvPFlag;
/*0x05d8*/ unsigned int             Meditating;
/*0x05dc*/ uint8_t                  Level;
/*0x05e0*/ CPhysicsInfo             LastCollision;
/*0x0610*/ unsigned int             StunTimer;
/*0x0614*/ bool                     bAlwaysShowAura;
/*0x0618*/ float                    BearingToTarget;
/*0x061c*/ float                    MyWalkSpeed;
/*0x0620*/ bool                     bSwitchMoved;
/*0x0624*/ int                      EnduranceCurrent;
/*0x0628*/ char                     LoginRelated[0x20];
/*0x0648*/ unsigned int             LastTick;
/*0x0650*/ unsigned int**           ppUDP;
...
// @sizeof(PlayerClient) == 0x1f78 :: 2022-07-21 (test) @ 0x1402a08de
