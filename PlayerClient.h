...
/*0x01c0*/ int                      Deity;
/*0x01c4*/ int                      berserker;
/*0x01c8*/ unsigned int             SpellGemETA[15];
/*0x0204*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x020c*/ unsigned int             FishingETA;
/*0x0210*/ int                      ManaCurrent;
/*0x0214*/ uint8_t                  FindBits;
/*0x0218*/ int                      Unknown4;
/*0x021c*/ unsigned int             StunTimer;
/*0x0220*/ unsigned int             NextSwim;
/*0x0224*/ char                     Handle[0x20];
/*0x0244*/ EqItemGuid               realEstateItemGuid;
/*0x0258*/ float                    BearingToTarget;
/*0x025c*/ uint8_t                  FD;
/*0x025d*/ bool                     bBetaBuffed;
/*0x0260*/ unsigned int             LastTick;
/*0x0264*/ float                    MyWalkSpeed;
/*0x0268*/ unsigned int             LastResendAddPlayerPacket;
/*0x026c*/ unsigned int             MinuteTimer;
/*0x0270*/ unsigned int             LastTrapDamageTime;
/*0x0274*/ uint8_t                  LastAttack;
/*0x0278*/ int                      WarCry;
/*0x027c*/ char                     DraggingPlayer[0x40];
/*0x02bc*/ bool                     bAttackRelated;
/*0x02bd*/ uint8_t                  CharClass;
/*0x02c0*/ int                      DoSpecialMelee;
/*0x02c4*/ bool                     bOfflineMode;
/*0x02c8*/ int64_t                  HPMax;
/*0x02d0*/ bool                     bShowHelm;
/*0x02d1*/ uint8_t                  Blind;
/*0x02d4*/ unsigned int             LastMealTime;
/*0x02d8*/ int                      PrimaryTintIndex;
/*0x02dc*/ bool                     bSummoned;
/*0x02e0*/ unsigned int             SpellCooldownETA;
/*0x02e4*/ float                    GetMeleeRangeVar1;
/*0x02e8*/ int                      CurrIOState;
/*0x02ec*/ uint8_t                  IsPassenger;
/*0x02ed*/ bool                     PvPFlag;
/*0x02f0*/ float                    ViewHeight;
/*0x02f4*/ bool                     bBuffTimersOnHold;
/*0x02f8*/ float                    CameraOffset;
/*0x02fc*/ int                      PetID;
/*0x0300*/ uint8_t                  StandState;
/*0x0301*/ uint8_t                  Original;
/*0x0302*/ bool                     LFG;
/*0x0304*/ unsigned int             EnduranceMax;
/*0x0308*/ float                    FallingStartZ;
/*0x030c*/ uint8_t                  Light;
/*0x0310*/ unsigned int             CorpseDragCount;
/*0x0314*/ bool                     bAlwaysShowAura;
/*0x0318*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0320*/ int64_t                  HPCurrent;
/*0x0328*/ int                      Anon;
/*0x032c*/ int                      Trader;
/*0x0330*/ int                      RealEstateID;
/*0x0334*/ unsigned int             TimeStamp;
/*0x0338*/ unsigned int             LastPrimaryUseTime;
/*0x033c*/ float                    MissileRangeToTarget;
/*0x0340*/ uint8_t                  Level;
/*0x0344*/ int                      IsAttacking;
/*0x0348*/ float                    RunSpeed;
/*0x0350*/ void*                    pTouchingSwitch;
/*0x0358*/ int                      Unknown1;
/*0x035c*/ bool                     Mercenary;
/*0x035d*/ uint8_t                  GMRank;
/*0x0360*/ unsigned int             LastTimeStoodStill;
/*0x0364*/ uint8_t                  TitleVisible;
/*0x0368*/ float                    MerchantGreed;
/*0x0370*/ void*                    pRaceGenderInfo;
/*0x0378*/ uint8_t                  FishingEvent;
/*0x037c*/ int                      NpcTintIndex;
/*0x0380*/ uint8_t                  InPvPArea;
/*0x0381*/ bool                     bSwitchMoved;
/*0x0382*/ uint8_t                  IntimidateCount;
/*0x0383*/ char                     Title[0x80];
/*0x0404*/ int                      HideMode;
/*0x0408*/ char                     LoginRelated[0x20];
/*0x0428*/ int                      SomeData[2];
/*0x0430*/ uint8_t                  HoldingAnimation;
/*0x0431*/ bool                     Linkdead;
/*0x0432*/ char                     Suffix[0x80];
/*0x04b8*/ SPAWNINFO*               pViewPlayer;
/*0x04c0*/ int                      Unknown2;
/*0x04c4*/ bool                     Sneak;
/*0x04c8*/ unsigned int             Meditating;
/*0x04cc*/ unsigned int             ACounter;
/*0x04d0*/ unsigned int             MasterID;
/*0x04d8*/ int64_t                  GuildID;
/*0x04e0*/ int                      EnduranceCurrent;
/*0x04e4*/ bool                     bTempPet;
/*0x04e8*/ int                      Unknown3;
/*0x04ec*/ bool                     bAnimationOnPop;
/*0x04f0*/ unsigned int             SitStartTime;
...
/*0x0504*/ char                     GM;
/*0x0508*/ int                      AFK;
/*0x050c*/ unsigned int             LastSecondaryUseTime;
/*0x0510*/ unsigned int             LoginSerial;
/*0x0518*/ CharacterZoneClient*     pCharacter;
/*0x0520*/ int                      Buyer;
/*0x0524*/ bool                     bStationary;
/*0x0528*/ LaunchSpellData          CastingData;
/*0x056c*/ unsigned int             LastRefresh;
/*0x0570*/ char                     DragNames[2][0x40];
/*0x05f0*/ unsigned int**           ppUDP;
/*0x05f8*/ CPhysicsInfo             LastCollision;
/*0x0628*/ int                      SecondaryTintIndex;
/*0x062c*/ unsigned int             NextIntimidateTime;
/*0x0630*/ int                      AltAttack;
/*0x0634*/ unsigned int             RespawnTimer;
...
// @sizeof(PlayerClient) == 0x1f58 :: 2022-11-30 (live) @ 0x1402a7c9e
