...
/*0x01cc*/ uint8_t                  Blind;
/*0x01cd*/ uint8_t                  FishingEvent;
/*0x01d0*/ LaunchSpellData          CastingData;
/*0x0214*/ unsigned int             NextSwim;
/*0x0218*/ int                      Deity;
/*0x021c*/ unsigned int             RespawnTimer;
/*0x0220*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0228*/ bool                     bStationary;
/*0x022c*/ int                      PetID;
/*0x0230*/ unsigned int             TimeStamp;
/*0x0238*/ void*                    pTouchingSwitch;
/*0x0240*/ int                      Anon;
/*0x0244*/ unsigned int             LastMealTime;
/*0x0248*/ void*                    pRaceGenderInfo;
/*0x0250*/ bool                     bOfflineMode;
/*0x0251*/ uint8_t                  Level;
/*0x0254*/ float                    MerchantGreed;
/*0x0258*/ bool                     bShowHelm;
/*0x0259*/ uint8_t                  LastAttack;
/*0x025c*/ float                    AnimationSpeedRelated;
/*0x0260*/ bool                     bTempPet;
/*0x0264*/ int                      Unknown3;
/*0x0268*/ char                     GM;
/*0x0269*/ uint8_t                  Original;
/*0x026a*/ uint8_t                  FindBits;
/*0x026c*/ unsigned int             SpellCooldownETA;
/*0x0270*/ uint8_t                  HoldingAnimation;
/*0x0274*/ float                    ViewHeight;
/*0x0278*/ uint8_t                  InPvPArea;
/*0x027c*/ float                    MyWalkSpeed;
/*0x0280*/ unsigned int             Zone;
/*0x0284*/ EqItemGuid               realEstateItemGuid;
/*0x0298*/ int                      NpcTintIndex;
/*0x029c*/ float                    MissileRangeToTarget;
/*0x02a0*/ bool                     bAttackRelated;
/*0x02a8*/ SPAWNINFO*               pViewPlayer;
/*0x02b0*/ bool                     bBetaBuffed;
/*0x02b8*/ unsigned int**           ppUDP;
/*0x02c0*/ uint8_t                  IsPassenger;
/*0x02c4*/ int                      RealEstateItemId;
/*0x02c8*/ char                     DraggingPlayer[0x40];
/*0x0308*/ float                    FallingStartZ;
/*0x030c*/ float                    RunSpeed;
/*0x0310*/ bool                     bSwitchMoved;
/*0x0311*/ char                     Title[0x80];
/*0x0394*/ int                      Buyer;
/*0x0398*/ int                      ManaMax;
/*0x039c*/ unsigned int             Meditating;
/*0x03a0*/ int                      Unknown4;
/*0x03a4*/ int                      Birthdate;
/*0x03a8*/ uint8_t                  FD;
/*0x03ac*/ int                      ManaCurrent;
/*0x03b0*/ float                    CameraOffset;
/*0x03b4*/ unsigned int             LastPrimaryUseTime;
/*0x03b8*/ uint8_t                  Light;
/*0x03b9*/ char                     Suffix[0x80];
/*0x043c*/ int                      SecondaryTintIndex;
/*0x0440*/ uint8_t                  IntimidateCount;
/*0x0444*/ int                      SomeData[2];
/*0x044c*/ unsigned int             SitStartTime;
/*0x0450*/ float                    GetMeleeRangeVar1;
/*0x0454*/ bool                     bAnimationOnPop;
/*0x0458*/ int                      CurrIOState;
/*0x045c*/ unsigned int             EnduranceMax;
/*0x0460*/ unsigned int             MinuteTimer;
/*0x0464*/ bool                     Mercenary;
/*0x0468*/ unsigned int             LastTimeStoodStill;
/*0x046c*/ char                     Handle[0x20];
/*0x0490*/ CharacterZoneClient*     pCharacter;
/*0x0498*/ int                      RealEstateID;
/*0x049c*/ unsigned int             LastRefresh;
/*0x04a0*/ char                     LoginRelated[0x20];
/*0x04c0*/ unsigned int             ACounter;
/*0x04c4*/ int                      EnduranceCurrent;
/*0x04c8*/ unsigned int             LoginSerial;
/*0x04cc*/ bool                     Sneak;
/*0x04d0*/ unsigned int             MasterID;
/*0x04d4*/ unsigned int             LastTrapDamageTime;
/*0x04d8*/ unsigned int             LastSecondaryUseTime;
/*0x04dc*/ int                      Trader;
/*0x04e0*/ uint8_t                  CharClass;
/*0x04e4*/ int                      AFK;
/*0x04e8*/ int                      WarCry;
/*0x04ec*/ uint8_t                  StandState;
/*0x04f0*/ unsigned int             FishingETA;
/*0x04f4*/ unsigned int             LastTick;
/*0x04f8*/ bool                     bAlwaysShowAura;
/*0x0500*/ int64_t                  HPMax;
/*0x0508*/ uint8_t                  TitleVisible;
/*0x050c*/ float                    BearingToTarget;
/*0x0510*/ bool                     LFG;
/*0x0511*/ bool                     bBuffTimersOnHold;
/*0x0512*/ uint8_t                  GMRank;
/*0x0514*/ unsigned int             LastResendAddPlayerPacket;
/*0x0518*/ int64_t                  GuildID;
/*0x0520*/ char                     DragNames[2][0x40];
/*0x05a0*/ int                      berserker;
/*0x05a4*/ int                      PrimaryTintIndex;
/*0x05a8*/ int64_t                  HPCurrent;
/*0x05b0*/ unsigned int             LastRangedUsedTime;
/*0x05b4*/ int                      AltAttack;
/*0x05b8*/ unsigned int             NextIntimidateTime;
/*0x05bc*/ unsigned int             SpellGemETA[15];
/*0x05f8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0600*/ int                      DoSpecialMelee;
/*0x0604*/ bool                     Linkdead;
/*0x0605*/ bool                     PvPFlag;
/*0x0606*/ bool                     bSummoned;
/*0x0608*/ int                      Unknown1;
/*0x060c*/ int                      IsAttacking;
/*0x0610*/ unsigned int             StunTimer;
/*0x0614*/ CPhysicsInfo             LastCollision;
/*0x0644*/ int                      HideMode;
/*0x0648*/ unsigned int             CorpseDragCount;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2023-06-15 (live) @ 0x1402dbede
