...
/*0x01dc*/ int                      Unknown2;
/*0x01e0*/ float                    GetMeleeRangeVar1;
/*0x01e4*/ uint8_t                  InPvPArea;
/*0x01e5*/ bool                     PvPFlag;
/*0x01e6*/ bool                     Sneak;
/*0x01e8*/ int                      AltAttack;
/*0x01f0*/ int64_t                  HPCurrent;
/*0x01f8*/ bool                     bAnimationOnPop;
/*0x01fc*/ unsigned int             LastRangedUsedTime;
/*0x0200*/ unsigned int             LastSecondaryUseTime;
/*0x0204*/ unsigned int             Meditating;
/*0x0208*/ float                    MissileRangeToTarget;
/*0x020c*/ bool                     bSwitchMoved;
/*0x0210*/ unsigned int             SpellGemETA[15];
/*0x024c*/ unsigned int             CorpseDragCount;
/*0x0250*/ int                      Buyer;
/*0x0254*/ unsigned int             LastMealTime;
/*0x0258*/ unsigned int             LastTrapDamageTime;
/*0x025c*/ unsigned int             NextSwim;
/*0x0260*/ int                      AFK;
/*0x0264*/ uint8_t                  HoldingAnimation;
/*0x0268*/ int                      CurrIOState;
/*0x026c*/ unsigned int             LastPrimaryUseTime;
/*0x0270*/ unsigned int             NextIntimidateTime;
/*0x0274*/ float                    MerchantGreed;
/*0x0278*/ uint8_t                  FD;
/*0x0279*/ char                     LoginRelated[0x20];
/*0x029c*/ unsigned int             EnduranceMax;
/*0x02a0*/ bool                     bAlwaysShowAura;
/*0x02a8*/ void*                    pTouchingSwitch;
/*0x02b0*/ uint8_t                  GMRank;
/*0x02b8*/ CharacterZoneClient*     pCharacter;
/*0x02c0*/ int                      Anon;
/*0x02c4*/ char                     GM;
/*0x02c8*/ unsigned int             ACounter;
/*0x02d0*/ SPAWNINFO*               pViewPlayer;
/*0x02d8*/ void*                    pRaceGenderInfo;
/*0x02e0*/ int                      EnduranceCurrent;
/*0x02e8*/ unsigned int**           ppUDP;
/*0x02f0*/ float                    MyWalkSpeed;
/*0x02f4*/ char                     Title[0x80];
/*0x0374*/ int                      ManaMax;
/*0x0378*/ float                    RunSpeed;
/*0x037c*/ float                    ViewHeight;
/*0x0380*/ int                      IsAttacking;
/*0x0384*/ bool                     bAttackRelated;
/*0x0385*/ uint8_t                  Original;
/*0x0388*/ int                      PrimaryTintIndex;
/*0x038c*/ unsigned int             RespawnTimer;
/*0x0390*/ bool                     bBuffTimersOnHold;
/*0x0394*/ int                      Trader;
/*0x0398*/ bool                     bShowHelm;
/*0x0399*/ uint8_t                  Level;
/*0x039c*/ unsigned int             SitStartTime;
/*0x03a0*/ int                      ManaCurrent;
/*0x03a4*/ char                     Suffix[0x80];
/*0x0424*/ uint8_t                  FindBits;
/*0x0425*/ char                     DragNames[2][0x40];
/*0x04a5*/ bool                     Mercenary;
/*0x04a8*/ float                    FallingStartZ;
/*0x04ac*/ uint8_t                  LastAttack;
/*0x04b0*/ int                      SomeData[2];
/*0x04b8*/ EqItemGuid               realEstateItemGuid;
/*0x04cc*/ float                    AnimationSpeedRelated;
/*0x04d0*/ float                    CameraOffset;
/*0x04d4*/ uint8_t                  CharClass;
/*0x04d8*/ int                      DoSpecialMelee;
/*0x04dc*/ int                      berserker;
/*0x04e0*/ unsigned int             MasterID;
/*0x04e4*/ float                    BearingToTarget;
/*0x04e8*/ unsigned int             FishingETA;
/*0x04ec*/ int                      WarCry;
/*0x04f0*/ int                      Deity;
/*0x04f4*/ bool                     bTempPet;
/*0x04f8*/ int                      Unknown3;
/*0x04fc*/ unsigned int             LastTick;
/*0x0500*/ unsigned int             LastTimeStoodStill;
/*0x0504*/ int                      PetID;
/*0x0508*/ unsigned int             MinuteTimer;
/*0x050c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0514*/ unsigned int             StunTimer;
/*0x0518*/ uint8_t                  Type2;
/*0x0519*/ uint8_t                  IsPassenger;
/*0x051a*/ bool                     Linkdead;
/*0x051b*/ uint8_t                  Blind;
/*0x051c*/ unsigned int             LoginSerial;
/*0x0520*/ uint8_t                  IntimidateCount;
/*0x0521*/ uint8_t                  TitleVisible;
/*0x0522*/ uint8_t                  Light;
/*0x0524*/ int                      Unknown1;
/*0x0528*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0530*/ uint8_t                  StandState;
/*0x0531*/ bool                     bOfflineMode;
/*0x0534*/ int                      SecondaryTintIndex;
/*0x0538*/ bool                     bSummoned;
/*0x053c*/ unsigned int             TimeStamp;
/*0x0540*/ unsigned int             LastResendAddPlayerPacket;
/*0x0544*/ LaunchSpellData          CastingData;
/*0x0588*/ unsigned int             Zone;
/*0x058c*/ char                     DraggingPlayer[0x40];
/*0x05cc*/ unsigned int             LastRefresh;
/*0x05d0*/ uint8_t                  FishingEvent;
/*0x05d4*/ int                      NpcTintIndex;
/*0x05d8*/ int64_t                  HPMax;
/*0x05e0*/ int64_t                  GuildID;
/*0x05e8*/ int                      Unknown4;
/*0x05ec*/ bool                     LFG;
/*0x05f0*/ unsigned int             SpellCooldownETA;
/*0x05f4*/ CPhysicsInfo             LastCollision;
/*0x0624*/ int                      HideMode;
/*0x0628*/ int                      RealEstateID;
/*0x062c*/ int                      RealEstateItemId;
/*0x0630*/ bool                     bBetaBuffed;
/*0x0631*/ bool                     bStationary;
...
// @sizeof(PlayerClient) == 0x1f50 :: 2022-11-08 (test) @ 0x1402a365e
