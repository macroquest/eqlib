...
/*0x1b8*/ uint64_t          unknown1b8;
/*0x1c0*/ uint32_t          unknown1c0;
/*0x1c4*/
...
/*0x01cc*/ char                     DraggingPlayer[0x40];
/*0x020c*/ EqItemGuid               realEstateItemGuid;
/*0x021e*/ bool                     Linkdead;
/*0x021f*/ bool                     bBetaBuffed;
/*0x0220*/ bool                     PvPFlag;
/*0x0224*/ unsigned int             SitStartTime;
/*0x0228*/ int                      berserker;
/*0x022c*/ int                      Anon;
/*0x0230*/ unsigned int             Zone;
/*0x0234*/ uint8_t                  HoldingAnimation;
/*0x0238*/ void*                    pRaceGenderInfo;
/*0x0240*/ uint8_t                  Blind;
/*0x0244*/ int                      Deity;
/*0x0248*/ unsigned int             LoginSerial;
/*0x024c*/ float                    MissileRangeToTarget;
/*0x0250*/ int                      SomeData[2];
/*0x0258*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0260*/ CPhysicsInfo             LastCollision;
/*0x0290*/ uint8_t                  InPvPArea;
/*0x0294*/ int                      EnduranceCurrent;
/*0x0298*/ unsigned int             LastTick;
/*0x029c*/ int                      DoSpecialMelee;
/*0x02a0*/ uint8_t                  GMRank;
/*0x02a4*/ int                      Unknown4;
/*0x02a8*/ uint8_t                  FD;
/*0x02ac*/ unsigned int             NextIntimidateTime;
/*0x02b0*/ float                    ViewHeight;
/*0x02b4*/ int                      Buyer;
/*0x02b8*/ bool                     bAlwaysShowAura;
/*0x02b9*/ uint8_t                  IntimidateCount;
/*0x02bc*/ unsigned int             LastRangedUsedTime;
/*0x02c0*/ char                     DragNames[2][0x40];
/*0x0340*/ unsigned int             MinuteTimer;
/*0x0344*/ int                      SecondaryTintIndex;
/*0x0348*/ char                     Handle[0x20];
/*0x0368*/ unsigned int**           ppUDP;
/*0x0370*/ int                      RealEstateID;
/*0x0374*/ unsigned int             RespawnTimer;
/*0x0378*/ bool                     Mercenary;
/*0x037c*/ unsigned int             LastRefresh;
/*0x0380*/ unsigned int             CorpseDragCount;
/*0x0384*/ uint8_t                  Level;
/*0x0385*/ bool                     Sneak;
/*0x0388*/ int                      RealEstateItemId;
/*0x038c*/ unsigned int             FishingETA;
/*0x0390*/ int                      ManaCurrent;
/*0x0394*/ bool                     bTempPet;
/*0x0398*/ int                      Unknown2;
/*0x039c*/ bool                     bSwitchMoved;
/*0x03a0*/ float                    BearingToTarget;
/*0x03a4*/ uint8_t                  TitleVisible;
/*0x03a8*/ unsigned int             Meditating;
/*0x03ac*/ float                    MyWalkSpeed;
/*0x03b0*/ int                      PrimaryTintIndex;
/*0x03b4*/ bool                     bOfflineMode;
/*0x03b8*/ int64_t                  GuildID;
/*0x03c0*/ int                      WarCry;
/*0x03c4*/ bool                     bAttackRelated;
/*0x03c8*/ unsigned int             NextSwim;
/*0x03cc*/ int                      AltAttack;
/*0x03d0*/ int64_t                  HPMax;
/*0x03d8*/ unsigned int             LastMealTime;
/*0x03e0*/ int64_t                  HPCurrent;
/*0x03e8*/ unsigned int             LastSecondaryUseTime;
/*0x03ec*/ unsigned int             LastTrapDamageTime;
/*0x03f0*/ unsigned int             SpellCooldownETA;
/*0x03f4*/ int                      Unknown3;
/*0x03f8*/ unsigned int             EnduranceMax;
/*0x03fc*/ bool                     bBuffTimersOnHold;
/*0x0400*/ float                    CameraOffset;
/*0x0404*/ uint8_t                  Light;
/*0x0408*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0410*/ unsigned int             LastResendAddPlayerPacket;
/*0x0414*/ uint8_t                  LastAttack;
/*0x0418*/ SPAWNINFO*               pViewPlayer;
/*0x0420*/ void*                    pTouchingSwitch;
/*0x0428*/ bool                     LFG;
/*0x0430*/ CharacterZoneClient*     pCharacter;
/*0x0438*/ int                      HideMode;
/*0x043c*/ int                      CurrIOState;
/*0x0440*/ uint8_t                  Original;
/*0x0444*/ unsigned int             TimeStamp;
/*0x0448*/ uint8_t                  FishingEvent;
/*0x0449*/ char                     GM;
/*0x044a*/ bool                     bStationary;
/*0x044c*/ int                      ManaMax;
/*0x0450*/ char                     Suffix[0x80];
/*0x04d0*/ int                      NpcTintIndex;
/*0x04d4*/ unsigned int             LastPrimaryUseTime;
/*0x04d8*/ int                      Trader;
/*0x04dc*/ char                     LoginRelated[0x20];
/*0x04fc*/ bool                     bShowHelm;
/*0x0500*/ float                    RunSpeed;
/*0x0504*/ float                    GetMeleeRangeVar1;
/*0x0508*/ uint8_t                  IsPassenger;
/*0x050c*/ float                    FallingStartZ;
/*0x0510*/ int                      PetID;
/*0x0514*/ uint8_t                  CharClass;
/*0x0518*/ unsigned int             SpellGemETA[15];
/*0x0554*/ uint8_t                  FindBits;
/*0x0558*/ int                      Unknown1;
/*0x055c*/ float                    AnimationSpeedRelated;
/*0x0560*/ char                     Title[0x80];
/*0x05e0*/ LaunchSpellData          CastingData;
/*0x0624*/ bool                     bSummoned;
/*0x0628*/ int                      IsAttacking;
/*0x062c*/ float                    MerchantGreed;
/*0x0630*/ unsigned int             LastTimeStoodStill;
/*0x0634*/ unsigned int             StunTimer;
/*0x0638*/ int                      AFK;
/*0x063c*/ bool                     bAnimationOnPop;
/*0x063d*/ uint8_t                  StandState;
/*0x0640*/ unsigned int             ACounter;
/*0x0644*/ unsigned int             MasterID;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2023-04-11 (test) @ 0x1402fe8be
