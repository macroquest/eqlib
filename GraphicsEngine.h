...
/*0x1070*/ __declspec(align(16)) glm::mat4x4 matrixIdentity;
/*0x10b0*/ __declspec(align(16)) glm::mat4x4 aMatrixWorldCurrent[NUM_BLEND_MATRICES];
/*0x12b0*/ __declspec(align(16)) glm::mat4x4 aMatrixWorldInverse[NUM_BLEND_MATRICES];
/*0x14b0*/ __declspec(align(16)) glm::mat4x4 aMatrixWorldInverseTransposed[NUM_BLEND_MATRICES];
/*0x16b0*/ glm::mat4x4*              apMatrixWorld[NUM_BLEND_MATRICES];
/*0x16f0*/ glm::mat4x4               matrixViewProj;
/*0x1730*/ glm::mat4x4               matrixView;
