...
// @sizeof(CXWnd) == 0x270 :: 2022-02-10 (live) @ 0x1405FF9D6
...
// @start: CXWnd Members
/*0x030*/ uint32_t    XMLIndex;
/*0x034*/ bool        bClickThroughMenuItemStatus;         // on/off
/*0x035*/ uint8_t     bResizableMask;
/*0x038*/ uint32_t    LastTimeMouseOver;
/*0x03c*/ bool        bUseInLayoutVertical;
/*0x03d*/ bool        bLeftAnchoredToLeft;
/*0x040*/ CTextObjectInterface* pTextObject;
/*0x048*/ CXRect      OldLocation;
/*0x058*/ bool        bKeepOnScreen;
/*0x05c*/ uint32_t    BackgroundDrawType;
/*0x060*/ uint32_t    BlinkFadeStartTime;
/*0x064*/ bool        bEscapableLocked;
/*0x068*/ int         BlinkState;
/*0x06c*/ bool        bMaximized;
/*0x070*/ CXRect      Location;
/*0x080*/ int         VScrollPos;
/*0x084*/ bool        bClientRectChanged;
/*0x085*/ bool        Enabled;
/*0x086*/ uint8_t     FadeAlpha;
/*0x088*/ uint32_t    BlinkFadeFreq;
/*0x08c*/ bool        bRightAnchoredToLeft;
/*0x08d*/ bool        Faded;
/*0x090*/ int         TopOffset;
/*0x098*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x0a0*/ bool        bTiled;
/*0x0a1*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x0a4*/ int         BlinkStartTimer;
/*0x0a8*/ int         BottomOffset;
/*0x0ac*/ uint32_t    TransitionStartTick;
/*0x0b0*/ int         Transition;
/*0x0b4*/ int         HScrollMax;
/*0x0b8*/ uint32_t    BGType;                              // found in CSidlScreenWnd__StoreIniInfo_x
/*0x0bc*/ uint8_t     Alpha;
/*0x0c0*/ uint32_t    WindowStyle;                         // bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border
/*0x0c4*/ CXRect      IconRect;
/*0x0d4*/ bool        bBorder;
/*0x0d8*/ uint32_t    BlinkFadeDuration;
/*0x0dc*/ bool        Locked;                              // found in CSidlScreenWnd__LoadIniInfo_x
/*0x0e0*/ CXRect      ClientRect;
/*0x0f0*/ bool        dShow;
/*0x0f4*/ int         managerArrayIndex;
/*0x0f8*/ uint32_t    TransitionDuration;
/*0x0fc*/ uint8_t     TargetAlpha;
/*0x0fd*/ bool        bScreenClipRectChanged;
/*0x100*/ ArrayClass2<unsigned int> RuntimeTypes;       // Size 0x1c
/*0x120*/ bool        bActive;
/*0x121*/ bool        bUseInLayoutHorizontal;
/*0x122*/ bool        bBorder2;
/*0x123*/ uint8_t     FadeToAlpha;                         // found in CSidlScreenWnd__StoreIniInfo_x
/*0x124*/ CXRect      TransitionRect;
/*0x138*/ CXWnd*      FocusProxy;
/*0x140*/ bool        bHCenterTooltip;
/*0x144*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x148*/ COLORREF    BGColor;                             // DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it.
/*0x14c*/ int         DeleteCount;
/*0x150*/ CTextObjectInterface* pTipTextObject;
/*0x158*/ CTextureAnimation* IconTextureAnim;
/*0x160*/ bool        Fades;
/*0x164*/ int         BlinkDuration;
/*0x168*/ bool        bMarkedForDelete;
/*0x16c*/ uint32_t    FadeDelay;
/*0x170*/ bool        Clickable;                           // found in CChatWindow__CChatWindow_x and the button handlers
/*0x174*/ int         RightOffset;
/*0x178*/ uint32_t    LastBlinkFadeRefreshTime;
/*0x17c*/ bool        bMaximizable;
/*0x180*/ CTextureFont* pFont;
/*0x188*/ bool        Unlockable;                          // found in CSidlScreenWnd__LoadIniInfo_x related to Locked
/*0x189*/ bool        bIsParentOrContextMenuWindow;
/*0x18a*/ bool        bFullyScreenClipped;
/*0x18b*/ bool        bClientClipRectChanged;
/*0x190*/ CXWndDrawTemplate* DrawTemplate;
/*0x198*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x19c*/ int         ParentAndContextMenuArrayIndex;
/*0x1a0*/ bool        bNeedsSaving;                        // will be true if you move or resize the window
/*0x1a4*/ int         VScrollMax;
/*0x1a8*/ CXRect      ClipRectScreen;
/*0x1b8*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x1bc*/ int         LeftOffset;
/*0x1c0*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x1c8*/ int64_t     Data;
/*0x1d0*/ bool        bClickThrough;                       // if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why
/*0x1d8*/ ControllerBase* pController;
/*0x1e0*/ COLORREF    DisabledBackground;
/*0x1e8*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
/*0x1f0*/ bool        Minimized;
/*0x1f1*/ bool        bClipToParent;
/*0x1f2*/ bool        bBringToTopWhenClicked;
/*0x1f3*/ bool        bIsTransitioning;
/*0x1f4*/ int         HScrollPos;
/*0x1f8*/ bool        bAction;
/*0x200*/ CXStr       WindowText;                          // CXWnd__GetWindowTextA_x has this one
/*0x208*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x210*/ bool        bBottomAnchoredToTop;
/*0x211*/ bool        bCaptureTitle;
/*0x214*/ CXSize      MinClientSize;
/*0x21c*/ uint32_t    FadeDuration;
/*0x220*/ bool        bTopAnchoredToTop;
/*0x228*/ CXStr       DataStr;
/*0x230*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x238*/ bool        MouseOver;                           // found in CXWnd__SetMouseOver_x
/*0x23c*/ CXRect      ClipRectClient;
/*0x250*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x258*/ CXSize      MaxClientSize;
/*0x260*/ CLayoutStrategy* pLayoutStrategy;
/*0x268*/ uint8_t     StartAlpha;
/*0x26c*/
// @end: CXWnd Members
};
...
// @sizeof(CSidlScreenWnd) == 0x2D8 :: 2022-02-10 (live) @ 0x1406256D1
...
// @sizeof(CEQXWndManager) == 0x290 :: 2022-02-10 (live) @ 0x1401C39A5
