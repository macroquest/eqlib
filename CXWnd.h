...
// @sizeof(CXWnd) == 0x1E0 :: 2021-11-12 (live) @ 0x9734FA
...
// @start: CXWnd Members
/*0x01c*/ uint32_t    TransitionStartTick;
...
/*0x024*/ uint32_t    BackgroundDrawType;
/*0x028*/ CXRect      IconRect;
/*0x038*/ ControllerBase* pController;
/*0x03c*/ uint8_t     FadeToAlpha;                         // found in CSidlScreenWnd__StoreIniInfo_x
/*0x03d*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x03e*/ uint8_t     Alpha;
/*0x03f*/ bool        Unlockable;                          // found in CSidlScreenWnd__LoadIniInfo_x related to Locked
/*0x040*/ int         ParentAndContextMenuArrayIndex;
/*0x044*/ bool        bRightAnchoredToLeft;
/*0x048*/ int         TopOffset;
/*0x04c*/ uint8_t     StartAlpha;
/*0x04d*/ bool        bHCenterTooltip;
/*0x050*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x054*/ CTextObjectInterface* pTipTextObject;
/*0x058*/ CXStr       WindowText;                          // CXWnd__GetWindowTextA_x has this one
/*0x05c*/ bool        Fades;
/*0x060*/ int         BlinkStartTimer;
/*0x064*/ uint32_t    FadeDuration;
/*0x068*/ uint8_t     FadeAlpha;
/*0x06c*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x070*/ int         managerArrayIndex;
/*0x074*/ CTextObjectInterface* pTextObject;
/*0x078*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x07c*/ int         DeleteCount;
/*0x080*/ uint32_t    BlinkFadeFreq;
/*0x084*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x088*/ CXRect      Location;
/*0x098*/ COLORREF    BGColor;                             // DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it.
/*0x09c*/ int         RightOffset;
/*0x0a0*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x0a4*/ bool        bClientRectChanged;
/*0x0a8*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x0ac*/ CXStr       DataStr;
/*0x0b0*/ CXWnd*      FocusProxy;
/*0x0b4*/ uint32_t    WindowStyle;                         // bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border
/*0x0b8*/ bool        bLeftAnchoredToLeft;
/*0x0b9*/ bool        bBringToTopWhenClicked;
/*0x0ba*/ bool        bTiled;
/*0x0c0*/ int64_t     Data;
/*0x0c8*/ CXRect      OldLocation;
/*0x0d8*/ CXRect      ClipRectClient;
/*0x0e8*/ int         Transition;
/*0x0ec*/ bool        bEscapableLocked;
/*0x0f0*/ CXWndDrawTemplate* DrawTemplate;
/*0x0f4*/ CTextureAnimation* IconTextureAnim;
/*0x0f8*/ int         VScrollPos;
/*0x0fc*/ bool        bMaximized;
/*0x100*/ int         BottomOffset;
/*0x104*/ uint8_t     TargetAlpha;
/*0x105*/ bool        bAction;
/*0x106*/ bool        bBottomAnchoredToTop;
/*0x107*/ bool        bMaximizable;
/*0x108*/ CXRect      ClientRect;
/*0x118*/ bool        Enabled;
/*0x11c*/ CXSize      MinClientSize;
/*0x124*/ int         HScrollPos;
/*0x128*/ bool        bBorder2;
/*0x12c*/ uint32_t    XMLIndex;
/*0x130*/ uint32_t    LastBlinkFadeRefreshTime;
/*0x134*/ int         BlinkState;
/*0x138*/ bool        bMarkedForDelete;
/*0x13c*/ CXSize      MaxClientSize;
/*0x144*/ uint32_t    BlinkFadeDuration;
/*0x148*/ uint32_t    FadeDelay;
/*0x14c*/ bool        bNeedsSaving;                        // will be true if you move or resize the window
/*0x14d*/ bool        Locked;                              // found in CSidlScreenWnd__LoadIniInfo_x
/*0x14e*/ uint8_t     bResizableMask;
/*0x150*/ COLORREF    DisabledBackground;
/*0x154*/ bool        bIsTransitioning;
/*0x158*/ CXRect      ClipRectScreen;
...
/*0x17e*/ bool        bUseInLayoutHorizontal;
/*0x17f*/ bool        bBorder;
/*0x180*/ uint32_t    TransitionDuration;
/*0x184*/ bool        Faded;
/*0x185*/ bool        bFullyScreenClipped;
/*0x186*/ bool        bActive;
/*0x188*/ int         HScrollMax;
/*0x18c*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
/*0x190*/ int         VScrollMax;
/*0x194*/ bool        bKeepOnScreen;
/*0x198*/ uint32_t    LastTimeMouseOver;
/*0x19c*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x1a0*/ CTextureFont* pFont;
/*0x1a4*/ bool        bTopAnchoredToTop;
/*0x1a5*/ bool        bUseInLayoutVertical;
/*0x1a6*/ bool        Clickable;                           // found in CChatWindow__CChatWindow_x and the button handlers
/*0x1a8*/ int         BlinkDuration;
/*0x1ac*/ CLayoutStrategy* pLayoutStrategy;
/*0x1b0*/ int         LeftOffset;
/*0x1b4*/ ArrayClass2<unsigned int> RuntimeTypes;       // Size 0x1c
/*0x1cc*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x1cd*/ bool        bIsParentOrContextMenuWindow;
/*0x1d0*/ uint32_t    BlinkFadeStartTime;
/*0x1d4*/ bool        bScreenClipRectChanged;
/*0x1d5*/ bool        bClipToParent;
/*0x1d6*/ bool        Minimized;
/*0x1d7*/ bool        bClientClipRectChanged;
/*0x1d8*/ bool        MouseOver;                           // found in CXWnd__SetMouseOver_x
/*0x1d9*/ bool        dShow;
/*0x1dc*/
// @end: CXWnd Members
};
