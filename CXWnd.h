...
// @sizeof(CXWnd) == 0x270 :: 2023-09-18 (test) @ 0x1405abd61
...
// @start: CXWnd Members
/*0x030*/ bool               bBringToTopWhenClicked;
/*0x034*/ uint32_t           TransitionDuration;
/*0x038*/ bool               Clickable;
/*0x039*/ uint8_t            FadeToAlpha;
/*0x03a*/ bool               Faded;
/*0x03b*/ bool               bAction;
/*0x040*/ CXStr              DataStr;
/*0x048*/ uint8_t            Alpha;
/*0x049*/ bool               bScreenClipRectChanged;
/*0x04a*/ bool               bKeepOnScreen;
/*0x04b*/ bool               bIsParentOrContextMenuWindow;
/*0x04c*/ uint32_t           BackgroundDrawType;
/*0x050*/ CXRect             OldLocation;
/*0x060*/ COLORREF           CRNormal;
/*0x064*/ bool               bBorder;
/*0x068*/ CXRect             IconRect;
/*0x078*/ CXRect             ClipRectClient;
/*0x088*/ bool               bBottomAnchoredToTop;
/*0x089*/ bool               bClickThroughMenuItemStatus;
/*0x08c*/ int                VScrollMax;
/*0x090*/ CXSize             MaxClientSize;
/*0x098*/ bool               bActive;
/*0x099*/ bool               Minimized;
/*0x09a*/ bool               bClientClipRectChanged;
/*0x09b*/ bool               ValidCXWnd;
/*0x09c*/ bool               Unlockable;
/*0x0a0*/ int                HScrollMax;
/*0x0a4*/ int                BlinkState;
/*0x0a8*/ bool               bIsTransitioning;
/*0x0ac*/ CXRect             TransitionRect;
/*0x0bc*/ bool               bCaptureTitle;
/*0x0c0*/ CXWnd*             FocusProxy;
/*0x0c8*/ uint32_t           TransitionStartTick;
/*0x0d0*/ CTextureFont*      pFont;
/*0x0d8*/ bool               bShowClickThroughMenuItem;
/*0x0dc*/ uint32_t           FadeDelay;
/*0x0e0*/ uint32_t           BlinkFadeDuration;
/*0x0e8*/ CTextureAnimation* IconTextureAnim;
/*0x0f0*/ uint32_t           FadeDuration;
/*0x0f8*/ CXStr              Tooltip;
/*0x100*/ bool               CloseOnESC;
/*0x104*/ int                BlinkDuration;
/*0x108*/ uint32_t           BlinkFadeFreq;
/*0x10c*/ bool               bMarkedForDelete;
/*0x10d*/ bool               dShow;
/*0x110*/ ControllerBase*    pController;
/*0x118*/ bool               Locked;
/*0x11c*/ CXRect             ClipRectScreen;
/*0x12c*/ bool               Enabled;
/*0x130*/ int                DeleteCount;
/*0x134*/ bool               bClientRectChanged;
/*0x138*/ int                RightOffset;
/*0x13c*/ bool               bNeedsSaving;
/*0x140*/ CXSize             MinClientSize;
/*0x148*/ bool               bBorder2;
/*0x14c*/ CXRect             ClientRect;
/*0x15c*/ bool               bClickThrough;
/*0x15d*/ bool               bClipToParent;
/*0x15e*/ bool               MouseOver;
/*0x160*/ int                TopOffset;
/*0x168*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x188*/ bool               Fades;
/*0x18c*/ int                Transition;
/*0x190*/ bool               bMaximized;
/*0x194*/ int                ZLayer;
/*0x198*/ int                LeftOffset;
/*0x19c*/ uint8_t            StartAlpha;
/*0x19d*/ bool               bMaximizable;
/*0x1a0*/ int                ParentAndContextMenuArrayIndex;
/*0x1a4*/ COLORREF           BGColor;
/*0x1a8*/ uint32_t           XMLIndex;
/*0x1ac*/ uint32_t           WindowStyle;
/*0x1b0*/ bool               bRightAnchoredToLeft;
/*0x1b1*/ bool               bEscapableLocked;
/*0x1b2*/ uint8_t            TargetAlpha;
/*0x1b3*/ bool               bTopAnchoredToTop;
/*0x1b4*/ bool               bLeftAnchoredToLeft;
/*0x1b8*/ CTextObjectInterface* pTipTextObject;
/*0x1c0*/ uint32_t           LastTimeMouseOver;
/*0x1c4*/ bool               bHCenterTooltip;
/*0x1c8*/ int                HScrollPos;
/*0x1cc*/ int                BlinkStartTimer;
/*0x1d0*/ CXWnd*             ParentWindow;
/*0x1d8*/ bool               bUseInLayoutVertical;
/*0x1e0*/ CXStr              XMLToolTip;
/*0x1e8*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x1f0*/ COLORREF           DisabledBackground;
/*0x1f4*/ int                VScrollPos;
/*0x1f8*/ int                BottomOffset;
/*0x200*/ CXWndDrawTemplate* DrawTemplate;
/*0x208*/ uint32_t           BlinkFadeStartTime;
/*0x20c*/ int                managerArrayIndex;
/*0x210*/ uint8_t            bResizableMask;
/*0x218*/ CTextObjectInterface* pTextObject;
/*0x220*/ CLayoutStrategy*   pLayoutStrategy;
/*0x228*/ CXRect             Location;
/*0x238*/ int64_t            Data;
/*0x240*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x248*/ bool               bFullyScreenClipped;
/*0x249*/ uint8_t            FadeAlpha;
/*0x250*/ CXStr              WindowText;
/*0x258*/ bool               bUseInLayoutHorizontal;
/*0x25c*/ uint32_t           BGType;
/*0x260*/ bool               bTiled;
/*0x264*/ uint32_t           LastBlinkFadeRefreshTime;

// @end: CXWnd Members
/*0x268*/ bool               bUsesClassicUI;
/*0x26c*/
...
// @sizeof(CSidlScreenWnd) == 0x2d8 :: 2023-09-18 (test) @ 0x1405a6781
...
// @sizeof(CEQXWndManager) == 0x298 :: 2023-09-18 (test) @ 0x140189e15
