...
// @sizeof(CXWnd) == 0x260 :: 2022-02-23 (test) @ 0x1405FEA06
...
// @start: CXWnd Members
/*0x030*/ bool        bClickThroughMenuItemStatus;         // on/off
/*0x034*/ int         VScrollMax;
/*0x038*/ int         LeftOffset;
/*0x03c*/ uint32_t    BlinkFadeDuration;
/*0x040*/ uint8_t     FadeAlpha;
/*0x041*/ bool        bBorder;
/*0x042*/ bool        bTopAnchoredToTop;
/*0x048*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x050*/ int         BlinkDuration;
/*0x054*/ bool        Unlockable;                          // found in CSidlScreenWnd__LoadIniInfo_x related to Locked
/*0x055*/ bool        bCaptureTitle;
/*0x058*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x060*/ bool        bClipToParent;
/*0x061*/ bool        bTiled;
/*0x062*/ bool        bIsTransitioning;
/*0x063*/ bool        bUseInLayoutHorizontal;
/*0x064*/ uint8_t     bResizableMask;
/*0x068*/ ArrayClass2<unsigned int> RuntimeTypes;       // Size 0x1c
/*0x088*/ CTextureFont* pFont;
/*0x090*/ CXRect      ClientRect;
...
/*0x0c0*/ uint8_t     FadeToAlpha;                         // found in CSidlScreenWnd__StoreIniInfo_x
/*0x0c4*/ uint32_t    FadeDuration;
/*0x0c8*/ uint32_t    BlinkFadeFreq;
/*0x0cc*/ bool        MouseOver;                           // found in CXWnd__SetMouseOver_x
/*0x0cd*/ bool        bUseInLayoutVertical;
/*0x0d0*/ int64_t     Data;
/*0x0d8*/ bool        Clickable;                           // found in CChatWindow__CChatWindow_x and the button handlers
/*0x0dc*/ uint32_t    XMLIndex;
/*0x0e0*/ uint8_t     TargetAlpha;
/*0x0e1*/ bool        Locked;                              // found in CSidlScreenWnd__LoadIniInfo_x
/*0x0e4*/ CXRect      IconRect;
/*0x0f8*/ CTextObjectInterface* pTextObject;
/*0x100*/ int         VScrollPos;
/*0x104*/ uint8_t     StartAlpha;
/*0x105*/ bool        bHCenterTooltip;
/*0x106*/ bool        bScreenClipRectChanged;
/*0x107*/ bool        bNeedsSaving;                        // will be true if you move or resize the window
/*0x108*/ bool        bEscapableLocked;
/*0x110*/ ControllerBase* pController;
/*0x118*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x11c*/ int         BottomOffset;
/*0x120*/ bool        bLeftAnchoredToLeft;
/*0x121*/ bool        Minimized;
/*0x124*/ CXSize      MaxClientSize;
/*0x130*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x138*/ int         HScrollMax;
/*0x13c*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x13d*/ bool        bBorder2;
/*0x13e*/ bool        bAction;
/*0x13f*/ bool        bFullyScreenClipped;
/*0x140*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x144*/ uint32_t    BlinkFadeStartTime;
/*0x148*/ bool        dShow;
/*0x150*/ CXStr       DataStr;
/*0x158*/ COLORREF    BGColor;                             // DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it.
/*0x15c*/ bool        bMaximizable;
/*0x15d*/ bool        bBottomAnchoredToTop;
/*0x15e*/ bool        bClickThrough;                       // if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why
/*0x160*/ int         HScrollPos;
/*0x164*/ bool        bActive;
/*0x168*/ int         RightOffset;
/*0x16c*/ CXRect      TransitionRect;
/*0x17c*/ int         DeleteCount;
/*0x180*/ uint32_t    FadeDelay;
/*0x184*/ bool        bBringToTopWhenClicked;
/*0x188*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x18c*/ uint32_t    BackgroundDrawType;
/*0x190*/ uint32_t    WindowStyle;                         // bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border
/*0x194*/ uint32_t    LastTimeMouseOver;
/*0x198*/ bool        Enabled;
/*0x199*/ bool        bMaximized;
/*0x19a*/ bool        bIsParentOrContextMenuWindow;
/*0x19c*/ CXSize      MinClientSize;
/*0x1a4*/ int         ParentAndContextMenuArrayIndex;
/*0x1a8*/ bool        bClientClipRectChanged;
/*0x1ac*/ int         TopOffset;
/*0x1b0*/ CXWndDrawTemplate* DrawTemplate;
/*0x1b8*/ CXWnd*      FocusProxy;
/*0x1c0*/ uint32_t    LastBlinkFadeRefreshTime;
/*0x1c4*/ uint32_t    TransitionDuration;
/*0x1c8*/ int         managerArrayIndex;
/*0x1cc*/ CXRect      ClipRectScreen;
/*0x1dc*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x1e0*/ int         BlinkStartTimer;
/*0x1e4*/ int         Transition;
/*0x1e8*/ uint32_t    BGType;                              // found in CSidlScreenWnd__StoreIniInfo_x
/*0x1f0*/ CTextObjectInterface* pTipTextObject;
/*0x1f8*/ CXRect      ClipRectClient;
/*0x208*/ bool        Faded;
/*0x210*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x218*/ bool        bKeepOnScreen;
/*0x220*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
/*0x228*/ CXRect      Location;
/*0x238*/ COLORREF    DisabledBackground;
/*0x23c*/ bool        bRightAnchoredToLeft;
/*0x240*/ int         BlinkState;
/*0x244*/ uint32_t    TransitionStartTick;
/*0x248*/ bool        bClientRectChanged;
/*0x24c*/ CXRect      OldLocation;
/*0x25c*/ uint8_t     Alpha;
/*0x260*/
// @end: CXWnd Members
};
...
// @sizeof(CSidlScreenWnd) == 0x2c8 :: 2022-02-23 (test) @ 0x1406246B1
...
// @sizeof(CEQXWndManager) == 0x290 :: 2022-02-23 (test) @ 0x1401C39C5
