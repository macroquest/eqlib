...
// @sizeof(CXWnd) == 0x1F0 :: 2021-10-14 (live) @ 0x973A6A
...
/*0x01d*/ bool        bUseInLayoutVertical;
/*0x020*/ uint32_t    BlinkFadeStartTime;
/*0x024*/ COLORREF    DisabledBackground;
/*0x028*/ bool        bClickThrough;                       // if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why
/*0x029*/ bool        bIsTransitioning;
/*0x02c*/ CXWndDrawTemplate* DrawTemplate;
/*0x030*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
/*0x034*/ uint32_t    XMLIndex;
/*0x038*/ bool        MouseOver;                           // found in CXWnd__SetMouseOver_x
...
/*0x044*/ uint8_t     FadeToAlpha;                         // found in CSidlScreenWnd__StoreIniInfo_x
/*0x048*/ uint32_t    BlinkFadeDuration;
/*0x04c*/ bool        Enabled;
/*0x050*/ int         ParentAndContextMenuArrayIndex;
/*0x054*/ CXRect      IconRect;
/*0x064*/ int         managerArrayIndex;
/*0x068*/ bool        bBottomAnchoredToTop;
/*0x069*/ bool        bCaptureTitle;
/*0x06a*/ bool        Minimized;
/*0x06c*/ int         DeleteCount;
/*0x070*/ CXStr       DataStr;
/*0x074*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x078*/ bool        bTopAnchoredToTop;
/*0x079*/ bool        bUseInLayoutHorizontal;
/*0x07a*/ bool        bLeftAnchoredToLeft;
/*0x07c*/ CXRect      Location;
/*0x08c*/ CXRect      ClientRect;
/*0x09c*/ ControllerBase* pController;
/*0x0a0*/ CXRect      OldLocation;
/*0x0b0*/ CXSize      MinClientSize;
/*0x0b8*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x0bc*/ CXSize      MaxClientSize;
/*0x0c4*/ bool        bClientClipRectChanged;
/*0x0c5*/ bool        Clickable;                           // found in CChatWindow__CChatWindow_x and the button handlers
/*0x0c8*/ int         RightOffset;
/*0x0cc*/ uint32_t    BlinkFadeFreq;
/*0x0d0*/ uint8_t     bResizableMask;
/*0x0d4*/ int         Transition;
/*0x0d8*/ CXRect      ClipRectClient;
/*0x0e8*/ bool        bTiled;
/*0x0ec*/ int         BlinkState;
/*0x0f0*/ bool        bFullyScreenClipped;
/*0x0f4*/ int         BlinkStartTimer;
/*0x0f8*/ CXRect      ClipRectScreen;
/*0x108*/ uint32_t    BGType;                              // found in CSidlScreenWnd__StoreIniInfo_x
/*0x10c*/ uint8_t     TargetAlpha;
/*0x110*/ CTextureFont* pFont;
/*0x114*/ int         BottomOffset;
/*0x118*/ bool        bClientRectChanged;
/*0x119*/ uint8_t     Alpha;
/*0x11c*/ uint32_t    LastTimeMouseOver;
/*0x120*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x124*/ bool        bKeepOnScreen;
/*0x128*/ uint32_t    LastBlinkFadeRefreshTime;
/*0x12c*/ bool        Faded;
/*0x12d*/ bool        bMaximized;
/*0x12e*/ bool        bScreenClipRectChanged;
/*0x130*/ int         BlinkDuration;
/*0x134*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x138*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x139*/ bool        bClickThroughMenuItemStatus;         // on/off
/*0x13c*/ uint32_t    FadeDuration;
/*0x140*/ bool        bMaximizable;
/*0x144*/ CTextObjectInterface* pTextObject;
/*0x148*/ bool        bBringToTopWhenClicked;
/*0x14c*/ int         LeftOffset;
/*0x150*/ CXRect      TransitionRect;
/*0x160*/ int         TopOffset;
/*0x168*/ int64_t     Data;
/*0x170*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x174*/ CLayoutStrategy* pLayoutStrategy;
/*0x178*/ CTextureAnimation* IconTextureAnim;
/*0x17c*/ bool        bIsParentOrContextMenuWindow;
/*0x180*/ uint32_t    TransitionDuration;
/*0x184*/ uint32_t    FadeDelay;
/*0x188*/ bool        bEscapableLocked;
/*0x189*/ bool        Fades;
/*0x18a*/ bool        bNeedsSaving;                        // will be true if you move or resize the window
/*0x18c*/ int         HScrollPos;
/*0x190*/ CXStr       WindowText;                          // CXWnd__GetWindowTextA_x has this one
/*0x194*/ bool        Locked;                              // found in CSidlScreenWnd__LoadIniInfo_x
/*0x198*/ uint32_t    BackgroundDrawType;
/*0x19c*/ uint8_t     StartAlpha;
/*0x1a0*/ uint32_t    TransitionStartTick;
/*0x1a4*/ bool        bRightAnchoredToLeft;
/*0x1a5*/ bool        dShow;
/*0x1a6*/ bool        bBorder2;
/*0x1a7*/ bool        bHCenterTooltip;
/*0x1a8*/ bool        bClipToParent;
/*0x1a9*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x1ac*/ COLORREF    BGColor;                             // DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it.
/*0x1b0*/ int         VScrollMax;
/*0x1b4*/ uint8_t     FadeAlpha;
/*0x1b8*/ ArrayClass2<unsigned int> RuntimeTypes;       // Size 0x1c
/*0x1d0*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x1d4*/ bool        bBorder;
/*0x1d5*/ bool        bActive;
/*0x1d6*/ bool        Unlockable;                          // found in CSidlScreenWnd__LoadIniInfo_x related to Locked
/*0x1d8*/ int         HScrollMax;
/*0x1dc*/ bool        bAction;
/*0x1e0*/ int         VScrollPos;
/*0x1e4*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x1e8*/ CTextObjectInterface* pTipTextObject;
/*0x1ec*/
// @end: CXWnd Members
};
