...
/*0x01d*/ bool        bNeedsSaving;                        // will be true if you move or resize the window
/*0x01e*/ bool        bRightAnchoredToLeft;
/*0x01f*/ bool        Minimized;
/*0x020*/ int         BlinkState;
/*0x024*/ bool        bHCenterTooltip;
/*0x025*/ bool        bBorder2;
/*0x028*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x02c*/ bool        bIsParentOrContextMenuWindow;
/*0x02d*/ bool        Fades;
/*0x030*/ int         LeftOffset;
/*0x034*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x038*/ bool        bBringToTopWhenClicked;
/*0x03c*/ CXRect      ClientRect;
/*0x04c*/ bool        bUseInLayoutHorizontal;
/*0x050*/ CLayoutStrategy* pLayoutStrategy;
/*0x054*/ CXWndDrawTemplate* DrawTemplate;
/*0x058*/ CXRect      OldLocation;
/*0x068*/ uint32_t    BlinkFadeStartTime;
/*0x06c*/ bool        bClientRectChanged;
/*0x070*/ uint32_t    BackgroundDrawType;
/*0x074*/ bool        bAction;
/*0x078*/ CTextObjectInterface* pTipTextObject;
/*0x07c*/ int         Transition;
/*0x080*/ int         BlinkStartTimer;
/*0x084*/ bool        bUseInLayoutVertical;
/*0x088*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x08c*/ uint32_t    BlinkFadeDuration;
...
/*0x098*/ int         managerArrayIndex;
/*0x09c*/ uint32_t    FadeDelay;
/*0x0a0*/ uint32_t    TransitionDuration;
/*0x0a4*/ uint8_t     bResizableMask;
...
/*0x0c4*/ bool        Faded;
/*0x0c8*/ ControllerBase* pController;
/*0x0cc*/ bool        bScreenClipRectChanged;
/*0x0d0*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x0d4*/ bool        bIsTransitioning;
/*0x0d8*/ int         BlinkDuration;
/*0x0e0*/ int64_t     Data;
/*0x0e8*/ bool        bActive;
/*0x0e9*/ uint8_t     StartAlpha;
/*0x0ea*/ bool        dShow;
/*0x0ec*/ uint32_t    LastTimeMouseOver;
/*0x0f0*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x0f4*/ uint32_t    XMLIndex;
/*0x0f8*/ bool        bFullyScreenClipped;
/*0x0fc*/ uint32_t    WindowStyle;                         // bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border
/*0x100*/ CXSize      MaxClientSize;
/*0x108*/ CXWnd*      FocusProxy;
/*0x10c*/ bool        bBottomAnchoredToTop;
/*0x10d*/ bool        bKeepOnScreen;
/*0x10e*/ bool        bTiled;
/*0x10f*/ bool        bClickThroughMenuItemStatus;         // on/off
/*0x110*/ int         ParentAndContextMenuArrayIndex;
/*0x114*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x115*/ bool        bEscapableLocked;
/*0x118*/ int         HScrollPos;
...
/*0x14c*/ uint8_t     Alpha;
/*0x14d*/ bool        Unlockable;                          // found in CSidlScreenWnd__LoadIniInfo_x related to Locked
/*0x14e*/ bool        bCaptureTitle;
/*0x14f*/ bool        bTopAnchoredToTop;
/*0x150*/ bool        bBorder;
/*0x154*/ CXRect      IconRect;
/*0x164*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x168*/ CXRect      Location;
/*0x178*/ CXRect      TransitionRect;
/*0x188*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x18c*/ int         VScrollMax;
/*0x190*/ int         RightOffset;
/*0x194*/ int         BottomOffset;
/*0x198*/ CXStr       DataStr;
/*0x19c*/ uint8_t     FadeAlpha;
/*0x1a0*/ uint32_t    LastBlinkFadeRefreshTime;
/*0x1a4*/ bool        Enabled;
/*0x1a8*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
/*0x1ac*/ bool        bClipToParent;
/*0x1ad*/ bool        Locked;                              // found in CSidlScreenWnd__LoadIniInfo_x
/*0x1b0*/ CXRect      ClipRectScreen;
/*0x1c0*/ int         DeleteCount;
/*0x1c4*/ uint32_t    FadeDuration;
/*0x1c8*/ int         VScrollPos;
/*0x1cc*/ bool        bMaximized;
/*0x1cd*/ bool        MouseOver;                           // found in CXWnd__SetMouseOver_x
/*0x1ce*/ bool        bClientClipRectChanged;
/*0x1d0*/ COLORREF    DisabledBackground;
/*0x1d4*/ bool        bLeftAnchoredToLeft;
/*0x1d5*/ bool        bMaximizable;
/*0x1d8*/ CXStr       WindowText;                          // CXWnd__GetWindowTextA_x has this one
/*0x1dc*/ uint8_t     TargetAlpha;
/*0x1e0*/ int         TopOffset;
/*0x1e4*/ CTextureFont* pFont;
/*0x1e8*/ bool        bClickThrough;                       // if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why
