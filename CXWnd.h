...
/*0x020*/ CXStr       XMLToolTip;                          // found in CSidlManager__CreateLabel_x
/*0x024*/ uint32_t    TransitionDuration;
/*0x028*/ int         VScrollPos;
/*0x02c*/ bool        bScreenClipRectChanged;
/*0x030*/ uint32_t    XMLIndex;
/*0x034*/ uint8_t     FadeToAlpha;                         // found in CSidlScreenWnd__StoreIniInfo_x
/*0x035*/ bool        bFullyScreenClipped;
/*0x038*/ CXRect      OldLocation;
/*0x048*/ bool        CloseOnESC;                          // found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed
/*0x04c*/ CXStr       Tooltip;                             // found in CSidlManager__CreateLabel_x
...
/*0x054*/ CXStr       WindowText;                          // CXWnd__GetWindowTextA_x has this one
/*0x058*/ bool        bTiled;
/*0x059*/ bool        Minimized;
/*0x05a*/ uint8_t     bResizableMask;
/*0x05c*/ CXRect      Location;
/*0x06c*/ bool        bKeepOnScreen;
/*0x070*/ int         HScrollPos;
/*0x074*/ COLORREF    CRNormal;                            // found in OnProcessFrame
/*0x078*/ bool        bCaptureTitle;
/*0x07c*/ int         Transition;
/*0x080*/ int64_t     Data;
/*0x088*/ uint8_t     TargetAlpha;
/*0x08c*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x090*/ CXSize      MinClientSize;
/*0x098*/ bool        bMaximizable;
/*0x09c*/ CTextObjectInterface* pTextObject;
/*0x0a0*/ ArrayClass2<unsigned int> RuntimeTypes;       // Size 0x1c
/*0x0b8*/ CTextObjectInterface* pTipTextObject;
/*0x0bc*/ bool        bLeftAnchoredToLeft;
/*0x0bd*/ bool        bHCenterTooltip;
/*0x0be*/ bool        bMaximized;
/*0x0bf*/ bool        bBorder;
/*0x0c0*/ bool        bClientClipRectChanged;
/*0x0c1*/ bool        bBottomAnchoredToTop;
/*0x0c2*/ bool        Faded;
/*0x0c4*/ uint32_t    BlinkFadeFreq;
/*0x0c8*/ bool        bBringToTopWhenClicked;
/*0x0cc*/ CXRect      ClipRectClient;
/*0x0dc*/ int         BlinkStartTimer;
/*0x0e0*/ CXWnd*      FocusProxy;
/*0x0e4*/ CXStr       DataStr;
/*0x0e8*/ bool        bActive;
...
/*0x10c*/ uint32_t    TransitionStartTick;
/*0x110*/ CXWnd*      ParentWindow;                        // CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute...
/*0x114*/ bool        bEscapableLocked;
/*0x118*/ int         ParentAndContextMenuArrayIndex;
/*0x11c*/ ControllerBase* pController;
/*0x120*/ COLORREF    BGColor;                             // DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it.
/*0x124*/ CXRect      IconRect;
/*0x134*/ uint32_t    BGType;                              // found in CSidlScreenWnd__StoreIniInfo_x
/*0x138*/ int         HScrollMax;
/*0x13c*/ uint8_t     FadeAlpha;
/*0x140*/ CXWndDrawTemplate* DrawTemplate;
/*0x144*/ uint8_t     Alpha;
/*0x148*/ int         LeftOffset;
/*0x14c*/ uint32_t    FadeDelay;
/*0x150*/ bool        bUseInLayoutHorizontal;
/*0x154*/ uint32_t    FadeDuration;
/*0x158*/ bool        bAction;
/*0x159*/ bool        bMarkedForDelete;
/*0x15c*/ uint32_t    LastTimeMouseOver;
/*0x160*/ bool        bShowClickThroughMenuItem;           // shows/hides the click through option on the window menu
/*0x161*/ bool        Enabled;
/*0x162*/ bool        Fades;
/*0x164*/ int         RightOffset;
/*0x168*/ bool        bClipToParent;
/*0x16c*/ CXRect      ClientRect;
/*0x17c*/ bool        bUseInLayoutVertical;
/*0x180*/ int         ZLayer;                              // found in CXWndManager__DrawWindows_x
/*0x184*/ bool        dShow;
/*0x185*/ bool        bIsTransitioning;
/*0x186*/ bool        bClickThroughMenuItemStatus;         // on/off
/*0x188*/ int         managerArrayIndex;
/*0x18c*/ COLORREF    DisabledBackground;
/*0x190*/ bool        bClientRectChanged;
/*0x194*/ uint32_t    BackgroundDrawType;
/*0x198*/ bool        ValidCXWnd;                          // IsValid has this one
/*0x199*/ bool        bBorder2;
