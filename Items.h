...
// @sizeof(ItemDefinition) == 0x640 :: 2023-03-21 (test) @ 0x140226ed8
...
/*0x028*/ ItemGlobalIndex       GlobalIndex;
/*0x034*/ int                   Open;
/*0x038*/ bool                  bItemNeedsUpdate;
/*0x039*/ bool                  bConvertable;
/*0x03a*/ bool                  bCollected;
/*0x03c*/ int                   ScriptIndex;
/*0x040*/ bool                  bCopied;
/*0x044*/ int                   OrnamentationIcon;
...
/*0x080*/ int                   AugFlag;
/*0x084*/ bool                  bRealEstateItemPlaceable;
/*0x088*/ ItemContainer         Contents;
/*0x0b0*/ unsigned int          NewArmorID;
/*0x0b4*/ int                   MerchantQuantity;
...
// @sizeof(ItemClient) == 0x140 :: 2023-03-21 (test) @ 0x1401f4869
constexpr size_t ItemClient_size = 0x140;
