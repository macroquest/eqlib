...
// @sizeof(ItemDefinition) == 0x640 :: 2023-06-27 (test) @ 0x140204b78
...
/*0x06c*/ int                   RealEstateID;
/*0x070*/ int                   ConvertItemID;
/*0x074*/ bool                  bDisableAugTexture;
/*0x078*/ int                   ScriptIndex;
/*0x07c*/ unsigned int          NewArmorID;
/*0x080*/ int                   Open;
/*0x084*/ int                   Luck;
/*0x088*/ EqItemGuid            ItemGUID;
/*0x09c*/ int                   AugFlag;
/*0x0a0*/ unsigned int          RespawnTime;
/*0x0a4*/ int                   Power;
/*0x0a8*/ bool                  bConvertable;
...
/*0x0e0*/ int                   ID;
/*0x0e4*/ int                   ActorTag1;
/*0x0e8*/ bool                  bCollected;
/*0x0e9*/ bool                  bCopied;
/*0x0ec*/ ItemGlobalIndex       GlobalIndex;
...
// @sizeof(ItemClient) == 0x148 :: 2023-06-27 (test) @ 0x1401d25b9
