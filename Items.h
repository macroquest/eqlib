...
// @sizeof(ItemDefinition) == 0x640 :: 2023-02-21 (test) @ 0x1401db978
...
/*0x008*/ SoeUtil::String       SaveString;
...
/*0x041*/ bool                  bDisableAugTexture;
/*0x044*/ int                   Open;
/*0x048*/ ItemGlobalIndex       GlobalIndex;
/*0x054*/ int                   NoDropFlag;
...
// @sizeof(ItemClient) == 0x148 :: 2023-02-21 (test) @ 0x1401a92b9
