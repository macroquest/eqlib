...
// @sizeof(ItemDefinition) == 0x610 :: 2022-03-15 (test) @ 0x140232aad
...
/*0x028*/ int                   Luck;
/*0x02c*/ int                   Charges;
/*0x030*/ int64_t               MerchantSlot;
/*0x038*/ int                   NoDropFlag;
/*0x03c*/ unsigned int          ItemHash;
/*0x040*/ ItemContainer         Contents;
/*0x068*/ CXStr                 SaveString;
...
/*0x0b8*/ unsigned int          RespawnTime;
/*0x0bc*/ int                   ID;
/*0x0c0*/ bool                  bRealEstateItemPlaceable;
/*0x0c4*/ int                   StackCount;
/*0x0c8*/ int                   Power;
/*0x0cc*/ bool                  bRankDisabled;
/*0x0d0*/ int                   ScriptIndex;
/*0x0d4*/ int                   ConvertItemID;
/*0x0d8*/ unsigned int          NewArmorID;
/*0x0dc*/ unsigned int          Tint;
/*0x0e0*/ bool                  bConvertable;
/*0x0e1*/ EqItemGuid            ItemGUID;
/*0x0f8*/ int64_t               Price;
/*0x100*/ int                   NoteStatus;
/*0x104*/ int                   ActorTag1;
/*0x108*/ int                   RealEstateID;
/*0x10c*/ unsigned int          LastCastTime;
/*0x110*/ bool                  bItemNeedsUpdate;
/*0x114*/ int                   AugFlag;
/*0x118*/ int                   OrnamentationIcon;
/*0x11c*/ ItemGlobalIndex       GlobalIndex;
/*0x128*/ int                   Open;
/*0x12c*/
...
// @sizeof(ItemClient) == 0x148 :: 2022-03-15 (test) @ 0x1402e097a
