...
// @sizeof(ItemDefinition) == 0x640 :: 2024-07-15 (live) @ 0x14020dd98
...
/*0x00c*/ bool                  bCopied;
/*0x010*/ SoeUtil::String       SaveString;
/*0x028*/ unsigned int          NewArmorID;
/*0x02c*/ int                   NoteStatus;
/*0x030*/ ITEMINFO*             Item1;
/*0x038*/ int                   Luck;
/*0x03c*/ int                   StackCount;
/*0x040*/ int                   ScriptIndex;
/*0x044*/ int                   Power;
/*0x048*/ int                   Open;
/*0x04c*/ bool                  bConvertable;
/*0x04d*/ bool                  bRankDisabled;
/*0x050*/ unsigned int          RespawnTime;
/*0x054*/ int                   ConvertItemID;
/*0x058*/ unsigned int          Tint;
/*0x060*/ ArrayClass<uint32_t>  RealEstateArray;
/*0x078*/ unsigned int          LastCastTime;
/*0x07c*/ int                   MerchantQuantity;
/*0x080*/ ItemGlobalIndex       GlobalIndex;
...
/*0x0d5*/ bool                  bItemNeedsUpdate;
/*0x0d8*/ int                   Charges;
/*0x0dc*/ int                   ID;
/*0x0e0*/ int                   ActorTag1;
/*0x0e4*/ bool                  bRealEstateItemPlaceable;
/*0x0e8*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x0f8*/ int                   AugFlag;
/*0x0fc*/ bool                  bCollected;
/*0x100*/ int64_t               Price;
/*0x108*/ int                   ActorTag2;
/*0x10c*/ EqItemGuid            ItemGUID;
/*0x120*/ int64_t               DontKnow;
/*0x128*/ int                   OrnamentationIcon;
/*0x12c*/ int                   ArmorType;
/*0x130*/
...
// @sizeof(ItemClient) == 0x148 :: 2024-07-15 (live) @ 0x1401d9409
