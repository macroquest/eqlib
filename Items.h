...
// @sizeof(ItemDefinition) == 0x640 :: 2024-03-04 (test) @ 0x140206638
...
/*0x10a*/ bool                  bConvertable;
/*0x10c*/ unsigned int          ItemHash;
/*0x110*/ int                   Charges;
/*0x114*/ int                   ID;
/*0x118*/ int                   ConvertItemID;
/*0x11c*/ bool                  bRankDisabled;
/*0x120*/ int                   OrnamentationIcon;
/*0x124*/ int                   ScriptIndex;
/*0x128*/ int                   ArmorType;
/*0x130*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x140*/
...
// @sizeof(ItemClient) == 0x158 :: 2024-03-04 (test) @ 0x1401d3429
