...
// @sizeof(ItemDefinition) == 0x640 :: 2022-08-26 (test) @ 0x1401d0dcd
...
/*0x020*/ int64_t               DontKnow;
/*0x028*/ int                   ActorTag1;
/*0x02c*/ int                   ArmorType;
/*0x030*/ int                   RealEstateID;
/*0x034*/ int                   StackCount;
/*0x038*/ int                   AugFlag;
/*0x03c*/ EqItemGuid            ItemGUID;
/*0x050*/ int                   ConvertItemID;
/*0x058*/ int64_t               MerchantSlot;
/*0x060*/ int                   OrnamentationIcon;
/*0x064*/ unsigned int          Tint;
/*0x068*/ bool                  bRankDisabled;
/*0x069*/ bool                  bCopied;
/*0x06c*/ int                   NoteStatus;
/*0x070*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x080*/ bool                  bRealEstateItemPlaceable;
/*0x088*/ SoeUtil::String       SaveString;
/*0x0a0*/ unsigned int          ItemHash;
/*0x0a8*/ ItemContainer         Contents;
/*0x0d0*/ ItemGlobalIndex       GlobalIndex;
/*0x0dc*/ bool                  bDisableAugTexture;
/*0x0dd*/ bool                  bConvertable;
/*0x0e0*/ int                   NoDropFlag;
/*0x0e4*/ bool                  bItemNeedsUpdate;
/*0x0e8*/ int64_t               Price;
/*0x0f0*/ int                   ScriptIndex;
/*0x0f4*/ unsigned int          LastCastTime;
/*0x0f8*/ int                   MerchantQuantity;
/*0x100*/ ArrayClass<uint32_t>  RealEstateArray;
/*0x118*/ int                   ActorTag2;
/*0x11c*/ int                   Open;
/*0x120*/ unsigned int          RespawnTime;
/*0x124*/ bool                  bCollected;
/*0x128*/ int                   Charges;
/*0x12c*/ unsigned int          NewArmorID;
/*0x130*/ int                   Luck;
/*0x134*/ int                   ID;
...
// @sizeof(ItemClient) == 0x160 :: 2022-08-26 (test) @ 0x140261c7a
