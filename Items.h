...
// @sizeof(ItemDefinition) == 0x640 :: 2024-06-11 (test) @ 0x14020cf68
...
/*0x010*/ int                   RealEstateID;
/*0x018*/ ItemContainer         Contents;
/*0x040*/ int64_t               Price;
/*0x048*/ bool                  bCollected;
/*0x04c*/ int                   AugFlag;
/*0x050*/ int                   ActorTag1;
/*0x054*/ bool                  bConvertable;
/*0x058*/ int                   OrnamentationIcon;
/*0x05c*/ int                   ID;
/*0x060*/ bool                  bItemNeedsUpdate;
/*0x064*/ int                   MerchantQuantity;
/*0x068*/ unsigned int          RespawnTime;
/*0x070*/ int64_t               DontKnow;
/*0x078*/ unsigned int          ItemHash;
/*0x07c*/ int                   NoDropFlag;
/*0x080*/ int                   Open;
/*0x084*/ unsigned int          Tint;
/*0x088*/ int                   ConvertItemID;
/*0x08c*/ bool                  bRealEstateItemPlaceable;
/*0x090*/ int                   ArmorType;
/*0x094*/ EqItemGuid            ItemGUID;
/*0x0a6*/ bool                  bDisableAugTexture;
/*0x0a8*/ CXStr                 ConvertItemName;
/*0x0b0*/ int                   StackCount;
/*0x0b4*/ unsigned int          NewArmorID;
/*0x0b8*/ int64_t               MerchantSlot;
/*0x0c0*/ ItemGlobalIndex       GlobalIndex;
/*0x0cc*/ int                   Charges;
/*0x0d0*/ int                   ActorTag2;
/*0x0d4*/ unsigned int          LastCastTime;
/*0x0d8*/ int                   Power;
/*0x0e0*/ ITEMINFO*             Item1;
/*0x0e8*/ bool                  bCopied;
/*0x0f0*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x100*/ bool                  bRankDisabled;
/*0x108*/ ArrayClass<uint32_t>  RealEstateArray;
/*0x120*/ int                   NoteStatus;
/*0x128*/ SoeUtil::String       SaveString;
/*0x140*/
...
// @sizeof(ItemClient) == 0x158 :: 2024-06-11 (test) @ 0x1401d8cb9
