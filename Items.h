...
// @sizeof(ItemDefinition) == 0x640 :: 2024-08-15 (live) @ 0x14020d598
...
/*0x014*/ bool                  bConvertable;
/*0x018*/ int                   ID;
/*0x01c*/ int                   RealEstateID;
/*0x020*/ int                   ConvertItemID;
/*0x024*/ int                   Charges;
/*0x028*/ unsigned int          RespawnTime;
/*0x02c*/ ItemGlobalIndex       GlobalIndex;
/*0x038*/ int                   NoteStatus;
/*0x03c*/ bool                  bCopied;
/*0x040*/ int                   ActorTag2;
/*0x048*/ ItemContainer         Contents;
/*0x070*/ bool                  bRankDisabled;
/*0x074*/ unsigned int          Tint;
/*0x078*/ ItemEvolutionDataPtr  pEvolutionData;
/*0x088*/ int64_t               Price;
/*0x090*/ ITEMINFO*             Item1;
/*0x098*/ int                   AugFlag;
/*0x09c*/ bool                  bRealEstateItemPlaceable;
/*0x09d*/ bool                  bCollected;
/*0x0a0*/ int                   MerchantQuantity;
/*0x0a4*/ int                   OrnamentationIcon;
/*0x0a8*/ int                   ActorTag1;
/*0x0b0*/ CXStr                 ConvertItemName;
/*0x0b8*/ bool                  bDisableAugTexture;
/*0x0bc*/ unsigned int          LastCastTime;
/*0x0c0*/ int64_t               MerchantSlot;
/*0x0c8*/ EqItemGuid            ItemGUID;
/*0x0e0*/ int64_t               DontKnow;
/*0x0e8*/ int                   Power;
/*0x0f0*/ ArrayClass<uint32_t>  RealEstateArray;
/*0x108*/ unsigned int          NewArmorID;
/*0x10c*/ int                   ScriptIndex;
/*0x110*/ int                   StackCount;
...
// @sizeof(ItemClient) == 0x150 :: 2024-08-15 (live) @ 0x1401d8dd9
