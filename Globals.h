...
EQLIB_VAR DWORD pinstCSpellDisplayMgr;
...
EQLIB_VAR DWORD CDisplay__InitCharSelectUI;
...
EQLIB_VAR DWORD CSpellDisplayWnd__SetSpell;
EQLIB_VAR DWORD CSpellDisplayWnd__UpdateStrings;
...
EQLIB_VAR DWORD CTribute__GetActiveFavorCost;
EQLIB_VAR DWORD CUnSerializeBuffer__GetString;
EQLIB_VAR DWORD CWndDisplayManager__FindWindow;
...
EQLIB_VAR DWORD ItemBase__CanGemFitInSlot;
EQLIB_VAR DWORD ItemBase__CreateItemTagString;
EQLIB_VAR DWORD ItemBase__GetImageNum;
EQLIB_VAR DWORD ItemBase__GetItemValue;
EQLIB_VAR DWORD ItemBase__IsEmpty;
EQLIB_VAR DWORD ItemBase__IsKeyRingItem;
EQLIB_VAR DWORD ItemBase__IsLore;
EQLIB_VAR DWORD ItemBase__IsLoreEquipped;
EQLIB_VAR DWORD ItemBase__ValueSellMerchant;
EQLIB_VAR DWORD ItemClient__CanDrop;
EQLIB_VAR DWORD ItemClient__CanGoInBag;
EQLIB_VAR DWORD ItemClient__CreateItemClient;
...
EQLIB_VAR DWORD MercenaryAlternateAdvancementManagerClient__BuyAbility;
...
EQLIB_VAR DWORD PcBase__GetAlternateAbilityId;
EQLIB_VAR DWORD PcBase__GetCombatAbility;
EQLIB_VAR DWORD PcBase__GetCombatAbilityTimer;
EQLIB_VAR DWORD PcBase__GetItemContainedRealEstateIds;
EQLIB_VAR DWORD PcBase__GetNonArchivedOwnedRealEstates;
EQLIB_VAR DWORD PcClient__AlertInventoryChanged;
EQLIB_VAR DWORD PcClient__GetConLevel;
EQLIB_VAR DWORD PcClient__HasLoreItem;
...
EQLIB_VAR DWORD PcZoneClient__GetItemRecastTimer;
...
EQLIB_VAR DWORD PcZoneClient__RemoveMyAffect;
EQLIB_VAR DWORD PcZoneClient__RemovePetEffect;
EQLIB_VAR DWORD pinstLootFiltersManager;
EQLIB_VAR DWORD PlayerBase__CanSee;
EQLIB_VAR DWORD PlayerBase__CanSee1;
EQLIB_VAR DWORD PlayerBase__GetVisibilityLineSegment;
EQLIB_VAR DWORD PlayerBase__HasProperty_j;
EQLIB_VAR DWORD PlayerBase__IsTargetable;
EQLIB_VAR DWORD PlayerClient__ChangeBoneStringSprite;
EQLIB_VAR DWORD PlayerClient__dPlayerClient;
EQLIB_VAR DWORD PlayerClient__GetPcClient;
EQLIB_VAR DWORD PlayerClient__PlayerClient;
EQLIB_VAR DWORD PlayerClient__SetNameSpriteState;
EQLIB_VAR DWORD PlayerClient__SetNameSpriteTint;
EQLIB_VAR DWORD PlayerManagerClient__GetPlayerFromPartialName;
EQLIB_VAR DWORD PlayerManagerClient__GetSpawnByID;
EQLIB_VAR DWORD PlayerManagerClient__GetSpawnByName;
EQLIB_VAR DWORD PlayerPointManager__GetAltCurrency;
EQLIB_VAR DWORD PlayerZoneClient__ChangeHeight;
EQLIB_VAR DWORD PlayerZoneClient__DoAttack;
...
EQLIB_VAR ForeignPointer<CSidlScreenWnd>             pClaimWnd;
...
EQLIB_VAR DWORD EQMain__LoginController__Shutdown;
