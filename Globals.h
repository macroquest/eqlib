...
EQLIB_VAR uintptr_t __MemChecker2;
EQLIB_VAR uintptr_t __MemChecker3;
...
EQLIB_VAR uintptr_t __IsResEffectSpell;
...
EQLIB_VAR uintptr_t CCombatSkillsSelectWnd__ShouldDisplayThisSkill;
...
EQLIB_VAR uintptr_t CComboWnd__GetTextRect;
...
EQLIB_VAR uintptr_t CContextMenuManager__GetMenu;
...
EQLIB_VAR uintptr_t CCursorAttachment__AttachToCursor1;
EQLIB_VAR uintptr_t CCursorAttachment__Deactivate;
...
EQLIB_VAR uintptr_t CDisplay__SetRenderWindow;
...
EQLIB_VAR uintptr_t CEverQuest__DeleteTargetIndicator;
...
EQLIB_VAR uintptr_t CEverQuest__EnterZone;
...
EQLIB_VAR uintptr_t CGaugeWnd__CalcFillRect;
EQLIB_VAR uintptr_t CGaugeWnd__CalcLinesFillRect;
...
EQLIB_VAR uintptr_t CharacterBase__GetMemorizedSpell;
...
EQLIB_VAR uintptr_t CListWnd__GetColumnTooltip;
EQLIB_VAR uintptr_t CListWnd__GetColumnWidth;
EQLIB_VAR uintptr_t CListWnd__GetCurSel;
EQLIB_VAR uintptr_t CListWnd__GetItemAtPoint;
EQLIB_VAR uintptr_t CListWnd__GetItemAtPoint1;
EQLIB_VAR uintptr_t CListWnd__GetItemData;
EQLIB_VAR uintptr_t CListWnd__GetItemHeight;
EQLIB_VAR uintptr_t CListWnd__GetItemIcon;
...
EQLIB_VAR uintptr_t CListWnd__ShiftColumnSeparator;
...
EQLIB_VAR uintptr_t CSidlManagerBase__FindButtonDrawTemplate1;
...
EQLIB_VAR uintptr_t CStmlWnd__CanBreakAtCharacter;
...
EQLIB_VAR uintptr_t CStmlWnd__InitializeWindowVariables;
...
EQLIB_VAR uintptr_t CTabWnd__GetCurrentPage;
EQLIB_VAR uintptr_t CTabWnd__GetCurrentTabIndex;
EQLIB_VAR uintptr_t CTabWnd__GetPageFromTabIndex;
EQLIB_VAR uintptr_t CTabWnd__GetPageInnerRect;
EQLIB_VAR uintptr_t CTabWnd__GetTabInnerRect;
...
EQLIB_VAR uintptr_t CXWnd__DrawChildren;
...
EQLIB_VAR uintptr_t CXWnd__GetBorderFrame;
...
EQLIB_VAR uintptr_t CXWnd__GetWindowTextA;
...
EQLIB_VAR uintptr_t MapViewMap__dMapViewMap;
EQLIB_VAR uintptr_t MapViewMap__GetWorldCoordinates;
EQLIB_VAR uintptr_t MapViewMap__MapViewMap;
