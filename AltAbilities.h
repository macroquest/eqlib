...
/*0x024*/ HashList<MercenaryAbilitiesData, AbilitiesSize>       MercenaryAbilities;
/*0x134*/ HashList<int, AbilitiesSize>                          MercenaryAbilitiesByGroupID;
/*0x244*/ RequirementAssociationManager                         ReqAssocManager;
/*0x474*/ HashList<int, AbilitiesSize>                          MercenaryAbilitiesOwnedByGroupID;
/*0x584*/ HashList<MercenaryAbilityGroup, AbilitiesSize>        MercenaryAbilityGroups;
/*0x694*/
};
