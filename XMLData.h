...
/*0x1c*/ CXMLEnumInfoArray     enumArray;
/*0x34*/ CHashCXStrCXMLDataPtr classItemHashes;
/*0x4c*/ CXMLDataClassArray    dataArray;
...
/*0x17c*/ bool bStyle_VScroll = false;
/*0x17d*/ bool bStyle_HScroll = false;
/*0x17e*/ bool bStyle_AutoVScroll = false;
/*0x17f*/ bool bStyle_AutoHScroll = false;
/*0x180*/ bool bStyle_Transparent = false;
/*0x181*/ bool bStyle_TransparentControl = false;
/*0x182*/ bool bStyle_Border = false;
/*0x183*/ bool bStyle_Tooltip = true;
/*0x184*/ CXStr sTooltipReference;
/*0x188*/ CXStr sEQType;
/*0x18c*/ uint32_t nWindowDrawTemplate_DrawTemplate = 0;
/*0x190*/ uint32_t nLayoutStrategy_Layout = 0;
/*0x194*/
};
...
/*0x194*/ bool bStyle_Checkbox = false;
/*0x198*/ CXStr sRadioGroup;
/*0x19c*/ CXStr sText;
/*0x1a0*/ CParamRGB MouseoverColor;
/*0x1d0*/ CParamRGB PressedColor;
/*0x200*/ bool bUseCustomMouseoverColor = false;
/*0x201*/ bool bUseCustomDisabledColor = false;
/*0x202*/ bool bUseCustomPressedColor = false;
/*0x203*/ bool bNoWrap = false;
/*0x204*/ bool bTextAlignCenter = false;
/*0x205*/ bool bTextAlignRight = false;
/*0x206*/ bool bTextAlighVCenter = false;
/*0x208*/ int TextOffsetX = 0;
/*0x20c*/ int TextOffsetY = 0;
/*0x210*/ CParamButtonDrawTemplate ButtonDrawTemplate;
/*0x260*/ uint32_t nButtonDrawTemplate_Template = 0;
/*0x264*/ CXStr sSoundPressed;
/*0x268*/ CXStr sSoundUp;
/*0x26c*/ CXStr sSoundFlyby;
/*0x270*/ CParamPoint DecalOffset;
/*0x294*/ CParamSize DecalSize;
/*0x2b8*/
};
