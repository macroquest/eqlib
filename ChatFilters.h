...
#define USERCOLOR_DIRECT_DAMAGE_YOU              397 // 142 - Direct Damage (Yours)
#define USERCOLOR_DIRECT_DAMAGE_OTHERS_CRITICAL  398 // 143 - Direct Damage (Other Critical Hits)
#define USERCOLOR_DOT_YOURS_CRITICAL             399 // 144 - DoTs (Your Critical Hits)
#define USERCOLOR_DOT_OTHERS_CRITICAL            400 // 145 - DoTs (Other Critical Hits)
#define USERCOLOR_DOT_DAMAGE_TAKEN               401 // 146 - DoTs (You Being Hit)
#define USERCOLOR_HEALS_RECEIVED                 402 // 147 - Heals Received
...
enum eChatChannel
{
	...
	CHAT_CHANNEL_CHAT_CHANNEL_INFO,
	CHAT_CHANNEL_95,
	CHAT_CHANNEL_SPELLS_DD_YOURS,
	CHAT_CHANNEL_SPELLS_DD_OTHERS_CRITICAL,
	CHAT_CHANNEL_DOT_YOURS_CRITICAL,
	CHAT_CHANNEL_DOT_OTHERS_CRITICAL,
	CHAT_CHANNEL_DOT_YOU_BEING_HIT,
	CHAT_CHANNEL_HEALS_RECEIVED,
	CHAT_CHANNEL_HEALS_YOUR_CRITICAL,
	CHAT_CHANNEL_HEALS_OTHERS_CRITICAL,
	CHAT_CHANNEL_MELEE_OTHERS_CRITICAL,

	NUM_CHAT_CHANNELS = 105,
};
